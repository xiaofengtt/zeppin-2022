    ...
    <div class="content">
	 ...
	 <div id="step1" class="step1">
		 ...
		 <s:iterator value='gradeMap' id='grade' >
		 	<li class="table-view-cell"><a href="../phone/userUpdateGrade?subject.id=<s:property value='subjectId' />&grade.id=<s:property value='key' />"><s:property value='value' />学期</a></li>
		 </s:iterator>
		 </ul>
		 <div class="step-dot">
			 <span class="cur"></span>
