...
<body>
	...
	<header class="bar bar-nav bar-nav-gs">
		...
		<s:if test="%{currentUserTest.medalType==1}">
			<a class="btn btn-link btn-nav purple pull-left"
				data-transition="slide-out" href="../phone/psychology.jsp"> <span
				class="icon icon-left-nav"></span> 返回首页
			</a>
		</s:if>
		<s:elseif test="%{currentUserTest.medalType==2}">
			<a class="btn btn-link btn-nav purple pull-left"
				data-transition="slide-out" href="../phone/learnAbility.jsp"> <span
				class="icon icon-left-nav"></span> 返回首页
			</a>
		</s:elseif>
		<s:elseif test="%{currentUserTest.medalType==3}">
			<a class="btn btn-link btn-nav purple pull-left"
				data-transition="slide-out" href="../phone/safety.jsp"> <span
				class="icon icon-left-nav"></span> 返回首页
			</a>
		</s:elseif>
