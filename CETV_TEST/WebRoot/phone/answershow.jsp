...
<body data-usertestid='<s:property value="usertId" />' data-clienttype='<s:property value="clientType" />' >
	...
	<header class="bar bar-nav bar-nav-gs">
		...
		<a class="btn btn-link btn-nav purple pull-right" data-transition="slide-out" href="../phone/chart.jsp?subjectId=<s:property value='#session.get("subject.id")' />"> 
			    返回首页	
		</a>
