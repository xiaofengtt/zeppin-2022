...
var questionOpt = {
	...
	qEditinit : function() {
		$.getJSON('../itemLoadItem?id='+url('?id')+'&split=_', function(r) {
			if(r.Status == 'success') {	
				...
				questionOpt.getgklist('textbook','textbookSearchAllTextbook',r.Records.subject_id);
	...
	Addinit : function() {
		...
		if(this.Pid == null) {//单独录入
			...
			questionOpt.getgklist('textbook','textbookSearchAllTextbook',obj.sid);
		}else {//试卷形式录入试题
			this.paperAddinit();
