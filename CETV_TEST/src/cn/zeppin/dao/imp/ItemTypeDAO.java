...
public class ItemTypeDAO extends HibernateTemplateDAO<ItemType, Integer> implements IItemTypeDAO{
	...
	public List<ItemType> searchItemType(Map<String, Object> searchMap,
		...
		//SubjectItemType的cache不能同步，固删   --rjf
//		if (searchMap.get("subjectid") != null && !searchMap.get("subjectid").equals("")){
//			hql.append(", SubjectItemType sit ");
//		}
		hql.append(" where 1=1 ");
		
		//SubjectItemType的cache不能同步，固删  --rjf
//		if (searchMap.get("subjectid") != null && !searchMap.get("subjectid").equals("")){
//			hql.append(" and it.id=sit.itemType ");
//			hql.append(" and sit.subject=").append(searchMap.get("subjectid"));
//		}
