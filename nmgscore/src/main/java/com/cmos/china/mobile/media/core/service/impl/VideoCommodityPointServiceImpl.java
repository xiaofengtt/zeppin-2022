...
public class VideoCommodityPointServiceImpl extends BaseServiceImpl implements IVideoCommodityPointService {
	...
	public void add(InputObject inputObject, OutputObject outputObject) throws Exception {
		...
		if(showType==null||showType.equals("")){
			throw new Exception("未选择显示类型");
		}
		if(timepoint==null||timepoint.equals("")){
			throw new Exception("未完成打点");
		}
		...
		if(showBanner==null||showBanner.equals("")){
			throw new Exception("未上传提示banner");
		}
		...
		if(videoinfo!=null){
			...
			throw new Exception("打点失败，请重新打点");
		}
