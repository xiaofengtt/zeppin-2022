...
public class VideoUtlity
{
     ...
     */
    public static String getVideoLenth(String url) throws ExceptionUtil, MalformedPatternException{
     ...
     * @throws MalformedPatternException 
     */
    public static String getVideoDpi(String url) throws ExceptionUtil, MalformedPatternException{
    	String infomation = getVideoInfo(url);
		PatternCompiler compiler =new Perl5Compiler();
     ...
     */
    public static String runCommand(List<String> command) throws ExceptionUtil, IOException, InterruptedException{
    ...
    public static boolean deleteDirectory(String sPath) {
        ...
        if (!sPath.endsWith(File.separator)) {  
        	sPaths = sPath + File.separator;  
        }  
        File dirFile = new File(sPaths);
