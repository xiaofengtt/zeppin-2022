...
(function(e) {
    ...
    if (e.fn.ajaxForm == undefined) {
        e.getScript("../assets/plugins/jquery.form.js")
    }
    var s1 = 0;
    var t = {};
    ...
    e.fn.uploadFile = function(n) {
        ...
        function h(t, n, r) {
            for (var i = 0; i < r.length; i++) {
                ...
                var d = new g(n, t);
                var v = "";
                if (t.showFileCounter) v = r[i].name;
                else v = r[i].name;
                d.filename.html(v);
        ...
        function g(t, n) {
            ...
            this.progressBackground = e("<div class='ajax-file-upload-bar-background'><div>").appendTo(this.progressDiv);
            this.progressbar = e("<div class='ajax-file-upload-bar " + t.formGroup + "'></div>").appendTo(this.progressBackground);
            this.i1bar = e("<span class='i1'>").appendTo(this.progressDiv);
            this.i2bar = e("<span class='i2'>").appendTo(this.progressDiv);
            this.i3bar = e("<span class='i3'>").appendTo(this.progressDiv);
            this.indexingButton = e("<span class='indexingButton' id='indexingButton_"+n.fileIndex+"'></span>").appendTo(this.progressDiv);
        ...
        function y(n, r, i, s, o, u) {
            ...
            var l = {
                ...
                beforeSend: function(e, n) {
                	var sizem = s1/1024/1024;
                	i.i1bar.html("上传速度:0KB/s");
                	i.i2bar.html("上传进度:0MB/"+sizem.toFixed(2)+"MB");
                	i.i3bar.html("剩余时间:00:00:00");
                    i.progressDiv.show();
                    i.cancel.hide();
                    i.done.hide();
                    if (r.showAbort) {
                ...
                uploadProgress: function(e, t, n, s) {
                	var tlc = (new Date()).getTime();
	                	if(t!=sl && tl !=tlc){
	                	var sizem = s1/1024/1024;
	                	var fc = t/1024/1024; 
	                	i.i2bar.html("上传进度:"+fc.toFixed(2)+"MB/"+sizem.toFixed(2)+"MB");
	                	var sc = t - sl;
	                	var vc = sc / (tlc - tl) * 1000;
	                	var vfc = vc / 1024;
	                	i.i1bar.html("上传速度:" + vfc.toFixed(2) + "KB/s");
	                	var tc = (n - t)/ vc;
	                	i.i3bar.html("剩余时间:"+toTime(tc.toFixed(0)));
                	}
                	sl = t;
                	tl = tlc;
                ...
                success: function(t, u, a) {
                	var sizem = s1/1024/1024;
                	i.i1bar.html("上传速度:0KB/s");
                	i.i2bar.html("上传进度:"+sizem.toFixed(2)+"MB/"+sizem.toFixed(2)+"MB");
                	i.i3bar.html("剩余时间:00:00:00");
...
//                        i.statusbar.remove()
        ...
        e(o).addClass(r.uploadButtonClass); (function b() {
            if (e.fn.ajaxForm) {
                if (r.dragDrop) {
                    var t = e('<div class="ajax-upload-dragdrop" id="ajax-upload-dragdrop" style="vertical-align:top;"></div>');
                    e(s).before(t);
                    e(t).append(o);
