        ...
        function h(t, n, r) {
            for (var i = 0; i < r.length; i++) {
                ...
                if (t.maxFileCount != -1 && n.selectedFiles >= t.maxFileCount) {
                    if (t.showError) e("<div style='color:red;'><b>" + r[i].name + "</b> " + t.maxFileCountErrorStr + "</div>").appendTo(n.errorLog);
                    continue
                }
                n.selectedFiles++;
                var s = t;
            ...
            f.change(function() {
                ...
                if (t.fileapi && t.formdata) {
                    ...
                    if (i.maxFileCount != -1 && n.selectedFiles + a.length > i.maxFileCount) {
                        if (i.showError) e("<div style='color:red;'><b>" + d + "</b> " + i.maxFileCountErrorStr + "</div>").appendTo(n.errorLog);
                        return
                    }
...
//                        i.statusbar.remove()
        ...
        this.formGroup = i;
        this.hide();
        this.errorLog = e("<div id='upload_errorLog_"+r.id+"'></div>");
