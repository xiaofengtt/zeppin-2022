...
function getList() {
	...
	d.showModal();
	$.getJSON('../front/admin/videoinfo!execute?uid=g0008&province='+province+str,function(r) {
		if(r.status == 'success') {
	...
	$.getJSON('../front/admin/videoinfo!execute?uid=g0001&pagesize=10&sort='+str+'&pagenum='+page+'&province='+province+'&status='+filterStatus, function(r) {
...
$(function(){
	function init() {
		var province = (url('?province') != null) ? url('?province') : '';
		$("#uploadButton").attr("href","../views/videoAdd.html?province="+province)
		$("#multipleUploadButton").attr("href","../views/videoMultipleAdd.html?province="+province);
