	...
	$.get('../front/web/webInterface!execute?uid=i0002&category='+id+'&pagesize='+num+'&pagenum=&sort=',function(r){
		if(r.status=="success"){
			...
			for ( var i = 0, l = r.data.length; i < l; i++ ) {
				...
				if(i==0){
					str+="<a href='Video.html?publish=" + r.data[i].publishId +"&id="+r.data[0].id+"&category="+id+"&pagetype=1'><div class='top'><div class='cover-img banner' style='background-image:url(../"+urlimg+");'></div></div><p class='bannerInfo'>"+titles+"</p></a>";
				}else{
					if(i>4){
						break;
					}else{
						str+="<a href='Video.html?publish=" + r.data[i].publishId +"&id="+r.data[i].id+"&category="+id+"&pagetype=1'><div class='video'><div class='img'><div class='top top1'><div class='cover-img' style='background-image:url(../"+urlimg+");'></div></div></div><p>"+titles+"</p><div class='clear'></div></div></a>";	
		...
		if(r.status=="success"){
			...
			for ( var i = 0, l = r.data.length; i < l; i++ ) {
				...
				if(i>6){
					...
					if(i%2==0){
						str+="<a href='Video.html?publish=" + r.data[i].publishId +"&id="+r.data[i].id+"&category="+id+"&pagetype=2'><div class='video_review video_reviewleft'><div class='top'><div class='cover-img' style='background-image:url(../"+urlimg+");'></div></div><p>"+titles+"</p></div></a>";
					}else{
						str+="<a href='Video.html?publish=" + r.data[i].publishId +"&id="+r.data[i].id+"&category="+id+"&pagetype=2'><div class='video_review video_reviewright'><div class='top'><div class='cover-img cover-img1' style='background-image:url(../"+urlimg+");'></div></div><p>"+titles+"</p></div></a>";
					}
				}
		...
		if(r.status=="success"){
			...
			for ( var i = 0, l = r.data.length; i < l; i++ ) {
				...
				if(i>2){
					...
					str+="<a href='Video.html?publish=" + r.data[i].publishId +"&id="+r.data[i].id+"&category="+id+"&pagetype=3'><div class='top top3'><div class='cover-img' style='background-image:url(../"+urlimg+");'></div></div></a>";
				}
			}	
			...
			for ( var i = 0, l = r.data.length; i < l; i++ ) {
				...
				if(i>6){
					...
					if(i%2==0){
						...
						str+="<a href='Video.html?publish=" + r.data[i].publishId +"&id="+r.data[i].id+"&category="+id+"&pagetype=2'><div class='video_review video_reviewright'><div class='top'><div class='cover-img' style='background-image:url(../"+urlimg+");'></div></div><p>"+titles+"</p></div></a>";
					}
				}
