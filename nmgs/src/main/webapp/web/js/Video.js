...
function related(e){
	...
	$.get('../front/web/webInterface!execute?uid=i0002&category='+e+'&pagesize=4&pagenum=&sort=',function(r){
		if(r.status=="success"){
			var str ="";
			for ( var i = 0, l = r.data.length; i < l; i++ ) {
