...
//	var oBigPhoto=document.getElementById('bigphoto');
//	var oSmallPhoto=document.getElementById('smallphoto');
//	var oProg=document.getElementById('prog');
//	var oImg=document.getElementById('img');
//	var oBg=document.getElementById('bg');
//	var iImgCount=arr.length-1;
...
//	var aImg=[];
//	var num=0;
//	var oImgBig=document.getElementById('imgBig');
...
//				oImg.setAttribute('_src','../'+arr[newNow]);
//			}
