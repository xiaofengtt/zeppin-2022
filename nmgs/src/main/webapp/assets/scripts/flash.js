...
//id="d43d03a8-bca5-4e6a-92d6-2cbcca272104";
$(function(){		
		...
		if(r.status=="success"){
			...
			for(var i=0;i<r.data.videoURLs.length;i++){
				...
				flashvars={
						...
						n:'这是提示点的功能|提示点测|提示啥',//提示点文字，跟k配合使用，如 提示点1|提示点2
				...
				flashvars.f=".."+r.data.videoURLs[1];
					...
					CKobject.embedSWF('../assets/ckplayer/ckplayer.swf','a1','ckplayer_a1','100%','100%',flashvars,params);
		}else{
			alert(r.message);
		}
	})
	...
	$.get('../front/web/webInterface!execute?uid=i0004&id='+id,function(r){
		if(r.status=="success"){
			Show=layer.open({
				  ...
				  scrollbar: false,
				  area: ['40%', ''],
				  content: '<div class="wrap"><div style="text-align: center;"><p class="leftAndright"><span class="left"></span><span style="display:inline-block;height: 21px;">左右滑动查看机身</span><span class="right"></span></p><div style="clear: both;"></div></div><div class="container pb30" style="width:90%"><div class="row"><div class=""><div class=""><div class=""><div id="circlr"><div id="loader"></div></div></div></div></div></div></div><div class="shoppers"><div class="shoppersLeft"><h1></h1></div><p class="money">&yen;<span class="number"></span><img src="../web/images/noMoney.png" alt="享受0元购机" /></p><a class="goBuy" href="javascript:" target="_blank">去购买</a><div class="clear"></div></div></div>' 
				}); 
