...
public class AliUtlity {
	...
	public static final String ALI_TRANSFER_CREATE_ORDER_API = "/transfer/recharge/aliCreateOrder";
	public static final String ALI_TRANSFER_QUERY_ORDER_API = "/transfer/recharge/aliQueryOrder";
	public static final String ALI_TRANSFER_CALLBACK_API = "/notice/alipay/companyNotice";
...
//			message = "银行卡号与手机号码匹配，360天内没有使用";
	...
	public static HashMap<String, Object> createOrder4wap(Map<String, Object> acParams, Map<String, String> params) {
		...
		try {
			...
			request.setReturnUrl(params.get("quit_url").toString());
			request.setBizContent("{" +
					...
					"\"quit_url\":\"" + params.get("quit_url").toString() + "\"," +
