...
//    	params.put("channel", "8c41c2ff-2c36-4f90-92e0-6c30618dd92d");
...
//		params.put("sign", MD5.getMD5(authInfo.toString()));
//		
//		params.put("title", "商品");
//		
//		try {
//			String result = WebUtil.post(url, params, 3000, 15000);
...
////		try {
////			Map<String, Object> aa = pc.createRechargeOrder("8c41c2ff-2c36-4f90-92e0-6c30618dd92d", "https://www.baidu.com", "商品", 20000, "1771112133213", "ASD", "一件", null);
