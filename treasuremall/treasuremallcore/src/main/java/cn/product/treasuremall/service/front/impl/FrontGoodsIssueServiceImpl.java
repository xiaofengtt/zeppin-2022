...
import cn.product.treasuremall.vo.front.GroupWinningInfoVO;
...
////		searchMap.put("type", GoodsCoverImageType.TYPE_LIST);
	...
	public void paymentList(InputParams params, DataResult<Object> result) {
		...
		if(Constants.GAME_TYPE_TRADITION.equals(gameType)) {
			tradition2PaymentList(result, pageNum, pageSize, sort, showId, goodsIssue, isLuck);
	...
	public void tradition2PaymentList(DataResult<Object> result, Integer pageNum, Integer pageSize, String sort, String showId, String goodsIssue, Boolean isLuck) {
		Map<String, Object> searchMap = new HashMap<String, Object>();
	...
	public void winningInfoList(InputParams params, DataResult<Object> result) {
		...
		if(Constants.GAME_TYPE_TRADITION.equals(gameType)) {
			tradition2WinningInfo(result, pageNum, pageSize, showId, goodsId, type, sort);
		} else if (Constants.GAME_TYPE_GROUP2.equals(gameType)) {
	 ...
	 * @param sort
	 */
	public void tradition2WinningInfo(DataResult<Object> result, Integer pageNum, Integer pageSize, String showId, String goodsId, String type, String sort) {
		Map<String, Object> searchMap = new HashMap<String, Object>();
		searchMap.put("showId", showId);
