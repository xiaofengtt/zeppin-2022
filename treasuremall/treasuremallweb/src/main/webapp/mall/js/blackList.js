        ...
        data: {
    		...
    		if (r.status == "SUCCESS") {
				var tableHtml = '<tr>'+
								...
								'<th width="120px" class="text-center">充值总额/元</th>'+
								'<th width="120px" class="text-center">提现总额/元</th>'+
								'<th width="150px" class="text-center">领取实物总额/元</th>'+
								'<th width="140px" class="text-center">用户获利/元</th>'+
