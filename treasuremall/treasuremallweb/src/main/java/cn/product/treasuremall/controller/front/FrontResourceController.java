...
import cn.product.treasuremall.entity.Resource.ResourceStatus;
...
@Controller
@RequestMapping(value = "/front/resource")
public class FrontResourceController extends BaseController{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2958853253121205511L;
