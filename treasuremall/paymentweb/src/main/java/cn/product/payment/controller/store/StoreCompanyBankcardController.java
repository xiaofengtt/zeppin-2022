...
public class StoreCompanyBankcardController extends BaseController {
	...
	@ActionParam(key = "bank", message="所属银行", type = DataType.STRING, required = true, maxLength = 36)
	@ActionParam(key = "holder", message="持卡人", type = DataType.STRING, required = true, maxLength = 200)
	@ActionParam(key = "accountNum", message="银行卡号", type = DataType.STRING, required = true, maxLength = 50)
	@ActionParam(key = "area", message="开户地区", type = DataType.STRING, required = true, maxLength = 200)
	@ActionParam(key = "branchBank", message="开户支行", type = DataType.STRING, required = true, maxLength = 200)
	@ResponseBody
