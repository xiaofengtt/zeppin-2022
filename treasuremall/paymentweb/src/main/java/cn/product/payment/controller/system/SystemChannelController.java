...
public class SystemChannelController extends BaseController {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3258933123139119319L;
	...
	public Result list(String status, String type, Integer pageNum, Integer pageSize, String sort) {
		InputParams params = new InputParams("systemChannelService", "list");
	...
	public Result get(String uuid) {
		InputParams params = new InputParams("systemChannelService", "get");
	...
	public Result changeStatus(String uuid, String status) {
		InputParams params = new InputParams("systemChannelService", "changeStatus");
		params.addParams("uuid", null, uuid);
		params.addParams("status", null, status);
		return this.execute(params);
	}
