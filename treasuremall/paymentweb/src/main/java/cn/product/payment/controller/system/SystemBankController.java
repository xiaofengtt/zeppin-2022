...
public class SystemBankController extends BaseController {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -1873064872888827651L;
	...
	public Result list(String name, String status, Integer pageNum, Integer pageSize, String sort) {
		InputParams params = new InputParams("systemBankService", "list");
	...
	public Result get(String uuid) {
		InputParams params = new InputParams("systemBankService", "get");
