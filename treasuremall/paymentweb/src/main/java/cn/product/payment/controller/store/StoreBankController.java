...
@Controller
@RequestMapping(value = "/store/bank")
public class StoreBankController extends BaseController {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4248399164943187287L;
	...
	public Result list(String name, String status, Integer pageNum, Integer pageSize, String sort) {
		InputParams params = new InputParams("storeBankService", "list");
	...
	public Result get(String uuid) {
		InputParams params = new InputParams("storeBankService", "get");
