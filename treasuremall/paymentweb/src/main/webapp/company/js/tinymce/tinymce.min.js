...
! function(e, t) {
    ...
    r(l, [], function() {
        ...
        return function(e, i) {
            ...
            }), f.addAttributeFilter("href,style", function(t, n) {
    ...
    a.settings.image_types = a.settings.image_types || ["image/png", "image/jpeg", "image/bmp", "image/gif"], a.settings.image_max_width = a.settings.image_max_width || "100%", a.on("BeforeRenderUI", function() {
        ...
        function d() {
			...
			h.bind("positionFixed", function(){
                ...
                var c = getBaseUrl()+b.data.url, d = $(a.previewElement), e = d.find("img"), f = e.width(), g = e.height(), h = new Image;
                d.data("-dz-url", c), h.onload = function() {
                    var a = 400, b = 500;
...
function getBaseUrl(){
    ...
    scriptSrc = scriptSrc.substr(0,scriptSrc.lastIndexOf('score')-1);
    return scriptSrc;
}
