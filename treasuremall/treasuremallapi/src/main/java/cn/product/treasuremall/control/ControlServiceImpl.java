...
/**
 * 后台服务接口接入 
 * (interfaceClass = ControlService.class, version="${treasuremall.service.version}", group="${treasuremall.service.apigroup}")
 */
@Service(interfaceClass = ControlService.class, version="${treasuremall.service.version}", group="${treasuremall.service.apigroup}")
