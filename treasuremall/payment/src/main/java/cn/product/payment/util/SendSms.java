...
public class SendSms {
	...
	private static final Map<String, String> suffixMap = new HashMap<String, String> () {
		...
		{
			put(Utlity.PARTMENT_UNION_PAYMENT,UNION_PAYMENT);
		}
	};
	private static final Map<String, String> idMap = new HashMap<String, String> () {
		...
		{
			put(Utlity.PARTMENT_UNION_PAYMENT,"8013510014,b801ac0a0162f96285a7");
		}
	};
	...
	private static final Map<String, String> urlMap = new HashMap<String, String> () {
		...
		{
			put(Utlity.PARTMENT_UNION_PAYMENT,URL_QIRUIYUN);
		}
	};
	...
	public static String getRsultNew(String result) {
		...
		try {
			...
			System.out.println(Utlity.timestampToString(new Timestamp(System.currentTimeMillis()))+"短信发送状态："+status);
			return status;
		} catch (Exception e) {
			return status;
		}
