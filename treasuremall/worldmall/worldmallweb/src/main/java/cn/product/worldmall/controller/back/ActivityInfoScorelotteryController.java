...
@Controller
@RequestMapping(value = "/back/activityScorelottery")
public class ActivityInfoScorelotteryController extends BaseController{
	

	/**
	 * 
	 */
	private static final long serialVersionUID = -1613773976254095010L;

	@RequestMapping(value="/get",method=RequestMethod.GET)
	@ActionParam(key = "uuid", message="uuid", type = DataType.STRING, required = true)
	@ResponseBody
	public Result get(String uuid){
		InputParams params = new InputParams("activityInfoScorelotteryService", "get");
	...
	public Result prizelist(String name, String status, Integer pageNum, Integer pageSize, String sort){
		InputParams params = new InputParams("activityInfoScorelotteryService", "prizelist");
