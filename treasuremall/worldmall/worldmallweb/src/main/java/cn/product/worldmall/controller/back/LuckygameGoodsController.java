...
public class LuckygameGoodsController extends BaseController{
	...
	@ResponseBody
	public Result list(String name, String status, Integer pageNum, Integer pageSize, String sort, String gameType, String demoFlag){
	...
	@ActionParam(key = "demoFlag", message="demoFlag", type = DataType.STRING)
	@ResponseBody
	public Result issuelist(String luckygameGoods, String status, Integer pageNum, Integer pageSize, String sort, String demoFlag){
