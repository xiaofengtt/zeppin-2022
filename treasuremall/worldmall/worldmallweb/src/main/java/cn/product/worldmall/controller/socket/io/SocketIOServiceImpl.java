...
public class SocketIOServiceImpl implements SocketIOService {
	private final static Logger log = LoggerFactory.getLogger(SocketIOServiceImpl.class);
	...
	public void setTransferService(TransferService transferService) {
		SocketIOServiceImpl.transferService = transferService;
	}
    /**
...
//            transferService = applicationContext.getBean(TransferService.class);
            if("lotteryList".equals(dataType)) {//获取即将开奖列表
            	...
            	input.addParams("demoFlag", null, "0");
        		DataResult<Object> dataReslut =  (DataResult<Object>) SocketIOServiceImpl.transferService.execute(input);
