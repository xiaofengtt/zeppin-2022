        ...
        data: {
    		...
    		if (r.status == "SUCCESS") {
    			var tableHtml = '<tr>'+
									...
									'<th width="10%" class="text-center">订单号</th>'+
									'<th width="10%" class="text-center">充值金额/美元</th>'+
        ...
        data: {
    		...
    		if (r.status == "SUCCESS") {
    			var tableHtml = '<tr>'+
									'<th width="7%" class="text-center">序号</th>'+
									'<th width="10%" class="text-center">订单号</th>'+
									'<th width="12%" class="text-center">提现金额/美元(不含手续费)</th>'+
									'<th width="8%" class="text-center">手续费/美元</th>'+
					...
					for(var i=0;i<r.data.length;i++){
						...
						+(r.data[i].poundage).toFixed(2)+'</td><td class="text-left"><p>PayPal账户：'
						+r.data[i].frontUserAccountNumber+'</p></td><td class="text-center">'
