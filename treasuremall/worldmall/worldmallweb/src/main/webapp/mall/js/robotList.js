    		...
    		if (r.status == "SUCCESS") {
				...
				for(var i=0;i<r.data.length;i++){
					...
					if(r.data[i].status!="delete"){
	    				...
	    				'"></td><td class="text-center">'+r.data[i].showId+'</td><td class="showDetail" style="position:relative;"><img src="'+imgUrl+
						'" class="touxiang" style="width:30%;text-align: right;diaplay:inline-block;float:left;" /><p class="activity-center" style="padding-left:5px;word-break:break-all">'+r.data[i].nickname+'</p>'+
