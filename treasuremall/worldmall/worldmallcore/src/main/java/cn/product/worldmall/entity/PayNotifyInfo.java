...
public class PayNotifyInfo implements Serializable {
	...
	public class PayNotifyInfoPayType{
		...
		public final static String RECHARGE_UNION_COM = "recharge_union_com";
		public final static String WITHDRAW_UNION_COM = "withdraw_union_com";
		public final static String RECHARGE_ACICPAY_COM = "recharge_acicpay_com";
		public final static String WITHDRAW_ACICPAY_COM = "withdraw_union_com";
		public final static String RECHARGE_JINZUN_COM = "recharge_jinzun_com";
		public final static String RECHARGE_STRIPE_COM = "recharge_stripe_com";
	}
