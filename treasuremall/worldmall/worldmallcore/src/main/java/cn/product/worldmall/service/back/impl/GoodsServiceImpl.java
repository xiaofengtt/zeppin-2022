...
import cn.product.worldmall.service.back.GoodsService;
import cn.product.worldmall.util.Utlity;
import cn.product.worldmall.vo.back.GoodsCoverImageVO;
import cn.product.worldmall.vo.back.GoodsVO;
...
public class GoodsServiceImpl implements GoodsService{
	...
	public void list(InputParams params, DataResult<Object> result) {
		...
		paramsls.put("demoFlag", demoFlag);
...
//		String admin = paramsMap.get("admin") == null ? "" : paramsMap.get("admin").toString();
		...
		g.setDemoFlag(goods.getDemoFlag());
		g.setInternationalInfo(goods.getInternationalInfo());
