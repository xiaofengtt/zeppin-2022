...
public class Utlity {
	...
	public static final String DEVICE_APP_IOS = "01";
	public static final String DEVICE_APP_ANDROID = "02";
...
//	public static final String PATH_URL = "http://192.168.1.120:28080";//生产测试
	public static final String PATH_URL = "https://api.happyxmall.com";//生产测试
	public static final String IMAGE_PATH_URL = "https://api.happyxmall.com";
//	public static final String IMAGE_PATH_URL = "http://47.56.81.202:28080";
	
	public static final String TANSFER_URL = "https://api.happyxmall.com";
//	public static final String TANSFER_URL = "http://192.168.1.116:28080";
	...
	public static final String PREFIX_NICKNAME = "user";
	...
	public static final Integer FRONT_USER_NORMAL_SHOW_ID_VALUE = 1200000;
...
//		return m.matches();
		if (mobiles != null && !"".equals(mobiles.trim()))
			return mobiles.matches("^[0-9]*[1-9][0-9]*$");
		else
			return false;
	}
	...
	public static String timeSpanToUsString(Timestamp ts) {
//		SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss MM, dd, yyyy");
		SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss MM, dd, yyyy 'GMT'Z");
		TimeZone tz = TimeZone.getTimeZone("GMT");
		sdf.setTimeZone(tz);
		return sdf.format(ts);
	}
	
	public static String timeSpanToUsString(Object ts) {
		SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss MM, dd, yyyy");
		return sdf.format(ts);
	}
     ...
     * @return
     */
    public static String getStarMobile4World(String mobile){
    	...
    	if(mobile != null && !"".equals(mobile)){
    		...
    		sb.append(mobile.substring(0, 3));//截取前四位身份证号码显示
    		sb.append("****");
        	sb.append(mobile.substring(mobile.length() - 3));//截取后四位身份证号码显示
    	}else{
    		return "";
    	}
	 ...
	 * @return
	 */
	public static String getNickname(Integer showId) {
		return PREFIX_NICKNAME + "_" + String.valueOf(showId);
	}
	
	public static void main(String[] args) {
		System.out.println(timeSpanToUsString(new Timestamp(System.currentTimeMillis())));
		...
		sdf.setTimeZone(tz);
		System.out.println(sdf.format(new Timestamp(System.currentTimeMillis())));
		System.out.println(timestampFormat(new Timestamp(System.currentTimeMillis()), format));
	}
}
