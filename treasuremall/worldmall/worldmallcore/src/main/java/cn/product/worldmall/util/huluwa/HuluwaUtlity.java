package cn.product.worldmall.util.huluwa;
...
import cn.product.worldmall.util.HttpClientUtil;
import cn.product.worldmall.util.Utlity;

public class HuluwaUtlity {

	public static final Logger logger= LoggerFactory.getLogger(HuluwaUtlity.class);
	
	public static final String APPID = "Mb2a3b";//xy112233
	public static final String API_CREATE_URL = "http://47.56.90.51:11888/Handler/sdk.ashx?type=create_neworder";
	public static final String API_QUERY_URL = "http://47.56.90.51:11888/Handler/sdk.ashx?type=query_pay";
	protected static final String API_KEY = "DPwrbBeGaxtvDbgtKHvd4fLkcU2j8EeiJWW2PFjLK5F5oX9HExz799n6m6fzSr/r";
	
	/*
	 * 生产
	 */
	public static final String NOTICE_URL_RECHARGE = Utlity.PATH_URL + "/notice/recharge/byHuluwa";
