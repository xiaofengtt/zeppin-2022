...
public class ImageUtils {
	...
	private static final RequestConfig config = RequestConfig.custom()
			.setConnectTimeout(30000).setSocketTimeout(300000).build();
...
//			res.setFiletype(typevalue);
			String typevalue = FileUtlity.getFileType(dataInputStream);
			res.setFiletype(typevalue);
			...
			if(resourcefile.exists()) {
				...
				throw new TransactionException("文件存储异常:"+imageName);
			}
