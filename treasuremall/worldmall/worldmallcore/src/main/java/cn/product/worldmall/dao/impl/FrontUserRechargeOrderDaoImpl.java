...
import cn.product.worldmall.mapper.FrontUserRechargeOrderMapper;
...
public class FrontUserRechargeOrderDaoImpl implements FrontUserRechargeOrderDao{
	...
	public void check(FrontUserRechargeOrder frontUserRechargeOrder, FrontUserAccount frontUserAccount, FrontUserHistory fuh) throws ParseException {
		...
		cah.setCreatetime(frontUserRechargeOrder.getOperattime());
		cah.setReason("用户充值");
		...
		//系统消息通知-充值
		this.frontUserMessageDao.sendMessage(frontUserRechargeOrder, fuh == null ? "" : fuh.getUuid());
	}
