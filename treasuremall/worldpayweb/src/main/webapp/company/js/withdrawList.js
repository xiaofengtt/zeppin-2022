	...
	$.ajax({
		...
		if (r.status == "SUCCESS") {
			var tableHtml = '<tr>'+
				...
				'<th width="180px" class="text-left">Withdrawal Info</th>'+
				...
				'<th width="100px" class="text-center">FailReason</th>'+
			...
			$(".detailBtn").click(function(){
				...
				layer.open({
					...
					title:false,
					area: ['800px', '550px'],
					content:['withdrawProcess.html?type=detail&uuid='+dataUuid,'no']
				}); 
				return false;
			});
			$(".closeBtn").click(function(){
				...
				layer.open({
					...
					title:false,
					area: ['800px', '550px'],
					content:['withdrawProcess.html?type=close&uuid='+dataUuid,'no']
				}); 
				return false;
			});
			$(".retryBtn").click(function(){
				...
				layer.open({
					...
					title:false,
					area: ['800px', '550px'],
					content:['withdrawProcess.html?type=retry&uuid='+dataUuid,'no']
				}); 
				return false;
			});
...
function exportFile(){
	...
	window.open('../store/userWithdraw/export?status='+status+'&channel='+channel+
