...
var baseRoleArr = [];
baseRoleArr['e71fd95e-adcd-4092-b230-21a457703a1d'] = "Administrator";
baseRoleArr['9f82edd6-98a1-4e0e-ad64-059346525d82'] = "Auditor";


$(".goBack-btn").click(function(){
	layer.confirm('Are you sure you want to return？', {
		title:'information',
		btn: ['Confirm', 'Cancel'],
	}, function(){	
		window.history.go(-1);
