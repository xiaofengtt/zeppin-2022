...
import com.product.worldpay.service.system.SystemCompanyAccountHistoryService;
import com.product.worldpay.vo.system.CompanyAccountHistoryVO;

@Service("systemCompanyAccountHistoryService")
public class SystemCompanyAccountHistoryServiceImpl implements SystemCompanyAccountHistoryService {
	...
	public void list(InputParams params, DataResult<Object> result) {
		...
		for(CompanyAccountHistory cah : list){
			...
			ChannelAccount cha = this.channelAccountDao.get(cah.getChannelAccount());
			if(cha != null){
