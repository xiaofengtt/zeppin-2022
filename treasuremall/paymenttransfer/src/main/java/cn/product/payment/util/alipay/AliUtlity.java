...
//		AlipayClient alipayClient = new DefaultAlipayClient(ALI_URL, "2016071901635869", privateKey,FORMAT,CHARSET, publicKey, SIGN_TYPE);
//		AlipayFundTransOrderQueryRequest request = new AlipayFundTransOrderQueryRequest();
//		request.setBizContent("{\"order_id\":\"20200629200040011100250042386146\"}");
