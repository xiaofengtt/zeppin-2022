  ...
  formSubmit: function (e) {
    ...
    wx.request({
      ...
      success: function (result) {
        ...
        var token = base64.encode(app.globalData.systemType + timestamp + app.globalData.userInfo.openId + md5.hexMD5(codeString));

        // 请求注册接口
        wx.request({
          url: app.globalData.urlBase + 'login/resetCheck',
          ...
          success: function (res) {
            if (res.data.status == 'SUCCESS') {
              //返回成功
              wx.navigateTo({
                url: '../reset/reset?phone=' + phone + '&code=' + code,
              })
  ...
  getCode: function (e) {
    ...
    wx.request({
      ...
      data: {
        ...
        codeType: base64.encode('resetpwd')
      },
      method: 'GET',
      success: function (res) {
        if (res.data.status == 'SUCCESS') {
