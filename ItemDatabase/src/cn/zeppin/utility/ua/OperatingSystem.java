...
public enum OperatingSystem {
	...
	WINDOWS_10(Manufacturer.MICROSOFT, OperatingSystem.WINDOWS, 24, "Windows 10", new String[] { "Windows NT 6.4" }, null, DeviceType.COMPUTER, null),
	...
	ANDROID2_TABLET(Manufacturer.GOOGLE, OperatingSystem.ANDROID2, 20, "Android 2.x Tablet", new String[] { "Kindle Fire", "GT-P1000", "SCH-I800" }, null,
	...
	iOS8_IPHONE(Manufacturer.APPLE, OperatingSystem.IOS, 45, "iOS 8 (iPhone)", new String[] { "iPhone OS 8_0" }, null, DeviceType.MOBILE, null), 
	...
	private final String[] excludeList; // don't match when these values are in
										// the agent-string
	private final Manufacturer manufacturer; //厂商
	private final DeviceType deviceType; 	//设备
	private final OperatingSystem parent;	//系统
