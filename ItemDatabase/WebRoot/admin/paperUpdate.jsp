						...
						<div class="paper-type-box" id="paper-type-box<s:property value='itemTypeId' />" data-setionid="<s:property value='id' />">
							<div class="question-handle-box handle-box">
								...
								<div class="control-box fn-clear">
									...
									<s:else>
	                                	<a href="../admin/itemNormalAdd.html?mtype=<s:property value='modeType' />&qtype=<s:property value='itemTypeId' />&paperid=<s:property value='paper.id' />&sectionid=<s:property value='id' />"><span class="add-icon"  data-itemtype="<s:property value='itemTypeId' />">添加</span></a>
									</s:else>
							...
							<div id="q<s:property value='id' />" class="question-item-box">
								<div class="control-box fn-clear">
									<s:if test="%{modeType==4}">
									<a class="btn btn-default btn-sm" href="../admin/itemGroupEdit.html?id=<s:property value='item' />&mtype=<s:property value='#section.modeType' />&qtype=<s:property value='#section.itemTypeId' />&paperid=<s:property value='paper.id' />&sectionid=<s:property value='#section.id' />"><span class="edit-icon" data-id="<s:property value='id' />">编辑</span></a>	
									</s:if>
									<s:else>
									<a class="btn btn-default btn-sm" href="../admin/itemNormalEdit.html?id=<s:property value='item' />&mtype=<s:property value='#section.modeType' />&qtype=<s:property value='#section.itemTypeId' />&paperid=<s:property value='paper.id' />&sectionid=<s:property value='#section.id' />"><span class="edit-icon" data-id="<s:property value='id' />">编辑</span></a>		
									</s:else>	
