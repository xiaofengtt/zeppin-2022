...
<body>
	<input id="scode" type="hidden" value="005005" />
        ...
        <div id="content">
            <div class="box box-main">
        		<form id="inputForm" action="" method="post" class="form-horizontal">
        			<input type="hidden" id="formType" name ="formType" value="TJyXtsypz"/>
        			<div class="box-body">
        				<div class="row">
                            <ol class="breadcrumb">
                                <li>信托受益凭据</li>
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required">*</span> 受益凭据编号：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="sypjbh" maxlength="80" class="form-control input-required"/>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 受益权编码：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="syqlbbm" maxlength="80" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="syrlx" class="form-control">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="syrbh" maxlength="60" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 受益人主体性质：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<select name="syrztxz" class="form-control">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 实际持有信托份额：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="sjcyxtfe" class="form-control number form-money"/>
									</div>
								</div>
							</div>
						</div>
