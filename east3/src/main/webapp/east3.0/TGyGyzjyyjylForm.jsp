...
<body>
	<input id="scode" type="hidden" value="006003" />
        ...
        <div id="content">
            <div class="box box-main">
        		<form id="inputForm" action="" method="post" class="form-horizontal">
        			<input type="hidden" id="formType" name ="formType" value="TGyGyzjyyjyl"/>
        			<div class="box-body">
        				<div class="row">
                            <ol class="breadcrumb">
                                <li>固有资金运用交易流水</li>
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required">*</span> 交易流水编号：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="jylsbh" maxlength="40" class="form-control input-required"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="jysj" maxlength="20" class="form-control form-time" value="" />
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 固有业务标识：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<select name="ywbs" class="form-control">
											<option value="证券投资">证券投资</option>
											<option value="理财投资">理财投资</option>
											<option value="股权投资">股权投资</option>
											<option value="贷款资金">贷款资金</option>
											<option value="期货投资">期货投资</option>
											<option value="同业拆借">同业拆借</option>
											<option value="租赁">租赁</option>
											<option value="债权类投资">债权类投资</option>
											<option value="收益权类投资">收益权类投资</option>
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="zjfx" class="form-control">
											<option value="划入">划入</option>
											<option value="划出">划出</option>
										</select>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="jydsbh" maxlength="40" class="form-control"/>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 交易对手类型：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<select name="jydslx" class="form-control">
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 交易币种：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<select name="jybz" class="form-control form-bz" data-live-search="true" id="bzSelect">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 本金：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="jhbj" class="form-control number form-money" title="本金" />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 收益：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="jhsy" class="form-control number form-money" title="收益" />
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 费用：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="fy" class="form-control number form-money" title="费用" />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="bfzh" maxlength="60" class="form-control"/>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="bfkhhmc" maxlength="200" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="bfkhhbh" maxlength="30" class="form-control"/>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="dfzh" maxlength="60" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="dfkhhmc" maxlength="200" class="form-control"/>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="dfkhhbh" maxlength="30" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 借据编号：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="jjbh" maxlength="80" class="form-control"/>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required">*</span> 冲补抹标志：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<select name="cbmbz" class="form-control input-required">
											<option value="正常">正常</option>
											<option value="冲账">冲账</option>
											<option value="补账">补账</option>
											<option value="抹账">抹账</option>
										</select>
									</div>
								</div>
							</div>
