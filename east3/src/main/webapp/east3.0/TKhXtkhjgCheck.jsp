    ...
    <script type="text/template" id="boxTpl">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 客户编号：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="khbh" maxlength="60" class="form-control" value="{{:khbh}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 客户全称：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="khqc" maxlength="200" class="form-control" value="{{:khqc}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 客户类型：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="khlx" maxlength="30" class="form-control" value="{{:khlx}}" readonly />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 统一社会信用代码：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="tyshxydm" maxlength="40" class="form-control" value="{{:tyshxydm}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="tsdz" maxlength="201" class="form-control" value="{{:tsdz}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="dh" maxlength="30" class="form-control" value="{{:dh}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 传真号码：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="cz" maxlength="30" class="form-control" value="{{:cz}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 是否集团客户：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="sfjtkh" maxlength="3" class="form-control" value="{{:sfjtkh}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 所属集团客户编号：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="ssjtkhbh" maxlength="60" class="form-control" value="{{:ssjtkhbh}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
...
<body>
	<input id="scode" type="hidden" value="003002" />
        ...
        <div id="content">
            <div class="box box-main">
        		<form id="inputForm" action="" method="post" class="form-horizontal">
					<input type="hidden" id="formType" name ="formType" value="TKhXtkhjg"/>
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>信托客户（机构）</li>
                                <li><a href="./TKhXtkhjgCheckList.jsp">数据审核</a></li>
