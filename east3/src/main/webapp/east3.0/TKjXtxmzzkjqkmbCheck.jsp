    ...
    <script type="text/template" id="boxTpl">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 信托总账会计科目编号：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="xtzzkjkmbh" maxlength="60" class="form-control" value="{{:xtzzkjkmbh}}" readonly/>
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 信托总账会计科目名称：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="xtzzkjkmmc" maxlength="200" class="form-control" value="{{:xtzzkjkmmc}}" readonly/>
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 信托总账会计科目级次：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="xtzzkjkmjc" maxlength="18" class="form-control digits" value="{{:xtzzkjkmjc}}" readonly/>
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 信托总账会计科目类型：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="xtzzkjkmlx" maxlength="18" class="form-control digits" value="{{:xtzzkjkmlx}}" readonly/>
					</div>
				</div>
			</div>
			<div class="col-xs-6">
...
<body>
	<input id="scode" type="hidden" value="002002" />
        ...
        <div id="content">
            <div class="box box-main">
        		<form id="inputForm" action="" method="post" class="form-horizontal">
					<input type="hidden" id="formType" name ="formType" value="TKjXtxmzzkjqkmb"/>
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>信托项目总账会计全科目表</li>
                                <li><a href="./TKjXtxmzzkjqkmbCheckList.jsp">数据审核</a></li>
