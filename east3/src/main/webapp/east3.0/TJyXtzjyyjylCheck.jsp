		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="jylsid" maxlength="40" class="form-control" value="{{:jylsid}}" readonly />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="dsfbh" maxlength="40" class="form-control" value="{{:dsfbh}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="bj" class="form-control number" value="{{:bj}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="sy" class="form-control number" value="{{:sy}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
        		...
        		<form id="inputForm" action="" method="post" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>信托资金运用交易流水</li>
                                <li><a href="./TJyXtzjyyjylCheckList.jsp">数据审核</a></li>
