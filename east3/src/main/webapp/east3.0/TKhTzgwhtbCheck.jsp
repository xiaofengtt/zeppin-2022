    ...
    <script type="text/template" id="boxTpl">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 实际合同编号：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="sjhtbh" maxlength="40" class="form-control" value="{{:sjhtbh}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="hzhtmc" maxlength="200" class="form-control" value="{{:hzhtmc}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="tzgwjgbh" maxlength="40" class="form-control" value="{{:tzgwjgbh}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="tzgwmc" maxlength="200" class="form-control" value="{{:tzgwmc}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
		...
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="qzlsqk" maxlength="200" class="form-control" value="{{:qzlsqk}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="gwfl" class="form-control number" value="{{:gwfl}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="sfgt" maxlength="3" class="form-control" value="{{:sfgt}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="gtje" class="form-control number" value="{{:gtje}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="ydcstzjm" class="form-control number" value="{{:ydcstzjm}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="ydtzblxz" maxlength="1000" class="form-control" value="{{:ydtzblxz}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="ydyjx" class="form-control number" value="{{:ydyjx}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="ydbcx" class="form-control number" value="{{:ydbcx}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="ydpcx" class="form-control number" value="{{:ydpcx}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="dsfjglx" maxlength="30" class="form-control" value="{{:dsfjglx}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="frdbmc" maxlength="200" class="form-control" value="{{:frdbmc}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
        		...
        		<form id="inputForm" action="" method="post" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>投资顾问合同表</li>
                                <li><a href="./TKhTzgwhtbCheckList.jsp">数据审核</a></li>
