		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="zhbh" maxlength="60" class="form-control" value="{{:zhbh}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="gyzhlc" maxlength="20" class="form-control" value="{{:gyzhlc}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="khjgzjhm" maxlength="30" class="form-control" value="{{:khjgzjhm}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="khqy" maxlength="6" class="form-control" value="{{:khqy}}" readonly />
					</div>
				</div>
			</div>
		</div>
        		...
        		<form id="inputForm" action="" method="post" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>固有账户信息</li>
                                <li><a href="./TGyGyzhxxCheckList.jsp">数据审核</a></li>
