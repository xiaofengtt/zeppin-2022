		...
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="xtzxmbmh" maxlength="50" class="form-control" value="{{:xtzxmbmh}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="qsrq" maxlength="8" class="form-control" value="{{:qsrq}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="sfaydrqqs" maxlength="6" class="form-control" value="{{:sfaydrqqs}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="ssxtye" class="form-control number" value="{{:ssxtye}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="xtbjljjfe" class="form-control number" value="{{:xtbjljjfe}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="xtsyljfpe" class="form-control number" value="{{:xtsyljfpe}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="tzgwljjbbc" class="form-control number" value="{{:tzgwljjbbc}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="tzgwljyjbc" class="form-control number" value="{{:tzgwljyjbc}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="strljjbbc" class="form-control number" value="{{:strljjbbc}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="strljyjbc" class="form-control number" value="{{:strljyjbc}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="xtfy" class="form-control number" value="{{:xtfy}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="xtfyl" class="form-control number form-decimal3" value="{{:xtfyl}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="sjsy" class="form-control number" value="{{:sjsy}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="sjsyl" class="form-control number form-decimal2" value="{{:sjsyl}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="sjxtbcl" class="form-control number form-decimal2" value="{{:sjxtbcl}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="sunshie" class="form-control number" value="{{:sunshie}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="shesuje" class="form-control number" value="{{:shesuje}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="pfje" class="form-control number" value="{{:pfje}}" readonly />
					</div>
				</div>
			</div>
		</div>
        		...
        		<form id="inputForm" action="" method="post" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>信托项目清算信息</li>
                                <li><a href="./TXmXtxmqsxxCheckList.jsp">数据审核</a></li>
