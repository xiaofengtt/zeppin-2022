...
<head>
	...
	<script>
    	<%	
    		String pageType = "TKjXtxmzzkjqkmb";
    ...
    <script type="text/template" id="queboxTpl">
        <tr>
            ...
            <td>{{:#index + 1}}</td>
            <td>{{:xtxmbh}}</td>
			<td class="xtxmbh">{{:xtxmbh}}</td>
            <td>{{:cjrq}}</td>
            <td class="createTime"></td>
            <td class="updateTime"></td>
            <td>
                <a href="./TKjXtxmzzkjqkmbForm.jsp?id={{:id}}">修改</a>
...
<body>
    <input id="listType" type="hidden" name="" value="TKjXtxmzzkjqkmb">
    <input id="xtxmbhName" type="hidden" name="" value="xtxmbh">
        ...
        <div id="content">
            <div class="box box-main">
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a class="btn btn-sm btn-primary check-button hidden" href="./TKjXtxmzzkjqkmbCheckList.jsp">审核列表</a>
                            <a class="btn btn-sm btn-primary pull-right cboxElement dataOutput" href="javascript:">导出数据</a>
                            <a class="btn btn-sm btn-primary pull-right mr-10" href="./TKjXtxmzzkjqkmbForm.jsp">添加数据</a>
