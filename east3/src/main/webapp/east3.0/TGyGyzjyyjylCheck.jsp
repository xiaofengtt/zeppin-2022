		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="ywbs" maxlength="20" class="form-control" value="{{:ywbs}}" readonly />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="jydsbh" maxlength="40" class="form-control" value="{{:jydsbh}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="jydslx" maxlength="6" class="form-control" value="{{:jydslx}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="jybz" maxlength="3" class="form-control" value="{{:jybz}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="jhbj" class="form-control number" value="{{:jhbj}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="jhsy" class="form-control number" value="{{:jhsy}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="fy" class="form-control number" value="{{:fy}}" readonly />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="jjbh" maxlength="80" class="form-control" value="{{:jjbh}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
        		...
        		<form id="inputForm" action="" method="post" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>固有资金运用交易流水</li>
                                <li><a href="./TGyGyzjyyjylCheckList.jsp">数据审核</a></li>
