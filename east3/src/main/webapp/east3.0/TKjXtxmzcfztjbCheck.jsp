		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="xttjkmbh" maxlength="60" class="form-control" value="{{:xttjkmbh}}" readonly/>
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="xttjkmmc" maxlength="200" class="form-control" value="{{:xttjkmmc}}" readonly/>
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="xttjkmje" class="form-control number" value="{{:xttjkmje}}" readonly/>
					</div>
				</div>
			</div>
		</div>
        		...
        		<form id="inputForm" action="" method="post" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>信托项目资产负债科目统计表</li>
                                <li><a href="./TKjXtxmzcfztjbCheckList.jsp">数据审核</a></li>
