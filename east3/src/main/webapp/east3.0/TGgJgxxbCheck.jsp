		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="zcdq" maxlength="6" class="form-control" value="{{:zcdq}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="clsj" maxlength="8" class="form-control" value="{{:clsj}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="yyzt" maxlength="10" class="form-control" value="{{:yyzt}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="frxm" maxlength="200" class="form-control" value="{{:frxm}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="jgdz" maxlength="200" class="form-control" value="{{:jgdz}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="gsgs" maxlength="1000" class="form-control" value="{{:gsgs}}" readonly />
					</div>
				</div>
			</div>
		</div>
        		...
        		<form id="inputForm" action="" method="post" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>机构信息表</li>
                                <li><a href="./TGgJgxxbCheckList.jsp">数据审核</a></li>
