...
<head>
    ...
    <script type="text/template" id="queboxTpl">
        <tr>
			...
			<td>{{:creatorName}}</td>
            <td>
				<a href="./TGgGdxxbForm.jsp?id={{:dataid}}">修改</a>
				<% if(flagCheck){ %>
					<a href="./TGgGdxxbCheck.jsp?id={{:id}}">审核</a>
				<% } %>
            </td>
        </tr>
    </script>
        ...
        <div id="content">
            <div class="box box-main">
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="./TGgGdxxbList.jsp" class="btn btn-sm btn-primary edit-button hidden">数据列表</a>
