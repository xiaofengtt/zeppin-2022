		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="gdlx" maxlength="12" class="form-control" value="{{:gdlx}}" readonly />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="cgbl" class="form-control number form-decimal2" value="{{:cgbl}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
        		...
        		<form id="inputForm" action="" method="post" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>交易对手（机构）股东信息</li>
                                <li><a href="./TKhJydsjggdxxCheckList.jsp">数据审核</a></li>
