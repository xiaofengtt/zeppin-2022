		...
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="syrqc" maxlength="200" class="form-control" value="{{:syrqc}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="jzdz" maxlength="200" class="form-control" value="{{:jzdz}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="zy" maxlength="60" class="form-control" value="{{:zy}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="grnsr" class="form-control number" value="{{:grnsr}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="jtnsr" class="form-control number" value="{{:jtnsr}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="gxlx" maxlength="60" class="form-control" value="{{:gxlx}}" readonly />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="gzdwdz" maxlength="200" class="form-control" value="{{:gzdwdz}}" readonly />
					</div>
				</div>
			</div>
		</div>
        		...
        		<form id="inputForm" action="" method="post" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>交易对手（个人）</li>
                                <li><a href="./TKhJydsgrCheckList.jsp">数据审核</a></li>
