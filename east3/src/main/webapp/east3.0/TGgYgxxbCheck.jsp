    ...
    <script type="text/template" id="boxTpl">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 员工工号：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="yggh" maxlength="40" class="form-control" value="{{:yggh}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="ygxm" maxlength="200" class="form-control" value="{{:ygxm}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="lxdh" maxlength="30" class="form-control" value="{{:lxdh}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 职务：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="zw" maxlength="40" class="form-control" value="{{:zw}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 是否高管：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="sfgg" maxlength="3" class="form-control" value="{{:sfgg}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 员工状态：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="ygzt" maxlength="30" class="form-control" value="{{:ygzt}}" readonly />
					</div>
				</div>
			</div>
		</div>
...
<body>
	<input id="scode" type="hidden" value="001002" />
        ...
        <div id="content">
            <div class="box box-main">
        		<form id="inputForm" action="" method="post" class="form-horizontal">
					<input type="hidden" id="formType" name ="formType" value="TGgYgxxb"/>
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>员工信息表</li>
                                <li><a href="./TGgYgxxbCheckList.jsp">数据审核</a></li>
