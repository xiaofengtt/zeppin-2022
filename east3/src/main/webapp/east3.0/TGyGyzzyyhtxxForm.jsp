						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="trzhtmc" maxlength="200" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="gyywlb" class="form-control">
											<option value="贷款">贷款</option>
											<option value="融资租赁">融资租赁</option>
											<option value="同业拆借">同业拆借</option>
											<option value="同业存款">同业存款</option>
											<option value="股票投资">股票投资</option>
											<option value="基金投资">基金投资</option>
											<option value="信托计划投资">信托计划投资</option>
											<option value="资管计划投资">资管计划投资</option>
											<option value="理财产品投资">理财产品投资</option>
											<option value="长期控股投资">长期控股投资</option>
											<option value="其他投资">其他投资</option>
											<option value="居间业务">居间业务</option>
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="sfbgscp" class="form-control">
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="btzcpdm" maxlength="40" class="form-control"/>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="ptzcpmc" maxlength="200" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="zhrzcb" class="form-control number form-decimal3" title="综合融资成本" />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="yqsyl" class="form-control number form-decimal2" title="预期收益率" />
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="bmmc" maxlength="40" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="jbrbh" maxlength="40" class="form-control"/>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<input name="txdq" type="hidden" value="" />
									</div>
								</div>
							</div>
						</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="tqzz" class="form-control">
											...
											<option value="附条件允许">附条件允许</option>
										</select>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="rzhtdqrq" maxlength="8" class="form-control form-date" />
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="yshtbh" maxlength="40" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="ysfqjglx" class="form-control">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="ysdslx" class="form-control">
											<option value="个人">个人</option>
											<option value="金融机构">金融机构</option>
											<option value="非金融机构">非金融机构</option>
										</select>
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="ysdsbh" maxlength="40" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
