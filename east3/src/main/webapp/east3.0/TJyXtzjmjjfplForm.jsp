						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="ywbz" class="form-control">
											<option value="申购">申购</option>
											<option value="赎回">赎回</option>
											<option value="受益权转出">受益权转出</option>
											<option value="受益权转入">受益权转入</option>
											<option value="过桥申购">过桥申购</option>
											<option value="过桥赎回">过桥赎回</option>
											<option value="分红">分红</option>
											<option value="强增">强增</option>
											<option value="强减">强减</option>
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="xtzxmbh" maxlength="50" class="form-control"/>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="xthtbh" maxlength="40" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="sypjbh" maxlength="80" class="form-control"/>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="zrdjbh" maxlength="40" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="srrlx" class="form-control">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="srrbh" maxlength="60" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="hsbz" class="form-control form-bz" data-live-search="true" id="bzSelect">
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="dwjz" class="form-control number form-decimal4" title="单位净值" />
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="jyje" class="form-control number form-money" title="交易金额" />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="jyfe" class="form-control number form-money" title="交易份额" />
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="jyfy" class="form-control number form-money" title="交易费用" />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="syje" class="form-control number form-money" title="收益金额" />
									</div>
								</div>
							</div>
							<div class="col-xs-6">
