    ...
    <script type="text/template" id="boxTpl">
        <div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 固有会计科目编号：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="gykjkmbh" maxlength="60" class="form-control" value="{{:gykjkmbh}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="gykjkmmc" maxlength="200" class="form-control" value="{{:gykjkmmc}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="gykjkmjc" maxlength="18" class="form-control digits" value="{{:gykjkmjc}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="sjkmbh" maxlength="60" class="form-control" value="{{:sjkmbh}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="sjkmmc" maxlength="200" class="form-control" value="{{:sjkmmc}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="gsywdl" maxlength="18" class="form-control digits" value="{{:gsywdl}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="gsywzl" maxlength="30" class="form-control" value="{{:gsywzl}}" readonly />
					</div>
				</div>
			</div>
		</div>
        		...
        		<form id="inputForm" action="" method="post" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>固有内部科目对照表</li>
                                <li><a href="./TKjGynbkmdzbCheckList.jsp">数据审核</a></li>
