        ...
        <div id="content">
            <div class="box box-main">
        		<form id="inputForm" action="" method="post" class="form-horizontal">
        			<input type="hidden" id="formType" name ="formType" value="TGgJgxxb"/>
        			<div class="box-body">
        				<div class="row">
                            <ol class="breadcrumb">
                                <li>机构信息表</li>
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 注册地区：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										...
										<input name="zcdq" type="hidden" value="" />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 成立时间：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="clsj" maxlength="8" class="form-control form-date"  />
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 营业状态：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<select name="yyzt" class="form-control">
											<option value="营业">营业</option>
											<option value="停业">停业</option>
											<option value="被合并">被合并</option>
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 法人姓名：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="frxm" maxlength="200" class="form-control"/>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 机构地址：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="jgdz" maxlength="200" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required hide">*</span> 公司概述：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="gsgs" maxlength="1000" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
