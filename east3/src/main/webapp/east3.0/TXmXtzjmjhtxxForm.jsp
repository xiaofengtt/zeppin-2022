        			...
        			<div class="box-body">
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="wtrbh" maxlength="60" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="wtrlx" class="form-control">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="syqbh" maxlength="100" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<label class="control-label col-sm-4" title="">
										<span class="required">*</span> 内部合同编号：<i class="fa icon-question hide"></i></label>
									<div class="col-sm-8">
										<input name="nbhtbh" maxlength="40" class="form-control input-required"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="wthtmc" maxlength="200" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="xsfs" class="form-control">
											<option value="自主营销">自主营销</option>
											<option value="银行推介（含代收代付）">银行推介（含代收代付）</option>
											<option value="证券公司推介">证券公司推介</option>
											<option value="保险推介">保险推介</option>
											<option value="其他信托公司推介">其他信托公司推介</option>
											<option value="其他金融机构推介">其他金融机构推介</option>
											<option value="其他渠道推介（第三方推介）">其他渠道推介（第三方推介）</option>
										</select>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="xssmc" maxlength="200" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="jfzclx" class="form-control">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="wtrqc" maxlength="200" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<input name="htqdd" type="hidden" value="" />
									</div>
								</div>
							</div>
							<div class="col-xs-6">
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="wtje" class="form-control number form-money" title="委托金额" />
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="sczjdzr" maxlength="8" class="form-control form-date"  />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="wtzjxz" class="form-control">
											<option value="自有资金">自有资金</option>
											<option value="代客理财">代客理财</option>
										</select>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="sfjrjglccp" class="form-control">
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="clcpbh" maxlength="40" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
