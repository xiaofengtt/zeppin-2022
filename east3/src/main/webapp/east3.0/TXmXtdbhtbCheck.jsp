		...
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="bzlx" maxlength="20" class="form-control" value="{{:bzlx}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
        ...
        <div id="content">
            <div class="box box-main">
        		<form id="inputForm" action="" method="post" class="form-horizontal">
					<input type="hidden" id="formType" name ="formType" value="TXmXtdbhtb"/>
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>信托担保合同表</li>
                                <li><a href="./TXmXtdbhtbCheckList.jsp">数据审核</a></li>
