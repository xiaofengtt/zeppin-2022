...
<head>
    ...
    <script type="text/template" id="queboxTpl">
        <tr>
            ...
            <td>
                <a href="./TKhJydsjgForm.jsp?id={{:id}}">修改</a>
...
<body>
    <input id="listType" type="hidden" name="" value="TKhJydsjg">
        ...
        <div id="content">
            <div class="box box-main">
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a class="btn btn-sm btn-primary check-button hidden" href="./TKhJydsjgCheckList.jsp">审核列表</a>
                            <a class="btn btn-sm btn-primary pull-right cboxElement dataOutput" href="javascript:">导出数据</a>
                            <a class="btn btn-sm btn-primary pull-right mr-10" href="./TKhJydsjgForm.jsp">添加数据</a>
