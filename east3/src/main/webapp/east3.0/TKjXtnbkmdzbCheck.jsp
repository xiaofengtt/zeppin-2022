    ...
    <script type="text/template" id="boxTpl">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 信托会计科目编号：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="xtkjkmbh" maxlength="60" class="form-control" value="{{:xtkjkmbh}}" readonly />
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="xtkjkmmc" maxlength="200" class="form-control" value="{{:xtkjkmmc}}" readonly />
					</div>
				</div>
			</div>
			<div class="col-xs-6">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="xtkjkmjc" maxlength="18" class="form-control digits" value="{{:xtkjkmjc}}" readonly />
					</div>
				</div>
			</div>
		</div>
        		...
        		<form id="inputForm" action="" method="post" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>信托内部科目对照表</li>
                                <li><a href="./TKjXtnbkmdzbCheckList.jsp">数据审核</a></li>
