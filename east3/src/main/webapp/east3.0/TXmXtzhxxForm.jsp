						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="zhbh" maxlength="40" class="form-control input-required"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="xtzhzh" maxlength="60" class="form-control"/>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="xtzhlx" class="form-control">
											<option value="信托专户">信托专户</option>
											<option value="证券账户（上海）">证券账户（上海）</option>
											<option value="证券账户（深圳）">证券账户（深圳）</option>
											<option value="证券账户（香港）">证券账户（香港）</option>
											<option value="证券保证金账户">证券保证金账户</option>
											<option value="中债登账户">中债登账户</option>
											<option value="上海清算所账户">上海清算所账户</option>
											<option value="期货资金账户">期货资金账户</option>
											<option value="期货套保">期货套保</option>
											<option value="期货套利">期货套利</option>
											<option value="期货投机">期货投机</option>
											<option value="基金账户（基金公司开立）">基金账户（基金公司开立）</option>
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="tgrmc" maxlength="200" class="form-control"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="tgrjrxkz" maxlength="30" class="form-control"/>
									</div>
								</div>
							</div>
							<div class="col-xs-6">
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="ye" class="form-control number form-money"/>
									</div>
								</div>
							</div>
						</div>
