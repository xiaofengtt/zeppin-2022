    ...
    <script type="text/template" id="boxTpl">
		...
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group">
					<label class="control-label col-sm-4" title="">
						<span class="required hide">*</span> 被担保合同编号：<i class="fa icon-question hide"></i></label>
					<div class="col-sm-8">
						<input name="bdbhtbh" maxlength="40" class="form-control" value="{{:bdbhtbh}}" readonly />
					</div>
				</div>
			</div>
		</div>
        ...
        <div id="content">
            <div class="box box-main">
        		<form id="inputForm" action="" method="post" class="form-horizontal">
					<input type="hidden" id="formType" name ="formType" value="TXmXtdbgxb"/>
                    <div class="box-body">
                        <div class="row">
                            <ol class="breadcrumb">
                                <li>信托担保关系表</li>
                                <li><a href="./TXmXtdbgxbCheckList.jsp">数据审核</a></li>
