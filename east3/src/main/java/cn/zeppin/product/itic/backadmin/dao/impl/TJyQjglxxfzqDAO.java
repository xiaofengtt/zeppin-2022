...
@Repository
public class TJyQjglxxfzqDAO extends BaseDAO<TJyQjglxxfzq, String> implements ITJyQjglxxfzqDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_JY_QJGLXXFZQ t where 1=1");
	...
	public List<TJyQjglxxfzq> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TJyQjglxxfzq t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_JY_QJGLXXFZQ t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
