...
@Repository
public class TXmXtdzywbDAO extends BaseDAO<TXmXtdzywb, String> implements ITXmXtdzywbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_XM_XTDZYWB t where 1=1");
	...
	public List<TXmXtdzywb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TXmXtdzywb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_XM_XTDZYWB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
