...
@Repository
public class TKhJydsgrDAO extends BaseDAO<TKhJydsgr, String> implements ITKhJydsgrDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_KH_JYDSGR t where 1=1");
	...
	public List<TKhJydsgr> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TKhJydsgr t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_KH_JYDSGR t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
