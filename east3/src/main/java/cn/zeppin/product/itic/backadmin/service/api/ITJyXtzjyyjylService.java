...
public interface ITJyXtzjyyjylService extends IBaseService<TJyXtzjyyjyl, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TJyXtzjyyjyl> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TJyXtzjyyjyl t, TSsOperatorVO operator);
}
