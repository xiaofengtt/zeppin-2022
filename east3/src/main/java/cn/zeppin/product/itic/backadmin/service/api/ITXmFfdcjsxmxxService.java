...
public interface ITXmFfdcjsxmxxService extends IBaseService<TXmFfdcjsxmxx, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TXmFfdcjsxmxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TXmFfdcjsxmxx t, TSsOperatorVO operator);
}
