...
@Service
public class TKjXtnbkmdzbService extends BaseService implements ITKjXtnbkmdzbService {
	...
	@Override
	public TKjXtnbkmdzb get(String id) {
		return TKjXtnbkmdzbDAO.get(id);
	}
	
	@Override
	public TKjXtnbkmdzb insert(TKjXtnbkmdzb t) {
		return TKjXtnbkmdzbDAO.insert(t);
	}

	@Override
	public TKjXtnbkmdzb delete(TKjXtnbkmdzb t) {
		return TKjXtnbkmdzbDAO.delete(t);
	}

	@Override
	public TKjXtnbkmdzb update(TKjXtnbkmdzb t) {
		return TKjXtnbkmdzbDAO.update(t);
	}

	@Override
	public Integer getCount(Map<String, String> inputParams) {
		return TKjXtnbkmdzbDAO.getCount(inputParams);
	}

	@Override
	public List<TKjXtnbkmdzb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		return TKjXtnbkmdzbDAO.getListForPage(inputParams, pageNum, pageSize, sorts);
	}

	@Override
	public void insertAll(List<Map<String, Object>> datasList, TSsOperatorVO operator) {
		for(Map<String, Object> datas : datasList){
			TKjXtnbkmdzb td = new TKjXtnbkmdzb();
			...
			check.setDatatype("TKjXtnbkmdzb");
	...
	@Override
	public void deleteWholeData(TKjXtnbkmdzb t, TSsOperatorVO operator) {
		TSsLog log = new TSsLog();
		log.setId(UUID.randomUUID().toString());
		log.setDatatype("TKjXtnbkmdzb");
		...
		this.TCheckInfoDAO.deleteByData("TKjXtnbkmdzb", t.getId());
		this.delete(t);
	}
}
