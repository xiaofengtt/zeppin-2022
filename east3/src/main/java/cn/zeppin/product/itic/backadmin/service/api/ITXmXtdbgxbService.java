...
public interface ITXmXtdbgxbService extends IBaseService<TXmXtdbgxb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TXmXtdbgxb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TXmXtdbgxb t, TSsOperatorVO operator);
}
