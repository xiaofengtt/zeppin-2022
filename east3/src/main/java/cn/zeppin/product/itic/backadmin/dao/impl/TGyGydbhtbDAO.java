...
@Repository
public class TGyGydbhtbDAO extends BaseDAO<TGyGydbhtb, String> implements ITGyGydbhtbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_GY_GYDBHTB t where 1=1");
	...
	public List<TGyGydbhtb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TGyGydbhtb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_GY_GYDBHTB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
