...
@Repository
public class TXmFfdcjsxmxxDAO extends BaseDAO<TXmFfdcjsxmxx, String> implements ITXmFfdcjsxmxxDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_XM_FFDCJSXMXX t where 1=1");
	...
	public List<TXmFfdcjsxmxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TXmFfdcjsxmxx t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_XM_FFDCJSXMXX t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
