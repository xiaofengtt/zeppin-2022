...
public interface ITGyGydbgxbService extends IBaseService<TGyGydbgxb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TGyGydbgxb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TGyGydbgxb t, TSsOperatorVO operator);
}
