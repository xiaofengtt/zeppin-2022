...
@Service
public class TXmXtxmyjhklypgbService extends BaseService implements ITXmXtxmyjhklypgbService {
	...
	public void insertAll(List<Map<String, Object>> datasList, TSsOperatorVO operator) {
		for(Map<String, Object> datas : datasList){
			...
			log.setDatatype("TXmXtxmyjhklypgb");
			...
			check.setDatatype("TXmXtxmyjhklypgb");
	...
	@Override
	public void deleteWholeData(TXmXtxmyjhklypgb t, TSsOperatorVO operator) {
		TSsLog log = new TSsLog();
		log.setId(UUID.randomUUID().toString());
		log.setDatatype("TXmXtxmyjhklypgb");
		...
		this.TCheckInfoDAO.deleteByData("TXmXtxmyjhklypgb", t.getId());
		this.delete(t);
	}
}
