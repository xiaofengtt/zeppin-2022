...
@Service
public class TGyGydbhtbService extends BaseService implements ITGyGydbhtbService {
	...
	@Override
	public TGyGydbhtb get(String id) {
		return TGyGydbhtbDAO.get(id);
	}
	
	@Override
	public TGyGydbhtb insert(TGyGydbhtb t) {
		return TGyGydbhtbDAO.insert(t);
	}

	@Override
	public TGyGydbhtb delete(TGyGydbhtb t) {
		return TGyGydbhtbDAO.delete(t);
	}

	@Override
	public TGyGydbhtb update(TGyGydbhtb t) {
		return TGyGydbhtbDAO.update(t);
	}

	@Override
	public Integer getCount(Map<String, String> inputParams) {
		return TGyGydbhtbDAO.getCount(inputParams);
	}

	@Override
	public List<TGyGydbhtb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		return TGyGydbhtbDAO.getListForPage(inputParams, pageNum, pageSize, sorts);
	}
	
	@Override
	public void insertAll(List<Map<String, Object>> datasList, TSsOperatorVO operator) {
		for(Map<String, Object> datas : datasList){
			TGyGydbhtb td = new TGyGydbhtb();
	...
	@Override
	public void deleteWholeData(TGyGydbhtb t, TSsOperatorVO operator) {
		TSsLog log = new TSsLog();
		log.setId(UUID.randomUUID().toString());
		log.setDatatype("TGyGydbhtb");
		...
		this.TCheckInfoDAO.deleteByData("TGyGydbhtb", t.getId());
		this.delete(t);
	}
}
