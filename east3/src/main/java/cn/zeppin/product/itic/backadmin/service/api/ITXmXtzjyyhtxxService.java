...
public interface ITXmXtzjyyhtxxService extends IBaseService<TXmXtzjyyhtxx, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TXmXtzjyyhtxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TXmXtzjyyhtxx t, TSsOperatorVO operator);
}
