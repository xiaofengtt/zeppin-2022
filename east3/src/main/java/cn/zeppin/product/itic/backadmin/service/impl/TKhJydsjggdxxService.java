...
@Service
public class TKhJydsjggdxxService extends BaseService implements ITKhJydsjggdxxService {
	...
	@Override
	public TKhJydsjggdxx get(String id) {
		return TKhJydsjggdxxDAO.get(id);
	}
	
	@Override
	public TKhJydsjggdxx insert(TKhJydsjggdxx t) {
		return TKhJydsjggdxxDAO.insert(t);
	}

	@Override
	public TKhJydsjggdxx delete(TKhJydsjggdxx t) {
		return TKhJydsjggdxxDAO.delete(t);
	}

	@Override
	public TKhJydsjggdxx update(TKhJydsjggdxx t) {
		return TKhJydsjggdxxDAO.update(t);
	}

	@Override
	public Integer getCount(Map<String, String> inputParams) {
		return TKhJydsjggdxxDAO.getCount(inputParams);
	}

	@Override
	public List<TKhJydsjggdxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		return TKhJydsjggdxxDAO.getListForPage(inputParams, pageNum, pageSize, sorts);
	}

	@Override
	public void insertAll(List<Map<String, Object>> datasList, TSsOperatorVO operator) {
		for(Map<String, Object> datas : datasList){
			TKhJydsjggdxx td = new TKhJydsjggdxx();
			...
			check.setDatatype("TKhJydsjggdxx");
	...
	@Override
	public void deleteWholeData(TKhJydsjggdxx t, TSsOperatorVO operator) {
		TSsLog log = new TSsLog();
		log.setId(UUID.randomUUID().toString());
		log.setDatatype("TKhJydsjggdxx");
		...
		this.TCheckInfoDAO.deleteByData("TKhJydsjggdxx", t.getId());
		this.delete(t);
	}
}
