...
public interface ITXmXtxmyjhklypgbService extends IBaseService<TXmXtxmyjhklypgb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TXmXtxmyjhklypgb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TXmXtxmyjhklypgb t, TSsOperatorVO operator);
