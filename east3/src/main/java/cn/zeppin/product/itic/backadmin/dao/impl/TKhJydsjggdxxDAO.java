...
@Repository
public class TKhJydsjggdxxDAO extends BaseDAO<TKhJydsjggdxx, String> implements ITKhJydsjggdxxDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_KH_JYDSJGGDXX t where 1=1");
	...
	public List<TKhJydsjggdxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TKhJydsjggdxx t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_KH_JYDSJGGDXX t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
