...
public interface ITXmXtdbhtbService extends IBaseService<TXmXtdbhtb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TXmXtdbhtb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TXmXtdbhtb t, TSsOperatorVO operator);
}
