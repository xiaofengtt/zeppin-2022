...
@Repository
public class TGyGyzjyyjylDAO extends BaseDAO<TGyGyzjyyjyl, String> implements ITGyGyzjyyjylDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_GY_GYZJYYJYLS t where 1=1");
	...
	public List<TGyGyzjyyjyl> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TGyGyzjyyjyl t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_GY_GYZJYYJYLS t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
