...
public interface ITKhXtkhjgService extends IBaseService<TKhXtkhjg, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TKhXtkhjg> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TKhXtkhjg t, TSsOperatorVO operator);
}
