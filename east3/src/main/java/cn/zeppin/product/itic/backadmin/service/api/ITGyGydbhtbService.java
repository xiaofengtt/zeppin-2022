...
public interface ITGyGydbhtbService extends IBaseService<TGyGydbhtb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TGyGydbhtb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TGyGydbhtb t, TSsOperatorVO operator);
}
