...
public interface ITKjXtnbkmdzbService extends IBaseService<TKjXtnbkmdzb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TKjXtnbkmdzb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TKjXtnbkmdzb t, TSsOperatorVO operator);
}
