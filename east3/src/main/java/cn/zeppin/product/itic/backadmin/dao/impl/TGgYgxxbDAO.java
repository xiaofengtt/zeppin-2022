...
@Repository
public class TGgYgxxbDAO extends BaseDAO<TGgYgxxb, String> implements ITGgYgxxbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_GG_YGXXB t where 1=1");
	...
	public List<TGgYgxxb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TGgYgxxb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_GG_YGXXB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
