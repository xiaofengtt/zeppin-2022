...
public interface ITGyGydzywbService extends IBaseService<TGyGydzywb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TGyGydzywb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TGyGydzywb t, TSsOperatorVO operator);
}
