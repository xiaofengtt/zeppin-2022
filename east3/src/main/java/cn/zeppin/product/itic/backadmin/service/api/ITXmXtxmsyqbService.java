...
public interface ITXmXtxmsyqbService extends IBaseService<TXmXtxmsyqb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TXmXtxmsyqb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TXmXtxmsyqb t, TSsOperatorVO operator);
}
