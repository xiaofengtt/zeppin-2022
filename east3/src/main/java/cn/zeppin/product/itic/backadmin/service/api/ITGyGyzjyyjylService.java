...
public interface ITGyGyzjyyjylService extends IBaseService<TGyGyzjyyjyl, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TGyGyzjyyjyl> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TGyGyzjyyjyl t, TSsOperatorVO operator);
}
