...
@Service
public class TJyXtsyqzrxxService extends BaseService implements ITJyXtsyqzrxxService {
	...
	@Override
	public TJyXtsyqzrxx get(String id) {
		return TJyXtsyqzrxxDAO.get(id);
	}
	
	@Override
	public TJyXtsyqzrxx insert(TJyXtsyqzrxx t) {
		return TJyXtsyqzrxxDAO.insert(t);
	}

	@Override
	public TJyXtsyqzrxx delete(TJyXtsyqzrxx t) {
		return TJyXtsyqzrxxDAO.delete(t);
	}

	@Override
	public TJyXtsyqzrxx update(TJyXtsyqzrxx t) {
		return TJyXtsyqzrxxDAO.update(t);
	}

	@Override
	public Integer getCount(Map<String, String> inputParams) {
		return TJyXtsyqzrxxDAO.getCount(inputParams);
	}

	@Override
	public List<TJyXtsyqzrxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		return TJyXtsyqzrxxDAO.getListForPage(inputParams, pageNum, pageSize, sorts);
	}
	
	@Override
	public void insertAll(List<Map<String, Object>> datasList, TSsOperatorVO operator) {
		for(Map<String, Object> datas : datasList){
			TJyXtsyqzrxx td = new TJyXtsyqzrxx();
			...
			check.setDatatype("TJyXtsyqzrxx");
	...
	@Override
	public void deleteWholeData(TJyXtsyqzrxx t, TSsOperatorVO operator) {
		TSsLog log = new TSsLog();
		log.setId(UUID.randomUUID().toString());
		log.setDatatype("TJyXtsyqzrxx");
		...
		this.TCheckInfoDAO.deleteByData("TJyXtsyqzrxx", t.getId());
		this.delete(t);
	}
}
