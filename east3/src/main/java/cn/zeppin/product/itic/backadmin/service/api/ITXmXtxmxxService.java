...
public interface ITXmXtxmxxService extends IBaseService<TXmXtxmxx, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TXmXtxmxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TXmXtxmxx t, TSsOperatorVO operator);
}
