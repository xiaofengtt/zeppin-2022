...
public interface ITKhJydsjgService extends IBaseService<TKhJydsjg, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TKhJydsjg> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TKhJydsjg t, TSsOperatorVO operator);
}
