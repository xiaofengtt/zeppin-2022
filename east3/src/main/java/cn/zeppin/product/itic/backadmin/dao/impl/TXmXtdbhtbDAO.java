...
@Repository
public class TXmXtdbhtbDAO extends BaseDAO<TXmXtdbhtb, String> implements ITXmXtdbhtbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_XM_XTDBHTB t where 1=1");
	...
	public List<TXmXtdbhtb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TXmXtdbhtb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_XM_XTDBHTB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
