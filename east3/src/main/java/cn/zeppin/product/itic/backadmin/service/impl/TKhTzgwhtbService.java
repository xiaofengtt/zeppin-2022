...
@Service
public class TKhTzgwhtbService extends BaseService implements ITKhTzgwhtbService {
	...
	@Override
	public TKhTzgwhtb get(String id) {
		return TKhTzgwhtbDAO.get(id);
	}
	
	@Override
	public TKhTzgwhtb insert(TKhTzgwhtb t) {
		return TKhTzgwhtbDAO.insert(t);
	}

	@Override
	public TKhTzgwhtb delete(TKhTzgwhtb t) {
		return TKhTzgwhtbDAO.delete(t);
	}

	@Override
	public TKhTzgwhtb update(TKhTzgwhtb t) {
		return TKhTzgwhtbDAO.update(t);
	}

	@Override
	public Integer getCount(Map<String, String> inputParams) {
		return TKhTzgwhtbDAO.getCount(inputParams);
	}

	@Override
	public List<TKhTzgwhtb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		return TKhTzgwhtbDAO.getListForPage(inputParams, pageNum, pageSize, sorts);
	}

	@Override
	public void insertAll(List<Map<String, Object>> datasList, TSsOperatorVO operator) {
		for(Map<String, Object> datas : datasList){
			TKhTzgwhtb td = new TKhTzgwhtb();
	...
	@Override
	public void deleteWholeData(TKhTzgwhtb t, TSsOperatorVO operator) {
		TSsLog log = new TSsLog();
		log.setId(UUID.randomUUID().toString());
		log.setDatatype("TKhTzgwhtb");
		...
		this.TCheckInfoDAO.deleteByData("TKhTzgwhtb", t.getId());
		this.delete(t);
	}
}
