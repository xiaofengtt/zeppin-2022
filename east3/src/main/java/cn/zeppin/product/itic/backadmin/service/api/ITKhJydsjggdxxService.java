...
public interface ITKhJydsjggdxxService extends IBaseService<TKhJydsjggdxx, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TKhJydsjggdxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TKhJydsjggdxx t, TSsOperatorVO operator);
}
