...
@Repository
public class TXmXtzhxxDAO extends BaseDAO<TXmXtzhxx, String> implements ITXmXtzhxxDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_XM_XTZHXX t where 1=1");
	...
	public List<TXmXtzhxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TXmXtzhxx t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_XM_XTZHXX t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
