...
public interface ITKjGyzcfzkmtjbService extends IBaseService<TKjGyzcfzkmtjb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TKjGyzcfzkmtjb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TKjGyzcfzkmtjb t, TSsOperatorVO operator);
}
