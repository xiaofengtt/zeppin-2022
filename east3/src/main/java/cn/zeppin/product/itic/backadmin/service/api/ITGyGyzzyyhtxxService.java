...
public interface ITGyGyzzyyhtxxService extends IBaseService<TGyGyzzyyhtxx, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TGyGyzzyyhtxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TGyGyzzyyhtxx t, TSsOperatorVO operator);
}
