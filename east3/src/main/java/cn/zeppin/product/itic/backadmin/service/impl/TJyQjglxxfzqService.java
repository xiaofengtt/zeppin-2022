...
@Service
public class TJyQjglxxfzqService extends BaseService implements ITJyQjglxxfzqService {
	...
	@Override
	public TJyQjglxxfzq get(String id) {
		return TJyQjglxxfzqDAO.get(id);
	}
	
	@Override
	public TJyQjglxxfzq insert(TJyQjglxxfzq t) {
		return TJyQjglxxfzqDAO.insert(t);
	}

	@Override
	public TJyQjglxxfzq delete(TJyQjglxxfzq t) {
		return TJyQjglxxfzqDAO.delete(t);
	}

	@Override
	public TJyQjglxxfzq update(TJyQjglxxfzq t) {
		return TJyQjglxxfzqDAO.update(t);
	}

	@Override
	public Integer getCount(Map<String, String> inputParams) {
		return TJyQjglxxfzqDAO.getCount(inputParams);
	}

	@Override
	public List<TJyQjglxxfzq> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		return TJyQjglxxfzqDAO.getListForPage(inputParams, pageNum, pageSize, sorts);
	}
	
	@Override
	public void insertAll(List<Map<String, Object>> datasList, TSsOperatorVO operator) {
		for(Map<String, Object> datas : datasList){
			TJyQjglxxfzq td = new TJyQjglxxfzq();
			...
			check.setDatatype("TJyQjglxxfzq");
	...
	@Override
	public void deleteWholeData(TJyQjglxxfzq t, TSsOperatorVO operator) {
		TSsLog log = new TSsLog();
		log.setId(UUID.randomUUID().toString());
		log.setDatatype("TJyQjglxxfzq");
		...
		this.TCheckInfoDAO.deleteByData("TJyQjglxxfzq", t.getId());
		this.delete(t);
	}
}
