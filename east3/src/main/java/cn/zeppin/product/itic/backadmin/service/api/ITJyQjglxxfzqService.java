...
public interface ITJyQjglxxfzqService extends IBaseService<TJyQjglxxfzq, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TJyQjglxxfzq> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TJyQjglxxfzq t, TSsOperatorVO operator);
}
