...
@Repository
public class TXmXtzjmjhtxxDAO extends BaseDAO<TXmXtzjmjhtxx, String> implements ITXmXtzjmjhtxxDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_XM_XTZJMJHTXX t where 1=1");
	...
	public List<TXmXtzjmjhtxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TXmXtzjmjhtxx t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_XM_XTZJMJHTXX t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
