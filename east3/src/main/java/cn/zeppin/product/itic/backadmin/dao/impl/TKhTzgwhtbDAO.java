...
@Repository
public class TKhTzgwhtbDAO extends BaseDAO<TKhTzgwhtb, String> implements ITKhTzgwhtbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_KH_TZGWHTB t where 1=1");
	...
	public List<TKhTzgwhtb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TKhTzgwhtb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_KH_TZGWHTB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
