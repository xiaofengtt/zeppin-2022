...
public interface ITJyQjglxxzqService extends IBaseService<TJyQjglxxzq, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TJyQjglxxzq> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TJyQjglxxzq t, TSsOperatorVO operator);
}
