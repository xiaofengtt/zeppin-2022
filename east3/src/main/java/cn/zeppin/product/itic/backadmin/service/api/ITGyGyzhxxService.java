...
public interface ITGyGyzhxxService extends IBaseService<TGyGyzhxx, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TGyGyzhxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TGyGyzhxx t, TSsOperatorVO operator);
}
