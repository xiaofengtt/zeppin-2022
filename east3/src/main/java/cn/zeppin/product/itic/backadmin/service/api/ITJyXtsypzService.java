...
public interface ITJyXtsypzService extends IBaseService<TJyXtsypz, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TJyXtsypz> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TJyXtsypz t, TSsOperatorVO operator);
}
