...
@Repository
public class TXmXtxmsyqbDAO extends BaseDAO<TXmXtxmsyqb, String> implements ITXmXtxmsyqbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_XM_XTXMSYQB t where 1=1");
	...
	public List<TXmXtxmsyqb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TXmXtxmsyqb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_XM_XTXMSYQB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
