...
@Repository
public class TJyXtsyqzrxxDAO extends BaseDAO<TJyXtsyqzrxx, String> implements ITJyXtsyqzrxxDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_JY_XTSYQZRXX t where 1=1");
	...
	public List<TJyXtsyqzrxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TJyXtsyqzrxx t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_JY_XTSYQZRXX t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
