...
@Repository
public class TJyXtsypzDAO extends BaseDAO<TJyXtsypz, String> implements ITJyXtsypzDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_JY_XTSYPZ t where 1=1");
	...
	public List<TJyXtsypz> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TJyXtsypz t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_JY_XTSYPZ t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
