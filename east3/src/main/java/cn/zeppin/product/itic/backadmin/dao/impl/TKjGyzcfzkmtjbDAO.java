...
@Repository
public class TKjGyzcfzkmtjbDAO extends BaseDAO<TKjGyzcfzkmtjb, String> implements ITKjGyzcfzkmtjbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_KJ_GYZCFZKMTJB t where 1=1");
	...
	public List<TKjGyzcfzkmtjb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TKjGyzcfzkmtjb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_KJ_GYZCFZKMTJB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
