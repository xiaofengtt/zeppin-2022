...
public interface ITGgJgxxbService extends IBaseService<TGgJgxxb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TGgJgxxb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TGgJgxxb t, TSsOperatorVO operator);
}
