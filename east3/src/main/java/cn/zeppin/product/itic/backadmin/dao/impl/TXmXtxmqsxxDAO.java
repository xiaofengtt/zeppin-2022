...
@Repository
public class TXmXtxmqsxxDAO extends BaseDAO<TXmXtxmqsxx, String> implements ITXmXtxmqsxxDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_XM_XTXMQSXX t where 1=1");
	...
	public List<TXmXtxmqsxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TXmXtxmqsxx t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_XM_XTXMQSXX t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
