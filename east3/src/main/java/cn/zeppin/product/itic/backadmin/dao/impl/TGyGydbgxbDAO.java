...
@Repository
public class TGyGydbgxbDAO extends BaseDAO<TGyGydbgxb, String> implements ITGyGydbgxbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_GY_GYDBGXB t where 1=1");
	...
	public List<TGyGydbgxb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TGyGydbgxb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_GY_GYDBGXB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
