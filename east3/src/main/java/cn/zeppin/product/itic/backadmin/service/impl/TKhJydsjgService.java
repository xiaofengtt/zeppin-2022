...
@Service
public class TKhJydsjgService extends BaseService implements ITKhJydsjgService {
	...
	@Override
	public TKhJydsjg get(String id) {
		return TKhJydsjgDAO.get(id);
	}
	
	@Override
	public TKhJydsjg insert(TKhJydsjg t) {
		return TKhJydsjgDAO.insert(t);
	}

	@Override
	public TKhJydsjg delete(TKhJydsjg t) {
		return TKhJydsjgDAO.delete(t);
	}

	@Override
	public TKhJydsjg update(TKhJydsjg t) {
		return TKhJydsjgDAO.update(t);
	}

	@Override
	public Integer getCount(Map<String, String> inputParams) {
		return TKhJydsjgDAO.getCount(inputParams);
	}

	@Override
	public List<TKhJydsjg> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		return TKhJydsjgDAO.getListForPage(inputParams, pageNum, pageSize, sorts);
	}

	@Override
	public void insertAll(List<Map<String, Object>> datasList, TSsOperatorVO operator) {
		for(Map<String, Object> datas : datasList){
			TKhJydsjg td = new TKhJydsjg();
	...
	@Override
	public void deleteWholeData(TKhJydsjg t, TSsOperatorVO operator) {
		TSsLog log = new TSsLog();
		log.setId(UUID.randomUUID().toString());
		log.setDatatype("TKhJydsjg");
		...
		this.TCheckInfoDAO.deleteByData("TKhJydsjg", t.getId());
		this.delete(t);
	}
}
