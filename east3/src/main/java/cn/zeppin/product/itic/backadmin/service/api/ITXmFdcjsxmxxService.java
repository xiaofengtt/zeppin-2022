...
public interface ITXmFdcjsxmxxService extends IBaseService<TXmFdcjsxmxx, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TXmFdcjsxmxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TXmFdcjsxmxx t, TSsOperatorVO operator);
}
