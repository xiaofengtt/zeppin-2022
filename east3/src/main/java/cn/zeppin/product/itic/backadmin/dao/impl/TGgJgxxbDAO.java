...
@Repository
public class TGgJgxxbDAO extends BaseDAO<TGgJgxxb, String> implements ITGgJgxxbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_GG_JGXXB t where 1=1");
	...
	public List<TGgJgxxb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TGgJgxxb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_GG_JGXXB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
