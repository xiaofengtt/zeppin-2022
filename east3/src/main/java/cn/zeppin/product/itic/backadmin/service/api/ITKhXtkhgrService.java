...
public interface ITKhXtkhgrService extends IBaseService<TKhXtkhgr, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TKhXtkhgr> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TKhXtkhgr t, TSsOperatorVO operator);
}
