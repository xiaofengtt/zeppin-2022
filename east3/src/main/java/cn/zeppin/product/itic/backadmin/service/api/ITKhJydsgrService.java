...
public interface ITKhJydsgrService extends IBaseService<TKhJydsgr, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TKhJydsgr> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TKhJydsgr t, TSsOperatorVO operator);
}
