...
public interface ITKhTzgwhtbService extends IBaseService<TKhTzgwhtb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TKhTzgwhtb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TKhTzgwhtb t, TSsOperatorVO operator);
}
