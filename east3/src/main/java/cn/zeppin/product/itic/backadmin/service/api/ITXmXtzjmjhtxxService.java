...
public interface ITXmXtzjmjhtxxService extends IBaseService<TXmXtzjmjhtxx, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TXmXtzjmjhtxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TXmXtzjmjhtxx t, TSsOperatorVO operator);
}
