...
@Service
public class TXmXtzhxxService extends BaseService implements ITXmXtzhxxService {
	...
	@Override
	public TXmXtzhxx get(String id) {
		return TXmXtzhxxDAO.get(id);
	}
	
	@Override
	public TXmXtzhxx insert(TXmXtzhxx t) {
		return TXmXtzhxxDAO.insert(t);
	}

	@Override
	public TXmXtzhxx delete(TXmXtzhxx t) {
		return TXmXtzhxxDAO.delete(t);
	}

	@Override
	public TXmXtzhxx update(TXmXtzhxx t) {
		return TXmXtzhxxDAO.update(t);
	}

	@Override
	public Integer getCount(Map<String, String> inputParams) {
		return TXmXtzhxxDAO.getCount(inputParams);
	}

	@Override
	public List<TXmXtzhxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		return TXmXtzhxxDAO.getListForPage(inputParams, pageNum, pageSize, sorts);
	}

	@Override
	public void insertAll(List<Map<String, Object>> datasList, TSsOperatorVO operator) {
		for(Map<String, Object> datas : datasList){
			TXmXtzhxx td = new TXmXtzhxx();
	...
	@Override
	public void deleteWholeData(TXmXtzhxx t, TSsOperatorVO operator) {
		TSsLog log = new TSsLog();
		log.setId(UUID.randomUUID().toString());
		log.setDatatype("TXmXtzhxx");
		...
		this.TCheckInfoDAO.deleteByData("TXmXtzhxx", t.getId());
		this.delete(t);
	}
}
