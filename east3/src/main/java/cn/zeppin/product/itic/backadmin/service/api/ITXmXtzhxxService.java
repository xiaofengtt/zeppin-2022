...
public interface ITXmXtzhxxService extends IBaseService<TXmXtzhxx, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TXmXtzhxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TXmXtzhxx t, TSsOperatorVO operator);
}
