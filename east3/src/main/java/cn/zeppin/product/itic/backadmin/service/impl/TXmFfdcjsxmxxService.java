...
@Service
public class TXmFfdcjsxmxxService extends BaseService implements ITXmFfdcjsxmxxService {
	...
	@Override
	public TXmFfdcjsxmxx get(String id) {
		return TXmFfdcjsxmxxDAO.get(id);
	}
	
	@Override
	public TXmFfdcjsxmxx insert(TXmFfdcjsxmxx t) {
		return TXmFfdcjsxmxxDAO.insert(t);
	}

	@Override
	public TXmFfdcjsxmxx delete(TXmFfdcjsxmxx t) {
		return TXmFfdcjsxmxxDAO.delete(t);
	}

	@Override
	public TXmFfdcjsxmxx update(TXmFfdcjsxmxx t) {
		return TXmFfdcjsxmxxDAO.update(t);
	}

	@Override
	public Integer getCount(Map<String, String> inputParams) {
		return TXmFfdcjsxmxxDAO.getCount(inputParams);
	}

	@Override
	public List<TXmFfdcjsxmxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		return TXmFfdcjsxmxxDAO.getListForPage(inputParams, pageNum, pageSize, sorts);
	}

	@Override
	public void insertAll(List<Map<String, Object>> datasList, TSsOperatorVO operator) {
		for(Map<String, Object> datas : datasList){
			TXmFfdcjsxmxx td = new TXmFfdcjsxmxx();
			...
			check.setDatatype("TXmFfdcjsxmxx");
	...
	@Override
	public void deleteWholeData(TXmFfdcjsxmxx t, TSsOperatorVO operator) {
		TSsLog log = new TSsLog();
		log.setId(UUID.randomUUID().toString());
		log.setDatatype("TXmFfdcjsxmxx");
		...
		this.TCheckInfoDAO.deleteByData("TXmFfdcjsxmxx", t.getId());
		this.delete(t);
	}
}
