...
@Repository
public class TKjXtnbkmdzbDAO extends BaseDAO<TKjXtnbkmdzb, String> implements ITKjXtnbkmdzbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_KJ_XTNBKMDZB t where 1=1");
	...
	public List<TKjXtnbkmdzb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TKjXtnbkmdzb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_KJ_XTNBKMDZB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
