...
@Service
public class TGgJgxxbService extends BaseService implements ITGgJgxxbService {
	...
	@Override
	public TGgJgxxb get(String id) {
		return TGgJgxxbDAO.get(id);
	}
	
	@Override
	public TGgJgxxb insert(TGgJgxxb t) {
		return TGgJgxxbDAO.insert(t);
	}

	@Override
	public TGgJgxxb delete(TGgJgxxb t) {
		return TGgJgxxbDAO.delete(t);
	}

	@Override
	public TGgJgxxb update(TGgJgxxb t) {
		return TGgJgxxbDAO.update(t);
	}

	@Override
	public Integer getCount(Map<String, String> inputParams) {
		return TGgJgxxbDAO.getCount(inputParams);
	}

	@Override
	public List<TGgJgxxb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		return TGgJgxxbDAO.getListForPage(inputParams, pageNum, pageSize, sorts);
	}
	
	@Override
	public void insertAll(List<Map<String, Object>> datasList, TSsOperatorVO operator) {
		for(Map<String, Object> datas : datasList){
			TGgJgxxb td = new TGgJgxxb();
	...
	@Override
	public void deleteWholeData(TGgJgxxb t, TSsOperatorVO operator) {
		TSsLog log = new TSsLog();
		log.setId(UUID.randomUUID().toString());
		log.setDatatype("TGgJgxxb");
		...
		this.TCheckInfoDAO.deleteByData("TGgJgxxb", t.getId());
		this.delete(t);
	}
}
