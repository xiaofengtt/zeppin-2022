...
@Service
public class TGyGyzjyyjylService extends BaseService implements ITGyGyzjyyjylService {
	...
	@Override
	public TGyGyzjyyjyl get(String id) {
		return TGyGyzjyyjylDAO.get(id);
	}
	
	@Override
	public TGyGyzjyyjyl insert(TGyGyzjyyjyl t) {
		return TGyGyzjyyjylDAO.insert(t);
	}

	@Override
	public TGyGyzjyyjyl delete(TGyGyzjyyjyl t) {
		return TGyGyzjyyjylDAO.delete(t);
	}

	@Override
	public TGyGyzjyyjyl update(TGyGyzjyyjyl t) {
		return TGyGyzjyyjylDAO.update(t);
	}

	@Override
	public Integer getCount(Map<String, String> inputParams) {
		return TGyGyzjyyjylDAO.getCount(inputParams);
	}

	@Override
	public List<TGyGyzjyyjyl> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		return TGyGyzjyyjylDAO.getListForPage(inputParams, pageNum, pageSize, sorts);
	}

	@Override
	public void insertAll(List<Map<String, Object>> datasList, TSsOperatorVO operator) {
		for(Map<String, Object> datas : datasList){
			TGyGyzjyyjyl td = new TGyGyzjyyjyl();
			...
			check.setDatatype("TGyGyzjyyjyl");
	...
	@Override
	public void deleteWholeData(TGyGyzjyyjyl t, TSsOperatorVO operator) {
		TSsLog log = new TSsLog();
		log.setId(UUID.randomUUID().toString());
		log.setDatatype("TGyGyzjyyjyl");
		...
		this.TCheckInfoDAO.deleteByData("TGyGyzjyyjyl", t.getId());
		this.delete(t);
	}
}
