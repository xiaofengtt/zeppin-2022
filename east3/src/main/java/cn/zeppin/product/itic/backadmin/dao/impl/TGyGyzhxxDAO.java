...
@Repository
public class TGyGyzhxxDAO extends BaseDAO<TGyGyzhxx, String> implements ITGyGyzhxxDAO {
	
	@Override
	public TGyGyzhxx insert(TGyGyzhxx t){
		return super.insert(t);
	}
	
	@Override
	public TGyGyzhxx delete(TGyGyzhxx t){
		return super.delete(t);
	}
	
	@Override
	public TGyGyzhxx update(TGyGyzhxx t){
		return super.update(t);
	}
	
	@Override
	public TGyGyzhxx get(String id) {
		return super.get(id);
	}
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_GY_GYZHXX t where 1=1");
	...
	@Override
	public List<TGyGyzhxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TGyGyzhxx t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_GY_GYZHXX t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
