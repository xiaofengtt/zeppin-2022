...
public interface ITKjXtxmzcfztjbService extends IBaseService<TKjXtxmzcfztjb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TKjXtxmzcfztjb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TKjXtxmzcfztjb t, TSsOperatorVO operator);
}
