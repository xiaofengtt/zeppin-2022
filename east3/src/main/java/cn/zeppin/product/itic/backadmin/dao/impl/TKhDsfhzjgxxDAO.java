...
@Repository
public class TKhDsfhzjgxxDAO extends BaseDAO<TKhDsfhzjgxx, String> implements ITKhDsfhzjgxxDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_KH_DSFHZJGXX t where 1=1");
	...
	public List<TKhDsfhzjgxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TKhDsfhzjgxx t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_KH_DSFHZJGXX t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
