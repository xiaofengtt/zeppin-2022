...
public interface ITJyXtsyqzrxxService extends IBaseService<TJyXtsyqzrxx, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TJyXtsyqzrxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TJyXtsyqzrxx t, TSsOperatorVO operator);
}
