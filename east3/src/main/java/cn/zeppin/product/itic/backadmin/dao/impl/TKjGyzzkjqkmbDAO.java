...
@Repository
public class TKjGyzzkjqkmbDAO extends BaseDAO<TKjGyzzkjqkmb, String> implements ITKjGyzzkjqkmbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_KJ_GYZZKJQKMB t where 1=1");
	...
	public List<TKjGyzzkjqkmb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TKjGyzzkjqkmb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_KJ_GYZZKJQKMB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
