...
public interface ITKjXtxmzzkjqkmbService extends IBaseService<TKjXtxmzzkjqkmb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TKjXtxmzzkjqkmb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TKjXtxmzzkjqkmb t, TSsOperatorVO operator);
}
