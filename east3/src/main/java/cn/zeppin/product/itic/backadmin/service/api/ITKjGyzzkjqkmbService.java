...
public interface ITKjGyzzkjqkmbService extends IBaseService<TKjGyzzkjqkmb, String> {
	 ...
	 * @return  List<Entity>
	 */
	 List<TKjGyzzkjqkmb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TKjGyzzkjqkmb t, TSsOperatorVO operator);
}
