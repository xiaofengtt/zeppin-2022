...
@Repository
public class TKjXtxmzzkjqkmbDAO extends BaseDAO<TKjXtxmzzkjqkmb, String> implements ITKjXtxmzzkjqkmbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_KJ_XTXMZZKJQKMB t where 1=1");
	...
	public List<TKjXtxmzzkjqkmb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TKjXtxmzzkjqkmb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_KJ_XTXMZZKJQKMB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
