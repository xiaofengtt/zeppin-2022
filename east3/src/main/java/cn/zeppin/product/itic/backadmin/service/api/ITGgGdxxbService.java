...
public interface ITGgGdxxbService extends IBaseService<TGgGdxxb, String> {
	 ...
	 * @return  List<Entity>
	 */
	List<TGgGdxxb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
	...
	/**
	  * 删除数据
	  */
	void deleteWholeData(TGgGdxxb t, TSsOperatorVO operator);
}
