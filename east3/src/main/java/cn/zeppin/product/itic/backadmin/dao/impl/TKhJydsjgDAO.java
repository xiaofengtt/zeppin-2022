...
@Repository
public class TKhJydsjgDAO extends BaseDAO<TKhJydsjg, String> implements ITKhJydsjgDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_KH_JYDSJG t where 1=1");
	...
	public List<TKhJydsjg> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TKhJydsjg t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_KH_JYDSJG t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
