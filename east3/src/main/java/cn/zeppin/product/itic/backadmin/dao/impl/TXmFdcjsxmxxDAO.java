...
@Repository
public class TXmFdcjsxmxxDAO extends BaseDAO<TXmFdcjsxmxx, String> implements ITXmFdcjsxmxxDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_XM_FDCJSXMXX t where 1=1");
	...
	public List<TXmFdcjsxmxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TXmFdcjsxmxx t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_XM_FDCJSXMXX t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
