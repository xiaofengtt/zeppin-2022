...
@Repository
public class TKjXtxmzcfztjbDAO extends BaseDAO<TKjXtxmzcfztjb, String> implements ITKjXtxmzcfztjbDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_KJ_XTXMZCFZTJB t where 1=1");
	...
	public List<TKjXtxmzcfztjb> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TKjXtxmzcfztjb t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_KJ_XTXMZCFZTJB t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
