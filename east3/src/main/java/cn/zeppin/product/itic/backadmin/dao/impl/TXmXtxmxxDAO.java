...
@Repository
public class TXmXtxmxxDAO extends BaseDAO<TXmXtxmxx, String> implements ITXmXtxmxxDAO {
	...
	public Integer getCount(Map<String, String> inputParams) {
		...
		builder.append(" select count(*) from T_XM_XTXMXX t where 1=1");
	...
	public List<TXmXtxmxx> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts) {
		StringBuilder builder = new StringBuilder();
		builder.append("from TXmXtxmxx t where 1=1 ");
	...
	public void submitData(Map<String,String> inputParams, String cjrq) {
		StringBuilder builder = new StringBuilder();
		builder.append(" update T_XM_XTXMXX t set cjrq='").append(cjrq).append("' , ctltime=sysdate where 1=1");
