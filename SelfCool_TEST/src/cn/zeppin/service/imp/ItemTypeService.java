...
public class ItemTypeService implements IItemTypeService {
	...
	public void addItemType(ItemType itemType) {
		...
		this.getItemTypeDAO().save(itemType);
	}
	...
	public void updateItemType(ItemType itemType) {
		// TODO Auto-generated method stub
		this.getItemTypeDAO().update(itemType);
	}
	...
	public void deleteItemType(ItemType itemType) {
		// TODO Auto-generated method stub
		itemType.setStatus(Dictionary.ITEM_TYPE_STATUS_CLOSED);
	 ...
	 */
	@Override
	public List<ItemType> searchItemType(Map<String, Object> searchMap, String sorts, int offset, int pagesize) {
		// TODO Auto-generated method stub
