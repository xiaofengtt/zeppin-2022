...
public class SsoUserTestAction extends BaseAction {
		...
		if (currentUser == null) {
			...
			if (subject != null) {
				...
				if (selectItems != null && selectItems.size() > 0) {
					Map<String, Object> autoPaperMap = this.getSsoUserTestService().createAutoTest(subject, currentUser, selectItems, split);
    ...
    */
	public void SubmitAutoPaper() {
		...
		if (currentUser == null) {
			...
			if (subject != null && ssoUserTest != null && userSubject != null
					&& currentUser.getId() == ssoUserTest.getSsoUser().getId()){
	...
	public void ItemList() {
		...
		if (currentUser == null || currentUser.getId() != userSubject.getSsoUser().getId()) {
