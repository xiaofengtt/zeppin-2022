...
public class TeacherTrainingReplaceDaoImpl extends BaseDaoImpl<TeacherTrainingReplace, Integer> implements
	...
	public List<TeacherTrainingReplace> getRecordsListByParams(Map<String, Object> params,
		...
		if(params != null && params.size()>0){
			...
			if(params.containsKey("ttr") && params.get("ttr") != null && Integer.parseInt(params.get("ttr").toString()) > -1){
				sb.append(" and ttre.bereplacedttr=");
				sb.append(params.get("ttr"));
			}
			if(params.containsKey("teacherName") && params.get("teacherName") != null && !"".equals(params.get("teacherName"))){
				sb.append(" and ((ttre.teacher.name like'%");
				sb.append(params.get("teacherName"));
				sb.append("%' or ttre.teacher.idcard like '%");
				sb.append(params.get("teacherName"));
				sb.append("%') or (ttre.bereplacedttr.teacher.name like'%");
				sb.append(params.get("teacherName"));
				sb.append("%' or ttre.bereplacedttr.teacher.idcard like '%");
				sb.append(params.get("teacherName"));
				sb.append("%'))");
			}
			if(params.containsKey("organizationScode") && params.get("organizationScode") != null && !"".equals(params.get("organizationScode"))){
				sb.append(" and (ttre.teacher.organization.scode like'%");
				sb.append(params.get("organizationScode"));
				sb.append("%' or ttre.bereplacedttr.teacher.organization.scode like '%");
				sb.append(params.get("organizationScode"));
				sb.append("%')");
			}
		}
