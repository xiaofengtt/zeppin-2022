	...
	IBaseDao<AssignTeacherTask, Integer>
{
     ...
     */
    public List<Map<String, Object>> getAssignTeacherTaskResults(String year, int rprojectId,int rsubjectId, UserSession us, int offset, int length);
    ...
    public List<Map<String, Object>> getAssignTeacherTaskResults(String year, int rprojectId,int rsubjectId, UserSession us, String projectlevel, int offset, int length);
    ...
    public List<Map<String, Object>> getAssignTeacherTaskResultsLevel(String year, int rprojectId,int rsubjectId, UserSession us, String projectlevel, int offset, int length, String orgNum);
}
