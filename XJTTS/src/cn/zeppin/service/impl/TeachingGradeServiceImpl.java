...
public class TeachingGradeServiceImpl extends
		BaseServiceImpl<TeachingGrade, Integer> implements
		ITeachingGradeService {
	...
	public List<TeachingGrade> getListByParams(Map<String, Object> map) {
		return this.teachingGradeDao.getListByParams(map);
	}
