...
public class TeacherServiceImpl extends BaseServiceImpl<Teacher, Integer> implements ITeacherService {
    ...
    public List<Teacher> getTeacherListByParams(HashMap<String,String> map){
    	return this.teacherDao.getTeacherListByParams(map);
    }

	@Override
	public List<Object[]> getListForPageBySql(Integer projectId, Short sbujectId,
			Integer trainingUnitId, int classes, int start, int limit,
			String sort) {
		// TODO Auto-generated method stub
		return this.teacherDao.getListForPageBySql(projectId, sbujectId, trainingUnitId, classes, start, limit, sort);
	}
