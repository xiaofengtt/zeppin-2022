	...
	BaseServiceImpl<ProjectApply, Integer> implements IProjectApplyService
{
    ...
    public List getListForExpert(Map<String, Object> searchMap,int offset,int length){
    	return projectApplyDao.getListForExpert(searchMap,offset,length);
    }
    
    public List getListForEvaluate(Map<String, Object> searchMap,int offset,int length){
    	return projectApplyDao.getListForEvaluate(searchMap,offset,length);
    }
    ...
    public List<ProjectApply> getProjectApplyByParams(Map<String, Object> params,
	    Map<String, String> sortParams, List<ProjectType> lityps)
    {
	return this.getProjectApplyDao().getProjectApplyByParams(params, sortParams, lityps);
    }
	...
	public int getCountByTrainingCollegeId(Integer collegeId) {
		// TODO Auto-generated method stub
		return this.projectApplyDao.getCountByTrainingCollegeId(collegeId);
	}
	...
	public int getProjectApplyCountByParams(Map<String, Object> params,
		...
		// TODO Auto-generated method stub
		return this.projectApplyDao.getProjectApplyCountByParams(params, sortParams);
	}
	...
	public List getProjectApplyByParams(Map<String, Object> params,
		...
		// TODO Auto-generated method stub
		return this.projectApplyDao.getProjectApplyByParams(params, sortParams, offset, length);
	}
	...
	public int getSearchCountByParams(Map<String, Object> params,
			Map<String, String> sortParams) {
		// TODO Auto-generated method stub
		return this.projectApplyDao.getSearchCountByParams(params, sortParams);
	}
	...
	public List getSearchByParams(Map<String, Object> params,
			Map<String, String> sortParams, int offset, int length) {
		// TODO Auto-generated method stub
		return this.projectApplyDao.getSearchByParams(params, sortParams, offset, length);
	}
	...
	public List<ProjectApply> getProjectApplyDByParams(Map<String, Object> params,
			Map<String, String> sortParams, int offset, int length) {
		// TODO Auto-generated method stub
		return this.projectApplyDao.getProjectApplyDByParams(params, sortParams, offset, length);
	}

	@Override
	public int getProjectApplyDCountByParams(Map<String, Object> params) {
		// TODO Auto-generated method stub
		return this.projectApplyDao.getProjectApplyDCountByParams(params);
	}
