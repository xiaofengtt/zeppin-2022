...
public class TrainingAdminServiceImpl extends BaseServiceImpl<TrainingAdmin, Integer> implements ITrainingAdminService {
	...
	@Override
	public List<TrainingAdmin> getTrainingAdminByTrainingCollege(
			Integer trainingCollegeId) {
		// TODO Auto-generated method stub
		String hql = "from TrainingAdmin t where 1 = 1 and t.status=1";
		if(trainingCollegeId > 0){
			hql += " and t.trainingCollege="+trainingCollegeId;
		}
		return this.getListByHSQL(hql);
	}
