 ...
 */
@Entity
@Table(name = "teacher_mobile_code",uniqueConstraints = { @UniqueConstraint(columnNames = "UUID")})
public class TeacherMobileCode implements java.io.Serializable {
	...
	public TeacherMobileCode() {
		super();
		// TODO Auto-generated constructor stub
	}


	public TeacherMobileCode(Integer teacher, String code, String uuid,
			Timestamp creattime) {
		super();
...
//
//	/** minimal constructor */
//	public TeacherMobileCode(Organization organization, TrainingSubject trainingSubject, Project project, Teacher teacher, TrainingCollege trainingCollege, Integer creator, Timestamp creattime, Short checkStatus, String uuid, Boolean isPrepare, Short finalStatus, Short trainingStatus,
...
//
//	/** full constructor */
//	public TeacherMobileCode(Organization organization, TrainingSubject trainingSubject, Project project, Teacher teacher, TrainingCollege trainingCollege, Integer creator, Timestamp creattime, Short checkStatus, String uuid, Boolean isPrepare, Short finalStatus,
