 ...
 *
 */
public class TeacherSignupReActionScope implements java.io.Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -3380260617225791010L;
	private Map<String, Object> trainingCount; // {c1：同项目同学科培训 ,c2：不大于,c3：1次}
	...
	public TeacherSignupReActionScope(Map<String, Object> trainingCount,
			Map<String, Object> years, List<String> projectLevel,
			List<String> projectType, List<String> project,
			List<String> subject, Map<String, Object> hours) {
		super();
	...
	public TeacherSignupReActionScope() {
		super();
	...
	public Map<String, Object> getTrainingCount() {
		return trainingCount;
	}
	


	public void setTrainingCount(Map<String, Object> trainingCount) {
		this.trainingCount = trainingCount;
	}
