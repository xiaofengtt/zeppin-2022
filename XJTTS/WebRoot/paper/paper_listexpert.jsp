...
<div class="main">
<div class="iconDiv">
			<a class="btn btnMyself btn-screen" href="../paper/paper_add?type=1" target="_blank">
							...
							<ul>
								<li><s:if test="%{status != 2 && submits.size()==0}">
									...
									<li><s:if
										...
										<a
											href="../paper/reportExpert_getReportExpertData.action?type=1&paperid=<s:property value="id"/>"
