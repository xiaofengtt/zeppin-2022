	...
	<div id="jqContent" class="" style="text-align: left; ">
		<div class="que-header2">
			<div class="inn">
				...
				<s:elseif test="%{#parameters.type[0]==4}">
					<h1>项目总结专家评审系统</h1>
				</s:elseif>
				<s:else>
...
var ttrid = '<s:property value="#parameters.ttrid"/>';
langVer=0;
var langsufix="";
if(langVer==1)
  langsufix="_en";
   ...
   if(needRegister=="true" && isRunning=="true" && refer.indexOf("/jq/")==-1) {
       ...
       window.onload=function(){
        ...
        if(tMsg&&tMsg.innerHTML && (!getCookie("noJQPromote")||val=="1") && CurrentDomain &&divNotRun){
          divNotRun.innerHTML="<div style=' margin-top:30px;'>"+tMsg.parentNode.innerHTML+"<div style='margin-top:10px;'><input type='button' value='确定' class='operation btn-myself' onclick='window.parent.PDF_close();' /></div></div>";
          window.onload=function(){
