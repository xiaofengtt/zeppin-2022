	...
	<div class="listwrap">
		...
		<div class="report-fliter">
			<form class="form-horizontal" role="form"
				action="../paper/report_getReportData.action">
						...
						<div class="chart-table clearfix">
							<table class="table table-bordered table-hover">
								...
								<tbody>
									...
									<s:iterator value="dataList" id="submit">
										...
										<tr>
											...
											<td><a
												href="../paper/report_detail.action?sub=<s:property value="id"/>&pid=<s:property value="#submit.psq.id"/>"
...
<script type="text/javascript">
	...
	var tcid = url('?tcid');
	var pid = url('?pid');
	$.getJSON('../paper/report_getReportDataPageJson.action?', {
		paperid : paperid,
		page : page,
		pid : pid,
		stid : stid,
	...
	$(function(){
		$('#output').click(function (e) {
            ...
            var http = '../paper/report_outputDataResult.action?paperid='+paperid+'&pid='+pid+'&tcid='+tcid+'&stid='+stid;
