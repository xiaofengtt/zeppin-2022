...
<s:action name="left_init" namespace="/admin" executeResult="true">
	<s:param name="leftName">总结评估问卷</s:param>
</s:action>
...
<div class="main">
<div class="iconDiv">
			<a class="btn btnMyself btn-screen" href="../paper/paper_add?type=4" target="_blank">
...
<!-- 			<a href="../paper/paper_add?type=4" target="_blank" -->
...
<!-- 							<button type="button" onclick="$(this).closest('.popover').hide()" class="btn btn-default">关闭</button> -->
<!-- 							<button type="button" onclick="copy(this)" -->
<!-- 								data-url="../paper/paper_copy?type=4" class="btn btn-primary">复制</button> -->
...
<!-- 		    </div> -->
		...
		<div id="stuff" class="list-content clearfix">
			<s:iterator value="summarizeList" id="learn">
							...
							<tbody>
								<tr>
									...
									<td width="auto"><a target="_blank"
										href="../paper/paper_view.action?type=4&id=<s:property
												...
												<td width="300px">
													<div id="projecttypecnt_<s:property value="id" />"
														...
														<div class="ufcwrap" id="resCon">
															<div class="ufc">
																<span class="usel"
																	onclick="showul($(this));getul(this,'4','<s:property value="id" />')"><strong>请选择项目...</strong></span>
																<ul class="uul"></ul>
															</div>
					...
					<div class="list-item-bd clearfix">
							...
							<ul>
								<li><s:if test="%{status != 2 && submits.size()==0}">
										<a class="view" target="_blank" title="设计问卷" editversion="0"
											...
											href="../paper/paper_edit?type=4&curid=<s:property value="id"/>">
									...
									<li><s:if
										test="%{projectsForProjectSummarizePsq.size()>0}">
										<a
											href="../paper/reportExpert_getReportExpertData.action?type=4&paperid=<s:property value="id"/>"
						...
						<div class="list-item-col " style="width:40%">
							...
							<div id="resmtr_<s:property value="id" />" class="promtc">
								<s:iterator value="projectsForProjectSummarizePsq" id="project">
									<div class="mtc">
										...
										<span
											onclick="delP(this,'<s:property value="id" />','4','<s:property value="#learn.getId()" />')"
