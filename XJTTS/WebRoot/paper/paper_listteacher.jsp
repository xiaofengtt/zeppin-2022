...
<s:action name="left_init" namespace="/admin" executeResult="true">
	<s:param name="leftName">教评学问卷</s:param>
</s:action>
...
<link href="../css/iframe.css" rel="stylesheet" type="text/css">
	...
	.usels strong b{display:inline-block;width:70px;padding-left:10px;}
	.score{display:none;}
	.score input{display:inline-block;width:70px;}
	.save,.edit{margin-left:5px;cursor:pointer;}
...
<div class="main">
<div class="iconDiv">
			<a class="btn btnMyself btn-screen" href="../paper/paper_add?type=2" target="_blank">
...
<!-- 			<a href="../paper/paper_add?type=2" target="_blank" -->
...
<!-- 		    </div> -->
		...
		<div id="stuff" class="list-content clearfix">
			<s:iterator value="teachList" id="learn">
							...
							<tbody>
								<tr>
									...
									<td width="auto"><a target="_blank"
										href="../paper/paper_view.action?type=2&id=<s:property
											value="id" />&t=x123"><s:property
												...
												<td width="300px">
													<div id="projecttypecnt_<s:property value="id" />"
														...
														<div class="ufcwrap" id="resCon">
															<div class="ufc">
																<span class="usel"
																	onclick="showul($(this));getul(this,'2','<s:property value="id" />')"><strong>请选择项目...</strong></span>
																<ul class="uul"></ul>
															</div>
												...
												<td width="180px">
													<span class="usels" onclick=""><strong>总分：<b><s:property value="totalScore" /></b></strong><a class="edit">修改</a></span>
													<div class="score"><input class="form-control" /><a class="save" name='<s:property
											value="id" />' onclick="saveScore(this);">保存</a></div>
												</td>
					...
					<div class="list-item-bd clearfix">
						...
						<div class="list-item-col "  style="width:40%">
							...
							<div id="resmtr_<s:property value="id" />" class="promtc">
								<s:iterator value="projectsForEvaluationTeacherPsq" id="project">
									<div class="mtc">
										...
										<span
											onclick="delP(this,'<s:property value="id" />','2','<s:property value="#learn.getId()" />')"
...
function changeYear(t){
	...
	$(".edit").click(function(){
		$(this).css("display","none").siblings("strong").find("b").css("display","none").parent().parent().siblings(".score").css("display","inline-block");
	});
	$(".save").click(function(){
	...
	function saveScore(obj){
		...
		var score=$(obj).siblings("input").val().replace(/(^\s*)|(\s*$)/g, "");
		var reg=/^[0-9]+(.[0-9]{1})?$/;
		if(score==""||reg.test(score)==false){
			$(obj).siblings("input").css({
				"border-color" : "#f00",
				"box-shadow" : "none"
			});
			layer.confirm('填写必须全部为数字', {
			  btn: ['确定'] //按钮
			}, function(){
			  layer.closeAll();
			});
			...
			if(score>100){
				...
				$(obj).siblings("input").removeAttr("style");
				$.ajax({
			        type: "POST",
			        url: "../paper/paper_addTotalScore.action",
			        ...
			        success: function (data) {
			        	...
			        	if(json.status==true){
			        		$(obj).parent().css("display","none").siblings(".usels").find("b").css("display","inline-block").html(score)
							.parent().siblings(".edit").css("display","inline-block");
