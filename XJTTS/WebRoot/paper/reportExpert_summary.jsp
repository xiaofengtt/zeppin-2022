	...
	<div class="listwrap">
		...
		<div class="nav">
			<ul class="nav nav-tabs">
				...
				<li>
					<a href="../paper/reportExpert_getReportExpertPaper.action?type=<s:property value="#parameters.type"/>&paperid=<s:property value="#parameters.paperid"/>">每题统计</a>
				</li>
		...
		<div class="report-fliter">
			<form class="form-horizontal" role="form"
				action="../paper/reportExpert_getReportExpertSummary.action">
				...
				<s:if test="summaryList.size() > 0">
					...
					<div class="result-content">
						<div class="chart-table clearfix">
							<h2>
								<span class="fl">此问卷专家评审总平均分： <s:property
										value="avgCountScore" />
								</span>
							</h2>
								...
								<tbody>
									...
									<s:iterator value="summaryList" id="question">
										<tr>
											...
											<td><s:property value="#question[4]" /></td>
										</tr>
