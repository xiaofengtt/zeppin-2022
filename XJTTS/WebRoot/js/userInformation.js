    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (Result == "OK") {
                ...
                graduationText.innerHTML = records.graduation;
                majorText.innerHTML = records.major;
                ...
                if(typeof(records.mainTeachingLanguage) == 'undefined'){
                	languageText.innerHTML = '未设置';
                }else {
                	languageText.innerHTML = records.mainTeachingLanguage;
                }
                if(typeof(records.mainTeachingGrades) == 'undefined'){
                	gradeText.innerHTML = '未设置';
                }else {
                	gradeText.innerHTML = records.mainTeachingGrades;
                }
                if(typeof(records.mainTeachingSubject) == 'undefined'){
                	subjectText.innerHTML = '未设置';
                }else {
    ...
    $.ajax({
        ...
        success: function (data) {
            if(data.Result == "OK"){
                ...
                $("#background").html(data.Records[0].teacher[0].eductionBackground.name);
//                $("#organization").html(data.Records[0].teacher[0].organization.name);
...
//                organizationText.innerHTML = $("#select2-chosen-1")[0].innerHTML;
                graduationText.innerHTML = $("#graduation").val();
                majorText.innerHTML = $("#major").val();
