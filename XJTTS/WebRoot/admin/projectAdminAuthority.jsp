...
<s:action name="left_init" namespace="/admin" executeResult="true">
	<s:param name="leftName">查看管理员权限</s:param>
</s:action>
<style type="text/css">
...
<div class="main">
	...
	<div class="tablewrap">
		<div id="searchbox" class="searchbox" style="right:0;top:15px;">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$('#ProjectTableContainer')
						.jtable(
								{
									title : '<a href="../admin/projectAdmin_authority.action">查看管理员权限</a> ',
									...
									actions : {
										listAction : '../admin/projectAdmin_getProjectAdminAuthorityList.action',
									},
									fields : {
										id : {
											title : 'ID',
