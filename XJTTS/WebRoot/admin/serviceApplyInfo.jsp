...
<div class="main">
	...
	<div class="iconDiv">
		<a class="btn btnMyself btn-create"
			...
			<p>
				<img src="../img/lanse.png" alt="蓝色三角"> <b>添加申请</b>
			</p>
		</a>
        ...
        success: function (json) {
        	...
        	if(data.Result=='OK'){
        		...
        		for(var i=0;i<data.Records.length;i++){
        			...
        			'<a class="answer">回复</a><a class="delete" onclick="doDelete('+data.Records[i].id+',1)">删除</a>'+''+
        	...
        	if(json.Result=="OK"){
        		if(json.TotalCount==0){
        			...
        			for(var i=0;i<json.Records.length;i++){
            			...
            			+''+'<a class="deleteChild showAll">显示全部</a><a class="deleteChild" onclick="doDelete('
