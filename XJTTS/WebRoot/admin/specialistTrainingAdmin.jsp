...
<s:action name="left_init" namespace="/admin" executeResult="true">
	<s:param name="leftName">授课专家管理</s:param>
</s:action>
<div class="main">
	...
	<div class="tablewrap">
		...
		<div class="cui-menu">
			<a class="btn btn-primary btn-create" data-fancybox-type="iframe"
				href="../admin/specialist_addInit.action">+ 添加授课专家</a>
		</div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$('#ProjectTableContainer')
						.jtable(
								{
									title : '<a href="../admin/specialist_initPage.action">授课专家管理</a> ',
									...
									actions : {
										listAction : '../admin/specialist_getSpecialistList.action',

										deleteAction : '../admin/specialist_deleteSpecialist.action'
									...
									fields : {
										...
										customedit : {
											...
											display : function(
													data) {
												var html = '<a class="ifrbox jtable-cmd-btn" data-fancybox-type="iframe" href="../admin/specialist_addInit.action?id='
														+ data.record.id
														+ '">编辑</a>';
												return html;
											}
