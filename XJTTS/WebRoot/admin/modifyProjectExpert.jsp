...
<body>
	<div class="ifrcnt container">
		...
		<div class="bd">
			...
			<form id="addprojectExpert" class="form-horizontal" role="form"
				action="../admin/projectExpertMana_opProjectExpert.action" method="post">
				...
				<div class="clearfix">
					...
					<div class="span5">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="" name="name" readonly class="readonly"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="" name="idcard" readonly class="readonly"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="" name="organization"
									value="<s:property	value="organization" />">
							</div>
						</div>
	...
	<script>
		...
		$(function() {
			$('#addprojectExpert').submit(
				function() {
					var str = $(this).serialize();
					$.get('admin/projectExpertMana_opProjectExpert.action?'+ str, function(data) {
