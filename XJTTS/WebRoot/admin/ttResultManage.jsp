...
<!-- 						</div> -->
				...
				<div class="row actionbar">
					...
					<div class="text-center">
						...
						<button class="btn btn-default btn-myself ifrmbox2" id="" type="button" href="teacherManage_adjustInit.action?editId="data-fancybox-type="iframe">导入</button>
						</s:if>
					</div>
				</div>
			</form>
			<div class="stateDiv">
<!-- 				<label>状态</label> -->
				<a class="light" value="-1">全部<span id="span1"></span></a>
				<a class="" value="1">未审核<span id="span3"></span></a>
				<a class="" value="2">已审核<span id="span2"></span></a>
				<a class="" value="-2">通过<span id="span4"></span></a>
				<a class="" value="0">未通过<span id="span5"></span></a>
			</div>
							...
							<table class="table table-bordered">
								<tbody>
									<tr>
										...
										<td width="200px"><span class="text-primary">培训项目：{{:projectName}}—{{:trainingName}}</span></td>
...
<script>
	...
	function ttrecordAdu(o, pp) {
		...
		var str = $(o).serialize() + '&page=' + pp+'&status='+$('.stateDiv a.light').attr("value");
		var enrollType = url();
