...
<link rel="stylesheet" href="../css/iframe.css">
	<style>#sumtable th,#sumtable td {min-width:80px; vertical-align: middle}
...
<div class="main">
	<div class="listwrap">
		<div class="list_bar">项目名额分配统计<a style="margin-left: 20px" href='../admin/assignTeacherTask_initAssignGroupResult.action'>多阶段项目名额分配统计</a></div>
