...
<s:action name="left_init" namespace="/admin" executeResult="true">
	<s:param name="leftName">职称设置</s:param>
</s:action>
	...
	<div class="tablewrap">
		...
		<div id="searchbox" class="searchbox" style="top:15px;">
			<form class="search search_form" action="/cloudadmin/" method="get">
				<fieldset>
					<label for="searchheader" class="placeholder overlabel">职称名称</label>
					<input autocomplete="off" id="searchheader" value="" type="text" name="q">
					<input type="hidden" name="" value="">
					<div class="show_dropdown">
						<div class="dropdown" style="display: block;">
							<ul>
								<li><label for="type_title">按职称名称</label><input type="radio" name="stype" value="name" checked="checked">
								</li>
										...
										.jtable(
												{
													...
													actions : {
														listAction : '../admin/jobTitle_List.action?type=all',
														updateAction : '../admin/jobTitle_Edit.action',
														deleteAction : '../admin/jobTitle_Delete.action',
														createAction : '../admin/jobTitle_Add.action'
													},
													fields : {
														id : {
															title : 'ID',
