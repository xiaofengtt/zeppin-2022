...
<s:action name="left_init" namespace="/admin" executeResult="true">
	<s:param name="leftName">发件箱列表</s:param>
</s:action>
<div class="main">
	...
	<div class="tablewrap">
		...
		<div class="cui-menu">
			<a class="btn btn-primary" href="../admin/mail_getInboxListInit.action">收件箱</a>&nbsp;&nbsp;
			<a class="btn btn-primary" href="javascript:void(0);">发件箱</a>
		</div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$('#ProjectTableContainer')
						.jtable(
								{
									title : '<a class="btn btn-primary" href="../admin/mail_adminAddInit.action">+ 写信息</a>',
									...
									actions : {
										listAction : '../admin/mail_getOutBoxListForProjectAdmin.action',
										deleteAction : '../admin/mail_changeStatus.action?method=output'
									},
									fields : {
										id : {
											title : '',
										...
										customedit : {
											...
											display : function(data) {
												var html = '<a class="jtable-cmd-btn" href="../admin/mail_getOutboxMailInformationInit.action?id='
														+ data.record.id
														+ '">查看</a>';
												return html;
											}
										...
										passwordedit : {
											...
											visibility : 'fixed',
											display : function(data) {
												var html = '<a class="jtable-cmd-btn" href="../admin/mail_adminAddInit.action?id='
													+ data.record.id
													+ '">转发</a>';
												return html;
											}
