	...
	<div class="listwrap">
		...
		<div class="iconDiv">
			<a class="btn btn-create btnMyself btn-screen"
				href="../admin/identifyClasshours_initAddProjectYearPage"
		...
		<div id="list-content" class="list-content clearfix"
			...
			<table class="table table-hover">
				<tr>
					<th width="17%" style="text-align: left;">项目名称</th>
...
<script type="text/javascript">
	...
	function getTable() {
		...
		$
				.getJSON(
						'../admin/identifyClasshours_getSpecialProjectYearList.action?page='+page,
						function(data) {
							if (data.status == "OK") {
...
// 			var year = $(obj).parent().parent().find("div.td9_0 option:selected").val();
			...
			$.getJSON('../admin/identifyClasshours_specialProjectYearAdd.action?method=edit&id=' + id
					+ '&projectId=' + projectId + '&centralizeCH='
	...
	function dele(obj){
		...
		//按钮
			...
			$.getJSON('../admin/identifyClasshours_deleteProjectYear.action?id=' + obj,
					function(data) {
						if (data.status == "OK") {
