	...
	<div class="tablewrap">
		<div class="cui-menu" style="width: 100%">
			<form id="aduTaskTeacher" class="form-horizontal"
				action="../admin/trainingStudentOpt_outputScore.action">
				<input type="hidden" name="id"
					value="<s:property value="projectApply.id"></s:property>">
				<div class="form-group">
					...
					<button class="btn btn-primary" id="findRecord" type="button" style="width:104px;">查询</button>
					&nbsp&nbsp&nbsp
					<button type="submit" id="output" class="btn btn-primary">导出学员成绩</button>
					&nbsp&nbsp&nbsp <a class="ifrmbox"
						href="../admin/trainingStudentOpt_inputInit.action"
						data-fancybox-type="iframe">
						<button type="button" id="output" class="btn btn-primary">上传学员成绩</button>
					</a>
				</div>
			</form>
		</div>
														...
														customedit : {
															...
															display : function(
																...
																if(data.record.trainingStatus == '未报到'){
																	...
																	var html = '<a target="_blank" href="../paper/paper_view.action?ttrid='+data.record.id+'&pid='+data.record.pid+'&sid='+data.record.sid+'&tc='+data.record.tc+'&type=2&valuator='+data.record.tid+'&id='+data.record.ttid+'"">评定/修改成绩</a>  <a class="ifrbox" data-fancybox-type="iframe" href="../admin/trainingStudentOpt_completeInit.action?id='
																	+ data.record.id
																	+ '">结业</a>';
																}
																return html;
