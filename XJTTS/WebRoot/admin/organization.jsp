				...
				<script type="text/javascript">
				    $(document).ready(function () {
				        ...
				        $('#OrgTableContainer').jtable({
				            ...
				            actions: {
				                listAction: '../admin/organization_getOrganizationList.action?pid=' + $('#pid').val() + '&oid=' + oid,
								...
								addviewchild: {
				                    ...
				                    display: function (data) {
										if(data.record.isschool == 0) {
											...
											var html = '<a class="ifrmbox" href="organization_mergeInit.action?id='+data.record.id+'" data-fancybox-type="iframe">学校合并</a>&nbsp&nbsp';
