...
<s:action name="left_init" namespace="/admin" executeResult="true">
	<s:param name="leftName">乡村教师培训统计</s:param>
</s:action>
...
<div class="main" onclick="closeSelect()">
	...
	<div class="listwrap">
		...
		<div class="conta">
			<h3 class="text-center">乡村教师培训统计</h3>
			<div class="row">
				...
				<div class="contentsDiv">
					<div class="statistics">
						<div class="titleDiv">
							...
							<p class="title">乡村教师参训人次</p>
							<p class="title">乡村教师参训人次占比</p>
							<p class="title">乡村教师培训覆盖率</p>
							<div class="clear"></div>
						</div>
					...
					<div class="clear"></div>
						<div class="pieChart col-md-6" style="float:left;">
							<p class="title text-center">乡村地区培训人次饼状图</p>
							<div id="containerpie" style="width: 99%;height: 433px;"></div>
						</div>
						<div class="pieChart col-md-6 text-center" style="float:right;">
							<p class="title">乡村地区教师培训覆盖率饼状图</p>
							<div id="containerrate" style="width: 99%;height: 433px;"></div>
						</div>
						<div class="clear"></div>
						<div class="pieChart col-md-12">
							<p class="title text-center">乡村地区教师培训人次历年变化曲线图</p>
							<div id="containerline" style="width: 99%;height: 433px;"></div>
						</div>	
					<table class="table tableThead">
						<tr><th width="25%">下属单位</th><th width="15%">总教师数</th><th width="10%">乡村教师数</th><th width="10%">总参训人次</th>
							<th width="10%">乡村教师参训人次</th><th width="10%">乡村教师培训人数</th><th width="10%">乡村教师参训人次占比</th>
							<th width="10%">乡村教师培训覆盖率</th></tr>
					</table>
					<table class="table tableThead theadFixed" style="display:none;">
						<tr><th width="25%">下属单位</th><th width="15%">总教师数</th><th width="10%">乡村教师数</th><th width="10%">总参训人次</th>
							<th width="10%">乡村教师参训人次</th><th width="10%">乡村教师培训人数</th><th width="10%">乡村教师参训人次占比</th>
							<th width="10%">乡村教师培训覆盖率</th></tr>
					</table>
...
<script src="../js/statisticsteacherTrainingCountry.js"></script>	
