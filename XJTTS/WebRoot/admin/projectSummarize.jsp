...
<s:action name="left_init" namespace="/admin" executeResult="true">
	<s:param name="leftName">项目总结评审</s:param>
</s:action>
<style>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$('#ProjectTableContainer')
						.jtable(
								{
									title : '<a href="../admin/projectReview_initSummarizePage.action">项目总结评审</a> ',
									...
									actions : {
										listAction : '../admin/projectReview_getProjectSummarizeList.action'
									},
									fields : {
										paid : {
											title : 'ID',
										...
										report:{
											...
											display : function(data){
												var html='<a target="_blank" href="../admin/projectReview_downloadFiles.action?id='+ data.record.paid +'">下载</a>';				
												return html;
											}
										},
										score : {
