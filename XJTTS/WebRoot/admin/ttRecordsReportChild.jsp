...
<div class="main">
		...
		<div class="list-content clearfix" style="padding-top:15px;">
			...
			<div class="alert alert-danger"
				...
				<div class="fliter-btn-wrap" style="display:none">
					<a href="../admin/ttResult_initReortAsstPage.action" id="returnButton" class="btn btn-primary">&larr;返回报送任务</a>
	...
	<script>
		$(function() {
			var leveltype = url('?leveltype') == null ? '' : url('?leveltype');
			var returnUrl = $('#returnButton').attr('href');
			$('#returnButton').attr('href',returnUrl+'?leveltype='+leveltype);
