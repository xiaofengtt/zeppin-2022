	...
	<div class="ifrcnt container">
		...
		<div class="hd">
			...
			<h4 align="center">
				...
				--
				<s:property value="teacherTrainingRecords.trainingSubject.name" />
			</h4>
		</div>
		<div class="bd">
...
// 														top.location.href = '../admin/trainingStudentOpt_changeSubjectInit.action';
														window.parent.$('#ProjectTableContainer').jtable('load', {
															projectId:window.parent.$('select[name="projectName"]').val(),
															subjectId : window.parent.$('#subjectName').val(),
															teacherIdCard : window.parent.$('#teacherIdCard').val(),
															teacherName : window.parent.$('#teacherName').val()
											            });
