			...
			<form class="form-horizontal" id="teacherManage" action="teacherManage_addItem.action"
				...
				<div class="clearfix">
					...
					<div class="span5">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="name"
									value="<s:property	value="teacher.name" />" <s:if test="organizationLevel == 1">class="readonly" readonly</s:if>  />
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="" autocomplete="off" name="idCard"
									value="<s:property	value="teacher.idcard" />"  <s:if test="organizationLevel == 1">class="readonly" readonly</s:if>  placeholder="">
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="graduation"
									value="<s:property	value="teacher.graduation" />" />
							</div>
						</div>
						...
						<div class="control-group">
							<label class="control-label" for="">是否为教学点教师</label>
							<div class="controls">
								<input name="isTeachingSchool" type="checkbox" data-text-label=""
									data-on="primary" data-off="default" data-on-label="是"
									data-off-label="否"
									<s:if test="teacher.isTeachingSchool==1" >checked</s:if>
					...
					<div class="span5">
						...
						<div class="control-group">
							<label class="control-label" for="">所学专业</label>
							<div class="controls">
								<input type="text" name="major"
									value="<s:property	value="teacher.major" />" />
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select name="status">
									<option value="1"
										<s:if test="teacher.status==1" >selected</s:if>>在职</option>
									<option value="2"
										<s:if test="teacher.status==2" >selected</s:if>>离职</option>
									<option value="3"
										<s:if test="teacher.status==3" >selected</s:if>>转出</option>
									<option value="4"
										<s:if test="teacher.status==4" >selected</s:if>>退休</option>
									<option value="5"
										<s:if test="teacher.status==5" >selected</s:if>>死亡</option>
								</select>
							</div>
						</div>
				...
				<div <s:if test="%{teacherEx.teacher == null}" >style="display:none"</s:if>>
					<div class="hd">
						<h3>教师资格证信息<s:if test="%{teacherEx.teacherCertificate == null}" >(未注册)</s:if></h3>
					</div>
					<input type="hidden" name="tcid" value="<s:property	value="teacherEx.teacherCertificate.id" />">
					<div class="bd">
						<div class="clearfix">
							<div class="span5">
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="certificate" readonly class="readonly"
											value="<s:property	value="teacherEx.teacherCertificate.certificate" />" placeholder="编号"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="">教师资格证认证机构</label>
									<div class="controls">
										<input type="text" id="" autocomplete="off" name="certificateBody" readonly class="readonly"
											value="<s:property	value="teacherEx.teacherCertificate.certificationBody" />" placeholder="认证机构"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="">教师资格证资格种类</label>
									<div class="controls">
										<input type="text" id="" autocomplete="off" name="type" readonly class="readonly"
											value="<s:property	value="teacherEx.teacherCertificate.type" />" placeholder="资格种类"/>
									</div>
								</div>
							</div>
							<div class="span5">
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" readonly autocomplete="off" data-provide="datepicker" readonly class="readonly"
											class="datepicker" id="" name="gettime" value="<s:date name="teacherEx.teacherCertificate.gettime" format="yyyy-MM-dd"/>">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="">状态</label>
									<div class="controls">
										<select name="status"  readonly class="readonly">
											<option value="1"
												<s:if test="teacherEx.teacherCertificate.status==1" >selected</s:if>>正常</option>
											<option value="0"
												<s:if test="teacherEx.teacherCertificate.status==0" >selected</s:if>>停用</option>
										</select>
									</div>
								</div>
							</div>
			...
			if(flag){
				...
				$('#teacherManage').submit(
						function() {
							...
							str=encodeURI(str);
							//alert(str);
							$.post('../admin/teacherManage_addItem.action?'+ str, function(data) {
