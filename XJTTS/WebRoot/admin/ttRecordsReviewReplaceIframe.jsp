			...
			<form class="form-horizontal" id="teacherManage" action=""
				...
				<div class="clearfix">
					...
					<label style="text-align: center; margin-bottom: 10px"><font color=red>（原报送学员）</font></label>
						...
						<div class="control-group">
							<label class="control-label" for="">教师职称</label>
							<div class="controls">
								<input type="text" readonly="readonly" value="<s:property	value="reTeacherEx.teacher.jobTitle.name" />"/>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" readonly="readonly" value="<s:property	value="reTeacherEx.teachingAge" />"/>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" readonly="readonly" value="<s:property	value="reTeacherEx.teacher.eductionBackground.name" />"/>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" readonly="readonly" value="<s:property	value="reTeacherEx.teacher.graduation" />"/>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" readonly="readonly" value="<s:property	value="reTeacherEx.teacher.major" />"/>
					...
					<div class="span5" style="border-left:1px solid #000; float: right;margin-left: 0px" >
						...
						<div class="control-group">
							<label class="control-label" for="">教师职称</label>
							<div class="controls">
								<input type="text" readonly="readonly" value="<s:property	value="teacherEx.teacher.jobTitle.name" />"/>
						...
						<div class="control-group">
							<label class="control-label" for="">教龄</label>
							<div class="controls">
								<input type="text" readonly="readonly" value="<s:property	value="teacherEx.teachingAge" />"/>
						...
						<div class="control-group">
							<label class="control-label" for="">学历</label>
							<div class="controls">
								<input type="text" readonly="readonly" value="<s:property	value="teacherEx.teacher.eductionBackground.name" />"/>
						...
						<div class="control-group">
							<label class="control-label" for="">毕业院校</label>
							<div class="controls">
								<input type="text" readonly="readonly" value="<s:property	value="teacherEx.teacher.graduation" />"/>
						...
						<div class="control-group">
							<label class="control-label" for="">所学专业</label>
							<div class="controls">
								<input type="text" readonly="readonly" value="<s:property	value="teacherEx.teacher.major" />"/>
				...
				<div class="row actionbar">
					<div align="center" style="margin-left: 50px;padding-top: 20px">
						<a class="btn btn-default btn-myself" onclick="adunopass();" id="adunopass" href="javascript:void(0)" data-url="../admin/ttRecord_reviewReplaceTeacher.action?method=nopass&id=<%=id%>">审核不通过</a>
						<a class="btn btn-default btn-primary btn-myself" onclick="adupass();" id="adupass" href="javascript:void(0)" data-url="../admin/ttRecord_reviewReplaceTeacher.action?method=pass&id=<%=id%>">审核通过</a>    
	...
	<script>
		...
		function adunopass() {
			...
			layer.prompt({
				  ...
				  layer.close(index);
				  cUrl = obj.attr('data-url')+"&reason="+value;
				  $.getJSON(cUrl, function(ret) {
						if (ret.Result == 'OK') {
							alert('成功,' + ret.Message);
							parent.$.colorbox.close();
