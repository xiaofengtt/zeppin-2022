...
//	private static final SimpleDateFormat sfd=new SimpleDateFormat("yyyy-MM-dd");
	 ...
	 */
	public static Date pastDays(Date date,Integer days) throws ParseException {
	 ...
	 * @throws ParseException
	 */
	public static Date pastDays1(Date date,Integer days) throws ParseException {
		Calendar c = Calendar.getInstance();
		c.setTime(date);
		c.add(Calendar.MINUTE, days);// 今天+1天
		Date tomorrow = c.getTime();
		return tomorrow;
	...
	public static void main(String[] args) {
		...
		try {
			...
			beginTime = df.parse("06:00:00");
			endTime = df.parse("22:00:00");
		} catch (Exception e) {
			e.printStackTrace();
		}
