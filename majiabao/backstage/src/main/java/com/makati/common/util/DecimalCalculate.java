...
private DecimalCalculate(){   
    ...
    public static double add(double ... vals){
    	BigDecimal initBd = new BigDecimal(0.00);
    	if(null != vals && vals.length >0){
    		for (double val:vals) {
    			 BigDecimal aVal = new BigDecimal(val);
    			 initBd = initBd.add(aVal);
			}
    	}
	...
	*/   
	...
	public static String getFormatNum(Object d){
		DecimalFormat   df   = new DecimalFormat("######0.00");
		return df.format(d);
	}
	public static String getFormatMoney(double d){
		double div = div(d, 1000);
		return getFormatNum(div);
	}

	public static Long getLong(Object d){
		if( d == null ) {
			return 0l;
		}
	...
	public static Integer getInteger(Object d){
		if( d == null ) {
			return 0;
		}
	...
	public static void main(String args[]){
	  ...
	  double rs = sub(v1,v2);
		rs = div(0,1000,2);
		DecimalFormat    df   = new DecimalFormat("######0.00");
		System.out.println(df.format(16.233));
