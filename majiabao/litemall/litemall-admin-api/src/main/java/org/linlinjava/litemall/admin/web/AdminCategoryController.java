...
public class AdminCategoryController {
    ...
    public Object create(@RequestBody LitemallCategory category) {
        ...
        category.setPicUrl(category.getPicUrl().replace("localhost:8080","103.139.3.231"));
        category.setIconUrl(category.getIconUrl().replace("localhost:8080","103.139.3.231"));
    ...
    @PostMapping("/update")
    public Object update(@RequestBody LitemallCategory category) throws SocketException {
        Object error = validate(category);
        if (error != null) {
            return error;
        }
