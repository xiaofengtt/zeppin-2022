...
@Validated
@Api(value = "商品信息",description = "商品信息查询接口")
...
//		data.put("shareImage", info.getShareUrl());
	...
	@ApiImplicitParams({
			@ApiImplicitParam(paramType="query", name = "categoryId", value = "(类目id)", required = false, dataType = "Int"),
			@ApiImplicitParam(paramType="query", name = "page", value = "(当前页)", required = true, dataType = "Int"),
			@ApiImplicitParam(paramType="query", name = "limit", value = "(分页总条数)", required = true, dataType = "Int"),
			@ApiImplicitParam(paramType="query", name = "maxprice", value = "价格范围", required = true, dataType = "Int"),
			@ApiImplicitParam(paramType="query", name = "minprice", value = "价格范围", required = true, dataType = "Int"),
			@ApiImplicitParam(paramType="query", name = "israndom", value = "是否随机获取商品(1是0否),使用随机参数不能指定keywork", required = true, dataType = "Int")
	})
	@AuthInterceptor(needAuthTokenVerify = false)
	public Object list(
		...
		@RequestParam(defaultValue = "0") Integer israndom,
...
//			sort="goods_sn";
		...
		if(israndom==1){
			...
			page = random1.nextInt (2000 / limit);
		}

		//查询列表数据
		List<LitemallGoods> goodsList = goodsService.querySelective(maxprice,minprice,categoryId, brandId, keyword, isHot, isNew, page, limit, sort, order);
...
//			String imgnurl= litemallGoods.getPicUrl ();
//
//
//			imgnurl=imgnurl.replaceAll ("img3m\\d.ddimg.cn","103.139.3.231/wx/storage/fetch1");
//			litemallGoods.setPicUrl (imgnurl);
//
//			String beiefurl=litemallGoods.getBrief ();
//			beiefurl=beiefurl.replaceAll ("img3m\\d.ddimg.cn","103.139.3.231/wx/storage/fetch1");
//			litemallGoods.setBrief (beiefurl);
//
//
//		}
...
//	{
//		String imgnurl="img3m7.ddimg.cn/123/11";
//		imgnurl=imgnurl.replaceAll ("img3m\\d.ddimg.cn","103.139.3.231/wx/storage/fetch1");
//		System.out.print (imgnurl);
//	}
