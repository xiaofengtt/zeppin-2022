...
public class LitemallGoodsService {
    ...
    public List<LitemallGoods> querySelective(Integer maxprice,Integer minprice,Integer catId, Integer brandId, String keywords, Boolean isHot, Boolean isNew, Integer offset, Integer limit, String sort, String order) {
        LitemallGoodsExample example = new LitemallGoodsExample();
        ...
        if (maxprice!=0) {
            criteria1.andPriceTo(minprice);
            criteria2.andPriceTo(minprice);
        }


        if (minprice!=0) {
            criteria1.andPriceTo1(maxprice);
            criteria2.andPriceTo1(maxprice);
        }
        ...
        PageHelper.startPage(offset, limit,true,false,null);
