 ...
 * 
 */
public class PeProvinceAction extends MyBaseAction {
...
//		this.getGridConfig().addColumn(this.getText("是否是国家级贫困县"), "isCountryPoor");
	...
	public void setEntityClass() {
		this.entityClass = PeProvince.class;
	}

	@Override
	public void setServletPath() {
		this.servletPath = "/entity/basic/peProvinceAction";
	}

	public void setBean(PeProvince instance) {
		super.superSetBean(instance);
	}

	public PeProvince getBean() {
		return (PeProvince) super.superGetBean();
	}
