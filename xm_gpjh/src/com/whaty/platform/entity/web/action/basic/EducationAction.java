...
import com.whaty.platform.entity.bean.Education;
 ...
 * 
 */
public class EducationAction extends MyBaseAction {
...
//		this.getGridConfig().addColumn(this.getText("备注"), "note", true,true,true, "TextArea", true, 2000);
	...
	public void setEntityClass() {
		this.entityClass = Education.class;
	}

	@Override
	public void setServletPath() {
		this.servletPath = "/entity/basic/educationAction";
	}

	public void setBean(Education instance) {
		super.superSetBean(instance);
	}

	public Education getBean() {
		return (Education) super.superGetBean();
	}
