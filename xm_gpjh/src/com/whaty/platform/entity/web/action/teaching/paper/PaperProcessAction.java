...
public class PaperProcessAction extends MyBaseAction {

	@Override
	public void initGrid() {
		this.getGridConfig().setCapability(false, false, false);

		this.getGridConfig().setTitle(this.getText("论文进展统计（学生）"));
//		this.getGridConfig().addColumn(this.getText("row_num"),"row_num",false,false,false,"");
		...
		//查看已经提交的详情
		String temp = "<a href='/entity/teaching/paperProcessInfo.action?bean.prTchStuPaper.prTchPaperTitle.peSemester.id=\" + record.data['peSemester_Id'] + \""
			+"&bean.prTchStuPaper.prTchPaperTitle.peTeacher.id=\" + record.data['peTeacher_Id'] + \"";
		//查看未提交的学生信息
		String stuInfo = "<a href='/entity/teaching/paperProcessStuInfo.action?peSemester=\" + record.data['peSemester_Id'] + \""
		...
		if(this.getGridConfig().checkBeforeAddMenu("/entity/teaching/paperProcessTeacher.action")){
		this.getGridConfig().addMenuScript(this.getText("以教师为对象统计"), "{window.location.href='/entity/teaching/paperProcessTeacher.action'}");
		}
		}
	...
	public void setServletPath() {
		this.servletPath="/entity/teaching/paperProcess";
	}
}
