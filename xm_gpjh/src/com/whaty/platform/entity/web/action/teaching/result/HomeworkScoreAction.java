...
public class HomeworkScoreAction extends MyBaseAction<PrTchStuElective> {
	...
	public void initGrid() {
		...
		this.getGridConfig().setTitle(this.getText("作业成绩列表"));
...
//				.getGridConfig()
//				.addMenuScript("批量导入",
//						"{window.open('/entity/manager/teaching/homeworkScore_batch.jsp')}");
	 ...
	 * @return
	 */
	public String homeworkScoreBatch(){
		this.setTogo("back");
		int count = 0;
		try {
			count = this.getExamScoreBatchService().saveHomeworkScore(this.getUpload());
		} catch (Exception e) {
	...
	public void setServletPath() {
		this.servletPath = "/entity/teaching/homeworkScoreView";
	}
