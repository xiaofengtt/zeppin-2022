...
import com.whaty.platform.entity.bean.MainTeachingGrade;
 ...
 * 
 */
public class MainTeachingGradeAction extends MyBaseAction {
...
//		this.getGridConfig().addColumn(this.getText("备注"), "note", true,true,true, "TextArea", true, 2000);
	...
	public void setEntityClass() {
		this.entityClass = MainTeachingGrade.class;
	}

	@Override
	public void setServletPath() {
		this.servletPath = "/entity/basic/mainTeachingGradeAction";
	}

	public void setBean(MainTeachingGrade instance) {
		super.superSetBean(instance);
	}

	public MainTeachingGrade getBean() {
		return (MainTeachingGrade) super.superGetBean();
	}


	public DetachedCriteria initDetachedCriteria() {
		DetachedCriteria dc = DetachedCriteria.forClass(MainTeachingGrade.class);
