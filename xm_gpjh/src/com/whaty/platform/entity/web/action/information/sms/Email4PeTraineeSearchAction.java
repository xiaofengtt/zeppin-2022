 ...
 *
 */
public class Email4PeTraineeSearchAction extends Email4PeManagerSearchAction {
	private static final long serialVersionUID = 1550415204852311471L;

	public void initGrid() {
		this.getGridConfig().setTitle(this.getText("学员邮件查询"));
	...
	public void setServletPath() {
		this.servletPath = "/entity/information/email4PeTraineeSearch";
	}
