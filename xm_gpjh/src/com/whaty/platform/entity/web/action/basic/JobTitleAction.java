...
import com.whaty.platform.entity.bean.JobTitle;
 ...
 * 
 */
public class JobTitleAction extends MyBaseAction {

	@Override
	public void initGrid() {
		this.getGridConfig().setCapability(true, true, true, true, true);
		this.getGridConfig().setTitle(this.getText("职称管理"));
...
//		this.getGridConfig().addColumn(this.getText("备注"), "note", true,true,true, "TextArea", true, 2000);
	...
	public void setEntityClass() {
		this.entityClass = JobTitle.class;
	}

	@Override
	public void setServletPath() {
		this.servletPath = "/entity/basic/jobTitleAction";
	}

	public void setBean(JobTitle instance) {
		super.superSetBean(instance);
	}

	public JobTitle getBean() {
		return (JobTitle) super.superGetBean();
	}
