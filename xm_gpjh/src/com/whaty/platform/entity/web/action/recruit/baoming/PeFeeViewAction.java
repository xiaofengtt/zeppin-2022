...
//		dc.createCriteria("enumConstByFlagFeeCheck","enumConstByFlagFeeCheck",DetachedCriteria.LEFT_JOIN);
	...
	public void initGrid() {
		this.getGridConfig().setTitle(this.getText("查看缴过费的所有学员"));
        this.getGridConfig().setCapability(false, false, false,true,false);
		this.getGridConfig().addColumn(this.getText("ID"), "id", false);
		this.getGridConfig().addColumn(this.getText("学员"),"name");
		this.getGridConfig().addColumn(this.getText("费用总额"),"feecount");
