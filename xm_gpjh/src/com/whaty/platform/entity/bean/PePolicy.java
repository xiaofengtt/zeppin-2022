...
public class PePolicy extends com.whaty.platform.entity.bean.AbstractBean
	...
	/** minimal constructor */
	public PePolicy(String title) {
		this.title = title;
	}

	/** full constructor */
	public PePolicy(EnumConst enumConstByFlagIstop, PeManager peManager,
