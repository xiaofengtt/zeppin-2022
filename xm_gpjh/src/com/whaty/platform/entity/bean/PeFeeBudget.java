...
/**
 * PeFeeBudget entity. @author MyEclipse Persistence Tools
 */

public class PeFeeBudget extends com.whaty.platform.entity.bean.AbstractBean
	...
	private PeFeeBudgetDetail peFeeBudgetDetail;
	...
	/** full constructor */
	public PeFeeBudget(PeUnit peUnit, PeProApplyno peProApplyno,
			PeFeeBudgetDetail peFeeBudgetDetail, Date trainingDate,
		...
		this.peFeeBudgetDetail = peFeeBudgetDetail;
	...
	public PeFeeBudgetDetail getPeFeeBudgetDetail() {
		return this.peFeeBudgetDetail;
	}

	public void setPeFeeBudgetDetail(PeFeeBudgetDetail peFeeBudgetDetail) {
		this.peFeeBudgetDetail = peFeeBudgetDetail;
	}
