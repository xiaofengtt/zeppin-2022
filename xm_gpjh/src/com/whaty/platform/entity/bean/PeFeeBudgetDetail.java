...
/**
 * PeFeeBudgetDetail entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class PeFeeBudgetDetail extends
	...
	private String noteNoplan;

	// Constructors

	/** default constructor */
	public PeFeeBudgetDetail() {
	}

	/** full constructor */
	public PeFeeBudgetDetail(Double feeSurvey, Double feeResearch,
			...
			Double feePublicity, Double feePetty, Double feeNoplan,
			...
			String notePublicity, String notePetty, String noteNoplan) {
	...
	public Double getFeeNoplan() {
		return this.feeNoplan;
	}

	public void setFeeNoplan(Double feeNoplan) {
		this.feeNoplan = feeNoplan;
	}
	...
	public String getNoteNoplan() {
		return this.noteNoplan;
	}

	public void setNoteNoplan(String noteNoplan) {
		this.noteNoplan = noteNoplan;
	}
