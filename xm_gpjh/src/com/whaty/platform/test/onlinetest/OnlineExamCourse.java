...
public abstract class OnlineExamCourse implements Items {
	private String id;
	...
	public abstract List getExamPapers(Page page);

	public abstract int getExamPapersNum();

	public abstract int addExamPaper(String paperId);

	public abstract int deleteExamPaper(String paperId);
