 ...
 * 
 */
package com.whaty.platform.info.config;
...
public class InfoConfig {
	...
	public InfoConfig(PlatformConfig platformConfig) throws PlatformException {
		this.setInfoConfigAbsPath(platformConfig.getPlatformConfigAbsPath());
	}

	public InfoConfig(String path) throws PlatformException {
	...
	public void getConfig() throws PlatformException {
		File file = new File(this.getInfoConfigAbsPath() + InfoConfig.FILENAME);
		if (!file.exists()) {
	...
	public void setConfig() throws PlatformException {
		...
		String filename = this.getInfoConfigAbsPath() + InfoConfig.FILENAME;
