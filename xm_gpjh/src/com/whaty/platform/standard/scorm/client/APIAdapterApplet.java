...
package com.whaty.platform.standard.scorm.client;
...
import com.whaty.platform.standard.scorm.datamodels.cmi.*;
import com.whaty.platform.standard.scorm.util.debug.DebugIndicator;
...
//This controls display of log messages to the java console
   ...
   ***************************************************************************/
   public void init()
   {
      ...
      {
         //this.servletURL =
         //new URL(protocol + "://" + host + ":" + port + "/whatymanager/lmscmi");
    	 this.servletURL =
         new URL(this.getParameter("servletUrl"));  
   ...
   ***************************************************************************/
   public String LMSInitialize(String param)
   {
      ...
      else
      {
         ...
         this.theSCOData = (SCODataManager) servletProxy.GetSCOData();
   ...
   public String LMSFinish(String param)
   {
      ...
      if ( (tempParm.equals("null")) || (tempParm.equals("")) )
      {
         if ( CheckInitialization() == true )
         {
            ...
            if ( lmsCore.getExit().getValue()!=null && lmsCore.getExit().getValue().equalsIgnoreCase("suspend") )
            {
