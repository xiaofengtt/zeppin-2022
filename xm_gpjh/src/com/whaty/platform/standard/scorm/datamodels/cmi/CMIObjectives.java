         ...
         if ( theRequest.hasMoreTokensToProcess() )
         {
            ...
            try
            {
               ...
               catch (ArrayIndexOutOfBoundsException e)
               {
                  ...
                  // Ask the CMIObjectiveData to performGet - this will test
                  // to make sure the element is a valid objectives element.
                  CMIObjectiveData tmpObj = new CMIObjectiveData();
                  result = tmpObj.isValidRequest(theRequest,dmErrorMgr);
