...
// ================ 加入新参数,以支持离线记录;
   ...
   private static final long serialVersionUID = -920384825517032646L;
   ...
   public CMICore()
   {
      ...
      //新加入参数,用于处理离线未提交数据; lwx add 2009-03-25
      uncommit_time = new Element("","checkString255","NULL",true,true,true); 
   }
   ...
   public Element getUncommitTime(){
	   return uncommit_time;
   }
   ...
   public void setUncommitTime(String uncommitTime){
   ...
   {
	   // 加入新参数;uncommit_time;//并且排列顺序与离线课件中OfflineRecordManage.java/ 获得离线的core相关连；
