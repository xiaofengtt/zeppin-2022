   ...
   implements Serializable
{
   ...
   /**
	 * 
	 */
	private static final long serialVersionUID = -2091278192954934065L;
// Student comments
                          ...
                          DMErrorManager dmErrorMgr)
   {
      ...
      if ( !theRequest.hasMoreTokensToProcess() )
      {
         ...
         if ( content.length() <= 4096)      // 对comments进行了修改,以前支持comments的累加,修改为不累加; 李卫新 2009-04-20
         {
