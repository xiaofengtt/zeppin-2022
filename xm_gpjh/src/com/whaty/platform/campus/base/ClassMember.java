...
public abstract class ClassMember implements Items {
	...
	public HashMap propMap = new HashMap();
	...
	public abstract String getIsExistMemberId(String memberType, String classId) throws PlatformException;
