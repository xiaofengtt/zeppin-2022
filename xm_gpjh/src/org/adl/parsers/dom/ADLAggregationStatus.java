...
// Source File Name:   ADLAggregationStatus.java
...
public class ADLAggregationStatus extends ADLElement
    implements Serializable
{
    ...
    public ADLAggregationStatus()
    {
        super("aggregationStatus");
        evaluation = new String();
        ruleList = new Vector();
    }

    public boolean fillAggregationStatus(Node node)
    {
        boolean flag = true;
        if(DebugIndicator.ON)
            System.out.println("******  ADLAggregationStatus:fillAggregationStatus()  *********");
