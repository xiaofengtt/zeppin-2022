...
// Source File Name:   ADLPostCondition.java
...
public class ADLPostCondition extends ADLElement
    implements Serializable
{
    ...
    public boolean fillPostCondition(Node node)
    {
        boolean flag = true;
        if(DebugIndicator.ON)
            System.out.println("******  ADLPostCondition:fillPostCondition()  *********");
