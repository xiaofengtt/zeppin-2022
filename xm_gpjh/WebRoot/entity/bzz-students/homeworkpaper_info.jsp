...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td background="/entity/function/images/table_02.gif" ><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="bg4">
                          <tr>
							...
							<font size=2><s:property value="courseRes.title"/>
							</td>
						  </tr>
                          		<tr>
							...
							<td class="neirong" valign=top>
							<s:property value="courseRes.content" escape="false"/>
							</td>
						  </tr>
                            	</table>
							</td>
		...
		<tr>
			<td align=center><input type=button style="font-size:12px;height:23;background-color:#ece9d8;border-width:1;" value="关闭" onclick="window.close();"></td>
		</tr>
                  </table> </td>
              </tr>
            </table></td>
