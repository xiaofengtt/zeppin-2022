                          ...
                          <tr>
                            <td height="8"> </td>
                                ...
                                <tr valign="middle"> 
                                  <td width="140" height="30" align="left" class="postFormBox"><span class="name"> 
                                    电子邮件：</span></td>
                                  <td class="postFormBox" style="padding-left:18px"><input class=selfScale id="email" name='email' value='<s:property value="peManager.email"/>' /></td>
                                </tr>
                                <tr valign="middle"> 
                                  ...
                                  <td class="postFormBox" style="padding-left:18px">
                                    <input class=selfScale name='phone' id="phone" value='<s:property value="peManager.phone"/>'  maxlength="11"/>                                  </td>
                                </tr>
                                <tr valign="middle"> 
                                  <td width="140" height="30" align="left" class="postFormBox"><span class="name">移动电话：</span></td>
                                  <td class="postFormBox" style="padding-left:18px"><input id="mobilephone" class=selfScale name='mobilePhone' value='<s:property value="peManager.mobilePhone"/>' maxlength="11"/></td>
                                </tr>
                                <tr valign="middle"> 
