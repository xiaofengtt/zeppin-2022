...
<%
	...
	try {
		...
		int paperId = testManage.addExamPaper(title,creatUser,status,note,time,teachclass_id);
		int count = testManage.addExamPaperByOnlineExamCourse(Integer.toString(paperId),testCourseId);
		
		if(paperId>0 && count>0 && types.equals("1")) {
%>
