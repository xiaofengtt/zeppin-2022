...
function menu(id)						//???
{
	...
	{					//?????????
		...
		printstr	+= "<tr><td id='pr"+currdata[i][0]+"' valign=middle class="+menutype+" onMouseUp="+onmouseup+">"+ico+"<span valign='bottom' onMouseDown='this.focus()' onMouseOver='over_str(this)' onMouseOut='out_str(this)' class='item' style='margin-left:3px;padding-left:4px;padding-right:4px' thisUrl="+ currdata[i][3] +" thisName=" + currdata[i][2] + ">"+menuname+" </span> </td></tr>\n";
