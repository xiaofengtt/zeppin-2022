                ...
                <td align="center"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                   <td height="26" background="/entity/function/images/tabletop.gif" style="background-repeat: no-repeat;filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=scale, src='/entity/function/images/tabletop.gif');">
                    ...
                    <tr>
                      <td width="55%" align="center" class="title">名&nbsp;&nbsp;&nbsp;&nbsp;称</td>
                      ...
                      <td width="1%" align="center" valign="bottom"><img src="/entity/function/images/topxb.gif"></td>
                      <td width="27%" align="center" class="title">操作</td>
                    </tr>                    
                  	</table>
                  </td>
                 </tr>
                 <s:iterator value="peVotePaperList" id="res">
                    <tr>
                      <td align="center" background="/entity/function/images/tablebian.gif">
						<table width="99%" border="0" cellspacing="0" cellpadding="0" class="mc1">
                          <tr > 
                           	<td width="55%"  align="center"  class="td1"><a target="_blank"  href="/entity/first/firstPeVotePaper_toVote.action?bean.id=<s:property value="id"/>"><s:property value="#res.title"/></a></td>
                            <td width="15%" align="center"  class="td1"><s:date name="#res.foundDate" format="yyyy-MM-dd" /></td>
                           
	                            <td width="30%" align="center"  class="td1">
	         <a target="_blank" href="/entity/first/firstPeVotePaper_toVote.action?bean.id=<s:property value="id"/>" title="开始投票"><img src="/entity/bzz-students/images/kctp.jpg" width="100" height="22" border="0" /></a>
            <a target="_blank" href="/entity/first/firstPeVotePaper_voteResult.action?bean.id=<s:property value="id"/>" title="查看结果"><img border="0" src="/entity/bzz-students/images/ckjg.jpg" width="100" height="22" /></a>
		            </td>
