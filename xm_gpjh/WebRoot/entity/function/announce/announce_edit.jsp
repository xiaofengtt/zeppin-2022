...
<form action="announce_editexe.jsp" method="POST" name="frmAnnounceUpdate" onsubmit="return chkSubmit()">
        <tr>
                    ...
                    <tr>
                      <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td><input name="title" type="text" size="30" maxlength="50" value="<%=announce.getTitle()%>"></td>
						  ...
						  <tr>
							...
							<textarea class="smallarea" cols="80" name="body" rows="12"><%=announce.getBody()%></textarea>
							</td>
						  </tr>
						  <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="65" align="right" class="text1">内容：
                                  ...
                                  <td width="90"><a href="javascript:window.history.back()"><img src="../images/fh.gif" width="82" height="23" border="0"></a></td>                                
