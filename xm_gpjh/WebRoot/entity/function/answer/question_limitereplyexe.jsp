...
<%
	...
	String islimitereply = request.getParameter("islimitereply");
	int ret = 0;
	...
	try
{
	...
	if(id != null)
	{
		...
		{
			if("0".equals(islimitereply))
				ret += interactionManage.setUnLimiteReply(id[i]);
			if("1".equals(islimitereply))
				ret += interactionManage.setLimiteReply(id[i]);
		}
	}
	else
	{
