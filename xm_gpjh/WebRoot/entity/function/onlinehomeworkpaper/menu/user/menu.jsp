...
<%
	try {
		...
		if(paper.getType().equals("0")) {
			questionList = paper.getPaperQuestion();
		} else {
			questionList = paper.getPaperQuestion(user.getId());
		}
...
<%
	...
	<%
		...
		{
	%>
	parent.parent.submain.location= "../../question_info.jsp?id=<%=id%>&tsId=<%=tsId%>";
	<%
		}
