					...
					<tr>
                            <td class="text2" background="/entity/function/images/table_02.gif" >
                            	<table border="0" align="left" cellpadding="0" cellspacing="0" width=77%>
                            		<tr>
                            			本次作业成绩：
                            			<td class="text2" width="95%" align="center"><input type="text" id="score" name="score" value="<s:property value="homeworkHistory.score"/>" maxlength="4" size="5">分 </td>
                            		</tr>
                            	</table>
							</td>
					</tr>
