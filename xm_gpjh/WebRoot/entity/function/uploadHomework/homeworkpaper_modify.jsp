...
<html>
<head>
<meta http-equiv="Content-Type" content="text/ht中国社会科学院（研究生院） charset=utf-8">
...
<form action="/entity/workspaceTeacher/interactionHomework_modifyHomeworkInfoExe.action" method="POST" name="frmAnnounce" onsubmit="return chkSubmit()">
        <input name="homeworkInfoId" type="hidden" value="<s:property value="homeworkInfoId" />">
                  ...
                  <table width="765" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="65" background="/entity/function/images/table_01.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="center" class="text1"><img src="/entity/function/images/xb3.gif" width="17" height="15"> <strong>修改作业基本信息</strong></td>
							<td width="300">&nbsp;</td>
                          </tr>
                        </table></td>
                    </tr>
                          ...
                          <tr>
                            ...
                            <tr>
								...
								<td class="neirong" valign=top>
									<input type=text name="title" class=input1 size=60 value="<s:property value="homeworkInfo.title"/>">
								</td>
						  	</tr>
						  	<tr>
                            	<td class="neirong" width=20% nowrap="nowrap">
								...
								<td>
								<input class="Wdate" type="text" value="<s:date name="homeworkInfo.startdate" format="yyyy-MM-dd hh:mm:ss"/>" name="startDate" id="hts" onfocus="new WdatePicker(this,'%Y-%M-%D %h:%m:%s',true)" maxdate="#F{$('hte').value}" onPicked="$('hte').onfocus()"/>
								</td>		                 
						  	</tr>
						  	<tr>
                            	<td class="neirong" width=20% nowrap="nowrap">
								...
								<td>
								<input class="Wdate" type="text" value="<s:date name="homeworkInfo.enddate" format="yyyy-MM-dd hh:mm:ss"/>" name="endDate" id="hte" onfocus="new WdatePicker(this,'%Y-%M-%D %h:%m:%s',true)" mindate="#F{$('hts').value}" />
								</td>
						  	</tr>
                          	<tr>
								...
								<td class="neirong" valign=top>
									<textarea class="smallarea" cols="80" name="note" rows="12"><s:property value="homeworkInfo.note"/> </textarea>
								</td>
						  	</tr>
                            	</table>
							</td>
