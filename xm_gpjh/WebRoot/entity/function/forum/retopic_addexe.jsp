...
<%
	...
	String courseId1 = openCourse.getId();
	...
	try
{
	...
	ret=interactionManage.addForum(title, body,	submitUserId, forumlist_id,  courseId,userName, related_id);
}
catch(Exception e)
{
...
%>
	<script>
		alert("回复成功");
		window.navigate("forum_detail.jsp?realted_id=<%=related_id%>");
	</script>	
<%
	}else{
%>
