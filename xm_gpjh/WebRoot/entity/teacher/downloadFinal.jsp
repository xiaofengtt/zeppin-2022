...
<table border="0" cellpadding="1" cellspacing="1" align="center" >
	<tr>
    	<td colspan="2" align="center">下载学生毕业论文终稿</td>
	</tr>
	<s:if test="paperContentList.size==0">
		<tr>
			<td colspan="2" align="center">学生还未上传终稿</td>
		</tr>
	</s:if>	
		...
		<tr>
	    	<td align="left">
	    		<a href="<s:property value='getUrl()'/>" target="_blank">
					<font color="blue"> <u> <s:property value="getUrl().substring(22, getUrl().length())"/> </u> </font>
				</a>
			</td>
