...
<strong>您当前的位置是:</strong>教师<s:property value="peTeacher.trueName"/>的工作室 > 通知公告</td>
  </tr>
  <tr>
 ...
 <s:iterator value="bulletinList" status="num">	
  <tr <s:if test="#num.index%2 == 0 ">bgcolor="#FFFFFF"</s:if><s:else>bgcolor="#EAF7FF"</s:else> >
  	 <td class="font01 border"><a href="/entity/workspaceTeacher/tchPeBulletinView_toInfo.action?bean.id=<s:property value="id"/>"> 
  ...
  <%@ include file="/entity/teacher/pub/bulletin_detail.jsp" %>
  </td>
  </tr>
</table>
</body>
