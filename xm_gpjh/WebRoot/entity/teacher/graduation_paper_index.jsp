...
<title>教师工作室 - 华南师范大学远程教育平台</title>
...
<frameset rows="47,*" frameborder="no" border="0" framespacing="0">
	<frame src="/entity/teacher/pub/graduatedesign_teacher_menu.jsp" name="submenu" scrolling="no" noresize>
<!-- 	<frame src="/entity/teaching/prTchPaperTitle.action" name="subcontent" scrolling="auto" noresize>   -->
	<frame src="/entity/workspaceTeacher/prTchPaperTitle.action" name="subcontent" scrolling="auto" noresize>
