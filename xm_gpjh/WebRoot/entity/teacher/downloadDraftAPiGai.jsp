...
<table border="0" cellpadding="1" cellspacing="1" align="center" >
	<tr>
    	<td colspan="2" align="center">下载教师批改初稿</td>
	</tr>	
	<s:if test="paperContentList.size==0">
		<tr>
			<td colspan="2" align="center">教师还未上传批改的初稿</td>
		</tr>
	</s:if>	
		...
		<tr>
	    	<td align="left">
	    		<a href="<s:property value='getUrl()'/>" target="_blank">
					<font color="blue"> <u> <s:property value="getUrl().substring(23, getUrl().length())"/> </u> </font>
				</a>
			</td>
