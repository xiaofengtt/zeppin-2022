...
<div id="main_content">
    <div class="content_title">论文初稿修改</div>
    <div class="cntent_k">
   	  <div class="k_cc">
   	  <form action="/entity/workspaceTeacher/prTchStuPaperDraftA_piGai.action" enctype="multipart/form-data" method="post" onsubmit="return validate();">
	  	...
	  	<table width="80%" border="0" cellpadding="0" cellspacing="0" align="center">
            ...
            <a href='/entity/workspaceTeacher/prTchStuPaperDraftA_toDownloadDraftA.action?paperId=<s:property value="paper.getId()"/>' target="_blank"><font color="#0000ff">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;查看初稿详细内容（下载附件）</font></a>
			<a href='/entity/workspaceTeacher/prTchStuPaperDraftA_toDownloadTeacherPiGai.action?paperId=<s:property value="paper.getId()"/>' target="_blank"><font color="#0000ff">查看教师修改（下载附件）</font></a>
			</td>
			</tr>
            <tr>
