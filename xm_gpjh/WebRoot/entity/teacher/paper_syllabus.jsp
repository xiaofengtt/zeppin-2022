...
<div id="main_content">
    <div class="content_title">论文开题报告修改</div>
    <div class="cntent_k">
   	  <div class="k_cc">
   	  <form action="/entity/workspaceTeacher/prTchStuPaperSyllabus_piGai.action" enctype="multipart/form-data" method="post" onsubmit="return validate();">
	  	...
	  	<table width="80%" border="0" cellpadding="0" cellspacing="0" align="center">
            ...
            <a href='/entity/workspaceTeacher/prTchStuPaperSyllabus_toDownloadSyllabus.action?paperId=<s:property value="paper.getId()"/>' target="_blank"><font color="#0000ff">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;查看开题报告详细内容（下载附件）</font></a>
			<a href='/entity/workspaceTeacher/prTchStuPaperSyllabus_toDownloadTeacherPiGai.action?paperId=<s:property value="paper.getId()"/>' target="_blank"><font color="#0000ff">查看教师修改（下载附件）</font></a>
			</td>
			</tr>
            <tr>
            ...
            <tr>
            <td valign="middle" class="postFormBox"> 开题报告截止日期：</td>
			<td valign="middle" class="postFormBox"><s:date name="paper.getPrTchPaperTitle().getPeSemester().getPaperSyllabusEndDate()" format="yyyy年MM月dd日" /> </td>
            </tr>
          <tr>
            <td valign="middle" class="postFormBox">开题报告批改信息：</td>
            <td valign="middle" >&nbsp;</td>
          </tr>
          ...
          <tr>
    <td class="tdLabel"><label for="paper" class="label">请上传批改后的开题报告附件：</label></td>
