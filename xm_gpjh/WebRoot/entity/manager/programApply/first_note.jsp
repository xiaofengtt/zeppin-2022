...
<html>
  ...
  <body>
<div id="main_content">
    <div class="content_title">查看初审意见</div>
    <div class="cntent_k">
   	  <div class="k_cc">
	  		<table align="center" border="0" width="700">
				
				<tr><td  class="oddrowbg2" height="500"><p>
				<s:if test="peProApply.enumConstByFkCheckFirst.code=='1010'">该项目尚未初审！</s:if>
				<s:else>
				<s:property value="peProApply.noteFirst" escape="false"/>
</s:else>
</p></td></tr>
			</table>
	  </div>
