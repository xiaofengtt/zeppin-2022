...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form name="final" method="get" action="/entity/exam/scoreManualInput.action" onsubmit="javascript:return pageGuarding();">
			<div id="main_content">
			   <div class="content_title">自动分配主干课程考试场次</div>
			   <div class="cntent_k" align="center">
			   <div class="k_cc">
			   <table width="80%">		   					   		
			   		<tr>
			   			<td width="18%">
			   				<div align="center" class="postFormBox">为xx学期生成主干课程考试场次</div>
		   			  	</td>
			   		</tr>
			   		<tr>
			   			<td width="18%">
			   				<div align="center" class="postFormBox"><input type="button" value="生成" ></div>
		   			  </td>
			   		</tr>
