...
<script>
	...
	//年级下拉列表
		    ...
		    major.render('showmajor');
			       ...
			       var faDate = new Ext.form.DateField({
                                fieldLabel: '补发日期',           
                                name: 'faDate',
                                id: 'fa',
                                format:'Y-m-d',
...
<script>
	...
	<body>
			<div id="main_content">
			   <div class="content_title">打印学生证</div>
			   <div class="cntent_k" align="center">
			   <div class="k_cc">
			      	  <form action="/entity/studentStatus/peStudentInfo_printStuCard.action" onsubmit="return check();" target="_blank" >
			<table width="554" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td height="8"> </td>
						        ...
						        <tr valign="middle"> 
                                  <td width="200" height="90" align="left" class="postFormBox"><span class="name">&nbsp;&nbsp;学号：&nbsp;&nbsp;</span></td>
                                  <td class="postFormBox" style="padding-left:18px">
						        ...
						        <tr valign="middle"> 
                                  <td width="200" height="90" align="left" class="postFormBox"><span class="name">&nbsp;&nbsp;入学日期：<font color="red">*</font></span></td>
                                  <td class="postFormBox" style="padding-left:18px">
                                  <div align="left" class="postFormBox" id = "startDate"></div>
                                  </td>
                          	    </tr>         
						        <tr valign="middle"> 
                                  <td width="200" height="90" align="left" class="postFormBox"><span class="name">&nbsp;&nbsp;补发日期：</span></td>
                                  <td class="postFormBox" style="padding-left:18px">
                                  <div align="left" class="postFormBox" id = "faDate"></div>
                                  </td>
                          	    </tr>                              	                       	                               	                           	    
                           <tr valign="middle"> 
