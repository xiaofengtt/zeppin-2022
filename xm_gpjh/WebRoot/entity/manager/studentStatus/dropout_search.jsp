...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form name="print" method="post" action="/entity/studentStatus/peStudentStatus_turntoDropoutChange.action">
			<div id="main_content">
			   <div class="content_title">学生退学</div>
			   <div class="cntent_k" align="center">
			   <div class="k_cc">
			   <table width="80%">
			   		<tr>
			   			<td colspan="2">
			   				<div align="center" class="postFormBox">请输入要退学学生的学号</div>
			   			</td>
			   		</tr>
			   		<tr>
			   			<td width="40%">
