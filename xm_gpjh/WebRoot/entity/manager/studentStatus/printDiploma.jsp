...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form name="print" id= "print" method="get" action="">
			<div id="main_content">
			   <div class="content_title">批量打印毕业证</div>
			   <div class="cntent_k" align="center">
			   <div class="k_cc">
			   <table width="80%">
			   		<tr>
			   			<td colspan="2">
			   				<div align="center" class="postFormBox">批量打印毕业证---选择条件</div>
			   			</td>
			   		</tr>
			   		...
			   		<tr>
			   			<td colspan="2">
			   				<div align="center" class="postFormBox"><input type="submit" value="批量打印"/></div>
			   			</td>
			   		</tr>
			   </table>
			   </div>
