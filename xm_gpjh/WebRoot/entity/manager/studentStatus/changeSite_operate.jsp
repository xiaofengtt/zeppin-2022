	...
	<head>
		...
		Ext.onReady(function(){
			...
			var siteCombo = new Ext.form.ComboBox({
				...
				valueField: 'id' ,
				typeAhead: true,
				name: 'bean.peSiteByFkNewSiteId.name',
				id:'peSiteByFkNewSiteId_id',
				mode: 'local',
				triggerAction: 'all',
				emptyText:'请选择学习中心...',
			...
			Ext.get("main_content").addListener("mouseover",function(){
				if(siteCombo.getValue()!=siteCombo.getRawValue()){
					document.getElementById("combo-box-sites-id").value=siteCombo.getValue();
				}
			});
...
<script >
  ...
  var obj =document.getElementById('combo-box-sites');
  if(obj.value=='' || obj.value =='请选择学习中心...'){
  	alert('请选择学习中心！');
  	return false;
  }		
  return true;
	...
	<body>
		<form name="print" method="get" action="/entity/studentStatus/peChangeSite_executechange.action"  onsubmit="return check();">
			<div id="main_content">
			   ...
			   <table width="100%">
			   		...
			   		<tr>
			   			...
			   			<td width="20%">
			   				<div align="center" class="form_table" >现所属学习中心</div>
			   			</td>
			   		</tr>
			   		<tr>
			   			<td>
			   			...
			   			<td>
			   				<div align="center" class="postFormBox" ><u><s:property value="bean.peStudent.peSite.name"/></u></div>
			   		...
			   		<tr valign="middle">
			   			<td colspan="1" valign="middle" nowrap="nowrap">
			   				<div align="left" class="postFormBox"><span class="name"><label>转到新学习中心*</label></span></div>
			   			</td>
			   			<td colspan="6">
			   				<div align="left" class="postFormBox">
			   					<input type="hidden" name="bean.peSiteByFkOldSiteId.id" value="<s:property value='bean.peSiteByFkOldSiteId.id'/>" />
			   					<input type="text" name="bean.peSiteByFkNewSiteId.name" value="<s:property value='bean.peSiteByFkNewSiteId.name'/>"  size="40" id="combo-box-sites" />
			   					<input type="hidden" name="bean.peSiteByFkNewSiteId.id" value="<s:property value='bean.peSiteByFkNewSiteId.id'/>" id="combo-box-sites-id"/>
			   				</div>
			   			</td>
			   		</tr>
