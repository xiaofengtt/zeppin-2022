  ...
  <head>
	...
	<script type="text/javascript">
		function checkAll(){
			...
			//验证用户名
			var login = document.getElementById("bean.loginId");
		...
		function checkEmail(){
			...
			var pattern= /^\w+([-+.]\w?)*@\w+([-]\w+)*(\.\w+([-]\w+)*){1,3}$/;///^([a-z.A-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+/;
		 	if(email.value!=''&&!pattern.test(email.value)){
				document.getElementById().innerHTML="邮箱格式不正确！\n请重新输入";
				email.select();
				return false;
			}
		}
		...
		function checkBirthday(inputObj) {
			...
			if(inputVal!=""&&!birPattern.test(inputVal)) {
				...
				var monthReg = /^0[1-9]{1}/;
				var month = monthReg.test(valArr[1])==true?parseInt(valArr[1].substr(1,1)):parseInt(valArr[1]);
...
<div id="main_content">
    <div class="content_title">&nbsp;添加评审专家信息</div>
    <div class="cntent_k">
   	  <div class="k_cc">
		<form id='teacherInfo' action="/entity/basic/peValuaExpertAction_addValuationExpert.action" method="post">
			<table width="554" border="0" align="center" cellpadding="0" cellspacing="0">
            	<tr>
  				...
  				<tr valign="middle"> 
	                ...
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.name' name="bean.name" maxlength="15"/></td>
                </tr>
  				<tr valign="middle"> 
	                <td width="140" height="30" align="left" class="postFormBox" style="padding-left:50px"><span class="name">&nbsp;&nbsp;用&nbsp;&nbsp;户&nbsp;&nbsp;名&nbsp;*：</span></td>
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.loginId' name="bean.loginId" maxlength="20"/></td>
                </tr>
                <tr valign="middle"> 
                ...
                <tr valign="middle"> 
	                ...
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.idcard' name="bean.idcard" onblur="operateIdentityNo()" /> <SPAN style="padding-left:10px;color:#ff0000" id="idCardInfo"></SPAN>  </td>
                </tr>
                <tr valign="middle"> 
                ...
                <tr valign="middle"> 
	                ...
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.telephone' name="bean.telephone" onblur="checkTelephoneNo()"/><SPAN style="padding-left:10px;color:#ff0000" id="telephoneInfo"></SPAN></td>
                </tr>
                <tr valign="middle"> 
                ...
                <tr valign="middle"> 
	                ...
	                <td class="postFormBox" style="padding-left:10px">
	                	<input type="text" id='bean.birthyearmonth' name="bean.birthyearmonth" onblur="checkBirthday(this)" /> <SPAN style="padding-left:10px;color:#ff0000" id="birthInfo"></SPAN> 
	                </td>
                </tr>
                <tr valign="middle"> 
	                <td width="140" height="30" align="left" class="postFormBox" style="padding-left:50px"><span class="name">&nbsp;&nbsp;所&nbsp;学&nbsp;专&nbsp;业：</span></td>
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.major' name="bean.major" maxlength="25"/>  </td>
                </tr>
                <tr valign="middle">
                ...
                <tr valign="middle"> 
	                ...
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.officePhone' name="bean.officePhone" onblur="checkOffcePhoneNo()"/><SPAN style="padding-left:10px;color:#ff0000" id="offcePhoneInfo"></SPAN> </td>
                </tr>
                <tr valign="middle"> 
                ...
                <tr valign="middle"> 
	                ...
	                <td class="postFormBox" style="padding-left:10px">
	                	<input type="text" id='bean.zip' name="bean.zip" onblur="checkZip()"/><SPAN style="padding-left:10px;color:#ff0000" id="zipInfo"></SPAN>
	                </td>
                </tr>
                <tr valign="middle"> 
	                <td width="140" height="30" align="left" class="postFormBox" style="padding-left:50px"><span class="name">&nbsp;&nbsp;住&nbsp;宅&nbsp;电&nbsp;话：</span></td>
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.homePhone' name="bean.homePhone" onblur="checkHomePhoneNo()"/><SPAN style="padding-left:10px;color:#ff0000" id="homePhoneInfo"></SPAN></td>
                </tr>
                <tr valign="middle"> 
	                <td width="140" height="30" align="left" class="postFormBox" style="padding-left:50px"><span class="name">&nbsp;&nbsp;传&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;真：</span></td>
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.fax' name="bean.fax" onblur="checkFaxPhoneNo()"/><SPAN style="padding-left:10px;color:#ff0000" id="faxPhoneInfo"></SPAN></td>
                </tr>
                <tr valign="middle"> 
	                <td width="140" height="30" align="left" class="postFormBox" style="padding-left:50px"><span class="name">&nbsp;&nbsp;备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</span></td>
	                <td class="postFormBox" style="padding-left:10px"><input id='bean.note' name="bean.note" style="width:400px;" maxlength="100"/> </td>
                </tr>
                <tr valign="middle"> 
