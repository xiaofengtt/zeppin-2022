  ...
  <head>
	...
	<script type="text/javascript">
		...
		function submitForm(){
			...
			if(isCheckSuc){
				var s=document.getElementById('teacherInfo');
				s.submit();
			}
		}
		//将弹出窗口居中显示
...
<div id="main_content">
    <div class="content_title">&nbsp;修改教学培训专家信息</div>
    <div class="cntent_k">
   	  <div class="k_cc">
		<form id='teacherInfo' action="/entity/basic/peTrainingExpertsAction_saveEdit.action" method="post" name="teacherInfo" >
			<table width="554" border="0" align="center" cellpadding="0" cellspacing="0">
            	<tr>
  				...
  				<tr valign="middle"> 
	                ...
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.name' name="bean.name" value="<s:property value="bean.name"/>" maxlength="10"/></td>
                </tr>
                <tr valign="middle"> 
	                ...
	                <td class="postFormBox" style="padding-left:10px">
	                	<select id='bean.peSubject' name="bean.peSubject.id" /> 
	                		...
	                		<s:iterator value="subjectList" id="subject">
	                			<option value="<s:property value="#subject[0]"/>" <s:if test="bean.peSubject.id==#subject[0]">selected</s:if>>
	                ...
	                <td class="postFormBox" style="padding-left:10px">
	                	<select id ='bean.peProvince' name="bean.peProvince.id" />
	                		...
	                		<s:iterator value="provinceList" id="province">
	                			<option value="<s:property value="#province[0]"/>" <s:if test="bean.peProvince.id==#province[0]">selected</s:if>>
                ...
                <tr valign="middle"> 
	                 ...
	                 <td class="postFormBox" style="padding-left:10px"><select id='bean.enumConstByFkStatus' name="bean.enumConstByFkStatus.id" /> <s:iterator value="statusList" id="status"><option value="<s:property value="#status[0]"/>" <s:if test="bean.enumConstByFkStatus.id==#status[0]">selected</s:if>><s:property value="#status[1]"/></option></s:iterator></select></td>
                </tr>
                <tr valign="middle"> 
	                <td width="140" height="30" align="left" class="postFormBox" style="padding-left:50px"><span class="name">&nbsp;&nbsp;手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机：</span></td>
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.telephone' name="bean.telephone" value="<s:property value="bean.telephone"/>" maxlength="25"/>  </td>
                </tr>
                <tr valign="middle"> 
                ...
                <tr valign="middle"> 
	                ...
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.birthdate' readonly="readonly" name="birthYearMonth" value="<s:date format="yyyy-MM" name="bean.birthdate"/>" onblur="checkBirthday(this)" />  </td>
                </tr>
                <tr valign="middle"> 
	                <td width="140" height="30" align="left" class="postFormBox" style="padding-left:50px"><span class="name">&nbsp;&nbsp;所&nbsp;学&nbsp;专&nbsp;业：</span></td>
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.major' name="bean.major" value="<s:property value="bean.major" />" maxlength="15"/>  </td>
                </tr>
                <tr valign="middle">
                ...
                <tr valign="middle"> 
	                ...
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.officePhone' name="bean.officePhone" value="<s:property value="bean.officePhone"/>" maxlength="15"/>  </td>
                </tr>
                <tr valign="middle"> 
                ...
                <tr valign="middle"> 
	                ...
	                <td class="postFormBox" style="padding-left:10px">
	                	<input type="text" id='bean.zip' name="bean.zip" value="<s:property value="bean.zip"/>" maxlength="6"/>
	                </td>
                </tr>
                <tr valign="middle"> 
	                <td width="140" height="30" align="left" class="postFormBox" style="padding-left:50px"><span class="name">&nbsp;&nbsp;住&nbsp;宅&nbsp;电&nbsp;话：</span></td>
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.homePhone' name="bean.homePhone" value="<s:property value="bean.homePhone"/>" maxlength="25"/>  </td>
                </tr>
                <tr valign="middle"> 
	                <td width="140" height="30" align="left" class="postFormBox" style="padding-left:50px"><span class="name">&nbsp;&nbsp;传&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;真：</span></td>
	                <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.fax' name="bean.fax" value="<s:property value="bean.fax"/>" maxlength="50"/>  </td>
                </tr>
                <tr valign="middle"> 
	                <td width="140" height="30" align="left" class="postFormBox" style="padding-left:50px"><span class="name">&nbsp;&nbsp;备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</span></td>
	                 <td class="postFormBox" style="padding-left:10px"><input type="text" id='bean.note' name="bean.note" style="width:400px;"value="<s:property value="bean.note"/>" maxlength="100"/></td>
                </tr>
                <tr valign="middle"> 
