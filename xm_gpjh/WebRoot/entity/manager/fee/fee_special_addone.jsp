...
<script >
  ...
  if(obj.value=='' || obj.value =='请选择费用类型...'){
  	alert('请选择费用类型！');
  	return false;
  }
...
Ext.onReady(function(){
	var feeTypeDataStore = new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
		            url: "/test/myList.action?sql=select id,name from enum_const where namespace='FlagFeeType' and code in ('2')"
		        }),
...
<s:form name = "feeform" action="/entity/fee/prFeeDetailSpecial_addexe.action" method="get"  onsubmit="return check();">
        ...
        <div class="cntent_k" id="zlb_content_start">
          ...
          <table width="68%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr valign="bottom" class="postFormBox"> 
              <td valign="bottom"><span class="name">费用类型*</span></td>
            ...
            <tr valign="bottom" class="postFormBox"> 
              <td valign="bottom"><span class="name">金额*</span></td>
            ...
            <tr class="postFormBox">
              <td ></td>
              <td><div id="onsubmit">
              <s:if test='msg.indexOf("成功")>=0'><input type="button" value ="返回" onclick="javascript:window.navigate('/entity/fee/prFeeDetailSpecial.action');" /></s:if>
