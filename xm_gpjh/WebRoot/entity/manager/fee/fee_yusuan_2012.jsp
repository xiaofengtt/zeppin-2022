...
-->
	...
	/*	if(xueyuan<0.4){
		...
		*/
		...
		var k = (num_fenpei&&num_a&&num_b&&num_c&&num_d&&num_e&&a&&b&&c&&d&&e&&f&&g&&h);
		return k;
		//return false; 
	}
	</script>
					...
					<table width="80%" border="0" style="border: 1px dashed #8bbedc;"
						...
						<tr>
							...
							<td align="left" id="td_item_1">
								...
								<input type="text" name="other_item_1" id="other_item_1"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.feeSurvey'/>" size="5" />							</td>
							<td align="left">
								<input type="text" name="note_item_1" id="note_item_1" maxlength="100" value="<s:property value='peFeeBudget.peFeeBudgetDetail.noteSurvey'/>"
									style="width: 73%" />							</td>
						...
						<tr>
							...
							<td align="left" id="td_item_2">
								...
								<input type="text" name="other_item_2" id="other_item_2"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.feeResearch'/>" size="5" />							</td>
							<td align="left">
								<input type="text" name="note_item_2" id="note_item_2" maxlength="100" value="<s:property value='peFeeBudget.peFeeBudgetDetail.noteResearch'/>"
									style="width: 73%" />							</td>
						</tr>
						<tr>
							<td align="center">
							...
							<td align="left" id="td_item_3">
								...
								<input type="text" name="other_item_3" id="other_item_3"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.feeArgument'/>" size="5" />							</td>
							<td align="left">
								<input type="text" name="note_item_3" id="note_item_3" maxlength="100" value="<s:property value='peFeeBudget.peFeeBudgetDetail.noteArgument'/>"
									style="width: 73%" />							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="left" id="td_item_6">
								...
								<input type="text" name="other_item_4" id="other_item_4"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.feeTrafficStu'/>" size="5"  />							</td>
							<td align="left">
								 <input type="text" name="note_item_4" id="note_item_4" maxlength="100" value="<s:property value='peFeeBudget.peFeeBudgetDetail.noteTrafficStu'/>"
									style="width: 73%" />  		</td>
						</tr>
						<tr>
							...
							<td align="left" id="td_item_7">
								...
								<input type="text" name="time_item_3" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteTeach.split('\\\\*')[1]"/>" size="2" />	
								人次						</td>
						...
						<tr>
						  ...
						  <td align="left" id="td_item_21">
						  		外地专家:
						  		<input type="text" name="price_item_10" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteTeach.split('\\\\*')[2]"/>" size="2" />
								元/人次×
								<input type="hidden" name="qty_item_10" value="1" size="2" />
								
								<input type="text" name="time_item_10" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteTeach.split('\\\\*')[3]"/>" size="2" />	
								人次					</td>
					  </tr>
						<tr>
						  <td align="left">&nbsp;</td>
						  <td align="left" id="td_item_22">
						  专家每人次平均授课学时数：<input type="text" name="xueshi_item_1" id="xueshi_item_1" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteNoplan"/>" size="2" />（1小时计1学时）</td>
					  </tr>
						<tr>
							<td align="center">
								交通费							</td>
							...
							<td align="left" id="td_item_8">
								...
								<input type="text" name="time_item_4" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteTrafficExpert.split('\\\\*')[1]"/>" size="2" />	
								人次						</td>
						</tr>
						<tr>
							<td align="center">
							...
							<td align="left" id="td_item_9">
								...
								<input type="text" name="time_item_5" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteMealAccExpert.split('\\\\*')[2]"/>" size="2" />	
								天						</td>
						</tr>
						<tr>
							<td rowspan="3" align="center">
							...
							<td align="left" id="td_item_10">
								...
								<input type="text" id="qty_item_6" name="qty_item_6" value="<s:if test="peFeeBudget.peFeeBudgetDetail.noteMaterials.split('\\\\*')[1] != null "><s:property value="peFeeBudget.peFeeBudgetDetail.noteMaterials.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>" size="2" />
						...
						<tr>
							...
							<td align="left" id="td_item_11">
								...
								<input type="text" name="other_item_5" id="other_item_5"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.feeCourse'/>" size="5" readonly="readonly"/>							</td>
							<td align="left">
								...
								<input type="text" name="wenben_item_1" id="wenben_item_1"
									value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteTextCourse.split('\\\\+')[0]"/>" size="2" />
								元；制作使用费:
								<input type="text" name="wenben_item_2" id="wenben_item_2"
									value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteTextCourse.split('\\\\+')[1]"/>" size="2" />		
								元						</td>
						...
						<tr>
							...
							<td align="left" id="td_item_12">
								...
								<input type="text" name="other_item_6" id="other_item_6"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.feeElectronCourse'/>" size="5" readonly="readonly"/>							</td>
							<td align="left">
								...
								<input type="text" name="dianzi_item_1" id="dianzi_item_1"
									value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteElectronCourse.split('\\\\+')[0]"/>" size="2" />
								元；制作使用费:
								<input type="text" name="dianzi_item_2" id="dianzi_item_2"
									value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteElectronCourse.split('\\\\+')[1]"/>" size="2" />	 	
									元					</td>
						</tr>
						<tr>
							...
							<td align="left">
								...
								<input type="text" name="total_item_7" id="total_item_7"
									value="<s:property value='peFeeBudget.peFeeBudgetDetailDetail.feeAreaRent'/>" size="5" readonly="readonly" />							</td>
							<td align="left" id="td_item_13">
								...
								元/班次/天×
								<input type="text" name="qty_item_7" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteAreaRent.split('\\\\*')[1]"/>" size="2" />
								班次×
								<input type="text" name="time_item_7" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteAreaRent.split('\\\\*')[2]"/>" size="2" />	
								天						</td>
						...
						<tr>
							...
							<td align="left">
								...
								<input type="text" name="total_item_8" id="total_item_8"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.feeEquipmentRent'/>" size="5" readonly="readonly" />							</td>
							<td align="left" id="td_item_14">
								
								<input type="text" name="price_item_8" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteEquipmentRent.split('\\\\*')[0]"/>" size="2" />
								元/班次/天×
								<input type="text" name="qty_item_8" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteEquipmentRent.split('\\\\*')[1]"/>" size="2" />
								班次×
								<input type="text" name="time_item_8" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteEquipmentRent.split('\\\\*')[2]"/>" size="2" />
								天							</td>
						</tr>
						<tr>
							<td rowspan="2" align="center">
							...
							<td align="left" id="td_item_15">
								...
								<input type="text" name="other_item_7" id="other_item_7"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.feeAppraise'/>" size="5" />							</td>
							<td align="left">
								<input type="text" name="note_item_7" id="note_item_7" maxlength="100" value="<s:property value='peFeeBudget.peFeeBudgetDetail.noteAppraise'/>"
									style="width: 73%" />							</td>
						...
						<tr>
							...
							<td align="left" id="td_item_16">
								...
								<input type="text" name="other_item_8" id="other_item_8"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.feeSummaryAppraise'/>" size="5" />							</td>
							<td align="left">
								<input type="text" name="note_item_8" id="note_item_8" maxlength="100" value="<s:property value='peFeeBudget.peFeeBudgetDetail.noteSummaryAppraise'/>"
									style="width: 73%" />							</td>
						</tr>
						<tr>
							...
							<td align="left" id="td_item_17">
								...
								<input type="text" name="price_item_9" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteLabourService.split('\\\\*')[0]"/>" size="2" />
								元/人次/天×
								...
								<input type="text" name="time_item_9" value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteLabourService.split('\\\\*')[2]"/>" size="2" />	
								天						</td>
						...
						<tr>
							...
							<td align="left" id="td_item_18">
								...
								<input type="text" name="other_item_9" id="other_item_9"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.feePublicity'/>" size="5" />							</td>
							<td align="left">
								<input type="text" name="note_item_9" id="note_item_9" maxlength="100" value="<s:property value='peFeeBudget.peFeeBudgetDetail.notePublicity'/>"
									style="width: 73%" />							</td>
						</tr>
						<tr>
							<td align="center">
							...
							<td align="left" id="td_item_19">
								...
								<input type="text" name="other_item_10" id="other_item_10"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.feePetty'/>" size="5" />							</td>
							<td align="left">
								<input type="text" name="note_item_10" id="note_item_10" maxlength="100" value="<s:property value='peFeeBudget.peFeeBudgetDetail.notePetty'/>"
									style="width: 73%" />							</td>
						</tr>
						<tr>
							<td align="center">
							...
							<td align="left" id="td_item_20">
								...
								<input type="text" name="other_item_11" id="other_item_11"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.feeNoplan'/>" size="5" />							</td>
							<td align="left">&nbsp;
							<!-- 
								<input type="text" name="note_item_11" id="note_item_11"
									value="<s:property value='peFeeBudget.peFeeBudgetDetail.noteNoplan'/>" maxlength="100" style="width: 73%" /> -->
							</td>
						</tr>
						<tr>
