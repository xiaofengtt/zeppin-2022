...
/*		if(num_2-num_total>0){
		...
		if(document.getElementById('peFeeActualBudget.projectDirector').value==''){
				$("#msg").html("<b>项目负责人不能为空！</b>");
				document.getElementById('peFeeActualBudget.projectDirector').focus();
				return false;
		}
		...
		<div class="content_title">
		  <div align="center" class="STYLE1">“国培计划”中小学教师培训经费决算表</div>
			...
			<div class="cntent_k" align="center">
				<form action="/entity/implementation/actualBudget_toSave.action" method="post" id="frmCreateCheckboxRange" onsubmit="return check();">
					<table width="80%" border="0" style="border: 1px dashed #8bbedc;"
                      ...
                      <tr>
                        <td>项目负责人：</td>
                        <td align="left"><input type="text" name="peFeeActualBudget.projectDirector" id="peFeeActualBudget.projectDirector" value="<s:property value='peFeeActualBudget.projectDirector'/>"
								maxlength="50"	style="width: 73%" /></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
					...
					<table width="80%" border="0" style="border: 1px dashed #8bbedc;" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td align="left" id="td_item_1">
								...
								元/人/天×
								<input type="text" id="qty_item_1" name="qty_item_1" value="<s:if test="peFeeActualBudget.peFeeActualBudgetDetail.noteMeal.split('\\\\*')[1] != null "><s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteMeal.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>" size="2" />
						...
						<tr>
							...
							<td align="left" id="td_item_2">
								...
								元/人/天×
								<input type="text" id="qty_item_2" name="qty_item_2" value="<s:if test="peFeeActualBudget.peFeeActualBudgetDetail.noteAccommodation.split('\\\\*')[1] != null "><s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteAccommodation.split('\\\\*')[1]"/></s:if>" size="2" />
						...
						<tr>
							...
							<td align="left" id="td_item_3">
								...
								<input type="text" name="qty_item_3" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteTeach.split('\\\\*')[1]"/>" size="2" />	
								次						</td>
						...
						<tr>
							...
							<td align="left" id="td_item_4">
								...
								<input type="text" name="qty_item_4" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteTrafficExpert.split('\\\\*')[1]"/>" size="2" />	
								人次						</td>
						...
						<tr>
							...
							<td align="left" id="td_item_6">
								...
								<input type="text" id="qty_item_6" name="qty_item_6" value="<s:if test="peFeeActualBudget.peFeeActualBudgetDetail.noteMaterials.split('\\\\*')[1] != null "><s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteMaterials.split('\\\\*')[1]"/></s:if>" size="2" />
						...
						<tr>
							...
							<td align="left">
								...
								<input type="text" name="total_item_7" id="total_item_7"
									value="<s:property value='peFeeActualBudget.peFeeActualBudgetDetail.feeAreaRent'/>" size="5" readonly="readonly"/>							</td>
							<td align="left" id="td_item_7">
								...
								<span id="span_1">元/人</span>×
								<input type="text" id="qty_item_7" name="qty_item_7" value="<s:if test="peFeeActualBudget.peFeeActualBudgetDetail.noteAreaRent.split('\\\\*')[1] != null "><s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteMaterials.split('\\\\*')[1]"/></s:if>" size="2" />
								<span id="span_qty_6">人</span>
						...
						<tr>
							...
							<td align="left">
								...
								<input type="text" name="total_item_8" id="total_item_8"
									value="<s:property value='peFeeActualBudget.peFeeBudgetDetailDetail.feeEquipmentRent'/>" size="5" readonly="readonly" />							</td>
							<td align="left" id="td_item_8">
								
								<input type="text" name="price_item_8" id="price_item_8" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteEquipmentRent.split('\\\\*')[0]"/>" size="2" />
								元/人×
								<input type="text" id="qty_item_8" name="qty_item_8" value="<s:if test="peFeeActualBudget.peFeeActualBudgetDetail.noteEquipmentRent.split('\\\\*')[1] != null "><s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteEquipmentRent.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>" size="2" />
								人 
						...
						<tr>
							...
							<td align="left" id="td_item_9">
								...
								<input type="text" name="price_item_9" id="price_item_9" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteLabourService.split('\\\\*')[0]"/>" size="2" />
								元/人×
								<input type="text" id="qty_item_9" name="qty_item_9" value="<s:if test="peFeeActualBudget.peFeeActualBudgetDetail.noteLabourService.split('\\\\*')[1] != null "><s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteLabourService.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>" size="2" />
								人  
						...
						<tr>
						  ...
						  <td align="left">经费:
              <input type="text" name="total_item_10" id="total_item_10" value="<s:property value='peFeeActualBudget.peFeeActualBudgetDetail.feeSurvey'/>" size="5" readonly="readonly" /></td>
				   	 <td align="left" id="td_item_10">				
								<input type="text" name="price_item_10" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteSurvey.split('\\\\*')[0]"/>" size="2" />
								元/件×
								<input type="text" name="qty_item_10" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteSurvey.split('\\\\*')[1]"/>" size="2" />
								件  
				   	...
				   	<td align="left" id="">后续培训所需生成性资源包的设计、制作费。</td>
						...
						<tr>
							...
							<td align="left">
								...
								<input type="text" name="total_item_11" id="total_item_11"
									value="<s:property value='peFeeActualBudget.peFeeActualBudgetDetail.feeResearch'/>" size="5" readonly="true"/>							</td>
							<td align="left" id="td_item_11">
								<input type="text" name="price_item_11" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteResearch.split('\\\\*')[0]"/>" size="2" />
								元/班次/天×
								<input type="text" name="qty_item_11" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteResearch.split('\\\\*')[1]"/>" size="2" />
								班次×
								<input type="text" name="time_item_11" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteResearch.split('\\\\*')[2]"/>" size="2" />
								天							</td>
						...
						<tr>
							...
							<td align="left">
								...
								<input type="text" name="total_item_12" id="total_item_12"
									value="<s:property value='peFeeActualBudget.peFeeActualBudgetDetail.feeArgument'/>" size="5" readonly="true" />							</td>
							<td align="left" id="td_item_12">
								<input type="text" name="price_item_12" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteArgument.split('\\\\*')[0]"/>" size="2" />
								元/人×
								<input type="text" id="qty_item_12" name="qty_item_12" value="<s:if test="peFeeActualBudget.peFeeActualBudgetDetail.noteArgument.split('\\\\*')[1] != null "><s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteArgument.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>" size="2" />
								人
						...
						<tr>
						  ...
						  <td align="left">经费:
              <input type="text" name="total_item_13" id="total_item_13" value="<s:property value='peFeeActualBudget.peFeeActualBudgetDetail.feeTrafficStu'/>" size="5" readonly="true"/></td>
						  <td align="left" id="td_item_13">
						  <input type="text" name="price_item_13" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteTrafficStu.split('\\\\*')[0]"/>" size="2" />
								元/班次/天×
								<input type="text" name="qty_item_13" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteTrafficStu.split('\\\\*')[1]"/>" size="2" />
								班次×
								<input type="text" name="time_item_13" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteTrafficStu.split('\\\\*')[2]"/>" size="2" />
								天
						  </td>
			    </tr>
						<tr>
              ...
              <input type="text" name="total_item_14" id="total_item_14"
									value="<s:property value='peFeeActualBudget.peFeeActualBudgetDetail.feeElectronCourse'/>" size="5" readonly="readonly" />
							</td>
							<td align="left" id="td_item_14">
								<input type="text" name="price_item_14" value="<s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteElectronCourse.split('\\\\*')[0]"/>" size="2" />
								元/人×
								<span id="span_qty_14"></span>
								<input type="text" id="qty_item_14" name="qty_item_14" value="<s:if test="peFeeActualBudget.peFeeActualBudgetDetail.noteElectronCourse.split('\\\\*')[1] != null "><s:property value="peFeeActualBudget.peFeeActualBudgetDetail.noteLabourService.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>" size="2" />
								人
