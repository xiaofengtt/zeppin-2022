...
<form action="/entity/teaching/pebzzManagerAssess_updateAssess.action" name="frm" method="post" onsubmit="return checknone();">
      ...
      <tr valign="top">
        ...
        <table width="96%" border="0" cellpadding="0" cellspacing="0">
        	...
        	<tr>
        		...
        		<td align="left"><input type="reset" value="重填"/> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
