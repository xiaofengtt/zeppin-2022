...
<s:form name = "batch" action="/entity/teaching/degreeEnglishScore_degreeEnglishScoreBatch.action" method="POST"  enctype="multipart/form-data" onsubmit ="return FileTypeCheck();">
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td><div class="content_title" id="zlb_title_start">批量导入学位英语成绩</div></td>
  </tr>
        ...
        <div class="cntent_k" id="zlb_content_start">
          ...
          <table width="68%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr valign="bottom" class="postFormBox"> 
              ...
              <td width="77%"> <span class="link" help="下载Excel格式的模版表格"><img src='<%=request.getContextPath()%>/entity/manager/images/buttons/excel.png' alt='Print' width="20" height="20" title='Print'>&nbsp;<a href='score_batch_degreeEnglish.xls' target=_blank>Excel报表</a></span></td>
            </tr>
            <tr valign="bottom" class="postFormBox"> 
              <td valign="bottom" nowrap="nowrap"><span class="name">学位英语成绩信息:</span></td>
  ...
  <tr>
    <td >
        ...
        1、到学位英语管理页面，查询出所需导入成绩的学生。下方选择报表格式，选择Excel导出。<br/>
        2、打开下载后的报表，保留学号，姓名，学位英语成绩 这三列，其余列全部删除。<br/>
        3、填写学生对应的学位英语成绩，填写完后保存。<br/>
