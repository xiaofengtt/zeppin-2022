...
<s:form name = "batch" action="/entity/teaching/peCourseManager_uploadCourse.action" method="POST"  enctype="multipart/form-data" onsubmit ="return FileTypeCheck();">
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td><div class="content_title" id="zlb_title_start">批量导入课程信息</div></td>
  </tr>
        ...
        <div class="cntent_k" id="zlb_content_start">
          ...
          <table width="68%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr valign="bottom" class="postFormBox"> 
              ...
              <td width="77%"> <span class="link" help="下载Excel格式的模版表格"><img src='<%=request.getContextPath()%>/entity/manager/images/buttons/excel.png' alt='Print' width="20" height="20" title='Print'>&nbsp;<a href='/entity/manager/teaching/uploadCourse.xls' target=_blank>Excel报表</a></span></td>
            </tr>
            <tr valign="bottom" class="postFormBox"> 
            ...
            <tr class="postFormBox">
              <td ></td>
             <td><input type=submit name="submit1" value = "上传" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="button" value="返回" onclick="javascript:window.history.back()" ></td>
            </tr>
         </table>
      </div>
