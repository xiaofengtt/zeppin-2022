...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form name="print" id= "print" method="get" action="/entity/teaching/teachingStat.action">
			<div id="main_content">
			   <div class="content_title">教师教学统计</div>
			   <div class="cntent_k" align="center">
			   <div class="k_cc">
			   <table width="80%">
			   		<tr>
			   			<td colspan="2">
			   				<div align="center" class="postFormBox">教师教学统计统计---选择条件</div>
			   			</td>
			   		</tr>
			   		<tr>
			   			<td>
