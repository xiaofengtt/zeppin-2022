...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form name="print" id= "print" method="get" action="/entity/teaching/countcheckofworkfee.action">
			<div id="main_content">
			   <div class="content_title">批改作业费核算</div>
			   <div class="cntent_k" align="center">
			   <div class="k_cc">
			   <table width="80%">
			   		<tr>
			   			<td colspan="2">
			   				<div align="center" class="postFormBox">批改作业费核算---选择条件</div>
			   			</td>
			   		</tr>
			   		<tr>
			   			<td>
			   		...
			   		<tr>
			   			<td>
			   				<div align="left" class="postFormBox"><span class="name"><label>其他条件..</label></span></div>
			   			</td>
			   			<td>
			   				<div align="left" class="postFormBox" >其他条件..</div>
			   			</td>
			   		</tr>
			   		<tr>
			   			<td colspan="2">
