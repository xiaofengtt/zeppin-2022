	...
	if(!batch_id.equals(""))
	{
		sql_en +="and b.id = '"+batch_id+"'";
				...
				String sql_t="select student_id,student_name,student_reg_no,student_phone,student_email,batch_name,enterprise_name from ("
										...
										+ "  from pe_bzz_student s, pe_bzz_batch b, pe_enterprise e where "
										+ "  s.fk_batch_id = b.id and s.fk_enterprise_id = e.id  and b.id = '"
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1048 style='border-collapse:
 ...
 %>
  ...
  width:787pt'><font color = 'red'>&lt;&lt;<%=ename%>&gt;&gt;</font>未学完学员列表</td>
  </tr>
