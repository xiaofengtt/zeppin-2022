...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   function isRight(num){
	...
	<body>
		<form name="print" id= "print" method="get" action="/entity/recruit/recruitManageExam.action" onsubmit="return showcheck();" >
			<div id="main_content">
			   <div class="content_title">考试生按分数线录取</div>
			   ...
			   <table width="80%">
			   		...
			   		<tr>
			   			<td>
			   				<div align="left" class="postFormBox"><span class="name"><label>总分数线<font color="#ff0000">*</font></label></span></div>
			   			</td>
			   			<td>
