...
<frameset rows="47,*" frameborder="no" border="0" framespacing="0">
	<frame src="/entity/student/student_info_menu.jsp" name="submenu" scrolling="no" noresize>
	<frame src="/entity/workspaceStudent/student_viewInfo.action" name="subcontent" scrolling="auto" noresize> 
</frameset>
<noframes></noframes>
<body>
</body>
