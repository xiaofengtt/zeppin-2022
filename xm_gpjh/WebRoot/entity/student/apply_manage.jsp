...
<frameset rows="47,*" frameborder="no" border="0" framespacing="0">
	<frame src="/entity/workspaceStudent/apply_toApplyMenu.action" name="submenu" scrolling="no" noresize>
	<frame src="/entity/workspaceStudent/student_toChangeStudent.action" name="subcontent" scrolling="auto" noresize>
</frameset>
<noframes></noframes>
<body>
</body>
