...
<frameset rows="47,*" frameborder="no" border="0" framespacing="0">
	<frame src="/entity/workspaceStudent/peLearningCourseScore_checkAndTurnMenu.action" name="submenu" scrolling="no" noresize>
	<frame src="/entity/workspaceStudent/peLearningCourseScore_toOldCourseScore.action" name="subcontent" scrolling="auto" noresize>
</frameset>
<noframes></noframes>
<body>
</body>
