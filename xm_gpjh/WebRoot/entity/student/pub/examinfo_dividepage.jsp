...
<table border="0" cellpadding="2" cellspacing="1" align="center" width=100%>
	<tr>
	<form name="jump" method="post" action="/entity/student/studentstudio_getExamInfo.action" onsubmit="return pageGuarding()">
		<td align=center width=40% style="font-family: Tahoma,Georgia;font-size: 9pt;"> 
		<s:if test="curPage == 1">
			<s:if test="totalPage > 1">
				<a href="/entity/student/studentstudio_getExamInfo.action?curPage=<s:property value="curPage+1"/>"><img src="/entity/images/xyy1.gif" width="57" height="20" border="0"></a> <a href="/entity/student/studentstudio_getExamInfo.action?curPage=<s:property value="totalPage"/>"><img src="/entity/images/my1.gif" width="57" height="20" border="0"></a>
			</s:if>
		</s:if>
		<s:elseif test="curPage > 1">
			<s:if test="totalPage > curPage">
				<a href="/entity/student/studentstudio_getExamInfo.action?curPage=1&coursetype=<s:property value="coursetype"/>"><img src="/entity/images/sy1.gif" width="57" height="20" border="0"></a> <a href="/entity/student/studentstudio_getExamInfo.action?curPage=<s:property value="curPage-1"/>&coursetype=<s:property value="coursetype"/>"><img src="/entity/images/syy1.gif" width="58" height="20" border="0"></a> 
				<a href="/entity/student/studentstudio_getExamInfo.action?curPage=<s:property value="curPage+1"/>"><img src="/entity/images/xyy1.gif" width="57" height="20" border="0"></a> <a href="/entity/student/studentstudio_getExamInfo.action?curPage=<s:property value="totalPage"/>"><img src="/entity/images/my1.gif" width="57" height="20" border="0"></a>
			</s:if>
	...
	<form name="setsize" method="post" action="/entity/student/studentstudio_getExamInfo.action?isLimit=1">
