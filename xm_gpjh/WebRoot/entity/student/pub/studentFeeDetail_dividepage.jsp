...
<table border="0" cellpadding="2" cellspacing="1" align="center" width=100%>
	<tr>
	<form name="jump" method="post" action="/entity/workspaceStudent/studentFee_toDetail.action" onsubmit="return pageGuarding()">
		<td align=center width=40% style="font-family: Tahoma,Georgia;font-size: 9pt;"> 
		<s:if test="curPage == 1">
			<s:if test="totalPage > 1">
				<a href="/entity/workspaceStudent/studentFee_toDetail.action?curPage=<s:property value="curPage+1"/>"><img src="/entity/student/images/xyy.gif" width="57" height="20" border="0"></a> <a href="/entity/workspaceStudent/studentFee_toDetail.action?curPage=<s:property value="totalPage"/>"><img src="/entity/student/images/my.gif" width="57" height="20" border="0"></a>
			</s:if>
		</s:if>
		<s:elseif test="curPage > 1">
			<s:if test="totalPage > curPage">
				<a href="/entity/workspaceStudent/studentFee_toDetail.action?curPage=1"><img src="/entity/student/images/sy.gif" width="57" height="20" border="0"></a> <a href="/entity/workspaceStudent/studentFee_toDetail.action?curPage=<s:property value="curPage-1"/>"><img src="/entity/student/images/syy.gif" width="58" height="20" border="0"></a> 
				<a href="/entity/workspaceStudent/studentFee_toDetail.action?curPage=<s:property value="curPage+1"/>"><img src="/entity/student/images/xyy.gif" width="57" height="20" border="0"></a> <a href="/entity/workspaceStudent/studentFee_toDetail.action?curPage=<s:property value="totalPage"/>"><img src="/entity/student/images/my.gif" width="57" height="20" border="0"></a>
			</s:if>
	...
	<form name="setsize" method="post" action="/entity/workspaceStudent/studentFee_toDetail.action?isLimit=1">
