...
<div id="main_content">
    <div class="content_title">论文终稿</div>
    <div class="cntent_k">
   	  <div class="k_cc">
   	  <form action="/entity/workspaceStudent/studentFinal_upload.action" enctype="multipart/form-data" method="post" onsubmit="return validate();">
	  	...
	  	<table width="80%" border="0" cellpadding="0" cellspacing="0" align="center">
            ...
            <a href='/entity/workspaceStudent/studentFinal_toDownloadFinal.action?paperId=<s:property value="paper.getId()"/>' target="_blank"><font color="#0000ff">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;查看终稿详细内容（下载附件）</font></a>
			</td>
			</tr>
            <tr>
          ...
          <tr>
    <td class="tdLabel"><label for="paper" class="label">请上传批改后的终稿附件：</label></td>
