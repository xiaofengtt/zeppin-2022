...
<frameset rows="47,*" frameborder="no" border="0" framespacing="0">
	<frame src="/entity/student/graduatedesign_student_menu.jsp" name="submenu" scrolling="no" noresize>
	<frame src="/entity/workspaceStudent/prTchStuPaperTitleSelect.action" name="subcontent" scrolling="auto" noresize>
</frameset>
<noframes></noframes>
<body>
</body>
