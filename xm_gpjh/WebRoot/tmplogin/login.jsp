...
<table width="1002" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td height="176" colspan="2"><img name="ordeer_r1_c1" src="/tmplogin/images/ordeer_r1_c1.jpg" width="130" height="176" border="0" id="ordeer_r1_c1" alt="" /></td>
    <td width="743" rowspan="2" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><img name="ordeer_r1_c3" src="/tmplogin/images/ordeer_r1_c3.jpg" width="743" height="130" border="0" id="ordeer_r1_c3" alt="" /></td>
      </tr>
      <tr>
        <td height="365" valign="top"><table width="617" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="56" height="90">&nbsp;</td>
            <td width="561" valign="middle"><img src="/tmplogin/images/lo.jpg" width="158" height="63" /></td>
          </tr>
          <tr>
            <td height="299" colspan="2" valign="top" background="/tmplogin/images/bg.jpg">
    ...
    <td colspan="2"><img name="ordeer_r1_c9" src="/tmplogin/images/ordeer_r1_c9.jpg" width="129" height="176" border="0" id="ordeer_r1_c9" alt="" /></td>
  </tr>
  <tr>
    <td width="117" height="372" valign="top"><img name="ordeer_r4_c1" src="/tmplogin/images/ordeer_r4_c1.jpg" width="117" height="145" border="0" id="ordeer_r4_c1" alt="" /></td>
    <td width="13" background="/tmplogin/images/ordeer_r4_c2.jpg">&nbsp;</td>
    <td width="13" background="/tmplogin/images/ordeer_r4_c9.jpg">&nbsp;</td>
    <td width="116" valign="top"><img name="ordeer_r4_c10" src="/tmplogin/images/ordeer_r4_c10.jpg" width="116" height="145" border="0" id="ordeer_r4_c10" alt="" /></td>
  </tr>
  <tr>
    <td rowspan="2">&nbsp;</td>
    <td colspan="3"><img name="ordeer_r8_c2" src="/tmplogin/images/ordeer_r8_c2.jpg" width="769" height="20" border="0" id="ordeer_r8_c2" alt="" /></td>
    <td rowspan="2">&nbsp;</td>
  </tr>
  <tr>
