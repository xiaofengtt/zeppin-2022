...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="newsbg">
  ...
  <tr>
    <td width="703"  height="68" valign="top" style="background-image:url(/web/news/images/1_11.jpg); background-repeat:repeat-x;" align="center" class="banquan">版权所有：生殖健康咨询师培训网企业远程培训中心 京ICP备05046845号<br />
