...
if (count < 1)
	...
	<script language="javascript">
	alert("删除成功!");
	window.navigate("query_group_main.jsp?group_id=<%=group_id%>&group_name=<%=group_name%>");
</script>
