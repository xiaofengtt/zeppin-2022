...
<%
	...
	String managepwd = platformConfig.getManagepwd();
	
	String mailSmtp = platformConfig.getMailSmtp();
	
	String mailUser = platformConfig.getMailUser();
	
	String mailPassword = platformConfig.getMailPassword();
%>
...
<tr>
	<td bgcolor="#D4E4EB" class="zhengwen">后台管理密码：</td>
	<td bgcolor="#D4E4EB" class="zhengwen"><input type=text name=managepwd value="<%=managepwd%>" size=50></td>
</tr>
<tr>
	<td bgcolor="#D4E4EB" class="zhengwen">Email的Smtp地址：</td>
	<td bgcolor="#D4E4EB" class="zhengwen"><input type=text name=mailSmtp value="<%=mailSmtp%>" size=50></td>
</tr>
<tr>
	<td bgcolor="#D4E4EB" class="zhengwen">Email默认用户：</td>
	<td bgcolor="#D4E4EB" class="zhengwen"><input type=text name=mailUser value="<%=mailUser%>" size=50></td>
</tr>
<tr>
	<td bgcolor="#D4E4EB" class="zhengwen">Email默认用户密码：</td>
	<td bgcolor="#D4E4EB" class="zhengwen"><input type=password name=mailPassword value="<%=mailPassword%>" size=50></td>
</tr>
<tr>
