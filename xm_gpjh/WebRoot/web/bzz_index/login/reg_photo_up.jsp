...
<br>
  <form name='photo_upform' action='/entity/recruit/peTraineeReg_doUpload.action' enctype="multipart/form-data" method='post' class='nomargin'>
  ...
  <tr> 
    <td valign="top" class="pageBodyBorder_zlb"> 
        <div class="cntent_k" id="zlb_content_start">
          ...
          <p style="color:red">注意：上传格式为zip的压缩包，压缩包中不能有文件夹，包中图片格式为jpg,图片名为"学员的用户名"+".jpg",例如：001.jpg；</p>
      </div>
   </td>
  </tr>
...
<s:if test="uploadMsg != '' and uploadMsg != null">
              		<script>
              			alert("<s:property value="uploadMsg"/>");
					</script>  
              	</s:if>
