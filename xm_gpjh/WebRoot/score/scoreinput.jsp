...
<frameset rows="47,*" frameborder="no" border="0" framespacing="0">
	<frame src="/score/score_input_menu.jsp" name="submenu" scrolling="no" noresize/>
	<frame src="/score/input/scoreinput_gotoinput.action" name="subcontent" scrolling="auto" noresize/>
</frameset>
<noframes></noframes>
<body>
</body>
