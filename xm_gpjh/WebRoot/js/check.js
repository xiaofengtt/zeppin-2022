...
/^[1-9]\d{5}$/
	...
	cardNoInfor.innerHTML='<div class="checkInfor">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请填写您的证件号码</div>'; 
	   ...
	   if(idcard.length == 0){
		...
		function fopwd1(){
			document.getElementById("baseInfor1").style.background="#D2D2FF";
			pwd1Infor.innerHTML='<div class="checkInfor">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;此密码在查询及修改报名信息时使用，请牢记</div>';
				  }
		...
		function fopwd(){
			document.getElementById("baseInfor1").style.background="#D2D2FF";
			pwdInfor.innerHTML='<div class="checkInfor">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请再次输入您的密码</div>';
				  }
...
function fozzmm(){
	...
	zzmmInfor.innerHTML='<div class="checkInfor">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请选择您的政治面貌</div>';
		...
		function foUpload(){
				document.getElementById("baseInfor1").style.background="#D2D2FF";
				uploadInfor.innerHTML='<div class="checkInfor">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;照片格式为bmp,jpg,gif,大小<100K</div>';
		 }
		...
		function blUpload(){
				...
				var obj =document.getElementById('upload');
				  ...
				  uploadInfor.innerHTML='';
				  	return true;
				  }
				  var length = obj.value.length;
				  var charindex = obj.value.lastIndexOf(".");
				  var ExtentName = obj.value.substring(charindex,length);
				  if(!(ExtentName == ".jpg" || ExtentName == ".JPG" || ExtentName == ".gif" || ExtentName == ".GIF" || ExtentName == ".bmp" || ExtentName == ".BMP" )){
				  	
				  	uploadInfor.innerHTML='<div class="checkError">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;照片格式只能是*.jpg、*.gif、*.bmp！请重新输入！</div>';
				  	return false;
				  }
				  uploadInfor.innerHTML='';
				  return true;
...
*/									
		...
		xueliInfor.innerHTML='<div class="checkError">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;文化程度不能为空！</div>';
				...
				if(document.getElementById('upload').value == ''){
				  ...
				  var obj = document.getElementById('upload').value;
				  var length = obj.length;
				  var charindex = obj.lastIndexOf(".");
				  var ExtentName = obj.substring(charindex,length);
				  if(!(ExtentName == ".jpg" || ExtentName == ".JPG" || ExtentName == ".gif" || ExtentName == ".GIF" || ExtentName == ".bmp" || ExtentName == ".BMP" )){
				  		flag=false;
				  	uploadInfor.innerHTML='<div class="checkError">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;照片格式只能是*.jpg、*.gif、*.bmp！请重新输入！</div>';
