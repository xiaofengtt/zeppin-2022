...
//////////////////////
var systemTitle = "中国石油大学（北京）现代远程教育教学教务管理平台";
var systemShortTitle = "石大在线";
var maxStatus = false;
var tipInfoLeftA = "收缩菜单";
var tipInfoLeftB = "展开菜单";
var tipInfoMaxA = "最大化工作区域";
var tipInfoMaxB = "恢复正常布局";
var defaultHelpInfo = "欢迎使用中国石油大学（北京）现代远程教育教学教务管理平台！鼠标移动到图标上，本区就会出现相应的帮助信息！点击本区上面的白色三角，可以最小化帮助区";
