...
//				System.out.println("-------------------");
	...
	public static String timeSpanToString2(Timestamp ts) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss");
		return sdf.format(ts);
	}
	
	public static String timeSpanToString3(Object ts) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy.MM.dd");
		return sdf.format(ts);
	}
	
	public static String timeSpanToString4(Object ts) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd");
		return sdf.format(ts);
	}
	public static String timeSpanToString5(Object ts) {
	 ...
	 * @return
	 */
	public static String getTeacherType(Short type) {
		switch (type) {
		case Dictionary.INVIGILATION_TEACHER_TYPE:
			return "考务组";
		case Dictionary.INVIGILATION_TEACHER_TYPE2:
			return "研究生";
	 ...
	 * @return
	 */
	public static String invigilateType(String type){
		if(Utlity.checkStringNull(type)){
			return "无";
		}
		return type.replace("1", "纸笔").
				replace("2", "无纸化").
				replace("3", "测试");
	}
	 ...
	 * @return
	 */
	public static String invigilateCampus(String type){
		if(Utlity.checkStringNull(type)){
			return "无";
		}
		return type.replace("1", "温泉校区").
				replace("2", "昆仑校区").
				replace("3", "文光校区");
	}
