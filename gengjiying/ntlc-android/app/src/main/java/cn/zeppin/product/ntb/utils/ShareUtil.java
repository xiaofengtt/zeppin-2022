...
public class ShareUtil {
    ...
    public ShareAction shareMenu(final String url, final String des, final UMShareListener umShareListener) {
...
//                        }
                        shareStyleWeb(share_media, url, "", des, umShareListener);
                    }
                });
...
//                .withText(des)
     ...
     * @return
     */
    public ShareAction shareStyleWeb(SHARE_MEDIA share_media, String url, String title, String des, UMShareListener umShareListener) {
    ...
    private class CustomShareListener implements UMShareListener {
        ...
        public void onResult(SHARE_MEDIA share_media) {
            ToastUitl.showToastCenter("分享成功");
        }
