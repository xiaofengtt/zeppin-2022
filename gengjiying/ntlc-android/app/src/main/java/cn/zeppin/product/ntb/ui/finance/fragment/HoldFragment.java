 ...
 * 持仓
 */
public class HoldFragment extends BaseFragment<FinancePresenter, FinanceModel> implements FinanceContract.View, BaseFragment.IRefreshListener{
    ...
    protected void initView() {
        ...
        mRxManager.on(AppConstant.REFRESH_FINANCE_HOLD, new Action1<Boolean>() {
            @Override
            public void call(Boolean isRefresh) {
                reloadData();
            }
    ...
    private void loadData() {
        showLoading("加载中...");
        mPresenter.getFinanceList(AppApplication.getInstance().getUuid(), ApiConstants.Finance.PROFIT, mStartPage, PAGESIZE, "");
    }
