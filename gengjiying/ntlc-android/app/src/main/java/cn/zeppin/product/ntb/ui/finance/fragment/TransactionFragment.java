...
import cn.zeppin.product.ntb.ui.finance.adapter.HoldAdapter;
 ...
 * 交易中
 */
public class TransactionFragment extends BaseFragment<FinancePresenter, FinanceModel> implements FinanceContract.View, BaseFragment.IRefreshListener{
    ...
    protected void initView() {
        ...
        mAdapter = new HoldAdapter(mList);
        ...
        mRxManager.on(AppConstant.REFRESH_FINANCE_TRANSACTION, new Action1<Boolean>() {
            @Override
            public void call(Boolean isRefresh) {
                reloadData();
            }
    ...
    private void loadData() {
        showLoading("加载中...");
        mPresenter.getFinanceList(AppApplication.getInstance().getUuid(), ApiConstants.Finance.TRANSACTION, mStartPage, PAGESIZE, "");
    }
