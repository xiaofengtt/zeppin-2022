/**
 * Project Name:CETV_TEST File Name:GradeAction.java Package
	...
	public void Delete() {
		...
		if (request.getParameterMap().containsKey("id")) {
			...
			if (grade == null) {
				...
				/*
				 * // 判断是否有子科目 int childCount = iGradeService.getChildCount(id);
				 * if (childCount > 0) { actionResult.init(FAIL_STATUS,
				 * grade.getName() + "存在子学段，请先删除子学段", null); } else {
				 */
