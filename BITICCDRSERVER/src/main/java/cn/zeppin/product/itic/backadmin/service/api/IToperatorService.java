 ...
 * @since 2018年04月16日
 */
public interface IToperatorService extends IBaseService<Toperator, Integer> {
	 ...
	 * @return  List<Entity>
	 */
	 List<Toperator> getListForPage(Map<String, String> inputParams, Integer pageNum, Integer pageSize, String sorts);
