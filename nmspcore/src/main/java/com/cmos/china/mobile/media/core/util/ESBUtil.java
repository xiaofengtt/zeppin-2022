...
public class ESBUtil {
	...
	public static EsbOutObject inputloginPost(String params , String id ,String url) throws ExceptionUtil {
		MessageInfo msg = new MessageInfo();
		msg.setRestMethodType(RestMethodType.POST);//调用方式，get，post。delete等
		msg.setClientId(id);//调用端clientID
		msg.setUri(url);//接口地址
	...
	public static EsbOutObject inputloginGet(String params , String id ,String url) throws ExceptionUtil {
		MessageInfo msg = new MessageInfo();
		msg.setRestMethodType(RestMethodType.GET);//调用方式，get，post。delete等
		msg.setClientId(id);//调用端clientID
		msg.setUri(url);//接口地址
