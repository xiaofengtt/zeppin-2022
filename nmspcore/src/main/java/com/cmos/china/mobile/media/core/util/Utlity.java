...
//	public static final String basePath = "/home/zyzxfs/server";
	public static final String basePath = PropertiesUtil.getString("basePath");
	private static final String VIDEOURL = PropertiesUtil.getString("VideoUrl");
	private static final String VIDEOURL_APP = PropertiesUtil.getString("VideoUrl_app");
	...
	public static Boolean checkOrderBy(String str) {  
	 ...
	 * @return
	 */
	public static Map<String, Object> repalceNull(Map<String, Object> params){
	 ...
	 * @return
	 */
	public static String getFullUrl(Object url) {
		String fullUrl = "";
		if(url != null && !"".equals(url.toString())){
			fullUrl = VIDEOURL + url.toString();
		}
		return fullUrl;
	}
	
	public static String getAppFullUrl(Object url) {
		String fullUrl = "";
		if(url != null && !"".equals(url.toString())){
			fullUrl = VIDEOURL_APP + url.toString();
		}
		return fullUrl;
	}
	
	public static String getTokenStr(String cid,String timestamp,String tokenKey){
		String token = "";
		BASE64(MD5(MD5(cid+ timestamp)+ tokenKey)+ timestamp);
		return token;
	}
