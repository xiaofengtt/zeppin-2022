...
function details(){
	...
	$.ajax({
        ...
        success: function (data) {
        	...
        	$("#content .content_inner span.title .categoryNameParent").html(json.Records.categoryName);
        	$("#content .content_inner span.title .categoryNameParentName").attr({"href":"list.html?parent="+json.Records.categoryName+"&&id="+categoryId});
        	$("#content .content_inner span.title .categoryName2").html(json.Records.parentName);
        	$("#content .content_inner span.title .categoryNameParent2").attr({"href":"details.html?id="+json.Records.parentId});
