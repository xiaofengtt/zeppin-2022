...
// 		}
		...
		var k = (num_a&&num_b&&num_c&&num_d&&num_e&&num_f&&num_g&&num_h&&num_i&&a&&b&&i&&j&&o&&p&&q);
		if(!k){
			$("#tijiao").removeAttr("disabled");
		}
		return k;
...
<body>
	<div id="main_content">
		<div class="content_title">
			<div align="center" class="STYLE1">“国培计划”——示范性项目培训经费预算表（适用于培训团队专项研修和紧缺领域骨干教师培训项目）</div>
		</div>
		<div class="cntent_k" align="center">
			<form action="budgetnewtwo_savePeBudgetmp.action" 
				...
				<table width="80%" border="0" style="border: 1px dashed #8bbedc;"
					...
					<tr>
						...
						<td align="left">
							...
							经费: <input type="text" name="total_item_5" id="total_item_5"
								value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeMealAccExpert'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_5">
						
							<input type="text" name="price_item_5" id="price_item_5"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteMealAccExpert.split('\\\\*')[0]"/>"
								size="2" /> 
							
							<span id="span_1">元/（人•半天）</span>× 
							
							<input type="text" id="qty_item_5" name="qty_item_5"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteMealAccExpert.split('\\\\*')[1]"/>"
								size="2" /> 
					...
					<tr>
						...
						<td align="left">
							经费: <input type="text" name="total_item_2" id="total_item_2"
								value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeAccommodation'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_2">
						
							<input type="text" name="price_item_2" size="2"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteAccommodation.split('\\\\*')[0]"/>" /> 元/人/天× 
							
							<input type="text" id="qty_item_2" name="qty_item_2"
								value="<s:if test="peFeeBudget.peFeeBudgetNewTwoDetail.noteAccommodation.split('\\\\*')[1] != null "><s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteAccommodation.split('\\\\*')[1]"/></s:if>"
								size="2" /> 
							<span id="span_qty_2">人</span>× 
							
							<input type="text" 	name="time_item_2" size="2"
							value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteAccommodation.split('\\\\*')[2]"/>" /> 天
						</td>
					...
					<tr>
						...
						<td align="left">
							经费: <input type="text" name="total_item_15" id="total_item_15"
								value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeMealExpert'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_15">
						
							<input type="text" name="price_item_15" size="2"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteMealExpert.split('\\\\*')[0]"/>" /> 元/人次×
							
							<input type="text" name="qty_item_15"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteMealExpert.split('\\\\*')[1]"/>"
								size="2" /> 人次
					...
					<tr>
						...
						<td align="left">
							...
							经费: <input type="text" name="total_item_4" id="total_item_4"
								value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeTrafficExpert'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_4">
						
							<input type="text" name="price_item_4"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteTrafficExpert.split('\\\\*')[0]"/>"
								size="2" /> 元/人次× 
								
							<input type="text" name="qty_item_4"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteTrafficExpert.split('\\\\*')[1]"/>"
								size="2" /> 人次
					...
					<tr>
						...
						<td align="left">
							...
							value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeMeal'/>"
							size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_1">
							
							<input type="text" name="price_item_1" size="2"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteMeal.split('\\\\*')[0]"/>"/> 元/人/天× 
							
							<input type="text" id="qty_item_1" 	name="qty_item_1" size="2" 
							value="<s:if test="peFeeBudget.peFeeBudgetNewTwoDetail.noteMeal.split('\\\\*')[1] != null  "><s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteMeal.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>"/> 
							<span id="span_qty_1">人</span>× 
							
							<input type="text"	name="time_item_1" size="2" 
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteMeal.split('\\\\*')[2]"/>"/> 天
					...
					<tr>
						...
						<td align="left">
							经费: <input type="text" name="total_item_17" id="total_item_17"
								value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeStaffAccommodation'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_17">
						
							<input type="text" name="price_item_17" size="2"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteStaffAccommodation.split('\\\\*')[0]"/>" /> 元/人/天× 
							
							<input type="text" id="qty_item_17" name="qty_item_17"
								value="<s:if test="peFeeBudget.peFeeBudgetNewTwoDetail.noteStaffAccommodation.split('\\\\*')[1] != null "><s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteStaffAccommodation.split('\\\\*')[1]"/></s:if>"
								size="2" /> 
							<span id="span_qty_2">人</span>× 
							
							<input type="text" 	name="time_item_17" size="2"
							value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteStaffAccommodation.split('\\\\*')[2]"/>" /> 天
						</td>
					...
					<tr>
						...
						<td align="left">
							...
							value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeElectronCourse'/>"
							size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_14">
							
							<input type="text" name="price_item_14" size="2"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteElectronCourse.split('\\\\*')[0]"/>"/> 元/人/天× 
							
							<input type="text" id="qty_item_14" 	name="qty_item_14" size="2" 
							value="<s:if test="peFeeBudget.peFeeBudgetNewTwoDetail.noteElectronCourse.split('\\\\*')[1] != null "><s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteElectronCourse.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>"/> 
							<span id="span_qty_14">人</span>× 
							
							<input type="text"	name="time_item_14" size="2" 
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteElectronCourse.split('\\\\*')[2]"/>"/> 天
					...
					<tr>
						...
						<td align="left">
							经费: <input type="text" name="total_item_18" id="total_item_18"
								value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeMealStaff'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_18">
						
							<input type="text" name="price_item_18" size="2"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteMealStaff.split('\\\\*')[0]"/>" /> 元/人次×
							
							<input type="text" name="qty_item_18"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteMealStaff.split('\\\\*')[1]"/>"
								size="2" /> 人次
					...
					<tr>
						...
						<td align="left">经费: <input type="text" name="total_item_10"
							id="total_item_10"
							value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeResearch'/>"
						...
						<td align="left" id="td_item_10">
							...
							<input type="text"
								name="price_item_10"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteResearch.split('\\\\*')[0]"/>"
								size="2" /> 元/班次/天× 
								
							<input type="text" name="qty_item_10"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteResearch.split('\\\\*')[1]"/>"
								size="2" /> 班次× 
								
							<input type="text" name="time_item_10"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteResearch.split('\\\\*')[2]"/>"
								size="2" /> 天
					...
					<tr>
						...
						<td align="left">经费: <input type="text" name="total_item_11"
							id="total_item_11"
							value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeArgument'/>"
							size="5" readonly="true" />
						</td>
						...
						<input type="text"
							name="price_item_11"
							value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteArgument.split('\\\\*')[0]"/>"
							size="2" /> 元/人×
						
						<input type="text" id="qty_item_11"
							name="qty_item_11"
							value="<s:if test="peFeeBudget.peFeeBudgetNewTwoDetail.noteArgument.split('\\\\*')[1] != null "><s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteArgument.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>"
					...
					<tr>
						...
						<td align="left">经费: <input type="text" name="total_item_12"
							id="total_item_12"
							value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeTrafficStu'/>"
							size="5" readonly="true" /></td>
						<td align="left" id="td_item_12">
						
						<input type="text"
							name="price_item_12"
							value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteTrafficStu.split('\\\\*')[0]"/>"
							size="2" /> 元/班次/天× 
							
						<input type="text" name="qty_item_12"
							value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteTrafficStu.split('\\\\*')[1]"/>"
							size="2" /> 班次× 
							
						<input type="text" name="time_item_12"
							value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteTrafficStu.split('\\\\*')[2]"/>"
							size="2" /> 天
					...
					<tr>
						...
						<td align="left">经费: <input type="text" name="total_item_9"
							id="total_item_9"
							value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeSurvey'/>"
							size="5" readonly="readonly" /></td>
						<td align="left" id="td_item_9">
						
							<input type="text" name="price_item_9"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteSurvey.split('\\\\*')[0]"/>"
								size="2" /> 元/件× 
							
							<input type="text" name="qty_item_9"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteSurvey.split('\\\\*')[1]"/>"
								size="2" /> 件 
					...
					<tr>
						<td align="center">学习资料费</td>
							<td align="left">经费: <input type="text" name="total_item_8"
								id="total_item_8"
								value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeEquipmentRent'/>"
								size="5" readonly="readonly" />
							</td>
							<td align="left" id="td_item_8">
							
								<input type="text" name="price_item_8" id="price_item_8"
									value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteEquipmentRent.split('\\\\*')[0]"/>"
									size="2" /> 元/人× 
									
								<input type="text" id="qty_item_8" name="qty_item_8"
									value="<s:if test="peFeeBudget.peFeeBudgetNewTwoDetail.noteEquipmentRent.split('\\\\*')[1] != null "><s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteEquipmentRent.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>"
					...
					<tr>
						<td align="center">办公用品费</td>
							<td align="left">经费: <input type="text" name="total_item_16"
								id="total_item_16"
								value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeOfficeSupplies'/>"
								size="5" readonly="readonly" />
							</td>
							<td align="left" id="td_item_16">
							
								<input type="text" name="price_item_16" id="price_item_16"
									value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteOfficeSupplies.split('\\\\*')[0]"/>"
									size="2" /> 元/人× 
									
								<input type="text" id="qty_item_16" name="qty_item_16"
									value="<s:if test="peFeeBudget.peFeeBudgetNewTwoDetail.noteOfficeSupplies.split('\\\\*')[1] != null "><s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteOfficeSupplies.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>"
					...
					<tr>
						...
						<td align="left" id="td_item_3">
							...
							<input type="text" name="price_item_3"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteTeach.split('\\\\*')[0]"/>"
								size="2" /> 元/次× 
							
							<input type="text" name="qty_item_3"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteTeach.split('\\\\*')[1]"/>"
								size="2" /> 次
					...
					<tr>
						...
						<td align="left">
							经费: <input type="text" name="total_item_6" id="total_item_6"
								value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeMaterials'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_6">
							<input type="text" name="price_item_6" id="price_item_6"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteMaterials.split('\\\\*')[0]"/>"
								size="2" /> 
							
							<span id="span_1">元/人次</span>× 
							
							<input type="text" id="qty_item_6" name="qty_item_6"
								value="<s:if test="peFeeBudget.peFeeBudgetNewTwoDetail.noteMaterials.split('\\\\*')[1] != null "><s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteMaterials.split('\\\\*')[1]"/></s:if>"
					...
					<tr>
						...
						<td align="left">经费: <input type="text" name="total_item_7"
							id="total_item_7"
							value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeAreaRent'/>"
							size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_7">
						
							<input type="text" name="price_item_7"  id="price_item_7"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteAreaRent.split('\\\\*')[0]"/>"
								size="2" /> <span id="span_1">元/人次/天</span>× 
								
							<input type="text" id="qty_item_7" name="qty_item_7"
								value="<s:if test="peFeeBudget.peFeeBudgetNewTwoDetail.noteAreaRent.split('\\\\*')[1] != null "><s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteAreaRent.split('\\\\*')[1]"/></s:if>"
								size="2" /> <span id="span_qty_6">人次</span>×
								
							<input type="text" 	name="time_item_7" size="2"
							value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteAreaRent.split('\\\\*')[2]"/>" /> 天
						</td>
					</tr>
					<tr>
						...
						<td align="left">
							经费: <input type="text" name="total_item_19" id="total_item_19"
								value="<s:property value='peFeeBudget.peFeeBudgetNewTwoDetail.feeOthers'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_19">
							文体活动费
							<input type="text" class="item_19" name="price_item_19" size="2"
								value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteOthers.split('\\\\*')[0]"/>" /> 元、 
							医药费
							<input type="text" class="item_19" id="qty_item_19" name="qty_item_19"
								value="<s:if test="peFeeBudget.peFeeBudgetNewTwoDetail.noteOthers.split('\\\\*')[1] != null "><s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteOthers.split('\\\\*')[1]"/></s:if>"
								size="2" /> 
							<span id="span_qty_2">元、</span> 
							其他支出
							<input type="text" class="item_19"	name="time_item_19" size="2"
							value="<s:property value="peFeeBudget.peFeeBudgetNewTwoDetail.noteOthers.split('\\\\*')[2]"/>" /> 元
						</td>
					</tr>
					<tr>
