...
<body>
	<div id="main_content">
		<div class="content_title">
			<div align="center" class="STYLE1">“国培计划”——示范性项目培训经费决算表（集中培训）</div>
		</div>
		<div class="cntent_k" align="center">
			<form action="actual_savePeActualBudget.action"
				...
				<table width="80%" border="0" style="border: 1px dashed #8bbedc;"
					...
					<tr>
						...
						<td align="left" id="td_item_1">
							...
							<input type="text" name="price_item_1" size="2"
								value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteMeal.split('\\\\*')[0]"/>"/> 元/人/天× 
							...
							<input type="text"	name="time_item_1" size="2" 
								value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteMeal.split('\\\\*')[2]"/>"/> 天
					...
					<tr>
						...
						<td align="left" id="td_item_2">
							...
							<input type="text" name="price_item_2" size="2"
								value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteAccommodation.split('\\\\*')[0]"/>" /> 元/人/天× 
							...
							value="<s:property value="peFeeBudget.peFeeBudgetDetail.noteAccommodation.split('\\\\*')[2]"/>" /> 天
						</td>
					...
					<tr>
						...
						<td align="left" id="td_item_13">
							...
							<input type="text"	name="price_item_13"
							...
							<input
								...
								size="2" /> <span id="span_qty_13">人 </span>
								
							<input type="hidden" name="time_item_13" value="1" size="2" />
						</td>
