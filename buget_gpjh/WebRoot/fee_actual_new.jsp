...
<body>
	<div id="main_content">
		<div class="content_title">
			<div align="center" class="STYLE1">“国培计划”——示范性项目培训经费决算表（适用于以集中培训为主的培训项目）</div>
		</div>
		<div class="cntent_k" align="center">
			<form action="actualnew_savePeActualBudget.action"
				...
				<table width="80%" border="0" style="border: 1px dashed #8bbedc;"
					...
					<tr>
						...
						<td align="left"><input type="text"
							name="peFeeBudgetNew.unitName" id="peFeeBudget.unitName"
				...
				<table width="80%" border="0" style="border: 1px dashed #8bbedc;"
					...
					<tr>
						...
						<td align="left">
							...
							value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeMeal'/>"
							size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_1">
							
							<input type="text" name="price_item_1" size="2"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteMeal.split('\\\\*')[0]"/>"/> 元/人/天× 
							
							<input type="text" id="qty_item_1" 	name="qty_item_1" size="2" value="<s:if test="peFeeBudgetNew.peFeeBudgetNewDetail.noteMeal.split('\\\\*')[1] != null "><s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteMeal.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>"/> 
							<span id="span_qty_1">人</span>× 
							
							<input type="text"	name="time_item_1" size="2" 
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteMeal.split('\\\\*')[2]"/>"/> 天
					...
					<tr>
						...
						<td align="left">
							经费: <input type="text" name="total_item_2" id="total_item_2"
								value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeAccommodation'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_2">
						
							<input type="text" name="price_item_2" size="2"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteAccommodation.split('\\\\*')[0]"/>" /> 元/人/天× 
							
							<input type="text" id="qty_item_2" name="qty_item_2"
								value="<s:if test="peFeeBudgetNew.peFeeBudgetNewDetail.noteAccommodation.split('\\\\*')[1] != null "><s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteAccommodation.split('\\\\*')[1]"/></s:if>"
								size="2" /> 
							<span id="span_qty_2">人</span>× 
							
							<input type="text" 	name="time_item_2" size="2"
							value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteAccommodation.split('\\\\*')[2]"/>" /> 天
						</td>
					...
					<tr>
						...
						<td align="left">
							...
							value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeElectronCourse'/>"
							size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_14">
							
							<input type="text" name="price_item_14" size="2"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteElectronCourse.split('\\\\*')[0]"/>"/> 元/人/天× 
							
							<input type="text" id="qty_item_14" 	name="qty_item_14" size="2" 
							value="<s:if test="peFeeBudgetNew.peFeeBudgetNewDetail.noteElectronCourse.split('\\\\*')[1] != null "><s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteElectronCourse.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>"/> 
							<span id="span_qty_14">人</span>× 
							
							<input type="text"	name="time_item_14" size="2" 
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteElectronCourse.split('\\\\*')[2]"/>"/> 天
					...
					<tr>
						...
						<td align="left">
							经费: <input type="text" name="total_item_15" id="total_item_15"
								value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeMealExpert'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_15">
						
							<input type="text" name="price_item_15" size="2"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteMealExpert.split('\\\\*')[0]"/>" /> 元/人次×
							
							<input type="text" name="qty_item_15"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteMealExpert.split('\\\\*')[1]"/>"
								size="2" /> 人次
					...
					<tr>
						...
						<td align="left" id="td_item_3">
							...
							<input type="text" name="price_item_3"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteTeach.split('\\\\*')[0]"/>"
								size="2" /> 元/次× 
							
							<input type="text" name="qty_item_3"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteTeach.split('\\\\*')[1]"/>"
								size="2" /> 次
					...
					<tr>
						...
						<td align="left">
							...
							经费: <input type="text" name="total_item_4" id="total_item_4"
								value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeTrafficExpert'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_4">
						
							<input type="text" name="price_item_4"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteTrafficExpert.split('\\\\*')[0]"/>"
								size="2" /> 元/人次× 
								
							<input type="text" name="qty_item_4"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteTrafficExpert.split('\\\\*')[1]"/>"
								size="2" /> 人次
					...
					<tr>
						...
						<td align="left">
							...
							经费: <input type="text" name="total_item_5" id="total_item_5"
								value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeMealAccExpert'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_5">
						
							<input type="text" name="price_item_5" id="price_item_5"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteMealAccExpert.split('\\\\*')[0]"/>"
								size="2" /> 
							
							<span id="span_1">元/（人•半天）</span>× 
							
							<input type="text" id="qty_item_5" name="qty_item_5"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteMealAccExpert.split('\\\\*')[1]"/>"
								size="2" /> 
					...
					<tr>
						...
						<td align="left">
							经费: <input type="text" name="total_item_6" id="total_item_6"
								value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeMaterials'/>"
								size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_6">
							<input type="text" name="price_item_6" id="price_item_6"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteMaterials.split('\\\\*')[0]"/>"
								size="2" /> 
							
							<span id="span_1">元/人次</span>× 
							
							<input type="text" id="qty_item_6" name="qty_item_6"
								value="<s:if test="peFeeBudgetNew.peFeeBudgetNewDetail.noteMaterials.split('\\\\*')[1] != null "><s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteMaterials.split('\\\\*')[1]"/></s:if>"
					...
					<tr>
						...
						<td align="left">经费: <input type="text" name="total_item_7"
							id="total_item_7"
							value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeAreaRent'/>"
							size="5" readonly="readonly" />
						</td>
						<td align="left" id="td_item_7">
						
							<input type="text" name="price_item_7"  id="price_item_7"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteAreaRent.split('\\\\*')[0]"/>"
								size="2" /> <span id="span_1">元/人次</span>× 
								
							<input type="text" id="qty_item_7" name="qty_item_7"
								value="<s:if test="peFeeBudgetNew.peFeeBudgetNewDetail.noteAreaRent.split('\\\\*')[1] != null "><s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteAreaRents.split('\\\\*')[1]"/></s:if>"
								size="2" /> <span id="span_qty_6">人次</span> 
					...
					<tr>
						...
						<td align="left">经费: <input type="text" name="total_item_9"
							id="total_item_9"
							value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeSurvey'/>"
							size="5" readonly="readonly" /></td>
						<td align="left" id="td_item_9">
						
							<input type="text" name="price_item_9"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteSurvey.split('\\\\*')[0]"/>"
								size="2" /> 元/件× 
							
							<input type="text" name="qty_item_9"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteSurvey.split('\\\\*')[1]"/>"
								size="2" /> 件 
					...
					<tr>
						<td align="center">学习资料费</td>
							<td align="left">经费: <input type="text" name="total_item_8"
								id="total_item_8"
								value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeEquipmentRent'/>"
								size="5" readonly="readonly" />
							</td>
							<td align="left" id="td_item_8">
							
								<input type="text" name="price_item_8" id="price_item_8"
									value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteEquipmentRent.split('\\\\*')[0]"/>"
									size="2" /> 元/人× 
									
								<input type="text" id="qty_item_8" name="qty_item_8"
									value="<s:if test="peFeeBudgetNew.peFeeBudgetNewDetail.noteEquipmentRent.split('\\\\*')[1] != null "><s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteEquipmentRent.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>"
					...
					<tr>
						<td align="center">办公用品费</td>
							<td align="left">经费: <input type="text" name="total_item_16"
								id="total_item_16"
								value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeOfficeSupplies'/>"
								size="5" readonly="readonly" />
							</td>
							<td align="left" id="td_item_16">
							
								<input type="text" name="price_item_16" id="price_item_16"
									value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteOfficeSupplies.split('\\\\*')[0]"/>"
									size="2" /> 元/人× 
									
								<input type="text" id="qty_item_16" name="qty_item_16"
									value="<s:if test="peFeeBudgetNew.peFeeBudgetNewDetail.noteOfficeSupplies.split('\\\\*')[1] != null "><s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteOfficeSupplies.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>"
					...
					<tr>
						...
						<td align="left">经费: <input type="text" name="total_item_10"
							id="total_item_10"
							value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeResearch'/>"
						...
						<td align="left" id="td_item_10">
							...
							<input type="text"
								name="price_item_10"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteResearch.split('\\\\*')[0]"/>"
								size="2" /> 元/班次/天× 
								
							<input type="text" name="qty_item_10"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteResearch.split('\\\\*')[1]"/>"
								size="2" /> 班次× 
								
							<input type="text" name="time_item_10"
								value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteResearch.split('\\\\*')[2]"/>"
								size="2" /> 天
					...
					<tr>
						...
						<td align="left">经费: <input type="text" name="total_item_11"
							id="total_item_11"
							value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeArgument'/>"
							size="5" readonly="true" />
						</td>
						...
						<input type="text"
							name="price_item_11"
							value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteArgument.split('\\\\*')[0]"/>"
							size="2" /> 元/人×
						
						<input type="text" id="qty_item_11"
							name="qty_item_11"
							value="<s:if test="peFeeBudgetNew.peFeeBudgetNewDetail.noteArgument.split('\\\\*')[1] != null "><s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteArgument.split('\\\\*')[1]"/></s:if><s:else><s:property value="#total_persons"/></s:else>"
					...
					<tr>
						...
						<td align="left">经费: <input type="text" name="total_item_12"
							id="total_item_12"
							value="<s:property value='peFeeBudgetNew.peFeeBudgetNewDetail.feeTrafficStu'/>"
							size="5" readonly="true" /></td>
						<td align="left" id="td_item_12">
						
						<input type="text"
							name="price_item_12"
							value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteTrafficStu.split('\\\\*')[0]"/>"
							size="2" /> 元/班次/天× 
							
						<input type="text" name="qty_item_12"
							value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteTrafficStu.split('\\\\*')[1]"/>"
							size="2" /> 班次× 
							
						<input type="text" name="time_item_12"
							value="<s:property value="peFeeBudgetNew.peFeeBudgetNewDetail.noteTrafficStu.split('\\\\*')[2]"/>"
							size="2" /> 天
				...
				<table width="80%" border="0" style="border: 1px dashed #8bbedc;"
					...
					<tr>
						<td width="50%" align="right">
							收款单位名称： 
							<input type="text"
								name="peFeeBudgetNew.payeeName" id="peFeeBudget.payeeName"
								value="<s:property value='peFeeBudgetNew.payeeName'/>"
								maxlength="50" style="width: 73%" />
						</td>
						<td width="50%" align="right">
							开户银行： <input type="text"
							name="peFeeBudgetNew.openingBank" id="peFeeBudget.openingBank"
					...
					<tr>
						<td align="right">账号： <input type="text"
							name="peFeeBudgetNew.accountNumber" id="peFeeBudget.accountNumber"
						...
						<td align="right">
							项目联系人及电话：						
							<input type="text"
								name="peFeeBudgetNew.contactInfo" id="peFeeBudget.contactInfo"
