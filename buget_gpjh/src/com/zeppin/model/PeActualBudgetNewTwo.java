 ...
 */
@Entity
@Table(name = "PEACTUALBUDGETNEWTWO")
@Repository("peActualBudgetNewTwo")
public class PeActualBudgetNewTwo {
	...
	private PeActualBudgetNewTwoDetail peFeeBudgetNewTwoDetail;
	...
	public PeActualBudgetNewTwoDetail getPeFeeBudgetNewTwoDetail() {
		return peFeeBudgetNewTwoDetail;
	}

	public void setPeFeeBudgetNewTwoDetail(PeActualBudgetNewTwoDetail peFeeBudgetNewTwoDetail) {
		this.peFeeBudgetNewTwoDetail = peFeeBudgetNewTwoDetail;
	}
