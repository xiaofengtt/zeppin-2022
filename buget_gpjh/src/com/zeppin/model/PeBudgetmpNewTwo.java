 ...
 */
@Entity
@Table(name = "PEBUDGETMPNEWTWO")
@Repository("peBudgetmpNewTwo")
public class PeBudgetmpNewTwo {
	...
	private PeBudgetmpNewTwoDetail peFeeBudgetNewTwoDetail;
	...
	public PeBudgetmpNewTwoDetail getPeFeeBudgetNewTwoDetail() {
		return peFeeBudgetNewTwoDetail;
	}

	public void setPeFeeBudgetNewTwoDetail(PeBudgetmpNewTwoDetail peFeeBudgetNewTwoDetail) {
