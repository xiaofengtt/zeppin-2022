 ...
 */
@Entity
@Table(name = "PEBUDGETMPNEW")
@Repository("peBudgetmpNew")
public class PeBudgetmpNew {
	...
	private PeBudgetmpNewDetail peFeeBudgetNewDetail;
	...
	public PeBudgetmpNewDetail getPeFeeBudgetNewDetail() {
		return peFeeBudgetNewDetail;
	}

	public void setPeFeeBudgetNewDetail(PeBudgetmpNewDetail peFeeBudgetNewDetail) {
