 ...
 */
@Entity
@Table(name = "PEBUDGETMP")
@Repository("peBudgetmp")
public class PeBudgetmp {
	...
	private PeBudgetmpDetail peFeeBudgetDetail;
	...
	public PeBudgetmpDetail getPeFeeBudgetDetail() {
		return peFeeBudgetDetail;
	}

	public void setPeFeeBudgetDetail(PeBudgetmpDetail peFeeBudgetDetail) {
