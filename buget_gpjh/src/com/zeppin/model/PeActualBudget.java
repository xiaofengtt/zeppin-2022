 ...
 */
@Entity
@Table(name = "PEACTUALBUDGET")
@Repository("peActualBudget")
public class PeActualBudget {
	...
	private PeActualBudgetDetail peFeeBudgetDetail;
	...
	public PeActualBudgetDetail getPeFeeBudgetDetail() {
		return peFeeBudgetDetail;
	}

	public void setPeFeeBudgetDetail(PeActualBudgetDetail peFeeBudgetDetail) {
