...
import com.zeppin.service.PeBudgetmpNewDetailService;

/**
 * @author Administrator
 * 
 */
@Service("peBudgetmpNewDetailService")
public class PeBudgetmpNewDetailServiceImpl implements PeBudgetmpNewDetailService {
	...
	@Override
	public PeBudgetmpNewDetail add(PeBudgetmpNewDetail t) {
		// TODO Auto-generated method stub
		return this.peBudgetmpNewDetailDao.add(t);
	}

	@Override
	public void delete(PeBudgetmpNewDetail t) {
		// TODO Auto-generated method stub
		this.peBudgetmpNewDetailDao.delete(t);
	}

	@Override
	public PeBudgetmpNewDetail load(String id) {
		// TODO Auto-generated method stub
		return this.peBudgetmpNewDetailDao.load(id);
	}

	@Override
	public PeBudgetmpNewDetail get(String id) {
		// TODO Auto-generated method stub
		return this.peBudgetmpNewDetailDao.get(id);
	}

	@Override
	public List<PeBudgetmpNewDetail> loadAll() {
		// TODO Auto-generated method stub
		return this.peBudgetmpNewDetailDao.loadAll();
	}

	@Override
	public List<PeBudgetmpNewDetail> findAll() {
		// TODO Auto-generated method stub
		return this.peBudgetmpNewDetailDao.findAll();
	}

	@Override
	public PeBudgetmpNewDetail update(PeBudgetmpNewDetail t) {
		// TODO Auto-generated method stub
		return this.peBudgetmpNewDetailDao.update(t);
	}

	@Override
	public List<Object> findByHSQL(String querySql) {
		// TODO Auto-generated method stub
		return this.peBudgetmpNewDetailDao.findByHSQL(querySql);
	}

	@Override
	public List<PeBudgetmpNewDetail> getListByHSQL(String hql) {
		// TODO Auto-generated method stub
		return this.peBudgetmpNewDetailDao.getListByHSQL(hql);
	}

	@Override
	public List<PeBudgetmpNewDetail> getListForPage(String hql, int pageId,
			int pageSize) {
		// TODO Auto-generated method stub
		return this.peBudgetmpNewDetailDao.getListForPage(hql, pageId, pageSize);
	}
	...
	public List executeSQL(String sql) {
		// TODO Auto-generated method stub
		return this.peBudgetmpNewDetailDao.executeSQL(sql);
	}

	@Override
	public void executeHSQL(String hql) {
		// TODO Auto-generated method stub
		this.peBudgetmpNewDetailDao.executeHSQL(hql);
	}

	@Override
	public void executeSQLUpdate(String sql) {
		// TODO Auto-generated method stub
		this.peBudgetmpNewDetailDao.executeSQLUpdate(sql);
	}
	...
	public List getListPage(String sql, int offset, int length) {
		// TODO Auto-generated method stub
		return this.peBudgetmpNewDetailDao.getListPage(sql, offset, length);
	}

	@Override
	public int queryRowCount(String hql) {
		// TODO Auto-generated method stub
		return this.peBudgetmpNewDetailDao.queryRowCount(hql);
	}
