...
@Component(value="tmanagerteams2")
public class TmanagerteamsBean2 extends enfo.crm.dao.CrmBusiExBean implements TmanagerteamsLocal2 {
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#append(enfo.crm.vo.TmanagerteamsVO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#modi(enfo.crm.vo.TmanagerteamsVO)
	 */
	@Override
	public void modi(TmanagerteamsVO vo) throws BusiException{
		...
		params[9] = Utility.parseInt(vo.getLeader2(),new Integer(0));
		params[10] =vo.getLeader3();
		super.cudProc(sql_modi_tmanagerteams,params);
	}


	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#delete(enfo.crm.vo.TmanagerteamsVO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#pagelist_query(enfo.crm.vo.TmanagerteamsVO, java.lang.String[], int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#list_query(enfo.crm.vo.TmanagerteamsVO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#append(enfo.crm.vo.TmanagerteammembersVO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#modi(enfo.crm.vo.TmanagerteammembersVO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#delete(enfo.crm.vo.TmanagerteammembersVO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#pagelist_query(enfo.crm.vo.TmanagerteammembersVO, java.lang.String[], int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#list_query(enfo.crm.vo.TmanagerteammembersVO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#list_query1(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#list_queryOp(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#my_list_query(enfo.crm.vo.TmanagerteammembersVO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see enfo.crm.manager.TmanagerteamsLocal2#quotaMoneyQueryById(java.lang.Integer, java.lang.Integer)
	 */
	@Override
