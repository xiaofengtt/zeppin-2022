...
//	查询信息模板
	public static String getSmsContent(Integer tempid, String defaulvalue)
			throws Exception {
		StringBuffer sb = newStringBuffer();
		...
		try {
			while (rslist.next()) {
				Argument.appendOptions(sb, rslist.getInt("TempID")+"_"+rslist.getString("Content"),
						rslist.getString("Title") , defaulvalue);
			}
		} finally {
			rslist.close();
			stmt.close();
