...
public class IntrustJdbcTemplate{
	...
	public synchronized static Connection getConnection() throws Exception {
		DataSource ds = (DataSource) context.getBean("intrustDataSource");
		return DbKit.get(ds);
	}
	 ...
	 * 
	 * 
	 * @param procSql 存储过程语句
	 * @param action 存储过程的回调函数
	 * 
