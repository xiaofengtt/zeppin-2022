...
<link href="styles/formly/formly.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="js/plugins/jquery.layout-1.3.js"></script>
<script type="text/javascript" src="js/plugins/jquery.scrollbar.js"></script>
...
<style type="text/css">
	.pagePortlet-2{ background-color:#e8ecf1;}   
	*{box-sizing: border-box;}
	.row{font-size: 0; padding:10px; }
	.row .col-box{display:inline-block;float: left; font-size: 14px; padding:10px;}
	.row .col-1{width: 8.333333333%;}
	.row .col-2{width: 16.66666666%;}
	.row .col-3{width: 25%;}
	.row .col-4{width: 32%;}
	.row .col-5{width: 41.66666666%;}
	.row .col-6{width: 50%;}
	.row .col-7{width: 58.33333333%;}
	.row .col-8{width: 66.66666666%;}
	.row .col-9{width: 75%;}
	.row .col-10{width: 83.3333333%;}
	.row .col-11{width: 91.6666666%;}
	.row .col-12{width: 100%;}
	.controlbutton{position: fixed; right:10px; bottom:10px; z-index:2; background-color:#ccc; padding:10px; cursor: pointer; border-radius: 5px;}
	.controlbutton:hover{ background-color:#0074C7;}
	.portlet-content object *{position:relative; z-index:0;}
</style>
...
/* 	Ext.onReady(function(){
	...
	function setAction(){
		...
		var url = '<%=request.getContextPath()%>/login/modiWorkBench.jsp?workbench='+v_workbench;
...
function showMsg(serial_no) {
	var retval = showModalDialog('/login/msg_detail.jsp?serial_no='+serial_no,'', 'dialogWidth:400px;dialogHeight:180px;status:0;help:0');
	if (retval==2) {
...
#table3{background-color:#fff; border-spacing:0; border-collapse:collapse;}
#table3 tr{}
#table3 tr td{ border:1px dotted #ccc; margin:0; line-height:30px;}
#table3 tr td a{color:#197fe6; text-decoration:none;}
#table3 .tr0 td{background-color:#75b2f0; color:#fff;}
#table3 .tr1 td{}
.ctrl{ float:right;}
.ctrl a{color:#197fe6;  text-decoration:none;}

.news-list{}
.news-list li{line-height:18px; padding:5px; border-bottom:1px dotted #ccc;}
.news-list li a{color:#333; text-decoration:none;}
.news-list li a font{color:#333;}
.news-list li:hover{ background-color:#75b2f0;}
.news-list li:hover a{color:#fff;}

.portlet-table{ border-spacing:0; border-collapse:collapse;}
.portlet-table tr td{ border-bottom:1px dotted #ccc; margin:0; line-height:30px;}
.portlet-table tr td:hover{ background-color:#75b2f0;}
.portlet-table tr td:hover a,
.portlet-table tr td:hover a font{color:#fff;}
.portlet-table tr td a{ text-decoration:none;}
.portlet-table tr td a font{color:#333;}
/*
.tablelinecolor{}
.tablelinecolor tr{}
.tablelinecolor tr td{}
.tablelinecolor tr td table{ border-spacing:0; border-collapse:collapse;}
.tablelinecolor tr td table td{border:none;}
.tablelinecolor .trh td{}
.tablelinecolor .tr0 td{background-color:#fff;}
.tablelinecolor .tr1 td{background-color:#fdfdfd;}
*/
</style>
</head>
<body class="pagePortlet pagePortlet-2">
<div class="controlbutton">
	<div class="icon x10 y8"></div>
</div>
...
<input type="hidden" name="display_flag" id="display_flag" value="<%=display_flag%>" />
	<div class="row">
		<div class="col-box col-12" id="product"  style="display:none">
			<div class="portlet portlet-inquiry">
				<div class="portlet-header">
					<div class="ctrl"><a href="#" class="a2" onclick="javascript:window.location.reload();">刷新</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="#" class="a2"	 onclick="javascript:showPrpductPre();">更多>></a></div>
					在售产品预约情况
				</div>
				<div class="portlet-content scroll" style="height:240px">
					<div style="margin-left:5px;height:30%;width:99%;">
		...
		<div class="col-box col-4" id="widget15" style="display:none;">
			<div class="portlet portlet-inquiry">
				<div class="portlet-header">近一周团队销售统计(单位:万元)</div>
				<div class="portlet-content scroll">
					<div class="widget"  style="padding:5px 0 0 5px;"> 
		                <div class="widget-content swf-object" style="position:relative; z-index:0;">    
						<% 
						...
						<%}else{
							...
							String chartHTMLCode2 = Chart.createChartHTML(request.getContextPath()+"/includes/charts/Bar2D.swf","",XMLStr2,"",407,210,false);	
						%>
							<%=chartHTMLCode2%>
						<%}%>                                    
		               </div>
		...
		<div id="widget98"  class="col-box col-4" <%if(Argument.getSyscontrolValue("FLOW_CONTROL") != 1){ %> style="display:none"<%} %>>
			<div class="portlet portlet-inquiry">
				<div class="portlet-header">待处理流程任务</div>
				<div class="portlet-content scroll">
					<li class="widget"> 
					<div class="widget-content"> 
	              		 <table  style="width:100%;border:5px;cellspacing:0;cellpadding:0;" class="portlet-table">
				<%
				int countToShow_1 = 0;
				if (workConfigList != null) {
					for (int i=0; i<workConfigList.size(); i++) {
		...
		<div class="col-box col-4" id="intro"  style="display:none">
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("main.menu.mySchedule",clientLocale)%></div>
				<div class="portlet-content scroll">
					<li class="widget">
	                <div class="widget-content">	           
					<%
		...
		<div class="col-box col-4" id="widget20" style="display:none">
			<div class="portlet portlet-inquiry">
		...
		<div class="col-box col-4" id="widget2" style="display:none;">
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("main.menu.promotionProduct",clientLocale)%></div>
				<div class="portlet-content scroll">
	             <li class="widget">  
	                <div class="widget-content">
					<%
					...
					<%		if (product_id.intValue()!=0){ %>
								<a href="#" onclick="javascript:productQuery('<%=product_id%>','<%=item_id%>');">
		...
		<div class="col-box col-4" id="widget3" style="display:none"><!--在售产品统计 -->
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("class.productMarketing",clientLocale)%></div>
				<div class="portlet-content scroll">
					<li class="widget" >  
                	<% 
            		int iCurrent = 0;
		...
		<div class="col-box col-4" id="widget10" style="display:none" ><!--渠道维护计划-->
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("message.channels",clientLocale)%><%=LocalUtilis.language("message.servicePlans",clientLocale)%></div>
				<div class="portlet-content scroll">
					<li class="widget">
	                <div class="widget-content">
					<%
		...
		<div class="col-box col-4" id="widget13" style="display:none"><!--待处理自助事务-->
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("main.menu.selfAffairs",clientLocale)%></div>
				<div class="portlet-content scroll">
			  <li class="widget">  
	                <div class="widget-content">	                	
						<% 
		...
		<%}%>	
		<div class="col-box col-4" id="widget14" style="display:none">
			<div class="portlet portlet-inquiry">
				<div class="portlet-header">收款计划提醒</div>
				<div class="portlet-content scroll">
					<li class="widget" >
	                <div class="widget-content">	           
					<%
		...
		<div class="col-box col-4" id="widget4" style="display:none"><!--待处理客户事务-->
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("main.menu.customerAffairs",clientLocale)%></div>
				<div class="portlet-content scroll">
					<li class="widget" >  
	                <div class="widget-content">
					<%	
		...
		<div class="col-box col-4" id="widget5" style="display:none"><!--我的会议-->
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("main.menu.myMeetings",clientLocale)%></div>
				<div class="portlet-content scroll">
					<li class="widget" >  
	                <div class="widget-content">	             	
						<% 
		...
		<div class="col-box col-4" id="widget6" style="display:none"><!--我的活动-->
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("main.menu.myActivity",clientLocale)%></div>
				<div class="portlet-content scroll">
					<li class="widget">  
	                <div class="widget-content">
						<% 
		...
		<div class="col-box col-4" id="widget11" style="display:none"><!--认购、到账审核-->
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("class.subscribeCheck",clientLocale)%></div>
				<div class="portlet-content scroll">
					<li class="widget" >  
	                <div class="widget-content"> 
						<% 
		...
		<div class="col-box col-4" id="widget7" style="display:none"><!--待审核申购合同-->
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("main.menu.auditingPurchaseContract",clientLocale)%></div>
				<div class="portlet-content scroll">
					<li class="widget" >  
	                <div class="widget-content">
						<% 
		...
		<div class="col-box col-4" id="widget8" style="display:none"><!--待处理活动任务-->
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("main.main.yourActivityTask",clientLocale)%></div>
				<div class="portlet-content scroll">
					<li class="widget" >  
	                <div class="widget-content">
						<% 
		...
		<div class="col-box col-4" id="widget9" style="display:none"><!--待审核活动任务-->
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("main.menu.auditingActivityTask",clientLocale)%></div>
				<div class="portlet-content scroll">
					<li class="widget" >  
	                <div class="widget-content">
					<% 
		...
		<div class="col-box col-4" id="widget12" style="display:none"><!--客户移交审核-->
			<div class="portlet portlet-inquiry">
				<div class="portlet-header"><%=LocalUtilis.language("message.CustomerTransferCheck",clientLocale)%></div>
				<div class="portlet-content scroll">
					<li class="widget" >  
	                <div class="widget-content">    
						<% 
		...
		<div class="col-box col-4" id="widget16" style="display:none">
			<div class="portlet portlet-inquiry">
				<div class="portlet-header">产品销售统计分析</div>
				<div class="portlet-content scroll">
					<li class="widget"> 
		...
		<div class="col-box col-4" id="widget17" style="display:<%if(list.size()==0) out.print("none"); %>"><!-- 新增合同处理消息开始 -->
			<div class="portlet portlet-inquiry">
				<div class="portlet-header">系统消息</div>
				<div class="portlet-content scroll">
				<li class="widget"> 
	                <div class="widget-content">    
					<%if (list.size()==0){ %>
		...
		if (daysBeforeDue>=0) {  %>
		<div class="col-box col-4" id="widget18" style="display:none">
			<div class="portlet portlet-inquiry">
				<div class="portlet-header">将到期产品</div>
				<div class="portlet-content scroll">
				<li class="widget" > 
	                <div class="widget-content">    
					<% 
	...
	<div id="setContent" class="passChange" style="display:none;">
...
<script>
j$(function(){
	j$(".table-done").tableList({
		icon:"x11 y29",
		tdWidth:{
			tdLast:40
		}
	});
	j$(".controlbutton").click(function() {
		j$(".swf-object").hide();
		j$(".passChange").dialog({
			title:"设置常用模块 ",
			height: 340,
	        ...
	        close:function(){j$(".swf-object").show();}
		});
	});
