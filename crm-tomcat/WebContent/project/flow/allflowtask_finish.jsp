...
String grid_name ="/project/flow/allflowtask_finish.jsp";//catalogList.get(1);
...
{
	showModalDialog('/project/flow/flowobject_tab.jsp?object_type='+object_type+'&flow_no='+flow_no+'&node_no='+node_no+'&show_flag=ViewOpinion&edit_right=no&object_id='+object_no, '', 'dialogWidth:1300px;dialogHeight:860px;status:0;help:0');
}
</script>
