...
<%
//初始化参数信息
String interfaceType_code = "FlowTask040";
...
{
	showModalDialog('/project/flow/flowobject_tab.jsp?object_type='+object_type+'&flow_no='+flow_no+'&node_no='+node_no+'&show_flag=ViewOpinion&edit_right=no&object_id='+object_no, '', 'dialogWidth:1000px;dialogHeight:760px;status:0;help:0');
}
//---------打印最终批复书---------
function printInfo(object_no,object_type)
{
	if(object_type=="BusinessApply")
		printPage('/project/print/flowapprove_print.jsp?object_type='+object_type+'&object_id='+object_no);
}
</script>
