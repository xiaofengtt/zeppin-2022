...
String table_code = "";
String grid_name ="";
String freeform_name ="";
if (catalogList!=null){
	if (catalogList.size()>0) table_code=(String)catalogList.get(0);
	if (catalogList.size()>1) grid_name =(String)catalogList.get(1);
	if (catalogList.size()>2) freeform_name =(String)catalogList.get(2);
}
