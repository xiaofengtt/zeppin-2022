...
Integer product_id = Utility.parseInt(request.getParameter("product_id"), new Integer(-1));//产品ID
...
<input type="hidden" name="action_flag" value="<%=action_flag%>"/><!--1 查询 但没有用到 2 传入明细客户ID -->
...
<table cellSpacing=0 cellPadding=4 width="100%" border=0>
	<tr>
		<td align="left" colspan="3">
			...
			<%=LocalUtilis.language("message.need",clientLocale)%> <!--需要--><input class="flatcheckbox" type="radio" class="checkcho" name="needFeedback" value="1" />
			<%=LocalUtilis.language("message.no",clientLocale)%> <!--不需要--><input class="flatcheckbox" type="radio" name="needFeedback" value="2" checked/>
		</td>
	</tr> 
</table>
<div align="right">	
