...
<div align="left" width="575px" class="page-title">
...
<table border="0" cellspacing="0" cellpadding="4" class="product-list">
	<tr>
	...
	<tr>
		...
		<td align="left">
			<select name="accountManager" style="width: 150px">
				<option value="<%=input_operatorCode%>" selected="selected"><%=input_operatorName%></option>
			</select>
		</td>
...
<div id="table_view" align="left">
	...
	<iframe id="ifrPage" align="center" width="575px" height="375px" frameborder="0"></iframe>
</div>
