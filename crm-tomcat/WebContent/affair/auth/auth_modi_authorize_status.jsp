...
Integer statusValue=Utility.parseInt(Utility.trimNull(request.getParameter("statusValue")),new Integer(2));
	...
	if (s != null){
		for(int i = 0;i < s.length; i++){
			...
			if(_id != 0){	
				...
				authorizationShareVO.setStatus(statusValue);
				authorizationShareVO.setInput_man(input_operatorCode);	
				authorizationShareLocal.modiStatus(authorizationShareVO);	
			}
		}
	}
...
<SCRIPT LANGUAGE="javascript">	
	sl_alert("²Ù×÷³É¹¦£¡");
	location = "<%=request.getContextPath()%>/affair/auth/auth_allocate.jsp";
</SCRIPT>
