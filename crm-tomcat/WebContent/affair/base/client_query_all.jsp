...
<table align="center">
	...
	<tr>
		...
		<td valign="bottom" align="right"></td><!--新增-->
		<td valign="bottom" align="left">
		</td>	
	</tr>
	<tr>
	...
	<tr>
        ...
        <td colspan="3"><%=LocalUtilis.language("message.start",clientLocale)%> <input type="text" onkeydown="javascript:nextKeyPress(this)" maxlength="10" name="start_current_score" size="20"
                ...
                value="<%=Utility.trimNull(start_current_score)%>"<%}%>> <%=LocalUtilis.language("message.end",clientLocale)%> <!-- 到 -->
	...
	<tr>  
        ...
        <td colspan="3"><%=LocalUtilis.language("message.start",clientLocale)%> <input type="text" onkeydown="javascript:nextKeyPress(this)" maxlength="9" name="start_rg_times" size="20" <%
                ...
                <%}%>> <%=LocalUtilis.language("message.end",clientLocale)%> <!-- 到 --> <input type="text" onkeydown="javascript:nextKeyPress(this)" maxlength="9" name="end_rg_times" size="20" <%
	...
	<tr>
		...
		<td align="center">
			<%=LocalUtilis.language("menu.customerRating",clientLocale)%> :<!--客户评级-->
		...
		<td align="center">
			<%=LocalUtilis.language("menu.CustomerClassification",clientLocale)%> :<!--客户分类-->
			<button type="button" class="xpbutton4" name="btnQuery" accessKey="q"
