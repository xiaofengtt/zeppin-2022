...
Integer tree_id = new Integer(Utility.parseInt(request.getParameter("tree_id"), 1)); // default is 1
Integer manager_id = new Integer(Utility.parseInt(request.getParameter("manager_id"), 1));
...
<form name="theform" method="post" action="<%=request.getContextPath()%>/affair/base/manager_edit.jsp" onsubmit="javascript:return validateForm(this);">
		...
		<br/>
		 <table border="0" width="100%" cellspacing="3">	
			<tr>
				...
				<td width="64%">
					<input type="hidden" name="serial_no" value="<%=tree_id%>"/>
					<select name="managerid" style="width:120px;">
						<%=Argument.getManager_Value(manager_id)%>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td width="64%">
					<input type="text" name="level_no" value="<%=level_no%>"/>
			...
			<tr>
				...
				<td width="64%">
					<input type="text" name="level_name" value="<%=level_name%>"/>
