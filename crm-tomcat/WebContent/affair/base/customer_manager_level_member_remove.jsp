<%@ page language="java" pageEncoding="GBK" import="enfo.crm.system.*,enfo.crm.affair.*,enfo.crm.vo.*, enfo.crm.customer.*,enfo.crm.tools.*,enfo.crm.dao.*" %>
...
{	
	...
	{	
		...
		if(str != null)
		{
			...
			local.delCustManagerTreeMember(vo);
		}
	}
}
%>
...
<SCRIPT LANGUAGE="javascript">
	sl_remove_ok("customer_manager_level_member_list.jsp?tree_id="+<%=tree_id%> + "&level_name="+'<%=level_name%>');
</SCRIPT>
<%local.remove();%>