...
//url设置
String tempUrl = "&begin_plan_date="+begin_plan_date
...
function QueryAction(){
	...
	var url = "send_info_query.jsp?page=<%=sPage%>&pagesize="+ document.theform.pagesize.value;	
	url = url + "&begin_plan_date=" + document.theform.begin_plan_date.value
				  + "&end_plan_date=" + document.theform.end_plan_date.value
...
function AppendAction(){
	...
	dialog("","iframe:"+url,"850px","450px","show","<%=request.getContextPath()%>"); 
	showWaitting(0);	
}
/*修改方法*/
...
<div>
	<TABLE id="table3" border="0" cellspacing="1" cellpadding="2" class="tablelinecolor" width="100%">
		<tr class="trh">
			<td width="7%" align="center"><%=LocalUtilis.language("class.serialNumber",clientLocale)%> <!--序号--></td>	
...
%>
	<tr class="tr<%=iCount%2%>">
		...
		<td align="center"><%=Argument.getOpNameByOpCode(input_man) %></td>	
		...
		<td align="center"><%= Argument.getOpNameByOpCode(check_man)%></td> 
