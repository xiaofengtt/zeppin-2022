...
<div id="queryCondition" class="qcMain" style="display:none;width:250px;">
	...
	<table>
		...
		<tr>
			<td align="center">
				<button class="xpButton3" accessKey=o name="btnQuery" onclick="javascript:chooseDate();">确定(<u>O</u>)</button>
			</td>
		</tr>
	</table>
</div>
			...
			<table border="0" width="100%">
				<tr align="center">
					<td>
						...
						&nbsp;&nbsp;
						<button class="xpbutton3" accessKey=q id="queryButton" name="queryButton">查询日期(<u>Q</u>)</button>
						&nbsp;&nbsp;
