...
Integer payPlan_id=Utility.parseInt(Utility.trimNull(request.getParameter("payPlan_id")),new Integer(0));
...
if(request.getMethod().equals("POST")){
	...
	tcoContractPayPlanVO.setPayPlan_id(payPlan_id);
	tcoContractPayPlanVO.setInvoice_time(invoice_time);
	tcoContractPayPlanVO.setInvoice_money(invoice_money);
	tcoContractPayPlanVO.setBank_id(bank_id);
	tcoContractPayPlanVO.setBank_acct(bank_acct);
	tcoContractPayPlanVO.setAcct_name(acct_name);
	tcoContractPayPlanVO.setInput_man(input_operatorCode);
	tcoContractPayPlanVO.setInvoice_summary(invoice_summary);
	tcoContractPayPlanLocal.setInvoice(tcoContractPayPlanVO);
	bSuccess = true;
...
<form name="theform" method="post" action="tcoInvoice_new.jsp" onsubmit="javascript:return validateForm(this);">
