...
<%
	...
	if(request.getMethod().equals("POST")){ 
		...
		tcoMaintainMoneyDetailVO.setMaintain_id(Utility.parseInt(maintain_id,new Integer(0))); 
		tcoMaintainMoneyDetailVO.setArrive_time(Utility.parseInt(arrive_time,new Integer(0)));
		tcoMaintainMoneyDetailVO.setArrive_money(Utility.parseDecimal(arrive_money,new BigDecimal(0.00)));
		tcoMaintainMoneyDetailVO.setArrive_summary(arrive_summary);
		tcoMaintainMoneyDetailVO.setInput_man(input_operatorCode); 
		tcoMaintainMoneyDetailVO.setIsAllArriveFlag(isAllArriveFlag);
		tcoMaintainMoneyDetailLocal.append(tcoMaintainMoneyDetailVO);
		bSuccess=true;
 	}	
 %>
<html>
...
<BODY class="BODY">
<form name="theform" method="post"  action="tcoMaintainMoneyDetail_new.jsp" onsubmit="javascript:return validateForm(this);">
<input type="hidden" name="maintain_id" value="<%=maintain_id%>">
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td><img border="0" src="<%=request.getContextPath()%>/images/ico_area.gif" align="absbottom" width="32" height="28"><font color="#215dc6"><b>维护费到账</b></font></td>
	</tr>
	<tr> 
		<td>
