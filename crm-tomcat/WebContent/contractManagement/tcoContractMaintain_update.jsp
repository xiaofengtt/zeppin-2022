...
<table border="0" width="68%" cellspacing="3">
	...
	<tr>
		...
		<td  align="left"><input type="text" name="coContractMaintain_sub_bh" value="<%=coContractMaintain_sub_bh%>" size="25" value="" onkeydown="javascript:nextKeyPress(this)"></td>
	...
	<tr>
		...
		<td align="left" >
			<input type="text" name="main_pro_name" value="<%=main_pro_name%>" size="25" value="" onkeydown="javascript:nextKeyPress(this)">
		</td>
	</tr>
	<tr>	
		<td align="right">维护周期: </td><!--维护周期-->
		<td align="left" >
			<input type="text" name="main_period" size="16" value="<%=main_period%>" onkeydown="javascript:nextKeyPress(this)">
		...
		<td>
			<INPUT TYPE="text" NAME="collect_time_picker" class=selecttext value="<%=collect_time%>" >
	...
	<tr>	
		...
		<td align="left" >
			<input type="text" name="ht_money" size="25" value="<%=ht_money%>" onkeydown="javascript:nextKeyPress(this)">
		</td>
		<td align="right">维护费金额:</td>
		<td>
			<input type="text" name="wh_money" size="25" value="<%=wh_money%>" onkeydown="javascript:nextKeyPress(this)">
		</td>
	</tr>
	<tr>
		<td align="right">合同说明</td>
		<td align="left" colspan="3">
			<textarea rows="" cols="100" name="main_summary"><%=main_summary %></textarea>
		</td>
	</tr>
</table>
	...
	<tr>
		...
		<td  align="left" colspan="3">
			<input id="oldAttachment" type="text" name="file_now" size="60" value="<%= origin_name%>" readonly="readonly"/>&nbsp;&nbsp;&nbsp;&nbsp;
           	...
           	<button type="button" class="xpbutton3"  id="btn_DelDbAttachment" name="btn_DelDbAttachment" onclick="javascript:deleteDbAttachment('<%=attachmentId%>','<%=save_name%>','<%=maintain_id%>');"><%=LocalUtilis.language("class.deleteAttachment",clientLocale)%></button><!-- 删除附件 -->
		</td>
	</tr>
	<%	}
	 %>
				...
				<%
				 ...
				 %>
				 	<tr class="tr<%=count%2%>">
						...
						<td><input type=text name="main_rate111" value="<%=main_rate %>"/>&nbsp;&nbsp;%</td>
						<td><input type=text name="main_money111" value="<%=main_money %>"/>&nbsp;&nbsp;(元)</td> 
					</tr>
				 <%		
...
<table border="0" width="100%">
	<tr>
		<td align="center">
		<button type="button" class="xpbutton3" id="btn_saveAttachment"  accessKey=s id="btnSave" name="btnSave" onclick="javascript:saveAction();"><%=LocalUtilis.language("message.save",clientLocale)%> (<u>S</u>)</button>
		&nbsp;&nbsp;<!--保存-->
