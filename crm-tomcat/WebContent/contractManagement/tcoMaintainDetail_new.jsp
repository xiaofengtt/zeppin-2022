...
<table border="0" width="100%" cellspacing="3">
	<tr>
		...
		<td  align="left">
			<select id="coContract_id" name="coContract_id" style="width: 146px">
	...
	<tr>
		...
		<td  align="left">
			<select id="coProduct_id" name="coProduct_id" style="width: 146px">
				<option value="">请选择 </option><!--请选择-->
				<%	
				    Iterator iterator1 = rsList.iterator();
					while(iterator.hasNext()){	
						map = (Map)iterator.next();		
