...
<BODY class="body" leftmargin="" topmargin=0 rightmargin=0 onload="javascript:print();close();">
	<p style="TEXT-ALIGN: center; MARGIN: 0cm 0cm 0pt" class="MsoNormal" align="center">
		<strong style="mso-bidi-font-weight: normal">
			<span style="FONT-FAMILY: 宋体; FONT-SIZE: 15pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">
				中投信托有限责任公司</span></br>
			<span style="FONT-FAMILY: 宋体; FONT-SIZE: 15pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">
				集合资金信托计划信托单位认购/申购确认书</span>
		</strong>
	</p><br>
	<p style="MARGIN: 0cm 0cm 0pt 21pt" class="MsoNormal">
		<font size="3";>
			<font face="Times New Roman"><%=Format.formatDateCn(validate.getBen_start_date().intValue()) %></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<span style="FONT-FAMILY: 宋体; mso-bidi-font-size: 10.5pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 
				'Times New Roman'">单位：人民币元</span>
		</font>
	</p><br>	
