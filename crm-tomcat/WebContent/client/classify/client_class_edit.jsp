...
<HTML>
<HEAD>
<TITLE><%=LocalUtilis.language("message.modifyCustClassification",clientLocale)%> </TITLE><!--修改客户分类-->
...
<script type='text/javascript' src='<%=request.getContextPath()%>/includes/customer_classify.js'></script>
<script language=javascript>
oState.cd_no = 2;
function SaveAction(){
...
<div align="left">
	<img border="0" src="<%=request.getContextPath()%>/images/member.gif" width="32" height="28"><b><%=LocalUtilis.language("message.modifyCustClassification",clientLocale)%> </b><!--修改客户分类-->
		...
		<tr>
			...
			<td width="200" vAlign=top align=left>
				...
				<div align="left" style="margin-left:5px;">
					...
					<!--返回-->
                    <button type="button"  class="xpbutton3" accessKey=c id="btnCancel" name="btnCancel" onclick="javascript:location.href='classify.jsp';"><%=LocalUtilis.language("message.back",clientLocale)%> 
                    (<u>C</u>)</button>
				</div> 
			</td>
			<td>
				<iframe src ="<%=request.getContextPath()%>/client/clientinfo/client_query_info2.jsp?cust_id=<%=cust_id%>" 
						name="sonIframe" frameborder="no" border="0" height="450" width="800" />
			</td>
		</tr>
	</table>
</div>
