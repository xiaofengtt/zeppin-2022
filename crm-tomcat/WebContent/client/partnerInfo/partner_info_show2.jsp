...
<table  id="table1" cellSpacing="1" cellPadding="2" width="95%"  bgcolor="#CCCCCC">
			 ...
			 <tr style="background:F7F7F7;">	
				 <%if(q_partn_type2_flag.intValue()==1){%>
			 			 <td width="25%"><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%=LocalUtilis.language("class.industry",clientLocale)%> £∫</font></td><!--À˘ Ù––“µ-->
					...
					<%}%>
					 <td width="25%"><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%=LocalUtilis.language("class.corporate",clientLocale)%> £∫</font></td><!--∑®»À–’√˚-->
					 <td width="25%"><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%= legal_man%></font> </td>
			 </tr>
...
<div id="r2" align="center" style="display:none;">
		...
		<table  id="table2" cellSpacing="1" cellPadding="2" width="95%"  bgcolor="#CCCCCC">
			<tr style="background:F7F7F7;">
				<td ><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%=LocalUtilis.language("class.serviceWay",clientLocale)%> £∫</font><br></td><!--¡™œµ∑Ω Ω-->
				<td colspan="3"><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%= touch_type_name%></font><br></td>
			</tr>
			
			<tr style="background:F7F7F7;">
				<td width="15%"><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%=LocalUtilis.language("class.customerHTel",clientLocale)%> £∫</font><br></td><!--º“Õ•µÁª∞-->
				<td width="*"><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%= h_tel%></font><br></td>
				<td width="15%"><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%=LocalUtilis.language("class.companyPhone",clientLocale)%> £∫</font><br></td><!--π´ÀæµÁª∞-->
				<td width="*"><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%= o_tel%></font><br></td>
			</tr>
			
			<tr style="background:F7F7F7;">
				<td><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%=LocalUtilis.language("class.customerMobile",clientLocale)%> £∫</font><br></td><!-- ÷ª˙-->
				<td><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%= mobile%></font><br></td>
				<td><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%=LocalUtilis.language("class.customerMobile",clientLocale)%> 2£∫</font><br></td><!-- ÷ª˙-->
				<td><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%= bp%></font><br></td>
			</tr>
			
			<tr style="background:F7F7F7;">
				<td><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%=LocalUtilis.language("class.fax",clientLocale)%> £∫</font><br></td><!--¥´’Ê-->
				<td><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%= fax%></font><br></td>
				<td><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;E-MAIL£∫</font><br></td>
				<td><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%= e_mail%></font><br></td>
			</tr>
			
			<tr style="background:F7F7F7;">
				<td><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%=LocalUtilis.language("class.postcode",clientLocale)%> £∫</font><br></td><!--” ’˛±‡¬Î-->
				<td colspan="3"><font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%= post_code%></font><br></td>
			</tr>
			
			<tr style="background:F7F7F7;">
				<td>&nbsp;<font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%=LocalUtilis.language("class.postAddress2",clientLocale)%> £∫</font><br></td><!--” ºƒµÿ÷∑-->
				<td colspan="3">&nbsp;<font size="2" face="Œ¢»Ì—≈∫⁄">&nbsp;&nbsp;<%= post_address%></font><br></td>
			</tr>			
		</table>
</div>
