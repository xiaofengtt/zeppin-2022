...
function showInfo(cust_id,cust_type) {
	...
	if (cust_type == 2)
		ret = showModalDialog('clinet_info_new_end_m.jsp?cust_id='+cust_id,'','dialogWidth:850px;dialogHeight:650px;status:0;help:0');
	else if (cust_type == 1)
		ret = showModalDialog('client_info_new_m.jsp?cust_id='+cust_id,'','dialogWidth:850px;dialogHeight:650px;status:0;help:0');
