...
function validateForm(form){
	...
	if(form.re_check_reason.value != ''){
		if(form.re_check_reason.value.replace(/[\u0391-\uFFE5]/g,"aa").length > 100){
			sl_alert("只允许输入50个字！");//
			form.re_check_reason.focus();
			return false;
		}
	}
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="page-title"><font color="#215dc6"><b>客户联系方式修改审核</b></font></td>
	</tr>
	<br/>
</table>
<table border="0" width="100%" cellspacing="3" class="product-list">
	...
	<tr>
		...
		<td align="left">
			<textarea style="width:220px" type="text" name="check_reason" class="edline"><%=Utility.trimNull(map.get("CHECK_REASON")) %></textarea>
		</td>
	</tr>
	<tr>
		<td align="right">审核意见:</td>
		<td align="left">
			<textarea style="width:220px" type="text" name="re_check_reason" class="edline" size="80" value=""></textarea>
		</td>
	</tr>
<%
