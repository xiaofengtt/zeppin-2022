		...
		<table border="0" width="100%" cellspacing="0" cellpadding=0>
			...
			<TR id=r0 <%if (subflag == 0) out.print("style='display:'"); else out.print("style='display:none'");%> bgColor=#ffffff>
				...
				<TABLE cellSpacing=1 cellPadding=2 width="100%"
					...
					<TBODY>
						...
						<tr bgColor=#ffffff>
							<td align="right"><%=LocalUtilis.language("class.printDeployBill",clientLocale)%>:</td><%=LocalUtilis.language("class.printDeployBill",clientLocale)%> 
							<td><b><%=print_deploy_bill_checked%></b></td>
							<td align="right"><%=LocalUtilis.language("class.customerIsLink",clientLocale)%>：</td><%=LocalUtilis.language("class.customerIsLink",clientLocale)%> 
			...
			<TR id=r4 <%if (subflag == 4) out.print("style='display:'"); else out.print("style='display:none'");%>
				...
				<table border="0" cellpadding="2" cellspacing="1"
					class="tablelinecolor" width="100%">
					<tr class="trh">
						<td bgcolor="#97e8ab" align="center"><%=LocalUtilis.language("menu.inputMan",clientLocale)%> </td><!--修改人-->
						<td bgcolor="#97e8ab" align="center"><%=LocalUtilis.language("menu.inputDate",clientLocale)%> </td><!--修改日期-->
						<td bgcolor="#97e8ab" align="center"><%=LocalUtilis.language("class.modifyField",clientLocale)%> </td><!--修改字段-->
						<td bgcolor="#97e8ab" align="center"><%=LocalUtilis.language("class.originalValue",clientLocale)%> </td><!--字段原值-->
						<td bgcolor="#97e8ab" align="center"><%=LocalUtilis.language("class.newValue",clientLocale)%> </td><!--字段新值-->
					</tr>
					<%
					...
					<tr>
						...
						<table id="table3" border="0" cellspacing="1" cellpadding="2"
							...
							<tr class="trh">
								...
								<td align="center" height="25"><%=LocalUtilis.language("message.eleValue",clientLocale)%> </td><!--要素值-->
							</tr>
							<%
			...
			<!-- end 定义要素-->
			<!-- start 客户交流-->
			<TR id=r8 <%if (subflag == 8) out.print("style='display:'"); else out.print("style='display:none'");%>
				bgColor=#ffffff>
				<TD>
				<TABLE cellSpacing=1 cellPadding=4 width="100%"
					class="tablelinecolor" border=0>
					<tr bgcolor="#97e8ab">
						<td align="center"><%=LocalUtilis.language("class.exchangeTime",clientLocale)%></td><%=LocalUtilis.language("class.exchangeTime",clientLocale)%> 
						...
						<td align="center"><%=LocalUtilis.language("class.infoLevel",clientLocale)%></td><%=LocalUtilis.language("class.infoLevel",clientLocale)%> 
					</tr>
			...
			<TR id=r6 <%if (subflag == 6) out.print("style='display:'"); else out.print("style='display:none'");%> bgColor="#ffffff">
				...
				<TABLE cellSpacing=1 cellPadding=4 width="100%"
					...
					<tr class="trh">
						...
						<td><%=LocalUtilis.language("class.benAmount2",clientLocale)%> </td><%=LocalUtilis.language("class.benAmount2",clientLocale)%> 
						<td><%=LocalUtilis.language("class.date2",clientLocale)%> </td><%=LocalUtilis.language("class.date2",clientLocale)%> 
					</tr>
					<%
					iCount = 0;
					iCurrent = 0;
					...
					for(int i=0; i<change_ben_list.size(); i++)
					{
						...
						if(Utility.trimNull(change_ben_map.get("CHANGE_TYPE_NAME")).equals("赎回"))
				...
				<td><br>
					...
					<tr bgColor=#ffffff>
						<td align="left" colspan="1" height="15"><font color="#CC99CC"
							size="-1"><%=LocalUtilis.language("message.docImg",clientLocale)%></font><%=LocalUtilis.language("message.docImg",clientLocale)%> 
						</td>
					</tr>
					<tr align="center">
						<td>
