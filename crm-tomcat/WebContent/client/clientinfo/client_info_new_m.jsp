...
if (cust_id.intValue()>0) {
	cust_vo.setCust_id(cust_id);
	cust_vo.setInput_man(input_operatorCode);
	List list = cust_local.listProcAll_m(cust_vo);
...
<form name="theform" method="post" action="client_info_new_m.jsp" enctype="multipart/form-data" target="">
...
<a style="display:none" href="client_info_new_m.jsp?cust_id=" id="reload"></a>
