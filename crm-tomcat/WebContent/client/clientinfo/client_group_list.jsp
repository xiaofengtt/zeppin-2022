...
$(function(){
	...
	$("#tree").fancytree({
		...
		tooltip:false,
		// source: SOURCE,
		source: { url: "/client/clientinfo/customerTreeJson.jsp"},
	...
	$("#tree").contextmenu({
		...
		menu: [
			{title: "查看群组成员", cmd: "viewGroupMember", uiIcon: "ui-icon-note" },
			{title: "添加下级群组", cmd: "addLower", uiIcon: "ui-icon-arrowreturn-1-e" },
			{title: "修改群组", cmd: "modifyGroup", uiIcon: "ui-icon-pencil" },
			{title: "删除群组", cmd: "deleteGroup", uiIcon: "ui-icon-trash" },
