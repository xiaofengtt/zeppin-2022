...
List list = custStatLocal.getSourceStat(vo);
...
String fileName1 = "客户来源分布-人数占比";
String fileName2 = "客户来源分布-金额占比";
for(int i=0;i<list.size();i++) {
	Map map = (Map)list.get(i);

	ItemName1[i] = Utility.trimNull(map.get("CUST_SOURCE_NAME"));	
	ItemName2[i] = Utility.trimNull(map.get("CUST_SOURCE_NAME"));	
...
%>	
				<tr class="tr<%=inCount%2%>">
					<td><%=Utility.trimNull(map.get("CUST_SOURCE_NAME"))%></td>
