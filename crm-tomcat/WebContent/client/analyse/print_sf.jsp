		...
		<tr>	
			<td width="50%">
				<table border="0" width="100%" cellspacing="0" cellpadding="4">
					<tr><td height="30px"></td></tr>
					<tr>
						<td><font size=1><!--收件公司:--><font size=2><%=Utility.trimNull(cust_map.get("CUST_NAME"))%>&nbsp;</font></td>
						<td><font size=1><!--联络人:--></td>
					</tr>
					<tr>
						<td colspan="2" height="65px" valign="top"><font size=1><!--地址:--><font size=2><%=Utility.trimNull(cust_map.get("POST_ADDRESS"))%></font></td>
						
					</tr>
					<tr>
						<td><font size=1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<!--联系电话:-->&nbsp;<font size=2><%=Utility.trimNull(cust_map.get("CUST_TEL"))%></td>
