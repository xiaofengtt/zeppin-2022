			...
			while(it.hasNext()){
				...
				<div <%if(print_deply_bill.intValue()==0){%>class="Noprint"<% }%>>
					...
					while(ben_it.hasNext())
					{
						...
						to_amount_show=Utility.trimNull(Format.formatMoney(Utility.stringToDouble(Utility.trimNull(ben_map.get("TO_AMOUNT")))));
						if ("".equals(ben_amount_show)){
							if ("".equals(to_amount_show))
								ben_amount_show="--";
							else
					...
					<tr>
						...
						<td align="right"><%=to_amount_show%></td>
					...
					<tr>
						...
						<td align="right">起止日期：<%if(startdate!=null && startdate.intValue()!=0) out.print(startdate); %>至<%if (enddate!=null && enddate.intValue()!=0) out.print(enddate); else out.print("今"); %></td>	
					</tr>
					</table>
					<table border="1" cellspacing="0" cellpadding="2" width="90%" align="center" style="border-collapse:collapse;"  bordercolor="black">
					<tr>
					...
					money_vo.setBen_card_no(bank_acc);
