					...
					<TR>
						...
						<table border="0" width="100%">
							<tr>
                                ...
                                <!--刷新-->
								<td align="right" valign="bottom"><button class="xpbutton3" accessKey=r name="btnRefresh" title='<%=LocalUtilis.language("message.refresh",clientLocale)%>' onclick="javascript:location.reload();"><%=LocalUtilis.language("message.refresh",clientLocale)%> (<u>R</u>)</button></td>
							</tr>
							<tr>
								<td colspan="2">
