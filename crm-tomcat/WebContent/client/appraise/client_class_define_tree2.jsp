...
for(int i = 0 ; i<list.size();i++){
	...
	sb.append(Utility.parseInt(Utility.trimNull(map.get("CLASSDEFINE_ID")),null)+"|"+level_id+"|"+Utility.parseInt(Utility.trimNull(map.get("CANMODI")),0)+"|"+Utility.parseInt(Utility.trimNull(map.get("CLASSDETAIL_ID")),0)+"|"+Utility.parseInt(Utility.trimNull(map.get("CANDEL")),0)+"|"+Utility.parseInt(Utility.trimNull(map.get("CANADD")),0));
	sb.append("\"");
	...
	else
	{
		...
		{
			sb.append(Utility.trimNull(map.get("CLASSDETAIL_NAME"))+"(购买过"+Utility.trimNull(map.get("CLASS_MINVALUE"))+"次)");
		}
		else if(Utility.trimNull(map.get("CLASSDEFINE_ID")).equals("11"))
		{
			if(Utility.trimNull(map.get("CLASS_MINVALUE")) == "" && "".equals(Utility.trimNull(map.get("CLASS_MINVALUE"))))
				sb.append(Utility.trimNull(map.get("CLASSDETAIL_NAME"))+"(小于"+Utility.trimNull(map.get("CLASS_MAXVALUE"))+"个月)");
			else
				sb.append(Utility.trimNull(map.get("CLASSDETAIL_NAME"))+"(大于"+Utility.trimNull(map.get("CLASS_MINVALUE"))+"个月)");
		}
		else if(Utility.trimNull(map.get("CLASSDEFINE_ID")).equals("12"))
		{
			if(Utility.trimNull(map.get("CLASS_MAXVALUE")) == "" && "".equals(Utility.trimNull(map.get("CLASS_MAXVALUE"))))
				sb.append(Utility.trimNull(map.get("CLASSDETAIL_NAME"))+"("+Utility.trimNull(Format.formatMoney(Utility.stringToDouble(Utility.trimNull(map.get("CLASS_MINVALUE")))))+"元以上)");
			else
				sb.append(Utility.trimNull(map.get("CLASSDETAIL_NAME"))+"("+Utility.trimNull(Format.formatMoney(Utility.stringToDouble(Utility.trimNull(map.get("CLASS_MINVALUE")))))+"-"+Utility.trimNull(Format.formatMoney(Utility.stringToDouble(Utility.trimNull(map.get("CLASS_MAXVALUE")))))+"元)");
		}
		else
