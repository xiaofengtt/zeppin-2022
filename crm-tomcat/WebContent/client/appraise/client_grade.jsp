...
<table>
	...
	<tr>
		...
		<td align="left" colspan="3"><input type="text" name="cust_name"
			...
			value="<%=cust_name%>"></td>
		<td align="right"><%=LocalUtilis.language("class.customerID",clientLocale)%>:</td><%=LocalUtilis.language("class.customerID",clientLocale)%> 
		...
		<TABLE cellSpacing=0 cellPadding=4 width="100%" align=center border=0>
			<TR>
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td><%=LocalUtilis.language("class.gradeLevel3",clientLocale)%> :</td><!--等级评定为-->
						...
						<button type="button"  class="xpbutton3" accessKey=n id="btnNew" name="btnNew"
							title='<%=LocalUtilis.language("message.assess",clientLocale)%>' onclick="javascript:assessLeve();"><%=LocalUtilis.language("message.assess",clientLocale)%> (<u>A</u>)</button>
						&nbsp;&nbsp;&nbsp;<%}%></td>
					</tr>
					<tr>
						<td colspan=3>
				...
				<table id="table3" border="0" cellspacing="1" cellpadding="2"
					...
					<tr class="trh">
						...
						<td align="center"><%=LocalUtilis.language("class.customerName",clientLocale)%></td><%=LocalUtilis.language("class.customerName",clientLocale)%> 
