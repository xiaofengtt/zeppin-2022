...
int pageFlag = Utility.parseInt(request.getParameter("pageFlag"),1);
...
<%if(pageFlag==1){ %>
<script type='text/javascript' src='<%=request.getContextPath()%>/includes/client_query_tree_all.js'></script>
<%}else{ %>
<script type='text/javascript' src='<%=request.getContextPath()%>/includes/classfiy_query_tree_all.js'></script>
<%} %>
<script language=javascript>
function SaveAction(){
...
<div align="left" class="page-title">
	<b><%=LocalUtilis.language("class.customerLevel",clientLocale)%> </b><!--客户级别-->
</div>	
<br/>
<div align="left">
