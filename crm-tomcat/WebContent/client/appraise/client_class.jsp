...
{
	location = 'client_class.jsp?page=<%=sPage%>&pagesize='+ document.theform.pagesize.value+getQueryCondition();
}

/**************************************************************************/
function advancedQuery(){
	var v = showModalDialog('/client/analyse/client_query_all.jsp?'+getQueryCondition(),'','dialogWidth:740px;dialogHeight:520px;status:0;help:0');
	if(v!=null)
	{	
		location = 'client_class.jsp?cust_no='          +v[0]
									+'&cust_name='      +v[1]
									+'&cust_source='    +v[2]
									+'&cust_type='      +v[3]
									+'&card_type='      +v[4]
...
<div>
	<table border="0" cellspacing="1" cellpadding="2"
		...
		<tr class="trh">
			...
			<td align="center"><%=LocalUtilis.language("message.modifyCustomerRating",clientLocale)%> </td><!--修改客户评级-->
		</tr>
<%
	int iCount = 0;
	int iCurrent = 0;
