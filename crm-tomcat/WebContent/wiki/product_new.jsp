...
if (preproduct_id.intValue() > 0 ){
	...
	if (listAll.size() > 0) {
		...
		expre_start_time = Utility.trimNull(map.get("EXPRE_START_TIME"));
		if (expre_start_time.length()>19) expre_start_time=expre_start_time.substring(0,19);
		expre_end_time = Utility.trimNull(map.get("EXPRE_END_TIME"));
		if (expre_end_time.length()>19) expre_end_time=expre_end_time.substring(0,19);
	}
}
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td align="left" class="page-title"><font color="#215dc6"><b><%=menu_info%>>>增加产品</b></font></td>
	</tr>
</table>
<br/>
<table width="100%" cellspacing="0" cellpadding="2" border="0" class="product-list"> 
	<tr>
...
<table border="0" width="100%">
	...
	<tr>
		...
		&nbsp;&nbsp;<!--保存-->
		<button type="button"  class="xpbutton3" accessKey=c id="btnCancel" name="btnCancel" onclick="javascript:history.back();">返回 (<u>B</u>)</button>
		&nbsp;&nbsp;<!--取消-->
	</tr>
</table>
</form>
