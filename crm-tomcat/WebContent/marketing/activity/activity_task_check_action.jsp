...
Integer transFlag = Utility.parseInt(Utility.trimNull(request.getParameter("transFlag")),new Integer(1));//1 活动审核列表，2 首页
...
window.onload = function(){
	...
	if(v_bSuccess=="true"){
		sl_alert("<%=LocalUtilis.language("message.checkOK",clientLocale)%> ！");	//审核成功
		CancelAction();
	}
}	
...
function validateForm(form){
	if(!sl_check(document.theform.check_options, "<%=LocalUtilis.language("class.taskCheckOptions",clientLocale)%> ",500,1)){return false;}//审核意见		
...
<div align="left" class="page-title">
	<font color="#215dc6"><b><%=LocalUtilis.language("menu.activityEndAction",clientLocale)%> </b></font><!--活动任务审核设置-->
</div>
			 ...
			 <p>
			  <table  id="table1" cellSpacing="1" cellPadding="2" width="95%"  bgcolor="#CCCCCC">
			 	<tr style="background:F7F7F7;">
			 			<td colspan="2" align="left"><font size="4" face="微软雅黑"><b>&nbsp;&nbsp;<%=LocalUtilis.language("message.activeInfo2",clientLocale)%> </b></font></td><!--所属活动信息-->
			 	</tr>
	...
	<div style="position:absolute; float:right; width:60%; ">
		 ...
		 <table  id="table2" cellSpacing="1" cellPadding="2" width="95%"  bgcolor="#CCCCCC">
 				...
 				<tr style="background:F7F7F7;">
					...
					<td><font size="2" face="微软雅黑">&nbsp;&nbsp;<%= completeTime%></font></td>	
				</tr>
				
 				<tr style="background:F7F7F7;">
					<td><font size="2" face="微软雅黑">&nbsp;&nbsp;<%=LocalUtilis.language("class.remark",clientLocale)%> ：&nbsp;</font></td><!--任务汇报-->
 					<td><font size="2" face="微软雅黑">&nbsp;&nbsp;<%= remark%></font></td>
				</tr>		
				
				 <tr style="background:F7F7F7;">
					<td><font size="2" face="微软雅黑">&nbsp;&nbsp;<%=LocalUtilis.language("class.responsibleMan",clientLocale)%> ：&nbsp;</font></td><!--负责人-->
 					<td><font size="2" face="微软雅黑">&nbsp;&nbsp;<%= check_man%></font></td>
				</tr>		
				
				 <tr style="background:F7F7F7;">	
					 <td><font size="2" face="微软雅黑">&nbsp;&nbsp;*<%=LocalUtilis.language("class.taskCheckOptions",clientLocale)%> ：</font></td><!--审核意见-->
