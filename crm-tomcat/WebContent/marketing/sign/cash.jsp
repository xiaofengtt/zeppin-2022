...
BigDecimal refund_money = new BigDecimal(0.0); //退款金额
...
if(listAll.size()>0){
	...
	refund_money = Utility.parseDecimal(Utility.trimNull(map.get("REFUND_MONEY")),new BigDecimal(0));
	jk_money = jk_money.subtract(refund_money); //缴款金额 - 退款金额
...
<table border="0" width="100%" class="Noprint" id="btnprint">
		<tr>
			...
			<button type="button"  class="xpbutton4" accessKey=p id="btnPrint" name="btnPrint" onclick="printOK(<%=premoneydetail_serial_no%>)">直接打印(<u>P</u>)</button>
			&nbsp;&nbsp;&nbsp;			
