...
if(!Utility.trimNull(request.getParameter("code")).equals("")){
cell_code = Utility.trimNull(request.getParameter("code"));
cell_name = "";
}
out.print(productCell.querySubJectJosn(input_bookCode,cell_id, cell_code,input_operatorCode,cell_name));
productCell.remove();
}catch(Exception e){
	throw e;
}
