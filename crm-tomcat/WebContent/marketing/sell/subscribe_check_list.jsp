...
function showInfo(serialno) {
	location = 'subscribe_check_info.jsp?checkflag=1&serial_no=' + serialno 
...
function StartQuery(){
    disableAllBtn(true);
    location = 'subscribe_check_list.jsp?page=1&pagesize=' + document.theform.pagesize.value 
    		 + '&product_id='+document.theform.product_id.value
    		 + '&contract_bh='+document.theform.contract_bh.value
 			 + '&q_cust_name='+document.theform.q_cust_name.value;
}
	...
	<table>
		...
		<tr>
			<td align="center" colspan=4>
				<!--确定-->
                <button type="button"  class="xpbutton3"  name="btnQuery" accessKey=o onclick="javascript:StartQuery();"><%=LocalUtilis.language("message.ok",clientLocale)%> (<u>O</u>)</button>
			</td>
		</tr>
	</table>
</div>
		...
		<TR>
			...
			<table id="table3" border="0" cellspacing="1" cellpadding="2" class="tablelinecolor" width="100%">
				<tr class="trh">
					...
					<%} %>
					<td align="center" width="50px"><%=LocalUtilis.language("class.qCustName",clientLocale)%> </td><!--受益人姓名-->
...
%>
				...
				<tr class="tr<%=(iCurrent % 2)%>">
					...
					<%} %>	
					<td align="center">
						<a href="javascript:disableAllBtn(true);showBenifiter(<%=serial_no%>);">
	         				<img border="0" src="<%=request.getContextPath()%>/images/user.gif" width="16" height="16">
	      				</a>
					</td>
					<td align="center" >
						<a href="javascript:disableAllBtn(true);showInfo(<%=serial_no%>)">
