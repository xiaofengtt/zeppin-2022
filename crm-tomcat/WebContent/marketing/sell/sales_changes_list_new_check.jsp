...
if(request.getMethod().equals("POST")){
	...
	String check_reason = Utility.trimNull(file.getParameter("check_reason"));
	...
	scVo.setCheck_reason(check_reason);
	try{
		sclocal.checkSalesChanges(scVo);
		bSuccess = true;
	}catch(Exception e){
...
<table border="0" width="100%" cellspacing="3" class="product-list">
	...
	<tr>
		...
		<td align="left">
			<input type="text" name="check_reason" class="edline" size="50" value="">
		</td>
	</tr>
</table>
