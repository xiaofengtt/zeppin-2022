	...
	<div>
		<table border="0" width="100%" cellspacing="1" cellpadding="1">
			<tr>
				...
				<font size=3><%=LocalUtilis.language("message.salesData",clientLocale)%>: </font><input type="file" style="font-size:9pt" name="file_info" size="40"  onkeydown="javascript:return false;">&nbsp;
					<%if (input_operator.hasFunc(menu_id, 101)){%>
					<!--上传-->
                    <button type="button"  class="xpbutton2" accessKey=u  id="btnSave" name="btnSave" onclick="javascript:validateForm();"><%=LocalUtilis.language("message.upload",clientLocale)%> </button>
					<%}%>
					...
					<!--确认导入-->
                    <button type="button"  class="xpbutton5"  id="btnSave" name="btnSave" onclick="javascript:save();"><%=LocalUtilis.language("message.confImport",clientLocale)%> </button>&nbsp;&nbsp;
					<%}%>
...
<%		}
		...
		<td align="right">
			<button type="button"  class="xpbutton3" style="float:right;" id="btnSave" name="btnSave" onclick="javascript:saveAction();">保存</button>	
		</td>
	</tr>
	</table>
