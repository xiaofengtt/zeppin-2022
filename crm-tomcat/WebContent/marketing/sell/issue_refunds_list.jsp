	...
	<tr>
		...
		<td>
			<select id="check_flag" name="check_flag" style="width:120px;">
				...
				<option value="1" <%if(check_flag.equals(new Integer(1))) out.print("selected");%>><%=LocalUtilis.language("message.unaudited",clientLocale)%> </option><!--未审核-->
				<option value="2" <%if(check_flag.equals(new Integer(2))) out.print("selected");%>><%=LocalUtilis.language("message.checked",clientLocale)%> </option><!--已审核-->
				<option value="3" <%if(check_flag.equals(new Integer(3))) out.print("selected");%>><%=LocalUtilis.language("message.finanAudit",clientLocale)%> </option><!--已财务审核-->
			</select>
		</td>
	</tr>
