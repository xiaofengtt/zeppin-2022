...
IPageList pageList = redeem.listAll(vo,totalColumn,Utility.parseInt(sPage,1),Utility.parseInt(sPagesize,8));

sUrl = "redemption_recheck_list.jsp?pagesize=" + sPagesize +
...
{
		location = 'redemption_recheck_info.jsp?flag=1&serial_no=' + serial_no + '&ben_serial_no='+ben_serial_no;
}
...
function refreshPage()
{
	...
	disableAllBtn(true);
	location = 'redemption_recheck_list.jsp?page=<%=sPage%>&pagesize=' + document.theform.pagesize.value +
...
<div id="queryCondition" class="qcMain" style="display:none;width:480px;">
	...
	<tr>
		<td align="right"><%=LocalUtilis.language("class.contractID",clientLocale)%> : </td><td align="left"><input type="text" name="contract_bh" onkeydown="javascript:nextKeyPress(this)" size="20"
								value=<%=contract_bh%>></td><!--合同编号-->	
				...
				<table border="0" width="100%" class="page-link">
					<tr valign="top">
						...
						<input type="hidden" class="xpbutton3" accessKey=r id="btnRefresh"
							...
							onclick="javascript:refreshPage();"><!--刷新(<u>R</u>)</button>
						&nbsp;&nbsp;&nbsp;-->
                        <!--返回上一页-->
						<input type="hidden" class="xpbutton3" accessKey=b id="btnReturn"
							...
							onclick="javascript:history.back();"><!--返回(<u>B</u>)</button>
						&nbsp;&nbsp;&nbsp;--></td>
					</tr>
				</table>
