...
function getSubProductOption(data)
{
	$("select_id_2").innerHTML = "<select style='width:430px;' name='sub_product_id' onkeydown='javascript:nextKeyPress(this)'"+
			...
			"<button type="button"  class='xpbutton2' name='show_sub_info' title='查看子产品信息' "+
		    "onclick='javascript:openSubProduct();'><%=LocalUtilis.language("message.view",clientLocale)%></button><!-- 查看 -->";
}
...
<table  border="0" width="100%" cellspacing="4" cellpadding="4" class="product-list">
	...
	<tr>
		<td align="right"><font color="red">*</font><%=LocalUtilis.language("class.productNumber",clientLocale)%> :&nbsp;&nbsp;</td><!--产品选择-->
	...
	<tr id="sub_product_flag" style="display:none;">
		<td align="right"><b><font color="red"><b>*</b></font><%=LocalUtilis.language("class.subProductID",clientLocale)%> </b>:&nbsp;&nbsp;</td><!--子产品选择-->
...
<table  border="0" width="100%" cellspacing="5" cellpadding="5" class="product-list">
	...
	<tr id="tr_prov_flag">
		...
		<td align="right" id="td_pro_level" style="display: none"><font color="red"><b>*</b></font><%=LocalUtilis.language("class.incomeLevel",clientLocale)%>:</td><!-- 收益级别 -->
		<td>
	...
	<tr style="display: <%=SUB_COOPER == 2 ? "none" : ""%>;">
		...
		<td align="right" id="td_city_serialno" style="display: none;"><%=LocalUtilis.language("class.citySerialNO",clientLocale)%> :</td><!--合同推介地-->
