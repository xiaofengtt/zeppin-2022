...
<div align="left" class="page-title">
	<font color="#215dc6"><b>销售管理>>预登记</b></font>
</div>
<!--客户选择-->
...
<fieldset>
<legend><b style="color: blue;">预登记信息</b></legend>
...
<!--预登记信息-->
		...
		<tr>
			<td align="right" width="13%">*<%=LocalUtilis.language("class.validDays",clientLocale)%> :</td><!--有效天数-->
			<td width="39%"><input name="reg_valid_days" type="text" size="27" value="<%=reg_valid_days%>"/>&nbsp;&nbsp;<%=LocalUtilis.language("message.days",clientLocale)%> <!--天--></td>
			<td align="right" width="13%">*<%=LocalUtilis.language("class.customerSource",clientLocale)%> :</td><!--客户来源-->
			<td width="35%">
