...
function SaveAction(){		
	if(document.theform.onsubmit()){
		disableAllBtn(true);
		document.theform.action="reserve_simple_add.jsp";
...
function validateForm(form){
	...
	document.getElementById("product_name").value = choose.options[choose.selectedIndex].text;alert(document.theform.huge_money.value);
...
<table cellSpacing=0 cellPadding=4 width="100%" border=0>
	...
	<tr>
		<td align="right" width="17%">*客户类型:</td>
		<td width="48%">
...
<tr>
			...
			<td colspan="3">
				<select size="1" name="pre_product_id" onkeydown="javascript:nextKeyPress(this)" class="productname" onChange="javascript:showPreinfo(this.value);">
		...
		<tr>
			...
			<td><input readonly class="edline" name="input_info1" id="input_info1" size="37" value=""/></td>
...
<table cellSpacing=0 cellPadding=3 width="100%" border=0>
		...
		<tr>
			...
			<td><input name="pre_money" size="27" value="" onkeydown="javascript:nextKeyPress(this)" onkeyup="javascript:showCnMoney(this.value)"><span id="pre_money_cn" class="span">&nbsp;</span></td>
<!--万-->
		...
		<tr>
			...
			<td>
				<INPUT TYPE="text" NAME="exp_reg_date_picker" class=selecttext size="22"
