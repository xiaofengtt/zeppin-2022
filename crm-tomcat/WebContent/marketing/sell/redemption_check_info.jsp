...
function CheckAction(){	
	if(confirm("<%=LocalUtilis.language("message.auditRedeemed",clientLocale)%> ？")){	//确认要进行赎回数据审核吗
		disableAllBtn(true);
		document.theform.action ="redemption_check_action.jsp";
...
<div align="right">
	<!--审核-->
    <button type="button"  class="xpbutton3" accessKey=s id="btnSave" name="btnSave" onclick="javascript:CheckAction();"><%=LocalUtilis.language("message.check",clientLocale)%>  (<u>S</u>)</button>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<!--返回-->
