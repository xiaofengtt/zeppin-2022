...
// 	local.modiPreMoneyDetail(vo);
	try{
		local.checkPreDoubleRecordInfo(vo);
		bSuccess = true;
	}catch(Exception e){
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="page-title"><font color="#215dc6"><b>双录信息审核</b></font></td>
	</tr>
	<br/>
</table>
...
<table border="0" width="100%">
	<tr>
		<td align="center">
		<button type="button"  class="xpbutton4" accessKey=s id="btnSave" name="btnSave" onclick="javascript:op_check(1);">审核通过 (<u>S</u>)</button>
		&nbsp;&nbsp;<!--审核通过-->
		<button type="button"  class="xpbutton4" accessKey=o id="btnSave" name="btnSave" onclick="javascript:op_check(0)">审核不通过 (<u>O</u>)</button>
		&nbsp;&nbsp;<!--审核不通过-->
