...
// 	re_check_reason = Utility.trimNull(request.getParameter("re_check_reason"));
...
<table border="0" width="100%" cellspacing="3" class="product-list">
	...
	<tr>
		...
		<td align="left">
			<input type="text" readonly="readonly" name="check_reason" class="edline" size="50" value="<%=Utility.trimNull(scmap.get("CHECK_REASON")) %>">
		</td>
	</tr>
	<tr>
		<td align="right">审核意见:</td>
		<td align="left">
			<input type="text" readonly="readonly" name="re_check_reason" class="edline" size="50" value="<%=Utility.trimNull(scmap.get("RE_CHECK_REASON")) %>">
		</td>
	</tr>
</table>
