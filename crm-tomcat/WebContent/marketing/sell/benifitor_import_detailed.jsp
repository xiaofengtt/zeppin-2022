...
//获得结果
IPageList pageList  = contractLocal.queryOldBenifitor(vo, new String[0],1,-1);
List contractList = pageList.getRsList();

Map contractMap = contractList.size()>0? (Map)contractList.get(0): new HashMap();

Integer str_qs_date = Utility.parseInt(Utility.trimNull(contractMap.get("合同签订日期")),new Integer(0));
Integer str_jk_date = Utility.parseInt(Utility.trimNull(contractMap.get("受益起始日期")),new Integer(0));
Integer str_end_date = Utility.parseInt(Utility.trimNull(contractMap.get("受益终止日期")),new Integer(0));
%>
<HTML>
<HEAD>
<TITLE></TITLE>
				...
				<FIELDSET >
					...
					<TABLE width="100%">
						...
						<TR>	
							...
							<TD align="right">受益金额 :</TD>
							<TD><input class="edline"  type="text" size="25" value="<%=Utility.trimNull(contractMap.get("受益金额"))%>"></TD>
						</TR>
						<TR>	
