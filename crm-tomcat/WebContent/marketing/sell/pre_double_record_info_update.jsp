...
// 	local.modiPreMoneyDetail(vo);
	try{
		local.modiPreDoubleRecordInfo(vo);
		bSuccess = true;
	}catch(Exception e){
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="page-title"><font color="#215dc6"><b>双录信息编辑</b></font></td>
	</tr>
	<br/>
</table>
<table border="0" width="100%" cellspacing="3" class="product-list">
	...
	<tr>
		...
		<td align="left">
			<input type="text" name="sl_date" id="sl_date" size="30" onclick="javascript:setday(this);" readOnly value="<%=sl_date%>"/> 	
		</td>
	</tr>
	<tr>
