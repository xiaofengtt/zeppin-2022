	...
	<table>
		<tr>
			...
			<td colspan="3">
				...
				<button class="searchbutton" onclick="javascript:searchProduct(document.theform.q_productCode.value);" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center" colspan="4">				
				<button class="xpButton3" accessKey=o name="btnQuery" onclick="javascript:StartQuery();"><%=LocalUtilis.language("message.ok",clientLocale)%> (<u>O</u>)</button><!--确认-->		
			</td>
		</tr>
	</table>
</div>
...
%></font>
	...
	<div align="right">
        ...
        <button class="xpbutton3"  id="queryButton" name="queryButton"><%=LocalUtilis.language("message.query",clientLocale)%> <!--查询--></button>&nbsp;&nbsp;&nbsp; 
		<button class="xpbutton4"  name="btnCertIden" title="手持设备读卡"	onclick="javascript:card_wireless();">手持设备读卡</button>&nbsp;&nbsp;&nbsp;
		<button class="xpbutton3"  name="btnCertIden" title="二代证读卡"	onclick="javascript:card_read();" style="display:none;">二代证读卡</button>&nbsp;&nbsp;&nbsp;
				<button class="xpbutton3"  name="btnCertIden" title="证件扫描"	onclick="javascript:card_discern();">证件扫描</button>&nbsp;&nbsp;&nbsp;
        <button class="xpbutton3"  name="btnCertIden" title="证件核查"	onclick="javascript:card_check();">证件核查</button>&nbsp;&nbsp;&nbsp;
	    <button class="xpbutton5"  id="btnStardar" name="btnStardar" title="合格投资人表打印" onClick="javascript:printStandard();">合格投资人表打印</button>&nbsp;&nbsp;
		<button class="xpbutton3" accessKey=n name="btnNew" title="新建预约" onclick="javascript:newInfo();">新建预约</button>&nbsp;&nbsp;&nbsp;<!--新建预约-->
   </div>	
</div>
<div id="cover"> 
...
<div id="msger">
	<table>
		...
		<tr>
			<td align="center" colspan="1"><button class="xpButton3" onclick="javascript:showNum();">确认 (<u>O</u>)</button></td>
			<td align="center" colspan="1"><button class="xpButton3" onclick="javascript:disChose();">取消 (<u>O</u>)</button></td>
		</tr>
	</table>
</div>
<div id="selectOptions">
	<table>
		...
		<tr>
			<td align="center" colspan="1"><button class="xpButton3" onclick="javascript:getChoose();">确认 (<u>O</u>)</button></td>
			<td align="center" colspan="1"><button class="xpButton3" onclick="javascript:disChose();">取消 (<u>O</u>)</button></td>
		</tr>
	</table>
</div>
...
<!-- start 到账处理信息 -->
	<tr id="tr<%=serial_no%>_0" style="display: none" bgcolor="#FFFF99">
		<td class="tdh" colspan="17">
			...
			%>
				<tr>
					<td bgcolor="#FFFFFF"><%=/*dz_time*/Format.formatDateLine((Integer)preMap.get("DZ_DATE"))%></td>
