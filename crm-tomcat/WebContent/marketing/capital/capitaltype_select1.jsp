...
<HTML>
	...
	setting = { 
		...
		//asyncUrl:"capitaltype_select1_json.jsp",  //获取节点数据的URL地址 使用这个地址数据显示不出来，hesl 2011.7.8
		asyncUrl:"capitaltype.txt",    //改成从txt里取就可以显示出来，原因还没找到，暂时通过txt中转下，找到原因后再修改,可能是编码问题，txt是utf8的才可以
		callback:{
		  click: zTreeClick,
	...
	<TBODY>
	 ...
	 <TD>
			...
			<tr class="product-list">
				<td><b><%=LocalUtilis.language("message.chooseType",clientLocale)%> <!--选择类别-->: <input type="text" name="selhref" size="40" readonly value='<%=sub_code%>'></b></td>
			</tr>
					<tr class="product-list">
						<td>
						<!-- 资产类别树-->
