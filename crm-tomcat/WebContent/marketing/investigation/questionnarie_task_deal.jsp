...
<BASE TARGET="_self">
<title><%=LocalUtilis.language("menu.questionnarieTaskDeal",clientLocale)%> </title>
<!--服务处理-->
...
function dealService(serial_no,serviceType){
	var url = "<%=request.getContextPath()%>/affair/service/service_deal_add.jsp?transFlag=2&serial_no="+serial_no+"&serviceType="+serviceType;
...
function refreshPage(){
	disableAllBtn(true);		
	window.location = 'questionnarie_task_deal.jsp?page=<%=sPage%>&pagesize=' + document.theform.pagesize.value+'<%=tempUrl%>';	
}

/*查询功能*/
function QueryAction(){				
	//url 组合
	var url = "questionnarie_task_deal.jsp?1=1" ;	
