...
vo.setQuotacheck_flag(new Integer(1));
...
<script language=javascript>
	...
	{
		var url ="quota_list.jsp?page=1&pagesize=" + document.theform.pagesize.value
	...
	function showInfo(preProductId){
		window.location.href="quota_info.jsp?preProductId="+preProductId;
	}
</script>
</HEAD>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<button type="button"  class="xpbutton3" accessKey=f id="queryButton" name="queryButton"><%=LocalUtilis.language("message.query",clientLocale)%> <!--查询-->(<u>F</u>)</button></div></td>				
					</tr>
					<tr><td>&nbsp;&nbsp;&nbsp; </td></tr>
				</table>
<table id="table3" border="0" cellspacing="1" cellpadding="2" class="tablelinecolor" width="100%" >
	<tr class=trtagsort>
		...
		<td align="center"><%=LocalUtilis.language("message.set",clientLocale)%> </td><!--设置-->
	</tr>
<%
