...
<script language=javascript>
	...
	{
		var url ="quota_adjust_list.jsp?page=1&pagesize=" + document.theform.pagesize.value
	...
	function showInfo(preProductId){
		window.location.href="quota_adjust_info.jsp?preProductId="+preProductId;
	}
</script>
</HEAD>
...
<table id="table3" border="0" cellspacing="1" cellpadding="2" class="tablelinecolor" width="100%">
	<tr class=trtagsort>
		...
		<td align="center"><%=LocalUtilis.language("message.edit",clientLocale)%> </td><!--设置-->
	</tr>
<%
