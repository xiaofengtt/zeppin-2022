...
function showInfo(preProductId,team_id){
	if(showModalDialog('quota_adjust.jsp?preProductId=' + preProductId + '&team_id=' + team_id, '', 'dialogWidth:380px;dialogHeight:220px;status:0;help:0') != null)
	{
		sl_update_ok();
		location.reload();
	}
...
<div >
	<table id="table3" border="0" cellspacing="1" cellpadding="2" class="tablelinecolor" width="100%" class="table-popup">
		<tr class=trtagsort>
	...
	if(list.size() >0){
	 ...
	 %>
			<tr class="tr0">
				...
				<td align="center"><%=Utility.parseInt(Utility.trimNull(map.get("PRE3000000")),new Integer(0)) %></td>
	            <td align="center">
