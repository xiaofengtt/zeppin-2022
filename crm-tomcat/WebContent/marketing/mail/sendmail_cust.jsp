...
String[] ret = null;//getCustEmailGroup返回值
...
window.onload = function(){
	...
	if(v_cust_name_alert.length>0){
		var alertInfo = "<%=LocalUtilis.language("message.customer",clientLocale)%>"/*客户*/+v_cust_name_alert+"<%=LocalUtilis.language("message.no2",clientLocale)%>Email，<%=LocalUtilis.language("message.mailCannotSend",clientLocale)%> ！" 
		//没有Email,无法发送邮件
...
<table border="0" width="98%" cellSpacing="1" cellPadding="2" bgcolor="#CCCCCC" class="table-popup">
		<tr style="background:F7F7F7;">
			<td width="120px">
				<p align="left"><font size="2" face="微软雅黑">&nbsp;&nbsp;<%=LocalUtilis.language("class.toEmail",clientLocale)%> ：</font></p>
			</td><!--收件人地址-->
			<td width="*">
		...
		<tr style="background:F7F7F7;">
			<td width="120px">
				<p align="left"><font size="2" face="微软雅黑">&nbsp;&nbsp;<%=LocalUtilis.language("class.toName",clientLocale)%> ：</font></p>
			</td><!--收件人姓名-->
			<td width="*">
		...
		<tr style="background:F7F7F7;">
			<td width="120px">
				<p align="left"><font size="2" face="微软雅黑">&nbsp;&nbsp;<%=LocalUtilis.language("class.fromName",clientLocale)%> ：</font></p>
			</td><!--发件人姓名-->
