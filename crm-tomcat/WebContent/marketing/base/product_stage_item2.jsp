...
%>
							<tr class="trbottom">
								<td class="tdh" width="9%" align="center" height="25"><b><%=LocalUtilis.language("message.total",clientLocale)%><!--合计--> <%=iCount2%> <%=LocalUtilis.language("message.entries",clientLocale)%> <!--项--></b></td>
								<td width="10%" align="center" height="25">-</td>
								<td width="10%" align="center" height="25">-</td>
								<td width="10%" align="center" height="25">-</td>
								<td width="10%" align="center" height="25"></td>
