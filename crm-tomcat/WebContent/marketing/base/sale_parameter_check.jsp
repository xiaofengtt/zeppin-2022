...
<div id="queryCondition" class="qcMain" style="display:none;width:550px;">
	...
	<table width="100%" cellspacing="0" cellpadding="2" border="0">
		...
		<tr>
			<td align="right">产品<%=LocalUtilis.language("class.productStatus",clientLocale)%> :</td><!--产品状态-->
			<td>				
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td align=right><div class="btn-wrapper">	<button type="button"  class="xpbutton3" accessKey=q id="queryButton" name="queryButton"><%=LocalUtilis.language("message.query",clientLocale)%> <!--查询-->(<u>Q</u>)</button></div>
						<br/>
						</td>				
					</tr>
				</table>
