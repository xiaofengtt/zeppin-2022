...
<%Integer product_id =
	Utility.parseInt(request.getParameter("product_id"), new Integer(0));
ProductLocal product = EJBFactory.getProduct();
ProductVO vo = new ProductVO();
vo.setProduct_id(product_id);
vo.setTask_type(new Integer(102));
				...
				<TBODY>
					<TR>
						...
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								<td class="page-title"><font color="#215dc6"><b><%=LocalUtilis.language("menu.toEarningsDistributionTime",clientLocale)%> </b></font></td><!--预计收益分配时间-->
							</tr>
						</table>
						<br/>
						<table border="0" width="100%" cellspacing="1" class="tablelinecolor">
							<tr class="trh">
								...
								<td width="49%"><%=LocalUtilis.language("class.toDistributionTime",clientLocale)%> </td><!--预计分配时间-->
							</tr>
							<%int iCount = 1;
