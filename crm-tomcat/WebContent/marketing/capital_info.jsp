...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
	<TR>
		...
		<TABLE cellSpacing=0 cellPadding=2 width="100%" border=0>
			<tr>
				<td class="page-title"><b>资产信息</b></td>
			</tr>
			<tr>
				<td>
				<br/>
		...
		<TABLE cellSpacing=0 cellPadding=3 width="100%" border=0 class="product-list">
			...
			<tr>
				...
				&nbsp;&nbsp;		<button type="button"  class="xpbutton2" onclick="javascript:selectContractBh();">查询</button>
				</td>
			...
			<tr>	
				...
				*投资领域:</td>
				...
				<button type="button"  class="xpbutton3" accessKey=b  name="btnBrowse" onclick="javascript:openTreeType();">浏览(B)...</button>
				<%}%>
				</td>
			</tr>
			<tr>
			...
			<tr>	
				...
				<button type="button"  class="xpbutton3" onclick="javascript:getCustomerName(document.theform.cust_id.value);">请选择...</button>
				<%}%>
				&nbsp;&nbsp;										
				</td>
			</tr> 
			...
			<tr>	
				...
				<button type="button"  class="xpbutton3" onclick="javascript:getCustomer2Name(document.theform.btzr_cust_id.value);">请选择...</button>
				<%}%>
				&nbsp;&nbsp;										
				</td>
			</tr> 
...
%>			<tr>
				...
				<table border="0" width="100%">
					<tr>
						<td align="right">
						<%if(readonly==0){%>
						<button type="button"  class="xpbutton3" accessKey=s id="btnSave" name="btnSave" onclick="javascript:validateForm(document.theform);">确定(<u>S</u>)</button>
						&nbsp;&nbsp;&nbsp;
						<%}%>
						<button type="button"  class="xpbutton3" accessKey=b id="btnCancel" name="btnCancel" onclick="javascript:window.close();">返回(<u>B</u>)</button>
						&nbsp;&nbsp;&nbsp;</td>
					</tr>
				</table>
				</td>
