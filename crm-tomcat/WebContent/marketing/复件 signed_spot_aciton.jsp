...
<div>
	<table  border="0" width="100%" cellspacing="2" cellpadding="2" style="border: 1px; border-style: dashed; border-color: blue; margin-top:5px;">
		<tr>
	...
	<table  border="0" width="100%" cellspacing="2" cellpadding="3" style="border: 1px; border-style: dashed; border-color: blue; margin-top:5px;">
		<TR>
		...
		<tr>
			...
			<td ><button class="xpbutton3"  title='<%=LocalUtilis.language("message.newRating",clientLocale)%>' onclick="javascript:newInfo(document.theform.customer_cust_id.value);"><%=LocalUtilis.language("message.rating",clientLocale)%> </button>
			</td>
			<%} %>
		</tr>
	</table>
	...
	<table  border="0" width="100%" cellspacing="4" cellpadding="4" style="border: 1px; border-style: dashed; border-color: blue; margin-top:5px;">
		...
		<tr>
			...
			<td>
				...
				<%if(inputflag2==1){%>
				<!-- 输入 -->
                <button class="xpbutton2" accessKey=x name="btnPrint" title='<%=LocalUtilis.language("message.input",clientLocale)%>' onclick="javascript:changeInput2(this);"><%=LocalUtilis.language("message.input",clientLocale)%> (<u>X</u>)</button>
				<%}%>
		...
		<%}%>
			<tr>
				...
				<td colspan="3">
					...
					<button class="xpbutton3" id="link_cust" onclick="javascript:showLinkCust();" style="display:none;">明细</button>
				</td>
			</tr>
			<tr>
