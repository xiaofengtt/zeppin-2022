...
if("".equals(flow_no)){
	String[] queryId = new String[2];
	String[] queryValue = new String[2];
	queryId[0] = "OBJECT_NO";
	queryId[1] = "OBJECT_TYPE";
	queryValue[0] = object_id;
	queryValue[1] = object_type;
	flow_no = ConfigUtil.getPropertyNameByIdValue("FLOW_STATE", "FLOW_NO", queryId, queryValue);
	
}
String flow_name = Utility.trimNull(request.getParameter("flow_name"));
String sPage = request.getParameter("page");
String sPagesize = request.getParameter("pagesize");
System.out.println("project_id=" + flow_no +";  object_id=" + object_id +";  object_type="+ object_type );

ImportFlowWorkLocal fwlocal = EJBFactory.getImportFlowWork();

//String jsonStr = Utility.trimNull(local.list_WorkFlow(project_id));
//去掉字符串中的回车符
String jsonStr = Utility.replaceAll(fwlocal.list_WorkFlowTrack(flow_no, object_id, object_type),System.getProperty("line.separator"),"");
...
<SCRIPT LANGUAGE="javascript" SRC="/includes/workflow_track.js"></SCRIPT>
