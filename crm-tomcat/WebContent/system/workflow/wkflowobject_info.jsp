...
String node_code = Utility.trimNull(request.getParameter("node_code"));//流程图节点状态编号
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
		<tr>
			<td>
				<img border="0" src="/images/member.gif" align="absbottom" width="32" height="28"><font color="#215dc6"><b>流程图节点操作对象</b></font>
			</td>
		</tr>
		<tr>
