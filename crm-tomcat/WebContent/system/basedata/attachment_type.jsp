...
{
	if(!sl_confirm("<%=LocalUtilis.language("message.delAttachmentTypeConfirm",clientLocale)%> "))//该操作将删除附件类别，要继续
	     return;
			...
			<TR>
				...
				<table id="table3" border="0" cellspacing="1" cellpadding="2"
					...
					<tr class=trtagsort>
						...
						<td><%=LocalUtilis.language("class.dfTable",clientLocale)%> </td><!--对应表名-->
