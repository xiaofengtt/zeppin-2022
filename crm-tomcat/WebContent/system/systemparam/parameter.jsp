...
<div id="queryCondition" class="qcMain" style="display:none;width:300px;">
	...
	<tr>
		<td align="right"><%=LocalUtilis.language("class.busiName3",clientLocale)%> :</td><!--业务类别-->
	...
	<tr>						
         <td align="right"><%=LocalUtilis.language("class.typeName4",clientLocale)%> :</td><!--业务名称-->
	...
	<tr>
		<td align="center" colspan="2"><button type="button"  class="xpbutton3" accessKey=s name="btnQuery"
									onclick="javascript:StartQuery();"><%=LocalUtilis.language("message.ok",clientLocale)%> <!--确认-->(<u>S</u>)</button>&nbsp;&nbsp;&nbsp;&nbsp;								
			</td>
		</tr>						
	</table>
</div>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<button type="button"  class="xpbutton3" accessKey=q id="queryButton" name="queryButton"
						<%if(!input_operator.hasFunc(menu_id, 108)){%> style="display:none"<%}%>><%=LocalUtilis.language("message.query",clientLocale)%> <!--查询-->(<u>Q</u>)
					</button>&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<table id="table3" border="0" cellspacing="1" cellpadding="2" class="tablelinecolor" width="100%">
				<tr class="trtagsort">
					<td width="14%"><input type="checkbox" name="btnCheckbox" class="selectAllBox" onclick="javascript:selectAll(document.theform.type_value);">
						<%=LocalUtilis.language("class.busiName",clientLocale)%>  &nbsp;</td><!--业务类别-->
					<td width="30%"><%=LocalUtilis.language("class.typeName2",clientLocale)%> </td><!--业务名称-->
					<td width="10%"><%=LocalUtilis.language("message.paraValue",clientLocale)%> </td><!--参数值-->
					<td width="*"><%=LocalUtilis.language("class.typeContent",clientLocale)%> </td><!--参数说明-->
					<td width="*">附加值1</td><!--附加值1-->
