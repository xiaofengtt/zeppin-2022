...
<%
//初始化参数信息
String interfaceType_code = "FormPrint010";
...
//----------配置-----------
function viewInfo(form_code,form_name){
	location ='/system/systemparam/formprint_detail.jsp?form_code='+form_code+'&form_name='+form_name;
}
//--------------预览-------------
function previewInfo(form_code){
	location='/system/systemparam/formprint_preview.jsp?form_code='+form_code;
}
//----------删除-----------
