...
<%
//初始化参数信息
String interfaceType_code = "OperatorQuery010";
...
{
	self.returnValue=op_code+"@@"+depart_id;
	self.close();
}
		...
		<TABLE cellSpacing=0 cellPadding=4 width="100%" align=center border=0>
			<TR>
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td align="right">
							<button type="button"  class="xpbutton3" accessKey=f id="queryCondition" name="queryButton">查询(<u>F</u>)</button>
							&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					<tr>
