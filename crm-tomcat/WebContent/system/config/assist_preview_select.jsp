...
<jsp:directive.page import="org.apache.commons.httpclient.util.LangUtils"/>
...
List elementTdShowList = configLocal.listElementOrderNO(catalog_code,1,"2");//所有记录的个数
...
<form name="theform" method="post" action="config_apply_info.jsp" >
