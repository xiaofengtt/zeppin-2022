...
List fieldAllList = ConfigUtil.getFieldShowList(interfaceType_codeone,identity_code,"1");//获取页面所有的有效元素集合
List fieldShowList = ConfigUtil.getFieldShowList(interfaceType_codeone,identity_code,"2");//获取页面所有显示的有效元素集合
List fieldHideList = ConfigUtil.getFieldShowList(interfaceType_codeone,identity_code,"3");//获取页面所有隐藏的有效元素集合
