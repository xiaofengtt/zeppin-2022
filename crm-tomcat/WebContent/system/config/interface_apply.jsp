...
//---------编辑---------
function showInfo(record_id,catalog_code)
{
	if(showModalDialog('<%=freeform_name%>?catalog_code='+catalog_code+'&record_id='+record_id, '', 'dialogWidth:960px;dialogHeight:660px;status:0;help:0') != null)
	{
		sl_update_ok();
		location.reload();
	}
...
function newInfo()
{	
	if(showModalDialog('/system/config/interface_apply_select.jsp', '', 'dialogWidth:280px;dialogHeight:150px;status:0;help:0') != null)
	{
		sl_update_ok();
		location.reload();
	}
...
<%
	...
	request.setAttribute("queryInputTypeStr",queryInputTypeStr);
%>
