...
//通过页面编码查找该表对应的主键字段
String identityCode = ConfigUtil.getIdentityCode(configLocal,interfaceType_code);//interfaceType_code
...
function sucSubmit(){
	...
	if(!(document.theform.INPUT_DEPT ==undefined) && (<%=identity_code.intValue()==0%>)){//修改时赋值
...
function initValue(){
	if("<%=identity_code%>"==0){
		document.theform.REGION_CODE.value=trim('<%=region_code%>');
		document.theform.REGION_NAME.value=trim('<%=region_name%>');
	}
}
</script>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
		<tr>
			<td>
				<img border="0" src="/images/member.gif" align="absbottom" width="32" height="28"><font color="#215dc6"><b>新增选择项</b></font>
			</td>
		</tr>
		<tr>
