...
<%
	...
	if(request.getMethod().equals("POST")){
		...
		scoreRuleBean.modiScoreRule(vo);
		bSuccess = true;
	}
%>
<html>
	...
	<body class="body">
		<form name="theform" method="post" action="modiScoreRule.jsp" onsubmit="javascript:return validateForm(this);">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				<tr><!--修改积分规则-->
					<td><img border="0" src="<%=request.getContextPath()%>/images/ico_area.gif" width="32" height="28"><font color="#215dc6"><b>修改积分规则</b></font></td>
				</tr>
				<tr>
					<td>
			...
			<table border="0" width="100%">
				<tr>
					<td align="right" width="150px">认购金额下限 :&nbsp;&nbsp;</td>
					<td align="left">
						<input type="text" style="width:200px;" name="more_amount" value="<%=more_amount %>"/>
					</td>
				</tr>
				<tr>
					<td align="right" width="150px">每万元积分值 :&nbsp;&nbsp;</td>
					<td align="left">
						<input type="text" style="width:200px;" name="unitscore" value="<%=unitscore %>"/>
					</td>
				</tr>
				<tr>
					<td align="right" width="150px">持有每天的积分值 :&nbsp;&nbsp;</td>
					<td align="left">
						<input type="text" style="width:200px;" name="dayscore" value="<%=dayscore %>"/>
					</td>
				</tr>
				<tr>
