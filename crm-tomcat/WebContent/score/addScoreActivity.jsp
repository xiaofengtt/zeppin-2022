<%@ page contentType="text/html; charset=GBK" import="enfo.crm.tools.Format,enfo.crm.tools.LocalUtilis,enfo.crm.tools.Utility,enfo.crm.score.*,enfo.crm.dao.*,java.util.*,java.math.*"%>
...
<%
	...
	if(request.getMethod().equals("POST")){
		...
		scoreActivityBean.addScoreActivity(vo);
		bSuccess = true;
	}
%>
<html>
	...
	<body class="body">
		<form name="theform" method="post" action="addScoreActivity.jsp" onsubmit="javascript:return validateForm(this);">
			<input type="hidden" name="bSuccess" id="bSuccess" value="<%=bSuccess %>"/>
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				<tr><!--新增积分活动-->
					<td><img border="0" src="<%=request.getContextPath()%>/images/ico_area.gif" width="32" height="28"><font color="#215dc6"><b>新增积分活动</b></font></td>
				</tr>
				<tr>
					<td>
			...
			<table border="0" width="100%">
				<tr>
					...
					<td align="left">
						<input type="text" name="score" <%if(score.intValue()==0){ %>value=""<%}else{ %>value="<%=score %><%} %>"/>
					</td>
				</tr>
				<tr>
