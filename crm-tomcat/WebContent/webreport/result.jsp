...
String query = Utility.getQueryString(request, 
					new String[] {"filename", "sqlArray", "fillZBArray", 
						"paramZBArray", "paramFlagArray", "defaultValueArray"});
...
function setView(){
	...
	if(result!=null)
		location.href = "result.jsp?<%=query%>"; //location.reload();
}
...
<TABLE border="0" width="100%">
	<TBODY>
		<TR>
			<TD>
				<button type="button"  class="rbutton1"  name="btnInputValue" title="查询条件" onclick="javascript:InputValue();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;查询条件</button>&nbsp;&nbsp;
				<button type="button"  class="rbutton2"  name="btnCleanValue" title="清除条件" disabled onclick="javascript:CleanValue();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;清除条件</button>&nbsp;&nbsp;
				<button type="button"  class="rbutton3"  name="btnDefaultValue" title="默认条件" disabled onclick="javascript:DefaultValue();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;默认条件</button>&nbsp;&nbsp;
				<button type="button"  class="rbutton4"  name="btnCreateReport" title="生成报表" disabled onclick="javascript:CreateReport();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;生成报表</button>&nbsp;&nbsp;
				<%
				
				//if (input_operator.hasFunc(menu_id, 150)){%>	<button type="button"  class="rbutton5"  name="btnPreview" title="打印预览" onclick="javascript:setPrint(1);">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;打印预览</button>&nbsp;&nbsp;
				<button type="button"  class="rbutton6"  name="btnPrintReport" title="打印报表" onclick="javascript:setPrint(0);">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;打&nbsp;&nbsp;印</button>&nbsp;&nbsp;<%//}%>
				<%//if (input_operator.hasFunc(menu_id, 160)){%>		<button type="button"  class="rbutton8"  name="btnExportReport" title="导出报表" onclick="javascript:exportReport();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;导出报表</button>&nbsp;&nbsp;<%//}%>
			<%if ( (user_id.intValue()==7 || user_id.intValue()==999) && "3804404".equals(menu_id)) { // 国联7,盈丰999 | 国联产品分配'3804404'%>
				<button type="button"  class="rbutton9"  name="btnSetView" title="显示设定" onclick="javascript:setView();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;显示设定</button>
			<%
			} %>
			</TD>
		</TR>
...
<%}			
	...
	%>	
		...
		//有CELL公式的话还要处理公式！
		//SingleeReport.SetFormula(def_col,def_row,SHEET_OUTPUT,'<%=sqlArray[n]%>');//因报表输出报错，先注释公式功能
	<%		  	
	}
