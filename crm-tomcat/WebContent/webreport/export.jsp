...
int flag = CellHelper.parseInt(request.getParameter("flag"),0);
%>
...
function exportFiles()
{
	...
	if(document.theform.serial_no[2].checked)
		ExportTXT(obj);
	if(document.theform.serial_no[3].checked)
	{
		if(!sl_check(document.theform.pdfname, "PDF文件名", 50, 1))
			return false;
		
		ExportPDF(obj,path+document.theform.pdfname.value,1,<%=flag%>);
	}						
	window.close();
}
</script>
