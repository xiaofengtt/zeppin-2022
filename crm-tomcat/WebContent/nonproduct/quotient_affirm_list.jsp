...
/*确认未通过功能*/
function quotientAffirmNopass(q_serialNo)
{
	location = 'quotient_affirm_nopass.jsp?q_serialNo='+q_serialNo;
}
...
<form name="theform" method="post" action="quotient_affirm_pass.jsp" onsubmit="javascript:return validateForm(this);">
<!--新增成功标志-->
...
<table  border="0" width="100%" cellspacing="0" cellpadding="3" class="table-popup">
   ...
   <tr>
		...
		<td align="LEFT">
			<input readonly class='edline' maxlength="16" name="q_changeAmount" value="<%=q_changeAmount%>" size="20"  onkeydown="javascript:nextKeyPress(this)" >
		</td>
		<td align="right"><b>*<%=LocalUtilis.language("message.date",clientLocale)%></b> :&nbsp;&nbsp;</td><!--日期-->
		<td>
		<input readonly class='edline' maxlength="16" name="q_changeDate" value="<%=q_changeDate%>" size="20"  onkeydown="javascript:nextKeyPress(this)" >
		</td>
   </tr>
</table>
<br>
...
<div align="right">
	<br>
	<!--份额确认通过-->
    <button type="button" class="xpbutton4" id="btnSave" name="btnSave" onclick="javascript:quotientAffirm();"><%=LocalUtilis.language("message.quotientAffirmPass",clientLocale)%> </button>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<!--份额确认未通过-->
    <button type="button" class="xpbutton5" id="btnNopass" name="btnNopass" onclick="javascript:quotientAffirmNopass(<%=q_serialNo %>);"><%=LocalUtilis.language("message.quotientAffirmNoPass",clientLocale)%></button>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<!--返回-->
