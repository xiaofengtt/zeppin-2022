...
/*  		jQuery.ajax({
            ...
            url:'http://192.168.2.162:8080/dologin',
            type:'POST', //GET
 			xhrFields: {
						...
						<tr valign="middle">
							...
							<td id="rightTD">
								<form id="loginForm" name="loginForm" method="post" onSubmit="return doSubmit();">
									...
									<p style="margin: 20px 0 16px 45px; padding-left: 18px;"><button type="button"   class="cssLoginBtn_L1" onmouseout="this.className='cssLoginBtn_L1'" onmouseover="this.className='cssLoginBtn_L2'" onclick="javascript:login_submit();"><%=LocalUtilis.language("login.login",clientLocale)%> </button></p>
								</form>
							</td>
						</tr>
					</table>
