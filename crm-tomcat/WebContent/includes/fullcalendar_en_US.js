...
var defaults = {
	...
	titleFormat: {
		month: 'yyyy MMMM',
		week: "yyyy MMM d[ yyyy]{'&#8212;' [ MMM] d}",//"MMM d[ yyyy]{ '&#8212;'[ MMM] d yyyy}",
		day: 'yyyy MMM d  dddd'//'dddd, MMM d, yyyy'
	},
	columnFormat: {
		month: 'ddd',
		week: 'ddd M/d',
    ...
    dayNames: ["Sunday", "Monday", "TuesDay", "Wednesday", "TuesDay", "Friday", "Saturday"],
    dayNamesShort: ["Sun", "Mon", "Tues", "Wed", "Tues", "Fri", "Sat"],
    buttonText: {
        prev: "&nbsp;&#9668;&nbsp;",
        next: "&nbsp;&#9658;&nbsp;",
        prevYear: "&nbsp;&lt;&lt;&nbsp;",
				...
				$.each(buttonStr.split(' '), function(i) {
					...
					$.each(this.split(','), function(j, buttonName) {
						if (buttonName == 'title') {
							...
							prevButton = null;
						}else if(buttonName == 'newBtn'){
							//tr.append("<td><input type=\"button\" value=\"新增\" class=\"fc-header-title\" style=\"margin-left:7px;\" onclick=\"onnewBtn()\"></td>");
							tr.append("<td><div style=\"margin-left:7px;\" class='fc-button-" + buttonName + " ui-state-default'><a href='#' onclick=\"onnewBtn()\">New</a></div></td>");
						}else{
							var buttonClick;
...
var dateFormatters = {
	...
	d	: function(d)	{ return d.getDate()+"日"},
	dd	: function(d)	{ return zeroPad(d.getDate())+"日"},
