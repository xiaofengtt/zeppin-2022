'设置IP地址成功
sub phone_Set2IPSucc(ByVal Param1, ByVal Param2)
	openConn
end sub

'收到连接成功
sub phone_ConnectServerSuc
	connect2serverSucc
end sub

'收到连接失败
sub phone_ConnectServerFailed
	connect2serverFaild
end sub

'收到注册DN成功
sub phone_RegisterExtensionSucc(ByVal no)
	registerDNSucc
end sub

'收到注册DN失败
sub phone_RegisterExtensionFailed
	registerDNFail
end sub
