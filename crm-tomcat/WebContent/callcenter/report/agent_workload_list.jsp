...
IPageList pageList = seatLocal.query_page_seatWorkload(vo,totalColumn,t_sPage,t_sPagesize);
%>
<HTML>
<HEAD>
<TITLE>坐席工作量报表</TITLE>
...
while(iterator.hasNext()){
		...
		callLength = Utility.trimNull((map.get("Hours")),null);
 		statusName = Utility.trimNull(map.get("statusName"));
 		statDate  = Utility.trimNull(map.get("StatDate"));
 		if(callLength == null){
 		 callLength = "0";
 		 }
%>
