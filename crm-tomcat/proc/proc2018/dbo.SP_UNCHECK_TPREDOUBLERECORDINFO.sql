...
GO
ALTER PROCEDURE SP_UNCHECK_TPREDOUBLERECORDINFO @IN_SERIAL_NO  INT, --序号 
											  @IN_STATUS     INT, --审核状态
...
AS
    ...
    SELECT @SBUSI_NAME = N'撤销审核客户预约双录'
    SELECT @SSUMMARY = N'撤销审核客户预约双录'
    ...
    --2.日志
    SELECT @SSUMMARY = N'撤销审核客户预约双录，产品名称：' + @V_PREPRODUCT_NAME
                                     + N'预约号：' + @V_PRE_CODE
                                   + N'双录时间：' + @V_SL_TIME
