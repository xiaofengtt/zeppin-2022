...
GO
CREATE PROCEDURE SP_QUERY_TCUSTRATING @IN_CUST_NAME    NVARCHAR(200),
									  @IN_CUST_TYPE	   INT,
                                      @IN_SUBJECT_ID   INT,
...
AS
	...
	SELECT A.CUST_ID,B.CUST_NAME,A.RATING_NAME,CASE B.SEX WHEN 1 THEN '男' WHEN 2 THEN '女' ELSE '' END SEX,E.CURRENT_SOURCE
		,A.RATING_DATE,B.TOTAL_MONEY,B.AGE,C.NUM,F.ALL_MONEY,F.ITEM_NUM,F.FX_LEVEL,F.AGE_LEVEL,F.FREE_OF_FLOW,F.BUREND_OF_DEBT 
	...
	SET @V_SQL = 'SELECT * FROM  #TEMP_QUERY_TCUSTRATING ORDER BY RATING_NAME'
