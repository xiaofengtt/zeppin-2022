...
GO
CREATE PROCEDURE SP_QUERY_TEAMPRE @IN_TEAM_ID      INT,                 --团队ID
...
AS
    ...
    SELECT  A.TEAM_ID,A.TEAM_NO,A.TEAM_NAME,PRE_MONEY,RG_MONEY,LESS300_NUMBER
    FROM TManagerTeams A LEFT JOIN (SELECT TEAM_ID,TEAM_NO,SUM(PRE_MONEY) AS PRE_MONEY,SUM(RG_MONEY) AS RG_MONEY, SUM(ISNULL(LESS300_NUMBER,0)) AS LESS300_NUMBER
    ...
    ORDER BY A.TEAM_ID,A.TEAM_NO,A.TEAM_NAME
GO
