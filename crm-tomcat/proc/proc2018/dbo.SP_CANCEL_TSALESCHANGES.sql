...
GO
ALTER PROCEDURE SP_CANCEL_TSALESCHANGES @IN_SERIAL_NO  INT, --序号 
											  @IN_STATUS     INT, --审核状态
											  @IN_INPUT_MAN  INT,  --操作员
											  @IN_CHECK_REASON  NVARCHAR(200)  --意见
WITH ENCRYPTION
AS
    SET NOCOUNT ON
    ...
    SELECT @SBUSI_NAME = N'撤销转销量申请'
    SELECT @SSUMMARY = N'撤销转销量申请'
    ...
    --2.日志
    SELECT @SSUMMARY = N'撤销转销量申请，产品名称：'+@V_PREPRODUCT_NAME
						+N'客户名称：' + @V_CUST_NAME
