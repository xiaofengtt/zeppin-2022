...
ALTER PROCEDURE [dbo].[SP_MODI_TCustomers] @IN_CUST_ID                         INT,
...
AS
    ...
    --todo 屏蔽修改客户电话
    DECLARE @V_IS_SHOW_REALPHONE NVARCHAR(10) = '0'
    SELECT top 1 @V_IS_SHOW_REALPHONE = [CTRL_VALUE]
  				FROM [EFCRM].[dbo].[TSYSTEM_CTRL] WHERE  [CTRL_TYPE] = 'IS_SHOW_REALPHONE'
	
	    IF @V_IS_SHOW_REALPHONE IS  NULL OR @V_IS_SHOW_REALPHONE = '0'
    BEGIN
