...
AS
	...
	BEGIN
		IF ISNULL(@IN_SERIAL_NO,0) <> 0
		SELECT C.ServiceTitle,B.CUST_NO,B.CUST_NAME,B.SERVICE_MAN,'' AS CUST_TEL,'' AS H_TEL,'' AS O_TEL,TR.TC_TEL AS MOBILE,'' AS BP,B.POST_ADDRESS,B.POST_ADDRESS2,B.POST_CODE,B.POST_CODE2,B.CARD_ID,A.*
		FROM TServiceTaskDetail A,TServiceTasks C,TCustomers B 
