...
GO
CREATE PROCEDURE SP_STAT_QUARTER_STATISTICS_2   @IN_BEGIN_DATE  INT=0,
												@IN_END_DATE    INT=0
                                              --@IN_INPUT_MAN   INT
...
AS
    ...
    BEGIN
        INSERT INTO @V_TEMP_TABLE(PRODUCT_ID,PRODUCT_NAME,VALID_PERIOD_NAME,
                        PRE_MONEY,FACT_MONEY,DIRECT_MONEY,DIRECT_RATE,CUST_COUNT,OWN_BUY_MONEY,AFTER_BAD_MONEY)
        SELECT A.PRODUCT_ID,A.PRODUCT_NAME,
            ...
            END AS DIRECT_RATE ,'',E.OWN_BUY_MONEY,F.AFTER_BAD_MONEY 
    ...
    BEGIN
        INSERT INTO @V_TEMP_TABLE(NUM_VIEW,PRE_MONEY,FACT_MONEY,DIRECT_MONEY,CUST_COUNT,OWN_BUY_MONEY,AFTER_BAD_MONEY,SALE_MONEY)
            ...
            FROM @V_TEMP_TABLE
    END            
   SELECT NUM_VIEW,PRODUCT_NAME,'' AS OTHER_1,VALID_PERIOD_NAME,PRE_MONEY,FACT_MONEY,
