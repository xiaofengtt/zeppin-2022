...
function setSidePos() {
    ...
    //divSurvey.style.height = a - 100 + "px";
}
function show(a) {
    return;
}
...
function loadComplete() {
    ...
    $importNoCache("../css/que/operation_new.js");
    $importNoCache("../css/que/kindeditor.js");
    $importNoCache("../css/que/createqattr_new.js");
    $importNoCache("../css/que/utility_new.js");
}
function getXmlHttp() {
    var a;
    try {
...
function save_paper(c, T, F) {
    ...
    var f = "../paper/paper_save.action?submitType=redesign&" + g + "&userguid=" + userGuid + "&validate_text=ys&t=" + (new Date()).valueOf() + "&sstate=" + encodeURIComponent(c);//接口
