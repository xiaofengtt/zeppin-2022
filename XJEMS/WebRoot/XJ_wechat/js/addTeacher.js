...
new input_test("#occupation,#bankOrg,#bankName");//20190418新增字段校验
new input_test_nan("#bankCard,#code,#authcode");
...
function replace(e){
	...
	e.src='../weixin/smsAuthImg?timestr='+timestamp+random;
}