	...
	<div class="main">
		...
		<div class="main_header">
			<div class="filter-applyStatus">
				<span>申报状态：</span> <a class="lighting" data-value="1" href="javascript:;">初次申报</a>
				<a data-value="3" href="javascript:;">安排监考</a> <a data-value="2" href="javascript:;">未安排监考</a>
				<a data-value="5" href="javascript:;">二次确认</a> <a data-value="4" href="javascript:;">未二次确认</a>
			</div>
			<div class="filter-type">
				<span>身份类别：</span> <a class="lighting" data-value="0" href="javascript:;">全部</a>
			...
			<div class="filter-teacherStatus">
				<span>教师状态：</span> <a class="lighting" data-value="-1" href="#">全部</a>
				<a data-value="1" href="#">正常</a> <a data-value="0" href="#">停用</a>
			</div>
