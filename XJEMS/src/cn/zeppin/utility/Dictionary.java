...
public class Dictionary {
	...
	public static final short INVIGILATION_TEACHER_CAMPUS_KL = 2;// 昆仑校区
	public static final short INVIGILATION_TEACHER_CAMPUS_WG = 3;// 文光校区

	// 监考类型
	public static final short INVIGILATE_TEACHER_TYPE0 = 0;// 均可
	public static final short INVIGILATE_TEACHER_TYPE1 = 1;// 纸笔
	public static final short INVIGILATE_TEACHER_TYPE2 = 2;// 无纸化
	public static final short INVIGILATE_TEACHER_TYPE3 = 3;// 测试
