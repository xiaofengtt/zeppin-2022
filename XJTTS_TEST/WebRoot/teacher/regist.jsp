...
<body>
	...
	<div class="login-cnt">
		<div class="row-fluid">
			...
			<div><h2 align="center" style="margin-bottom: 25px;margin-right: 90px">教师注册信息</h2></div>
			<div class="container" align="center">
				<div class="bd">
					<div class="alert alert-danger"
						style="display: none; margin: 0 15px 15px;"></div>
					<form class="form-horizontal" id="teacherManage"
						action="trg_register.action" method="post" name="teahcer">
						...
						<div class="clearfix">
							...
							<div class="span5">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="password" id="" autocomplete="off" name="password"
											value="" placeholder="">
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<select onchange="areacityy(this,'city')" style="width: 220px;"
										...
										</select><br /> <select id="areacity" style="width: 110px;"
											onchange="areacityy(this,'county')" class="span1"
											name="cityId">
											<option value="-1">请选择</option>
										...
										</select> <select id="areacounty" style="width: 100px;" class="span1"
											name="countyId">
											<option value="-1">请选择</option>
							...
							<div class="span5">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="" name="mobile"
											value="<s:property	value="teacher.mobile" />"
											placeholder="手机">
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input name="organization" data-val="true"
											data-val-number="<s:property value="organizationp.id"/>"
											data-name="<s:property value="organizationp.name"/>"
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" readonly autocomplete="off"
											data-provide="datepicker" class="datepicker" id=""
											name="teachingAge"
											value="<s:date name="teacher.teachingAge" format="yyyy-MM-dd"/>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="unMainTeachingSubject"
											id="unMainTeachingSubject" multiple>
											<s:iterator value="lstteacTeachingSubjectExs" id="e">
												<option value="<s:property value="#e.id" />"
													search="<s:property
												value="#e.searchString" />"
											...
											<s:iterator value="teacherEx.unMaintTeachingSubjects" id="ee">
												<option value="<s:property value="#ee.subject.id" />"
													selected><s:property value="#ee.subject.name" /></option>
											</s:iterator>
										</select>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="unMainTeachingLanguage"
											id="unMainTeachingLanguage" multiple>
											<s:iterator value="lstLanguages" id="e">
												<option value="<s:property value="#e.id" />"
													<s:if test="%{#e.id==teacher.chineseLanguageLevel}" >selected</s:if>><s:property
														value="#e.name" /></option>
											...
											<s:iterator value="teacherEx.unMainTeachingLanguages" id="ee">
												<option value="<s:property value="#ee.language.id" />"
													selected><s:property value="#ee.language.name" /></option>
											</s:iterator>
										</select>
						...
						<div class="row actionbar">
							<div class="offset8">
								...
								<button id="colorboxcancel" onclick="window.history.go(-1)"
...
.login-footer a {
	color: #1d88b1;
			...
			<div id="footer">
				Copyright &copy; 2014 新疆维吾尔自治区教育厅. <a target="_blank"
					href="http://www.xjedu.gov.cn/">联系我们</a> &nbsp;&nbsp;|&nbsp;&nbsp;
...
// 					.select2();
		...
		$(function() {
			$('#teacherManage').submit(function() {
				...
				str = encodeURI(str);
				//alert(str);
				$.post('../teacher/trg_register.action?' + str, function(data) {
