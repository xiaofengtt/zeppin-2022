...
<div class="main">
	<div class="listwrap">
		...
		<div class="cui-menu2">
			<a href="../paper/paper_add?type=3" target="_blank"
				class="btn btn-primary btn-create"> + 设计新问卷 </a> <a
				href="../paper/paper_getReportUserList.action"
				class="btn btn-primary btn-search"> <b>登录码列表</b>
			</a>
		</div>
