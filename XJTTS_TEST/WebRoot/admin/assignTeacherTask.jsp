...
<s:action name="left_init" namespace="/admin" executeResult="true">
	<s:param name="leftName">学员名额分配管理</s:param>
</s:action>
<link rel="stylesheet" href="../css/iframe.css">

<div class="main">
	<div class="listwrap">
		<div class="list_bar">学员名额分配管理</div>
		<div style="padding-top:15px;">
		<form id="reprtTask" class="form-horizontal" role="form" action="../admin/assignTeacherTask_initPage.action">
						...
						<table class="table table-bordered">
							<tbody>
								<tr>
									...
									<td width="200px"><span class="text-primary">
		...
		$.getJSON(
			'../admin/ttRecord_getAssignTaskOrganization.action?projectId='
				...
				if (data.subjects.length > 0) {
					...
					$.each(data.subjects, function(i, c) {
						if(c.id==sid){
							cLis += '<option value="' +c.id + '" selected="selected">' + c.name	+ '</option>';
						}else{
							cLis += '<option value="' +c.id + '">' + c.name	+ '</option>';
						}
					});
