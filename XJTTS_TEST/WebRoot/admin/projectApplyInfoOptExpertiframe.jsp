						...
						<tbody>
							<tr>
								...
								<td width="180px"><span id="status_{{:id}}">
									{{if record_status}}
									<a onclick="addExpert(this)" data-id="{{:id}}" data-url="../admin/projectApplyOpt_addProjectApplyExpert.action?id={{:id}}&paid=<s:property value="id" />" href="javascript:void(0)">添加评审权限</a>
									{{else}}
									<a onclick="deleteExpert(this)" data-id="{{:id}}" data-url="../admin/projectApplyOpt_deleteProjectApplyExpert.action?id={{:id}}&paid=<s:property value="id" />" href="javascript:void(0)">删除评审权限</a>
									{{/if}}
									</span>
								</td>
							</tr>
