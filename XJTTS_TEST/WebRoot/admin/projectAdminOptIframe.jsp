			...
			<form id="addprojectAdmin" class="form-horizontal" role="form"
				...
				<div class="clearfix">
					...
					<div class="span5">
						...
						<!-- <div class="control-group">
							<label class="control-label" for="">单位层级</label>
							<div class="controls">
								<select name="level">
									<option value="1" <s:if test="level==1" >selected</s:if>>派出单位</option>
									<option value="2" <s:if test="level==2" >selected</s:if>>承训单位</option>
								</select>
							</div>
						</div>
						 -->
