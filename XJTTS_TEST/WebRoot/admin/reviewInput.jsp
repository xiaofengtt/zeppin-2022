...
<body>
	<div class="ifrcnt container">
		...
		<div class="bd">
			...
			<form class="form-horizontal" id="upload" action="../admin/ttRecord_inputScore.action"
				method="post" name="upload" enctype="multipart/form-data" >
				<div class="clearfix">
					<div class="span5">					
						<div class="control-group" style="width:600px">
							<label class="control-label" for="">上传未通过审核学员记录</label>
							<div class="controls" >
								<div id="applydoc" class="">&nbsp;上传未通过审核学员记录&nbsp;&nbsp;</div>
	...
	<script>
		...
		$(function() {
			...
			function getSchedule(){
				...
				str=encodeURI(str);
				$.post('../admin/ttRecord_getPercent.action?'+ str, function(data) {
...
// 						window.alert(message);
			...
			$('#upload').submit(
					function() {
						...
						$.post('../admin/ttRecord_inputScore.action?'+ str, function(data) {
							var Result = data.Result;
							var message = data.Message;
							if (Result == "OK") {
