...
<!-- 									</td>		 -->
									<td width="120px">状态:
										<s:if test="#tex.teacher.status == -1">
											<span>未审核</span>
										</s:if>
										<s:elseif test="#tex.teacher.status == 2"><font color=red>已停用</font></s:elseif>
										<s:elseif test="#tex.teacher.status == 0"><font color=red>未通过审核</font></s:elseif>
										<s:else><span>已审核</span></s:else>
									</td>
								</tr>
							</tbody>
						</table>
