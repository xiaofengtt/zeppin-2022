...
<body>
	<div class="ifrcnt container">
		...
		<div class="alert alert-danger" align="center"
			...
			<h4 align="center"><s:property value="teacherTrainingRecords.project.name"/></h4>
		</div>
		<div class="bd">
				<div class="form-group">
					<h4 align="center"><label class="col-sm-2 control-label" for="">学员姓名:</label> <s:property value="teacherTrainingRecords.teacher.name"/></h4>
					
				</div>
				<form class="" id="changeSubject" action="" method="post">
					<div class="form-group" style="text-align: center;">
						<label class="col-sm-2 control-label" for="">培训学科:</label>
						<div class="col-sm-9">
		...
		$(function() {
			$('#changeSubject').submit(
					function() {
						...
						$.post('../admin/trainingStudentOpt_changeSubject.action?'+ str+'&ttrId='+ttrId, function(ret) {
							if (ret.Result == 'OK') {
