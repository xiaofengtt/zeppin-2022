...
public interface ITeacherTrainingRecordsService extends IBaseService<TeacherTrainingRecords, Integer> {
	 ...
	 * @return
	 */
	public int getAduTeacherCount(String teacherName, int projectId, int subjectId, int trainingUnit, int isAdmin, int status, Organization organization, List<ProjectType> lityps, String enrollType);
	 ...
	 * @return
	 */
	public List getAduTeacher(String teacherName, int projectId, int subjectId, int trainingUnit, int isAdmin, int status, Organization organization, List<ProjectType> lityps, int offset, int length, String enrollType);
