        ...
        data: {
    		...
    		if (r.status == "SUCCESS") {
    			...
    			for(var i=0;i<r.data.length;i++){
    				...
    				+'<td data-id="'+r.data[i].uuid+'"><a class="mr-5" href="categoryDetail.html?uuid='+r.data[i].uuid+'">修改</a><a class="disableBtn mr-5">禁用</a><a class="deleteBtn">删除</a></td>'
    				+'</tr>';
    			}
                $('#pageTool').Paging({
                    prevTpl: "<",
