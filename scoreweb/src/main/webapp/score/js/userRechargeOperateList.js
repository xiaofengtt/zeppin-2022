    		...
    		if (r.status == "SUCCESS") {
    			...
    			for(var i=0;i<r.data.length;i++){
    				...
    				if(r.data[i].status == "nopass"){
    					tableHtml = tableHtml +'<td data-id="'+r.data[i].uuid+'"><a class="mr-5" href="userRechargeOperateDetail.html?type=1&uuid='+r.data[i].uuid+'">重新提交</a></td>'
    				}else{
    					tableHtml = tableHtml +'<td data-id="'+r.data[i].uuid+'"><a class="mr-5" href="userRechargeOperateDetail.html?type=0&uuid='+r.data[i].uuid+'">查看</a></td>'
    				}
