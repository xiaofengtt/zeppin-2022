...
import cn.zeppin.product.score.entity.FrontUser.FrontUserType;
import cn.zeppin.product.score.entity.FrontUserAccount;
import cn.zeppin.product.score.entity.FrontUserAccount.FrontUserAccountStatus;
...
import cn.zeppin.product.score.mapper.FrontUserMapper;
...
import cn.zeppin.product.score.util.IDCardUtil;
import cn.zeppin.product.score.util.JuHeUtility;
...
public class FrontUserServiceImpl implements FrontUserService{
	...
	public HashMap<String, Object> register(String token,String mobile) throws TransactionException{
		...
		if(realMD5Str.equals(md5Str)){//成功
			...
			this.frontUserAccountService.insert(fua);
