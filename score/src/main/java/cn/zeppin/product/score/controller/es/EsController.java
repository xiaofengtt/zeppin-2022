package cn.zeppin.product.score.controller.es;
...
import cn.zeppin.product.score.entity.es.EsModel;
import cn.zeppin.product.score.entity.es.EsPage;
import cn.zeppin.product.score.util.ElasticsearchUtil;
...
public class EsController {
    ...
    public String insertJson() {
        ...
        jsonObject.put("id", Utlity.getCaptcha());
    ...
    public String insertModel() {
        ...
        esModel.setId(Utlity.getCaptcha());
