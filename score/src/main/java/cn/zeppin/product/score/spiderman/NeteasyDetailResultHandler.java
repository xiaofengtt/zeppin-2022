 ...
 * 结果处理器
 */
public class NeteasyDetailResultHandler implements ResultHandler {
	...
	public void handle(ResultTask task, Counter c) {
		...
		newstime = newstime.substring(0,newstime.indexOf("来源")).trim();
		...
		news.setSource(NewsSource.NETEASY);
