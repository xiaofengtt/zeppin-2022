        ...
        data: {
    		...
    		if (r.status == "SUCCESS") {
    			...
    			for(var i=0;i<r.data.length;i++){
    				...
    				+'<td>'+status+'</td>'
    				if(r.data[i].status == "normal"){
    					tableHtml = tableHtml +'<td class="text-right" data-id="'+r.data[i].uuid+'"><a class="" href="userRechargeCheckDetail.html?type=1&uuid='+r.data[i].uuid+'">审核</a></td>'
    				}else{
    					tableHtml = tableHtml +'<td class="text-right" data-id="'+r.data[i].uuid+'"><a class="" href="userRechargeCheckDetail.html?type=0&uuid='+r.data[i].uuid+'">查看</a></td>'
    				}
