...
<head id="ctl00_Head1">
	...
	<link href="assets/newsolid_38.css" rel="stylesheet" type="text/css">
</head>
...
<body>
    ...
    <div id="jqContent" class="" style="text-align: left; ">
		<div class="que-header2">
			<div class="inn">
				<h1>2013年新疆国培计划问卷系统</h1>
				<p>发布者：国培计划项目办公室  13-7-22</p>
			</div>
		</div>
...
<div class="survey" style="margin:0px auto;">
	...
	<div id="ctl00_ContentPlaceHolder1_JQ1_divHead" class="surveyhead" style="border: 0px;">
		<h1 id="ctl00_ContentPlaceHolder1_JQ1_h1Name">
			<span id="ctl00_ContentPlaceHolder1_JQ1_lblQuestionnaireName"><s:property value="paper.title" escape="false"/></span></h1>
		...
		<div id="ctl00_ContentPlaceHolder1_JQ1_divDec" class="surveydescription">
			...
			<span id="ctl00_ContentPlaceHolder1_JQ1_lblQuestionnaireDescription" style="vertical-align: middle;"><s:property value="paper.about" escape="false"/></span>
		</div>
		<div style="clear: both;">
		</div>
	</div>
...
<div id="ctl00_ContentPlaceHolder1_JQ1_question" class="surveycontent">
        ...
        <style type="text/css">
			...
			<div id="ctl00_ContentPlaceHolder1_JQ1_surveyContent">
				<fieldset class="fieldset" id="fieldset1">
					...
					<s:if test="%{#q.type == 0}">
					<div class="div_title_page_question"><s:property value="#q.name" escape="false"/></div>
					</s:if>
					
					<s:if test="%{#q.type == 2}">
					<div class="div_question" id="div1">
						<div class="div_title_question_all">
							<div class="div_topic_question"><b><s:property value="#q.inx"/>.</b></div>
							<div id="divTitle1" class="div_title_question"><s:property value="#q.name" escape="false"/><span style="color:red;">&nbsp;*</span></div>
						...
						<div class="div_table_radio_question" id="divquestion1">
							...
							<ul>
								...
								<li style="width:<s:property value="#f"/>%;"><input type="radio" name="q<s:property value="#q.inx"/>" id="q<s:property value="#q.inx"/>_<s:property value="#q.inx"/>" value="<s:property value="#a.inx"/>"><label for="q<s:property value="#q.inx"/>_<s:property value="#a.inx"/>"><s:property value="#a.name"/></label></li>
								</s:iterator>
								</s:if>
								<s:if test="%{#q.scale != 0}">
									<s:iterator value="answers" id="a" status="st">
									...
									<s:if test="%{#q.scale != 1}">
									<s:if test="#st.first">
									<li class="notchoice" style="padding-right:15px;padding-top:5px;"><b><s:property value="#a.name" escape="false"/></b></li>
									</s:if> 
									<li style="padding-left:3px;" name="q<s:property value="#q.inx"/>" id="q<s:property value="#q.inx"/>_<s:property value="#a.inx"/>" value="<s:property value="#a.score"/>" title="<s:property value="#a.name"/>" class="off<s:property value="#q.scale"/>"></li>
									<s:if test="#st.last">
									<li class="notchoice" style="padding-left:15px;padding-top:5px;"><b><s:property value="#a.name" escape="false"/></b></li>
									</s:if>
									</s:if>
									<s:if test="%{#q.scale == 1}">
									<li style="padding-left:3px;width:120px"><input type="radio" name="q<s:property value="#q.inx"/>" id="q<s:property value="#q.inx"/>_<s:property value="#a.inx"/>" value="<s:property value="#a.inx"/>" title="<s:property value="#a.name"/>"/><b><s:property value="#a.name" escape="false"/></b></li>
									</s:if>
					...
					<div class="div_question" id="div1">
						<div class="div_title_question_all">
							<div class="div_topic_question"><b><s:property value="#q.inx"/>.</b></div>
							<div id="divTitle1" class="div_title_question"><s:property value="#q.name"/><span style="color:red;">&nbsp;*</span></div>
							<div style="clear:both;"></div>
						</div>
						<div class="div_table_radio_question" id="divquestion1">
							<div class="div_table_clear_top"></div>
							<ul>
								...
								<li style="width:99%;"><input type="checkbox" name="q<s:property value="#q.inx"/>" id="q<s:property value="#q.inx"/>_<s:property value="#q.inx"/>" value="<s:property value="#a.inx"/>"><label for="q<s:property value="#q.inx"/>_<s:property value="#a.inx"/>"><s:property value="#a.name"/></label></li>
								</s:iterator>
								<div style="clear:both;"></div>
							</ul>
							<div style="clear:both;"></div>
					...
					<div class="register_div"><div style="display:none;" id="divpoweredby">Powered by <a href="http://www./" title="国培计划项目办公室" class="link-06f" target="_blank"><strong>国培计划项目办公室</strong></a><span style="font-family:Tahoma">™</span></div></div></fieldset></div>
        ...
        <table id="submit_table" style="margin:0 auto;">
            ...
            <tbody><tr>
                <td id="ctl00_ContentPlaceHolder1_JQ1_tdCode" style="display: none;">
                    <input id="txtCode" size="14" maxlength="10" onkeydown="enter_clicksub(event);" style="height:24px; line-height:24px; border:1px solid #7F9DB9;">&nbsp;&nbsp;<img id="imgCode"  style="display:none;">
                </td>

                <td>
                    <input type="button" class="submitbutton" value="提交答卷" onmouseout="this.className=&#39;submitbutton&#39;;" id="submit_button">
                  
                     &nbsp;&nbsp;
                </td> 
                 <td>
                    
                    <div id="divPreviewQ" style="display:none;"><div style="margin:30px auto; text-align:center;"><a id="hrefPQ" target="_blank" onclick="alert(&quot;您的答卷还没有提交，请预览答卷后返回此页面并点击“提交按钮”提交答卷！&quot;);PDF_close();return true;" class="btnbg"><span>成功生成预览，点击查看</span></a></div></div>
                </td> 
                <td>
                    <a href="http://www./viewstat/2586349.aspx" id="ctl00_ContentPlaceHolder1_JQ1_hrefViewResult" class="link-U00a6e6" style="margin-left:10px; display:none;" target="_blank">
                        查看结果</a>
                </td>
                <td align="right">
                    <span id="spanTest" style="visibility:hidden;"> &nbsp;&nbsp;<input type="button" style="font-weight: bold;" class="operation" value="试填问卷" id="submittest_button" title="只有发布者才能看到试填按钮，试填的答卷不会参与结果统计！"><a title="只有发布者才能看到试填按钮，试填的答卷不会参与结果统计！" style="color: green" href="javascript:void(0);"><b>(?)</b></a>&nbsp;&nbsp;<span style="color: #ff3300;"></span></span>
                </td>  
    ...
    <div id="divMinTime" style="position: absolute; width: 140px; font-size: 14px; color: rgb(102, 102, 102); left: 773px; top: 595px; display: none;">
...
<div id="ctl00_ContentPlaceHolder1_JQ1_divLeftBar" style="text-align: center; position: absolute; width: 50px; padding: 8px 0px; left: 1104px; top: 431px; background-color: rgb(255, 255, 255); background-position: initial initial; background-repeat: initial initial;" class="leftbar">
    <div id="divProgressBar">
        ...
        <div style="text-align:left;">
            <span id="loadprogress" style="font-weight: bold; visibility: visible;">&nbsp;&nbsp;100%</span>
        </div>
        <div id="ctl00_ContentPlaceHolder1_JQ1_divProgressImg" style="float: left; padding-left: 15px; visibility: visible;">
            ...
            <div id="loading" title="已答题比率">
                <span id="loadcss" style="height: 100%; line-height: 0; font-size: 0px; overflow: hidden;"></span>
            </div>
        </div>
