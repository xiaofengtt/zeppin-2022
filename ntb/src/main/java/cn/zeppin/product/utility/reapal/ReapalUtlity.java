...
//		model.addAttribute("msg", res);
	 ...
	 * @throws Exception
	 */
	public static Map<String, Object> qcbWithdrawBatchSubmit(WithdrawDataArray wda)
			throws Exception {
		Map<String, Object> result = new HashMap<String, Object>();
		Map<String, String> map = new HashMap<String, String>(0);
		map.put("charset", ReapalUtil.getCharset());
		map.put("trans_time", wda.getTrans_time());
		map.put("notify_url", ReapalUtil.qcb_company_notify_url_pay);
		map.put("batch_no", wda.getBatch_no());
		map.put("batch_count", wda.getCount()+"");
		map.put("batch_amount", wda.getPrice().toString());
		map.put("pay_type", ReapalUtil.pay_type_normal);
...
//		model.addAttribute("msg", res);
	 ...
	 * @throws Exception
	 */
	public static Map<String, Object> qcbEmpWithdrawBatchSubmit(WithdrawDataArray wda)
			throws Exception {
		Map<String, Object> result = new HashMap<String, Object>();
		Map<String, String> map = new HashMap<String, String>(0);
		map.put("charset", ReapalUtil.getCharset());
		map.put("trans_time", wda.getTrans_time());
		map.put("notify_url", ReapalUtil.qcb_employee_notify_url_pay);
		map.put("batch_no", wda.getBatch_no());
		map.put("batch_count", wda.getCount()+"");
		map.put("batch_amount", wda.getPrice().toString());
		map.put("pay_type", ReapalUtil.pay_type_normal);
...
//		model.addAttribute("msg", res);
	 ...
	 * @throws Exception
	 */
	public static Map<String, Object> qcbEmpRepaymentBatchSubmit(WithdrawDataArray wda)
			throws Exception {
		Map<String, Object> result = new HashMap<String, Object>();
		Map<String, String> map = new HashMap<String, String>(0);
		map.put("charset", ReapalUtil.getCharset());
		map.put("trans_time", wda.getTrans_time());
		map.put("notify_url", ReapalUtil.qcb_employee_notify_url_repay);
		map.put("batch_no", wda.getBatch_no());
		map.put("batch_count", wda.getCount()+"");
		map.put("batch_amount", wda.getPrice().toString());
		map.put("pay_type", ReapalUtil.pay_type_normal);
