...
//	protected static final String url = "http://testagentpay.reapal.com/agentpay/";
	...
	public static final String qcb_company_notify_url_pay = Utlity.PATH_URL+"/web/notice/reapalQcbWithdrawNotice";
	public static final String qcb_employee_notify_url_pay = Utlity.PATH_URL+"/web/notice/reapalQcbEmployeeWithdrawNotice";
	public static final String qcb_employee_notify_url_repay = Utlity.PATH_URL+"/web/notice/reapalQcbEmployeeRepaymentNotice";
