...
import cn.zeppin.product.ntb.qcb.vo.wechat.Token;
...
public class CommonUtil {
	 ...
	 * @return
	 */
	public static Token getAccessToken(String appId,String app_secrect) {
		Token token = null;
		String requestUrl = ConfigUtil.TOKEN_URL.replace("APPID", appId).replace("APPSECRET",app_secrect);
		// 发起GET请求获取凭证
