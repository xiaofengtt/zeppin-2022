...
public class ShbxInsuredVO implements Entity {
	...
	private String householdareaParent;
	...
	public ShbxInsuredVO(ShbxInsured si){
		...
		this.mobile = si.getMobile();
		this.householdarea = si.getHouseholdarea();
		this.householdtype = si.getHouseholdtype();
		this.worktime = si.getWorktime();
		if(si.getWorktime() != null){
			this.worktimeCN = Utlity.timeSpanToDateString(si.getWorktime());
		}
	...
	public String getHouseholdareaParent() {
		return householdareaParent;
	}

	public void setHouseholdareaParent(String householdareaParent) {
		this.householdareaParent = householdareaParent;
	}
