 ...
 *
 */
public interface ICompanyAccountTransferOperateService extends IBaseService<CompanyAccountTransferOperate, String> {
	/**
	 * 根据参数查询结果列表
	 * @param inputParams
	 * @param pageNum
	 ...
	 */
	public void check(CompanyAccountTransferOperate companyAccountTransferOperate) throws TransactionException;
