 ...
 *
 */
public interface ICompanyAccountOperateService extends IBaseService<CompanyAccountOperate, String> {
	/**
	 * 根据参数查询结果列表
	 * @param inputParams
	 * @param pageNum
	 ...
	 */
	public void check(CompanyAccountOperate companyAccountOperate) throws TransactionException;
