...
@Controller
@RequestMapping(value = "/backadmin/operateOperator")
public class OperateOperatorController extends BaseController{
	...
	public Result get(String uuid) {
		...
		//验证角色
		if (!BkOperatorRoleUuid.OPERATE_MANAGER.equals(operator.getRole()) && !BkOperatorRoleUuid.OPERATE_EDITOR.equals(operator.getRole())){
			return ResultManager.createFailResult("运营用户角色错误！");
		}
	...
	public Result list(String name, String status, Integer pageNum, Integer pageSize, String sorts) {
		...
		String role = "'"+BkOperatorRoleUuid.OPERATE_MANAGER+"','"+BkOperatorRoleUuid.OPERATE_EDITOR+"'";
	...
	public Result add(String role, String name, String realname, String mobile, String email) {
		//验证角色
		if (!BkOperatorRoleUuid.OPERATE_MANAGER.equals(role) && !BkOperatorRoleUuid.OPERATE_EDITOR.equals(role)){
			return ResultManager.createFailResult("运营用户角色错误！");
		}
	...
	public Result edit(String uuid, String role, String name, String realname, String mobile, String email, String status) {
		...
		if(operator != null && uuid.equals(operator.getUuid())){
			...
			return ResultManager.createDataResult(operator,"修改运营用户信息成功");
		}else{
			return ResultManager.createFailResult("该条数据不存在！");
		}
	}
