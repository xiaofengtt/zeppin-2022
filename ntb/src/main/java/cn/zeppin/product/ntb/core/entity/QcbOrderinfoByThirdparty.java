...
/**
 * @description 【数据对象】企财宝第三方支付平台订单信息记录
 */

@Entity
@Table(name = "qcb_orderinfo_by_thirdparty", uniqueConstraints = {@UniqueConstraint(columnNames = "order_num")})
public class QcbOrderinfoByThirdparty extends BaseEntity {
	...
	public class QcbOrderinfoByThirdpartyAccountType{
		public final static String COMPANY = "company";
		public final static String EMPLOYEE = "employee";
	}
	
	public class QcbOrderinfoByThirdpartyReturnStatus{
	...
	public class QcbOrderinfoByThirdpartyType{
	...
	public class QcbOrderinfoByThirdpartyResultStatus{
		public final static String SUCCESS = "SUCCESS";
