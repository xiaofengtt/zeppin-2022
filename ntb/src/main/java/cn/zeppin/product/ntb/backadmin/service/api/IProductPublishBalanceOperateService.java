 ...
 *
 */
public interface IProductPublishBalanceOperateService extends IBaseService<ProductPublishBalanceOperate, String> {
	/**
	 * 根据参数查询结果列表
	 * @param inputParams
	 * @param pageNum
	 ...
	 */
	public void check(ProductPublishBalanceOperate bankFinancialProductPublishOperate) throws TransactionException;
