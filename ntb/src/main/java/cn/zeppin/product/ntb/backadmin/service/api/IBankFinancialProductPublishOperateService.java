 ...
 *
 */
public interface IBankFinancialProductPublishOperateService extends IBaseService<BankFinancialProductPublishOperate, String> {
	/**
	 * 根据参数查询结果列表
	 * @param inputParams
	 * @param pageNum
	 ...
	 */
	public void check(BankFinancialProductPublishOperate bankFinancialProductPublishOperate) throws TransactionException;
