...
public class QcbCompanyPayrollRecordsVO implements Entity {
	...
	private String createtimeCN;
 	...
 	public QcbCompanyPayrollRecordsVO(){
		
	}
	
	public QcbCompanyPayrollRecordsVO(QcbCompanyPayrollRecords qcpr){
