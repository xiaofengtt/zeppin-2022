 ...
 *
 */
public interface IInvestorProductBuyAgreementService extends IBaseService<InvestorProductBuyAgreement, String> {
	...
	public void updateBatch(List<InvestorProductBuyAgreement> listUpdate, List<InvestorProductBuyAgreement> listInsert);
