...
/**
 * @description 【数据对象】企财宝员工
 */

@Entity
@Table(name = "qcb_employee", uniqueConstraints = {@UniqueConstraint(columnNames = "mobile"), @UniqueConstraint(columnNames = "openid"), @UniqueConstraint(columnNames = "idcard")})
public class QcbEmployee extends BaseEntity {
	...
	public class QcbEmployeeStatus{
