 ...
 *
 */
public interface ICouponStrategyOperateService extends IBaseService<CouponStrategyOperate, String> {
	/**
	 * 根据参数查询结果列表
	 * @param inputParams
	 * @param pageNum
	 ...
	 */
	public void check(CouponStrategyOperate couponStrategyOperate) throws TransactionException;
