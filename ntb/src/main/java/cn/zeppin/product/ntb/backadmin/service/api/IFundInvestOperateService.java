 ...
 *
 */
public interface IFundInvestOperateService extends IBaseService<FundInvestOperate, String> {
	/**
	 * 根据参数查询结果列表
	 * @param inputParams
	 * @param pageNum
	 ...
	 */
	public void check(FundInvestOperate fundInvestOperate) throws TransactionException;
