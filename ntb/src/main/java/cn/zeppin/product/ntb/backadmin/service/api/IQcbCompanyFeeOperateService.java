 ...
 *
 */
public interface IQcbCompanyFeeOperateService extends IBaseService<QcbCompanyFeeOperate, String> {
	/**
	 * 根据参数查询结果列表
	 * @param inputParams
	 * @param pageNum
	 ...
	 */
	public void check(QcbCompanyFeeOperate QcbCompanyFeeOperate) throws TransactionException;
