...
/**
 * @description 【数据对象】第三方支付平台订单信息记录(微信、支付宝)
 */

@Entity
@Table(name = "orderinfo_by_thirdparty", uniqueConstraints = {@UniqueConstraint(columnNames = "order_num")})
public class OrderinfoByThirdparty extends BaseEntity {
	...
	public class OrderinfoByThirdpartyReturnStatus{
	...
	public class OrderinfoByThirdpartyType{
	...
	public class OrderinfoByThirdpartyResultStatus{
		public final static String SUCCESS = "SUCCESS";
