 ...
 * 
 * 
 * @description 【数据对象】用户现金红包
 */

@Entity
@Table(name = "investor_red_packet")
public class InvestorRedPacket extends BaseEntity {
	...
	public class InvestorRedPacketStatus{
	...
	public void setPirce(BigDecimal price) {
		this.price = price;
	}
