...
/**
 * 
 * @description 【数据对象】前台活期理财操作信息
 */

@Entity
@Table(name = "fund_publish_operate")
public class FundPublishOperate extends BaseEntity {
	...
	public class FundPublishOperateType{
	...
	public class FundPublishOperateStatus{
	...
	@Column(name = "fund_publish", length = 36)
