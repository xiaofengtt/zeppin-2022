...
public class SecurityByNtbRealm extends AuthorizingRealm {
    ...
    public SecurityByNtbRealm(CacheManager cacheManager, CredentialsMatcher matcher) {
     ...
     * @return
     */
    public static SecurityByNtbRealm getInstance() {
    	DefaultSecurityManager securityManager = (DefaultSecurityManager) SecurityUtils.getSecurityManager();
    	Collection<Realm> realms = securityManager.getRealms();
    	Collection<Realm> typeRealms = new ArrayList<>();
        for (Realm realm : realms) {
            if (realm.getName().contains(LoginType.NTB.toString()))
                typeRealms.add(realm);
        }
    	SecurityByNtbRealm realm = (SecurityByNtbRealm) typeRealms.iterator().next();
		return realm;
    }
    ...
    public static String encrypt(Object source, ByteSource salt) {
    	HashedCredentialsMatcher credentialsMatcher = (HashedCredentialsMatcher) SecurityByNtbRealm.getInstance().getCredentialsMatcher();
