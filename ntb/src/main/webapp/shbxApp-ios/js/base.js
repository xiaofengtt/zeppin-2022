...
$(function(){
	...
	$(".payBox").css("min-height",windowHeight-68);
	$("#code-box").height(windowHeight);
	$(".agreementBox").height(windowHeight-24);
//	$("body,html,.wrap").css("min-height",windowHeight+20);
})
function refresh(){
