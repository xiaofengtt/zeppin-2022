...
<body>
		...
		<div id="content">
			<div class="content-inner">
				...
				<div class="progressDiv">
				 ...
				 <!-- 注册form开始 -->
				<form:form id="resetsubmit" class="register-form" action="../rest/qcb/admin/rePwd" method="post"> 
				<div class="progressContent">
					...
					<div class="firstContent contentDiv">
						...
						<div class="form-group">
							...
							<div class="form-item"><input type="text" class="mobile" placeholder="请输入手机号" /></div>
						...
						<div class="form-group">
							...
							<div class="form-item">
								<input type="text" class="kaptcha" placeholder="请输入验证码"/>
						...
						<div class="clear"></div>
						<button class="firstConfirm continueBtn">验证</button>
						<div class="clear"></div>
						<!--<a class="goBack">返回</a>-->
					</div>
					...
					<div class="secContent contentDiv">
						<div class="form-group">
							...
							<div class="form-item"><input type="password" class="newPassword" name="passwordNew" placeholder="8-20位数字、字母或符号组合" /></div>
							<div class="tipsBox tipsBoxs"><p class="tips">8-20个字符，包含数字、字母和特殊字符</p></div>
							<div class="clear"></div>
						</div>
						<div class="form-group">
							<label class="label">确认密码</label>
							<div class="form-item"><input type="password" class="confirmPassword" name="passwordNewCheck" placeholder="请再次输入您的新密码" /></div>
							<div class="tipsBox"><p class="tips">两次密码不一致</p></div>
							<div class="clear"></div>
						</div>
						<div class="clear"></div>
						<button class="secConfirm light completeBtn">确定</button>
						<div class="clear"></div>
					</div>
					<!--第三步-->
				...
				<!-- 校验短信验证码正确form -->
				<form:form id="checkCodesubmit" action="../rest/qcb/admin/rePwdcheck" method="post"> 
				</form:form>
			</div>
		</div>
	...
	<script type="text/javascript" src="js/fotgetPassword.js?v=<%=Math.random()%>" ></script>
</body>
</html>