	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location"><a>理财产品发布操作管理</a><span>></span><a class="current" id="titlename"></a></div>
								...
								<div class="content-item-info">
									...
									<div class="form-group col-md-12">
										...
										<div class="content-items">
											<span id="collectStarttimes"></span> 至 <span id="collectEndtimes"></span><br>
											<span class="editSpan" id="collectStarttime" style="margin-left:0;"></span> <span class="editSpan" id="collectEndtime"></span>
										</div>
										<div class="clear"></div>
									</div>
									<div class="form-group col-md-12">
									...
									<div class="form-group col-md-12">
										...
										<span id="maturityDates"></span>
										 ...
										 <br>
										<span class="editSpan" id="valueDate" style="color:red;margin-left:0;"></span>
										</div>
										<div class="clear"></div>
									</div>
									<div class="form-group col-md-12">
		...
		<script type="text/javascript" src="js/productPublishOperateDetail.js" ></script>
