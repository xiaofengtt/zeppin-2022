...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./repaymentAuditing.jsp">产品结算还款申请</a><span>></span><a class="current">信息</a></div>
                <div class="clear"></div>
            </div>
                ...
                <div class="product_msg">
                    ...
                    <div class="invest_msg text_box">
                        ...
                        <div class="price_msg">
                            <ul>
                                <%-- <li>手续费：0.00</li> --%>
                                <li >总投资：<span class="color_orange" id="investAll"></span></li>
    ...
    <script src="./js/repaymentAuditingMsg.js"></script>
