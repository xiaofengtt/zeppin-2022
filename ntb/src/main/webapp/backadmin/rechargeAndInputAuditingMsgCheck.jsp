...
<script type="text/template" id="valueTpl">
    <p class="cn_price" id="rechargeBigValue">人民币：壹拾万元</p>
    <div class="form_item">
        <span><i>* </i>充值金额</span>
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
            <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./auditingItem.jsp">待审批事项</a><span>></span><a href="./rechargeAndInputAuditingCheck.jsp">企业账户充值、资金支出待审核事项</a><span>></span><a class="current">信息</a></div>
                <div class="clear"></div>
            </div>
    ...
    <script type="text/javascript" src="js/rechargeAndInputAuditingMsgCheck.js"></script>
