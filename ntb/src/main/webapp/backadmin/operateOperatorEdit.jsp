			...
			<div class="form-group form-group-double col-xs-6">
				...
				<div class="col-xs-12">
					<select id="role" name="role">
						<option id="0127fcbe-f57f-11e6-ac06-cacda7da5000" value="0127fcbe-f57f-11e6-ac06-cacda7da5000" >运营经理</option>
						<option id="49f5c6f5-f8d2-45c2-94bb-4036be1c4bb6" value="49f5c6f5-f8d2-45c2-94bb-4036be1c4bb6" >运营编辑</option>
					</select>
				</div>
				<div class="clear"></div>
			</div>
	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location"><div class="locationLeft"><a href="javascript:">后台用户管理</a><span>></span><a href="operateOperatorList.jsp">运营用户管理</a><span>></span><a class="current">修改运营用户</a></div>
					<div class="clear"></div>
				</div>
				<div class="layerOpen">
		...
		<script type="text/javascript" src="js/operateOperatorEdit.js" ></script>
