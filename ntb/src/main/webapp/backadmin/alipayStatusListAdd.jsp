...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">用户权限管理</a><span>></span><a href="./alipayStatusList.jsp">支付方式</a><span>></span><a class="current">添加</a></div>
                <div class="clear"></div>
            </div>
            <div class="main-contain pt-13 pl-14 pr-16">


                <form:form class="add_account_form" action="../rest/backadmin/bkpayment/add" method="post" id="add">
    ...
    <script src="./js/alipayStatusListAdd.js"></script>
</body>
</html>
