    ...
    <div class="product_item">
        <table class="product_head" cellspacing="0" cellpadding="0">
            <tr class="tr_bg_blue">
                ...
                <td width="80%" class="product_name color_blue"><a href="./accountMessageAuditingMsg.jsp?uuid={{:uuid}}">【{{:companyAccountTypeCN}}】{{:companyAccountName}} ({{:companyAccountCompany}},{{:companyAccountNum}})</a></td>
                <td width="20%">

                    {{if status == "checked"}}
                        <a href="./accountMessageAuditingMsg.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./auditingItem.jsp">申请事项</a><span>></span><a class="current">企业账户信息变动申请</a></div>
                <div class="clear"></div>
            </div>
    ...
    <script type="text/javascript" src="./js/accountMessageAuditing.js"></script>
</body>
</html>
