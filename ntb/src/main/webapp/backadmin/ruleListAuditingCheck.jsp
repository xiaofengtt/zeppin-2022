    ...
    <div class="product_item">
        <table class="product_head" cellspacing="0" cellpadding="0">
            <tr class="tr_bg_blue">
                ...
                <td width="80%" class="product_name">
                    <a href="./ruleListAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_blue">【{{:strategyIdentification}}】({{:couponStrategyName}})</a>
                </td>
                <td width="20%">
                    {{if status == "checked"}}
                        <a href="./ruleListAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                    {{else status == "unpassed"}}
                        <a href="./ruleListAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                    {{else status == 'unchecked'}}
                        <a href="./ruleListAuditingMsgCheck.jsp?uuid={{:uuid}}">审核</a>
                        <!-- <div class="btn-group">
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">内容管理CMS</a><span>></span><a class="current">投放策略待审核事项</a></div>
                <div class="clear"></div>
            </div>
    ...
    <script type="text/javascript" src="./js/ruleListAuditingCheck.js"></script>
</body>
</html>
