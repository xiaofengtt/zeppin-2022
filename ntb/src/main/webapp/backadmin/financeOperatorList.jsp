					...
					<table>
						<tr>
							<td class="td-left" width="50%">
								{{if role=='0e15ae93-f57f-11e6-ac06-cacda7da5000'}}
									<span class="list-tiem-manager"><img src="../backadmin/img/list_manager.png"/>{{:roleName}}</span>
								{{else}}
									<span>{{:roleName}}</span>
								{{/if}}
							...
							<td width="50%" class="text-right">
								<a class="btn callOff" href="financeOperatorEdit.jsp?uuid={{:uuid}}">修改</a>
								<a class="btn" onclick="deleteThis(this)" data-url="../rest/backadmin/financeOperator/delete?uuid={{:uuid}}">删除</a>
							</td>
						</tr>
					</table>
				</div>
	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location">
					<div class="locationLeft"><a href="">后台用户管理</a><span>></span><a class="current">财务用户管理</a></div>
					<a class="btn-add add addNew" href="../backadmin/financeOperatorAdd.jsp" style="margin-top:0px;">+&ensp;财务用户</a>
					<div class="clear"></div>
				</div>
				<div class="main-contain">
					<div class="topDiv">
						<div class="leftDiv">
							<span>财务用户（<span id="totalCount"></span>）</span>
						</div>
						<div class="rightDiv">
		...
		<script type="text/javascript" src="js/financeOperatorList.js" ></script>
