				...
				<div class="list-operate-hd">
					<table>
						<tr height="40px">
							...
							<td width="80%">
								{{if type=='netvalue'}}
									<span><a href="./fundPublishAuditingNetvalueCheck.jsp?uuid={{:uuid}}">【{{:fundPublishName}}】 ({{:scode}})</a></span>
								{{else}}
									<span><a href="./fundPublishAuditingMsgCheck.jsp?uuid={{:uuid}}">【{{:fundPublishName}}】 ({{:scode}})</a></span>
								{{/if}}
							...
							<td width="20%" class="text-center operate">
								{{if status=='checked'}}
									{{if type=='netvalue'}}
										<a href="./fundPublishAuditingNetvalueCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
									{{else}}
										<a href="./fundPublishAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
									{{/if}}
								{{else status=='unchecked'}}
									{{if type=='netvalue'}}
										<a href="./fundPublishAuditingNetvalueCheck.jsp?uuid={{:uuid}}">审核</a>
									{{else}}
										<a href="./fundPublishAuditingMsgCheck.jsp?uuid={{:uuid}}">审核</a>
									{{/if}}
									<!-- <div class="btn-group">
								...
								{{else status=='unpassed'}}
									{{if type=='netvalue'}}
										<a href="./fundPublishAuditingNetvalueCheck.jsp?uuid={{:uuid}}">查看</a>
									{{else}}
										<a href="./fundPublishAuditingMsgCheck.jsp?uuid={{:uuid}}">查看</a>
									{{/if}}
								{{/if}}
							</td>
						</tr>
	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location">
					<div class="locationLeft"><a class="current">活期理财信息审核</a></div>
					<div class="clear"></div>
				</div>
...
<!-- 					</div> -->
        ...
        <script type="text/javascript" src="./js/fundPublishAuditingCheck.js" ></script>
	</body>
</html>
