        ...
        <table class="product_head" cellspacing="0" cellpadding="0">
            <tr class="tr_bg_blue">
                ...
                <td width="80%" class="product_name color_blue">
                    ...
                    {{if type == "redeem"}}
                        <a href="./redeemptionAuditingMsg.jsp?uuid={{:uuid}}">&ensp;{{:bankFinancialProductName}}</a>
                    {{else}}
                        <a href="./investAuditingMsg.jsp?uuid={{:uuid}}">&ensp;{{:bankFinancialProductName}}</a>
                    {{/if}}
                </td>
                <td width="20%">
                    ...
                    {{if status == "checked"}}
                        {{if  type == "redeem"}}
                            <a href="./redeemptionAuditingMsg.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                        {{else}}
                            <a href="./investAuditingMsg.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                        {{/if}}
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./auditingItem.jsp">申请事项</a><span>></span><a class="current">企业投资、赎回申请</a></div>
                <div class="clear"></div>
            </div>
    ...
    <script type="text/javascript" src="./js/investAndRedeemptionAuditing.js"></script>
</body>
</html>
