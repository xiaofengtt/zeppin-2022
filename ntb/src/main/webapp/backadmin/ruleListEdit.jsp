...
<body>
    ...
    <div class="text_box add_account_form box" style="margin-top:40px;">
    	<p class="text_title">修改投放策略</p>
        <form:form id="form" action="../rest/backadmin/couponStrategy/edit" method="post">
            <div class="form_item">
                <span><i>* </i> 投放ID：</span>
    ...
    <script type="text/javascript" src="./js/ruleListEdit.js"></script>
</body>
</html>
