					...
					<table>
						<tr>
							<td class="td-left" width="50%">
								{{if role=='0127fcbe-f57f-11e6-ac06-cacda7da5000'}}
							...
							<td width="50%" class="text-right">
								<a class="btn callOff" href="operateOperatorEdit.jsp?uuid={{:uuid}}">修改</a>
								<a class="btn" onclick="deleteThis(this)" data-url="../rest/backadmin/operateOperator/delete?uuid={{:uuid}}">删除</a>
							</td>
						</tr>
					</table>
				</div>
	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location">
					<div class="locationLeft"><a href="">后台用户管理</a><span>></span><a class="current">运营用户管理</a></div>
					<a class="btn-add add addNew" href="../backadmin/operateOperatorAdd.jsp" style="margin-top:0px;">+&ensp;运营用户</a>
					<div class="clear"></div>
				</div>
				<div class="main-contain">
					<div class="topDiv">
						<div class="leftDiv">
							<span>运营用户（<span id="totalCount"></span>）</span>
						</div>
						<div class="rightDiv">
		...
		<script type="text/javascript" src="./js/operateOperatorList.js" ></script>
