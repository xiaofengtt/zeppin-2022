    ...
    <div class="product_item">
        <table class="product_head" cellspacing="0" cellpadding="0">
            <tr class="tr_bg_blue">
                <td width="5%">
                    {{if type == "edit"}}
                        <span class="product_tip bg_black">{{:typeCN}}</span>
                    {{else type == "add"}}
                        <span class="product_tip bg_green">{{:typeCN}}</span>
                    {{else type == "open"}}
                        <span class="product_tip bg_blue">{{:typeCN}}</span>
                    {{else type == "closed"}}
                        <span class="product_tip bg_orange">{{:typeCN}}</span>
                    {{else type == "delete"}}
                        <span class="product_tip bg_gray">{{:typeCN}}</span>
                    {{/if}}
                </td>
                <td width="80%" class="product_name color_blue"><a href="./alipayStatusListAuditingMsgCheck.jsp?uuid={{:uuid}}">【{{:bkPaymentName}}】{{:bkPaymentDes}} </a></td>
                <td width="20%">
                    {{if status == "checked"}}
                        <a href="./alipayStatusListAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                    {{else status == "unpassed"}}
                        <a href="./alipayStatusListAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                    {{else status == 'unchecked'}}
                        <a href="./alipayStatusListAuditingMsgCheck.jsp?uuid={{:uuid}}">审核</a>
                        <!-- <div class="btn-group">
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">用户权限管理</a><span>></span><a class="current">支付方式变动待审核事项</a></div>
                <div class="clear"></div>
            </div>
                ...
                <div class="condition">
                    ...
                    <div class="statusDiv filter1">
                        ...
                        <div>
                            ...
                            <a id="closed">关闭<span id="closedCount">(0)</span></a>
    ...
    <script type="text/javascript" src="./js/alipayStatusListAuditingCheck.js"></script>
</body>
</html>
