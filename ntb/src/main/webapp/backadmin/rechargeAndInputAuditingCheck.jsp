        ...
        <table class="product_head" cellspacing="0" cellpadding="0">
            <tr class="tr_bg_blue">
                ...
                <td width="80%" class="product_name color_blue">
                    {{if companyAccountHistoryInfo.type == "recharge"}}
                        <a href="./rechargeAndInputAuditingMsgCheck.jsp?uuid={{:uuid}}">
                            【{{:companyAccountHistoryInfo.companyAccountInInfo.typeCN}}】
                            {{:companyAccountHistoryInfo.companyAccountInInfo.accountName}}
                             ({{:companyAccountHistoryInfo.companyAccountInInfo.accountNum}})
                        </a>
                    {{else companyAccountHistoryInfo.type == "expend"}}
                        <a href="./rechargeAndInputAuditingMsgCheck.jsp?uuid={{:uuid}}">
                            【{{:companyAccountHistoryInfo.companyAccountOutInfo.typeCN}}】
                            {{:companyAccountHistoryInfo.companyAccountOutInfo.accountName}}
                             ({{:companyAccountHistoryInfo.companyAccountOutInfo.accountNum}})
                        </a>
                    {{/if}}
                </td>
                <td width="20%">
                    {{if status == "checked"}}
                        <a href="./rechargeAndInputAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                    {{else status == "unpassed"}}
                        <a href="./rechargeAndInputAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                    {{else status == 'unchecked'}}
                        <a href="./rechargeAndInputAuditingMsgCheck.jsp?uuid={{:uuid}}">审核</a>
                        <!-- <div class="btn-group">
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./auditingItem.jsp">待审批事项</a><span>></span><a class="current">企业账户充值、资金支出待审核事项</a></div>
                <div class="clear"></div>
            </div>
                ...
                <div class="condition">
                    ...
                    <div class="statusDiv filter1">
                        ...
                        <div>
                            ...
                            <a id="expend">费用录入<span id="expendCount">(0)</span></a>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="./js/rechargeAndInputAuditingCheck.js"></script>
</body>
</html>
