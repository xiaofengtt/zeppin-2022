...
<body>
    ...
    <div class="text_box">
        <p class="text_title">批量删除银行虚拟账号</p>
        ...
        <form:form id="form" action="../rest/backadmin/qcbVirtualAccounts/batchDelete" method="post">
    ...
    <script type="text/javascript" src="./js/bankFictitiousAccountDelete.js"></script>
</body>
</html>
