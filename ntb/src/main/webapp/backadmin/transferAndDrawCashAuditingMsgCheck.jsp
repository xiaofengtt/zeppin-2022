...
<script type="text/template" id="queboxTpl">
    <div class="msg_card text_box">
        ...
        <span class="card_balance">
            余额：
            <i>{{:newData.companyAccountOutInfo.accountBalanceCN}}</i>
        </span>
    </div>
...
<script type="text/template" id="msgTpl">
    ...
    <div class="form_item">
        <span><i>* </i>转账金额</span>
        <input type="text" name="totalAmount" value="{{:newData.totalAmountCN}}" id="transferValue">
        <small>元</small>
    </div>

    <div class="form_item">
        <span><i>* </i>手续费</span>
        <input type="text" name="poundage" value="{{:newData.poundageCN}}" id="poundage">
        <small>元</small>
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./accountControllerList.jsp">账户管理</a><span>></span><a href="./transferAndDrawCashAuditing.jsp">企业账户间转账待审核事项</a><span>></span><a class="current">转账变动审核信息</a></div>
                <div class="clear"></div>
            </div>
    ...
    <script type="text/javascript" src="js/transferAndDrawCashAuditingMsgCheck.js"></script>
</body>
</html>
