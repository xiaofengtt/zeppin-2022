        ...
        <table class="product_head" cellspacing="0" cellpadding="0">
            <tr class="tr_bg_blue">
                ...
                <td width="50%" class="product_name color_blue">
                    <a href="./QCBcompanyAccountRateAuditingMsgCheck.jsp?uuid={{:uuid}}">
                        【{{:typeCN}}】
                        {{:qcbCompany}}
                    </a>
                </td>
                ...
                <td width="20%" style="padding:0 10px;text-align:center;">
                    {{if status == "checked"}}
                        <a href="./QCBcompanyAccountRateAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                    {{else status == "unpassed"}}
                        <a href="./QCBcompanyAccountRateAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                    {{else status == 'unchecked'}}
                        <a href="./QCBcompanyAccountRateAuditingMsgCheck.jsp?uuid={{:uuid}}">审核</a>
                        <!-- <div class="btn-group">
...
<body>
    ...
    <script type="text/javascript" src="./js/QCBcompanyAccountRateAuditingCheck.js"></script>
</body>
</html>
