        ...
        <table class="product_head" cellspacing="0" cellpadding="0">
            <tr class="tr_bg_blue">
                ...
                <td width="50%" class="product_name color_blue">
                    <a href="./QCBcompanyAccountRateAuditingMsg.jsp?uuid={{:uuid}}">
                        【{{:typeCN}}】
                        {{:qcbCompany}}
                    </a>
                </td>
                <td width="20%" class="product_name color_blue" style="padding:0 10px;border-left:1px solid #c1c1c1;border-right:1px solid #c1c1c1;">
                    <span style="">费率：{{:fee}}</span>
                </td>
                <td width="20%" style="padding:0 10px;text-align:center;">

                    {{if status == "checked"}}
                        <a href="./QCBcompanyAccountRateAuditingMsg.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
...
<body>
    ...
    <script type="text/javascript" src="./js/QCBcompanyAccountRateAuditing.js"></script>
</body>
</html>
