...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">内容管理CMS</a><span>></span><a href="./imgMsgList.jsp">图文内容管理</a><span>></span><a class="current">添加图文信息</a></div>
                <div class="clear"></div>
            </div>
            <div class="main-contain pt-13 pl-14 pr-16">
                <div class="text_box add_account_form">
                    ...
                    <div class="upload_box">
                        <form class="" action="index.html" method="post" id="upload_html">
                            <input type="file" name="" value="" id="file_html">
                            <a href="javascript:void(0);">添加文件</a>
                        </form>
                        &ensp;
                        <form class="" action="index.html" method="post" id="upload_img">
                            <input type="file" name="" value="" id="file_img">
                            <a href="javascript:void(0);">添加封面</a>
                        </form>
                    </div>
                    <div class="form_item">
                        <span><i>*</i> 文件链接：</span>
                        <span style="text-align:left;width:auto;"><a href="javascript:void(0);" id="file_html_name"></a></span>
                    </div>
                    <div class="form_item">
                        <span><i>*</i> 文件名：</span>
                    ...
                    <div class="form_item">
                        ...
                        <span style="text-align:left;width:auto;max-width:50%;">
                            <img src="" alt="" style="width:100%;" id="file_img_name">
                        </span>
                    </div>
                    <div class="btn_group">
    ...
    <script src="./js/imgMsgAdd.js"></script>
</body>
</html>
