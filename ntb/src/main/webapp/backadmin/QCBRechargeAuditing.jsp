        ...
        <table class="product_head" cellspacing="0" cellpadding="0">
            <tr class="tr_bg_blue">
                ...
                <td width="50%" class="product_name color_blue">
                    {{if type == "recharge"}}
                        <a href="./QCBRechargeAuditingMsg.jsp?uuid={{:uuid}}">
                            【{{:typeCN}}】
                            {{:qcbCompany}}
                        </a>
                    {{else}}
                        <a href="./QCBexpendAuditingMsg.jsp?uuid={{:uuid}}">
                            【{{:typeCN}}】
                            {{:qcbCompany}}
                        </a>
                    {{/if}}
                ...
                <td width="20%" class="product_name color_blue" style="padding:0 10px;border-left:1px solid #c1c1c1;border-right:1px solid #c1c1c1;">
                    <span style="">金额：{{:price}}</span>
                </td>
                <td width="20%" style="padding:0 10px;text-align:center;">

                    {{if status == "checked"}}
                        {{if type == "recharge"}}
                            <a href="./QCBRechargeAuditingMsg.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                        {{else}}
                            <a href="./QCBexpendAuditingMsg.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                        {{/if}}
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">企财宝网站管理</a><span>></span><a class="current">申请事项</a></div>
                <div class="clear"></div>
            </div>
    ...
    <script type="text/javascript" src="./js/QCBRechargeAuditing.js"></script>
</body>
</html>
