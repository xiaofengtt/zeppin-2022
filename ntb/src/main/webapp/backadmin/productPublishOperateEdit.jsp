	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location"><a href="productPublishOperateList.jsp">理财产品发布操作管理</a><span>></span><a class="current" id="titlename"></a></div>
		...
		<script type="text/javascript" src="js/productPublishOperateEdit.js" ></script>
