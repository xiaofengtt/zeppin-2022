...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./auditingItem.jsp">待审批事项</a><span>></span><a href="./fundPublishInvestAuditing.jsp">活期投资投资/赎回申请</a><span>></span><a class="current">信息</a></div>
                <div class="clear"></div>
            </div>
    ...
    <script type="text/javascript" src="./js/fundPublishRedemAuditingMsg.js"></script>
</body>
</html>
