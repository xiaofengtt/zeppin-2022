	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location"><div class="locationLeft"><a href="javascript:">后台用户管理</a><span>></span><a href="financeOperatorList.jsp">财务用户管理</a><span>></span><a class="current">添加财务用户</a></div>
					<div class="clear"></div>
				</div>
				<div class="layerOpen">
