				...
				<div class="list-operate-hd">
					<table>
						<tr height="40px">
							...
							{{/if}}
							<td width="80%">
								<span><a target="_blank" href="productPublishOperateCheckDetail.jsp?uuid={{:uuid}}">【{{:custodianName}}】{{:bankFinancialProductPublishName}} ({{:scode}})</a></span>
							</td>
							<td width="20%" class="text-center operate">
								{{if status=='checked'}}
									<a target="_blank" href="productPublishOperateCheckDetail.jsp?uuid={{:uuid}}">查看</a>
