...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">内容管理CMS</a><span>></span><a href="./columnList.jsp">栏目管理</a><span>></span><a class="current">添加下级栏目</a></div>
                <div class="clear"></div>
            </div>
    ...
    <script src="./js/editNextColumn.js"></script>
</body>
</html>
