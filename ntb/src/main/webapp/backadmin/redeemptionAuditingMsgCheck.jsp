...
<script type="text/template" id="tableTpl">
    ...
    <tr style="height:45px">
        ...
        <td class="totalReturn">
            <!-- {{if productPublishTargetReturn != "-"}}
                {{:productPublishTargetReturn/100 * totalAmount}}
            {{else}}
                -
            {{/if}} -->
        </td>
        <td><input type="number" name="" value="{{:totalRedeemCN}}" style="margin:0;width:150px;" step="0.01" class="rede_num" disabled></td>
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./auditingItem.jsp">待审批事项</a><span>></span><a href="./investAndRedemptionAuditingCheck.jsp">企业投资、赎回待审核事项</a><span>></span><a class="current">信息</a></div>
                <div class="clear"></div>
            </div>
    ...
    <script type="text/javascript" src="./js/redeemptionAuditingMsgCheck.js"></script>
</body>
</html>
