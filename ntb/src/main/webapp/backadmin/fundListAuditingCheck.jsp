				...
				<div class="list-operate-hd">
					<table>
						<tr height="40px">
							...
							<td width="80%">
								{{if type=='netvalue'}}
									<span><a href="./fundListAuditingMsgCheck.jsp?uuid={{:uuid}}">【{{:fundName}}】 ({{:scode}})</a></span>
								{{else}}
									<span><a href="./fundListAuditingMsgCheck.jsp?uuid={{:uuid}}">【{{:fundName}}】 ({{:scode}})</a></span>
								{{/if}}
							...
							<td width="20%" class="text-center operate">
								{{if status=='checked'}}
									{{if type=='netvalue'}}
										<a href="./fundListAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
									{{else}}
										<a href="./fundListAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
									{{/if}}
								{{else status=='unchecked'}}
									{{if type=='netvalue'}}
										<a href="./fundListAuditingMsgCheck.jsp?uuid={{:uuid}}">审核</a>
									{{else}}
										<a href="./fundListAuditingMsgCheck.jsp?uuid={{:uuid}}">审核</a>
									{{/if}}
								...
								{{else status=='unpassed'}}
									{{if type=='netvalue'}}
										<a href="./fundListAuditingMsgCheck.jsp?uuid={{:uuid}}">查看</a>
									{{else}}
										<a href="./fundListAuditingMsgCheck.jsp?uuid={{:uuid}}">查看</a>
									{{/if}}
								{{/if}}
...
<!-- 					</div> -->
        ...
        <script type="text/javascript" src="./js/fundListAuditingCheck.js" ></script>
	</body>
</html>
