	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location"><div class="locationLeft"><a href="controllerInfoList.jsp">功能信息管理</a><span>></span><a class="current">修改功能</a></div>
...
<!-- 							<div class="btnGroup text-center"> -->
		...
		<script type="text/javascript" src="js/controllerInfoEdit.js" ></script>
