    ...
    <div class="product_item">
        <table class="product_head" cellspacing="0" cellpadding="0">
            <tr class="tr_bg_blue">
                ...
                <td width="60%" class="product_name color_blue">
                    {{if companyAccountHistoryInfo.type == "recharge"}}
                        <a href="./rechargeAndInputAuditingMsg.jsp?uuid={{:uuid}}">
                ...
                <td width="20%">
                    ...
                    {{if status == "checked"}}
                        <a href="./rechargeAndInputAuditingMsg.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./auditingItem.jsp">申请事项</a><span>></span><a class="current">企业账户充值、资金支出申请</a></div>
                <div class="clear"></div>
            </div>
                ...
                <div class="condition">
                    ...
                    <div class="statusDiv filter1">
                        ...
                        <div>
                            ...
                            <a id="expend">费用支出<span id="expendCount">(0)</span></a>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="./js/rechargeAndInputAuditing.js"></script>
</body>
</html>
