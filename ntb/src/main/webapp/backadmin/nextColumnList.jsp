...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">内容管理CMS</a><span>></span><a>栏目管理</a><span>></span><a class="current">二级菜单管理</a></div>
                <div class="clear"></div>
            </div>
            <div class="main-contain pt-13 pl-14 pr-16">
                ...
                <div class="screening">
                    ...
                    <a href="./addNextColumn.jsp" class="add_account">添加下级栏目</a>
                ...
                <table cellspacing="0" cellpadding="0" class="msg_table">
                    ...
                    <tbody id="queboxCnt">
                        <tr>
                            ...
                            <td>理财产品</td>
                            <td>
                                <a href="./editNextColumn.jsp?uuid={{:uuid}}">修改</a>
	...
	<script src="./js/nextColumnList.js"></script>
</body>
</html>
