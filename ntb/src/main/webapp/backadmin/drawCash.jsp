...
<script type="text/template" id="thirdTpl">
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./accountControllerList.jsp">账户管理</a><span>></span><a class="current">提现</a></div>
                <div class="clear"></div>
            </div>
            <div class="main-contain pt-13 pl-14 pr-16">
                ...
                <div class="recharge_msg text_box">
                    <p class="text_title">提现信息</p>
                    <form:form class="add_account_form" action="../rest/backadmin/companyAccountTransfer/withdraw" method="post" id="submit">
    ...
    <script type="text/javascript" src="js/drawCash.js"></script>
</body>
</html>
