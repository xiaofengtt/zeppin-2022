	...
	<head>
		...
		<script id="queboxTpl" type="text/template">
			<tr>
				...
				<td>
					<a class="editDaily" href="fundDailyEdit.jsp?uuid={{:uuid}}">修改</a>
					<a onclick="deleteThis(this)" data-uuid="{{:uuid}}" data-status="unchecked">删除</a>
				</td>
			</tr>
		</script>
	</head>
		...
		<div class="contain">
			...
			<div class="contain-right">
				...
				<div class="main-contain">
					...
					<div class="title">历史净值<a class="btn-add add addNew">+&ensp;录入净值</a></div>
					<div class="clear"></div>
