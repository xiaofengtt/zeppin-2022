$(document).ready(function() {
    ...
    //获取筛选项
    getStatusList("../rest/backadmin/bkpayment/operateCheckStatusList");
    getTypeList();
    getList();
    ...
    function getTypeList() {
        ...
        $.ajax({
                url: "../rest/backadmin/bkpayment/operateCheckTypeList",
                type: "get",
                data: {
    ...
    function getList(name, sorts) {
        ...
        $.ajax({
                url: '../rest/backadmin/bkpayment/operateCheckList',
                type: 'get',
                data: {
                    "pageNum": pageNum,
                    "pageSize": 10,
