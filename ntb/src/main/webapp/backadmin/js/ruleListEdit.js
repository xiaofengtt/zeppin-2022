$(document).ready(function() {
    ...
    function get() {
        $.ajax({
                url: '../rest/backadmin/couponStrategy/get',
                type: 'get',
                data: {
                    "uuid": uuid
                }
            ...
            .done(function(r) {
                if (r.status == "SUCCESS") {
                    $("#strategyIdentification").val(r.data.strategyIdentification);
                    $("#expiryDate").val(r.data.expiryDateCN);
                    $("#uuid").val(r.data.uuid);
                    cardListArr = r.data.couponMap.couponList;
