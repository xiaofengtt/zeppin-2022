$(document).ready(function() {
    ...
    function getStatusList() {
        ...
        $.ajax({
                url: "../rest/backadmin/companyAccountTransfer/operateCheckStatusList",
                type: "get",
                data: {
    ...
    function getTypeList() {
        ...
        $.ajax({
                url: "../rest/backadmin/companyAccountTransfer/operateCheckTypeList",
                type: "get",
                data: {
    ...
    function getList(name, sorts) {
        ...
        $.ajax({
                url: '../rest/backadmin/companyAccountTransfer/operateCheckList',
                type: 'get',
                data: {
                    "pageNum": pageNum,
                    "pageSize": 10,
