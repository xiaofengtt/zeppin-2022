$(document).ready(function() {
    ...
    function getStatusList() {
        ...
        $.ajax({
                url: "../rest/backadmin/qcbcompany/operateFeeStatusList",
                type: "get",
                data: {
                    "type": "fee_ticket"
                }
    ...
    function deleteThis(t) {
        layer.confirm('确定要删除吗?', function(index) {
            ...
            $.get('../rest/backadmin/qcbcompany/operateFeeDelete?uuid=' + uuid, function(r) {
                if (r.status == 'SUCCESS') {
                    layer.msg('操作成功', {
                        time: 2000
                    }, function() {
    ...
    function submitThis(t) {
        layer.confirm('确定要提交审核吗?', function(index) {
            ...
            var obj = $(t);
            var uuid = obj.attr('data-uuid');
            $.get('../rest/backadmin/qcbcompany/operateFeeSubmitCheck?uuid=' + uuid, function(r) {
                if (r.status == 'SUCCESS') {
                    layer.msg('操作成功', {
                        time: 1000
                    }, function() {
    ...
    function getList(name, sorts) {
        ...
        $.ajax({
                url: '../rest/backadmin/qcbcompany/operateFeeList',
                type: 'get',
                data: {
                    "pageNum": pageNum,
                    "pageSize": 10,
