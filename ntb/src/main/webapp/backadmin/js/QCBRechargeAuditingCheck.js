$(document).ready(function() {
    ...
    function checkThis(t) {
        ...
        layer.confirm('确定要变更状态吗?', function(index) {
            ...
            $.get('../rest/backadmin/qcbCompanyTransfer/operateCheck?uuid=' + uuid + '&status=' + status + '&reason=' + reason, function(r) {
                if (r.status == 'SUCCESS') {
                    layer.msg('操作成功', {
                        time: 2000
                    });
    ...
    function getStatusList() {
        ...
        $.ajax({
                url: "../rest/backadmin/qcbCompanyTransfer/operateCheckStatusList",
                type: "get",
                data: {
    ...
    function getTypeList() {
        ...
        $.ajax({
                url: "../rest/backadmin/qcbCompanyTransfer/operateCheckTypeList",
                type: "get",
                data: {
    ...
    function getList(name, sorts) {
        ...
        $.ajax({
                url: '../rest/backadmin/qcbCompanyTransfer/operateCheckList',
                type: 'get',
                data: {
                    "pageNum": pageNum,
                    "pageSize": 10,
