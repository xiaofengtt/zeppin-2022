$(document).ready(function() {
    ...
    //获取筛选项
    getStatusList("../rest/backadmin/productPublishBalance/operateCheckStatusList");
    // getTypeList();
    getList();
    ...
    //
    //     $.ajax({
    //             url: "../rest/backadmin/productPublishBalance/operateCheckTypeList",
    //             type: "get",
    //             data: {
    ...
    function getList(name, sorts) {
        ...
        $.ajax({
                url: '../rest/backadmin/productPublishBalance/operateCheckList',
                type: 'get',
                data: {
                    "pageNum": pageNum,
                    "pageSize": 10,
