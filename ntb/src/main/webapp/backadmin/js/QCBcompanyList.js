...
function getStatusList() {
    ...
    $("#deletedCount").html("(0)");
    $("#allCount").html("(0)");
    $.get('../rest/backadmin/qcbcompany/statusList', function(r) {
        if (r.status == 'SUCCESS') {
            var totalCount = 0;
...
function getList() {
    ...
    var str = '';
    str += '&status=' + status;
    $.get('../rest/backadmin/qcbcompany/list?pageNum=' + page + '&pageSize=10&name=' + name + str, function(r) {
        if (r.status == 'SUCCESS') {
