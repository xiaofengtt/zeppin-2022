$(document).ready(function() {
	...
	$.get('../rest/backadmin/operateOperator/get?uuid='+uuid,function(r) {
		if(r.status =='SUCCESS') {
...
$('#formsubmit').submit(function() {
	...
	if(name==""){
		...
		$.post('../rest/backadmin/operateOperator/edit',str, function(data) {
			if (data.status == "SUCCESS") {
				layer.msg('修改成功', {
					time: 1000 
				}, function(){
					window.location.href="operateOperatorList.jsp";
				}); 
			} else {
