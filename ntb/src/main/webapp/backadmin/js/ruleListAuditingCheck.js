$(document).ready(function() {
    ...
    function getStatusList() {
        ...
        $.ajax({
                url: "../rest/backadmin/couponStrategy/operateCheckStatusList",
                type: "get",
                data: {
    ...
    function getTypeList() {
        ...
        $.ajax({
                url: "../rest/backadmin/couponStrategy/operateCheckTypeList",
                type: "get",
                data: {
    ...
    function getList(name, sorts) {
        ...
        $.ajax({
                url: '../rest/backadmin/couponStrategy/operateCheckList',
                type: 'get',
                data: {
                    "pageNum": pageNum,
                    "pageSize": 10,
