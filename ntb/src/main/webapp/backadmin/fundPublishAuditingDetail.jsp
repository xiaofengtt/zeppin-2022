	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location"><a href="fundPublishAuditing.jsp">活期理财发布申请</a><span>></span><a class="current" id="titlename"></a></div>
        ...
        <script type="text/javascript" src="./js/fundPublishAuditingDetail.js"></script>
	</body>
</html>
