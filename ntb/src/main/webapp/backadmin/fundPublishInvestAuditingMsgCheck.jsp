...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./auditingItem.jsp">待审批事项</a><span>></span><a href="./fundPublishInvestAuditingCheck.jsp">活期投资待审核事项</a><span>></span><a class="current">信息</a></div>
                <div class="clear"></div>
            </div>
            <div class="main-contain pt-13 pl-14 pr-16">
                ...
                <div class="select_account">
                    ...
                    <span id="balance" class="color_red" style="font-size:14px;">余额：</span>
                </div>
                ...
                <div class="product_msg">
                    ...
                    <div class="invest_msg text_box">
                        ...
                        <div class="all_price_box">
                            <span>手续费</span>
                            <input type="text" name="" value="0.00" id="poundageValue">
                            <p class="all_price">总计：</p>
                        </div>
    ...
    <script type="text/javascript" src="./js/fundPublishInvestAuditingMsgCheck.js"></script>
