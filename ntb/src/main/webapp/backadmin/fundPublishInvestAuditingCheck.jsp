        ...
        <table class="product_head" cellspacing="0" cellpadding="0">
            <tr class="tr_bg_blue">
                ...
                <td width="80%" class="product_name color_blue">
                    {{if type == "invest"}}
                        <a href="./fundPublishInvestAuditingMsgCheck.jsp?uuid={{:uuid}}">
                            【{{:fund}}】
                        </a>
                    {{else}}
                        <a href="./fundPublishRedemAuditingMsgCheck.jsp?uuid={{:uuid}}">
                            【{{:fund}}】
                        </a>
                    {{/if}}
                </td>
                <td width="20%">
                    {{if status == "checked"}}
                        <a href="./fundPublishInvestAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                    {{else status == "unpassed"}}
                        <a href="./fundPublishInvestAuditingMsgCheck.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
                    {{else status == 'unchecked'}}
                        <a href="./fundPublishInvestAuditingMsgCheck.jsp?uuid={{:uuid}}">审核</a>
                        <!-- <div class="btn-group">
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./auditingItem.jsp">待审批事项</a><span>></span><a class="current">活期投资待审核事项</a></div>
                <div class="clear"></div>
            </div>
    ...
    <script type="text/javascript" src="./js/fundPublishInvestAuditingCheck.js"></script>
</body>
</html>
