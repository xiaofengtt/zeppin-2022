	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location"><a href="bankFinancialProductOperateCheckList.jsp">理财产品信息审核管理</a><span>></span><a id="titlename"></a><span>></span><a class="current" id="titlename">净值</a></div>
		...
		<script type="text/javascript" src="js/bankFinancialProductOperateCheckNetvalue.js" ></script>
