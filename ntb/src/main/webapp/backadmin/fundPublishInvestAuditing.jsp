        ...
        <table class="product_head" cellspacing="0" cellpadding="0">
            <tr class="tr_bg_blue">
                ...
                <td width="60%" class="product_name color_blue">
                    {{if type == "invest"}}
                        <a href="./fundPublishInvestAuditingMsg.jsp?uuid={{:uuid}}">
                            【{{:fund}}】
                        </a>
                    {{else}}
                        <a href="./fundPublishRedemAuditingMsg.jsp?uuid={{:uuid}}">
                            【{{:fund}}】
                        </a>
                    {{/if}}
                </td>
                ...
                <td width="20%">
                    ...
                    {{if status == "checked"}}
                        <a href="./fundPublishInvestAuditingMsg.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./auditingItem.jsp">申请事项</a><span>></span><a class="current">活期投资/赎回申请</a></div>
                <div class="clear"></div>
            </div>
    ...
    <script type="text/javascript" src="./js/fundPublishInvestAuditing.js"></script>
</body>
</html>
