...
<script type="text/template" id="queboxTpl">
    ...
    <div class="form_item">
        <span><i>* </i> 名称：</span>
        <input type="text" name="couponName" value="{{:couponName}}" id="couponName" placeholder="请输入名称..." autocomplete="off">
    </div>
    ...
    <div class="form_item">
        <span><i>* </i> 最小投资额：</span>
        <input type="number" name="minInvestAccount" value="{{:minInvestAccount}}" placeholder="请输入最小投资额..." id="minInvestAccount" autocomplete="off">
        <small>元</small>
    </div>

    <div class="form_item">
        <span><i>* </i> 使用期限：</span>
        <input type="checkbox" name="" value="" class="checkbox" {{if deadline != "0"}}checked{{/if}}>发放日起
        <input type="number" name="deadline" value="{{:deadline}}" class="m_time" id="deadline" autocomplete="off" min="0">天内
    </div>

    <div class="form_item">
        <span></span>
        <input type="checkbox" name="" value="" class="checkbox" {{if expiryDateCN != ""}}checked{{/if}}>截止时间
        <input type="text" name="expiryDate" value="{{:expiryDateCN}}" class="end_time" id="expriyDate" autocomplete="off" readonly>
    </div>
</script>
</head>
<body>
    <div class="text_box add_account_form box">
        <form:form action="../rest/backadmin/coupon/edit" method="post" id="submit">
            <p class="text_title">编辑优惠券</p>
    ...
    <script type="text/javascript" src="./js/cardListEdit.js" ></script>
</body>
</html>
