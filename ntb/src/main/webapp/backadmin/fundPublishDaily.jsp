	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location">
					<div class="locationLeft"><a href="fundPublishList.jsp">活期理财发布管理</a><span>></span><a class="current">每日净值</a></div>
				</div>
				<div class="clear"></div>
				<div class="main-contain">
					...
					<div class="trend">
						<p class="chart-title"><span id="chart-title">近一年</span>净值走势</p>
					...
					<div class="list-content">
						<table class="table table-bordered table-hover text-center">
							<tr><th width="35%" class="text-center">日期</th><th width="35%" class="text-center">净值</th><th width="30%" class="text-center">操作</th></tr>
		...
		<script type="text/javascript" src="./js/fundPublishDaily.js" ></script>
	</body>
</html>
