	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location"><a href="./fundPublishList.jsp">活期理财发布管理</a><span>></span><a class="current" id="titlename"></a></div>
				<form:form id="formsubmit" role="form" method="post">
        ...
        <script type="text/javascript" src="./js/fundPublishEdit.js"></script>
	</body>
</html>
