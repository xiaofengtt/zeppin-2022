...
<html>
	<head>
		...
		<script id="DataTpl" type="text/template">
			...
			<div class="btnGroup text-center">
				<a class="btn sureBtn btn-edit" href="financeOperatorEdit.jsp?uuid={{:uuid}}">修改</a>
	...
	<body>
		<div class="layerOpen">
			<p class="text-left title">财务用户详情</p>
			<div class="contents">
				<div id="DataCnt"></div>
				<div class="clear"></div>
			</div>
		...
		<script type="text/javascript" src="js/financeOperatorDetail.js" ></script>
	</body>
</html>