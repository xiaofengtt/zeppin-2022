...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="./advertList.jsp">广告内容管理</a><span>></span><a class="current">详情</a></div>
                <div class="clear"></div>
            </div>
            <div class="main-contain pt-13 pl-14 pr-16">
                <div class="text_box add_account_form">
                    <p class="text_title" style="margin-bottom:20px;">添加广告内容</p>
                    <form:form class="" action="../rest/backadmin/advert/edit" method="post" id="sub">
    ...
    <script src="./js/advertEdit.js"></script>
</body>
</html>
