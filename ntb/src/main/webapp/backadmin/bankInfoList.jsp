	...
	<head>
		...
		<script id="queboxTpl" type="text/template">
			<tr>
				...
				<td><span>{{:singleLimit}}</span></td>
				<td><span>{{:dailyLimit}}</span></td>
			...
			<div class="contain-right">
				...
				<div class="main-contain">
					<table class="table table-hover text-center table-striped tableList PFSCR">
						<thead>
							<tr>
								<th class="nameTh" width="21.4368%">名称</th>
								<th class="text-center" width="12.031%">单笔限额</th>
								<th class="text-center" width="12.031%">每日限额</th>
								<th class="text-center logoTh" width="15.031%">LOGO</th>
								<th class="text-center" width="10.5526%">状态</th>
