...
<script type="text/template" id="queboxTpl">
    <div class="product_item">
        <table class="product_head" cellspacing="0" cellpadding="0">
            <tr class="tr_bg_blue">
                <td width="7%">
                    <span class="product_tip {{if type == 'edit'}}bg_black{{else}}bg_green{{/if}}">结算还款</span>
                </td>
                <td width="80%" class="product_name color_blue"><a href="./repaymentAuditingMsgCheck.jsp?uuid={{:uuid}}&puuid={{:bankFinancialProductPublish}}">&ensp;{{:bankFinancialProductPublishName}}</a></td>
                <td width="20%">
                    {{if status == "checked"}}
                        <a href="./repaymentAuditingMsgCheck.jsp?uuid={{:uuid}}&puuid={{:bankFinancialProductPublish}}" class="color_gray">查看</a>
                    {{else status == "unpassed"}}
                        <a href="./repaymentAuditingMsgCheck.jsp?uuid={{:uuid}}&puuid={{:bankFinancialProductPublish}}" class="color_gray">查看</a>
                    {{else status == 'unchecked'}}
                        <a href="./repaymentAuditingMsgCheck.jsp?uuid={{:uuid}}&puuid={{:bankFinancialProductPublish}}">审核</a>
                        <!-- <div class="btn-group">
...
<body>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            <div class="location">
                <div class="locationLeft"><a href="">财务管理</a><span>></span><a href="./auditingItem.jsp">待审批事项</a><span>></span><a class="current">产品结算还款待审核事项</a></div>
                <div class="clear"></div>
            </div>
    ...
    <script type="text/javascript" src="./js/repaymentAuditingCheck.js"></script>
</body>
</html>
