	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location"><a href="fundPublishAuditingCheck.jsp">活期理财信息审核</a><span>></span><a class="current" id="titlename"></a></div>
						...
						<div class="content-item">
							...
							<div class="content-item-info">
								...
								<div class="form-group col-md-12">
									...
									<div class="content-items">
                                        <span id="gps"></span>
                                        <span class="editSpan" id="gp"></span>
									</div>
									<div class="clear"></div>
								</div>
								<div class="form-group col-md-12">
        ...
        <script type="text/javascript" src="./js/fundPublishAuditingMsgCheck.js"></script>
	</body>
</html>
