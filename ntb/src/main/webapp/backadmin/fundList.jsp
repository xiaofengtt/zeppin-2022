			...
			<div class="list-item">
				<div class="list-item-hd">
					<table>
						<tr height="37px">
							<td width="70%">
								<a class="fundName" href="./fundEdit.jsp?uuid={{:uuid}}"><span>【{{:gpName}}】({{:name}} {{:scode}})</span></a>
							</td>
							<td width="30%" class="text-right">
								<a class="btn" href="./fundEdit.jsp?uuid={{:uuid}}">修改</a>
							</td>
						</tr>
					</table>
				</div>
	...
	<body>
		...
		<div class="contain">
			...
			<div class="contain-right">
				<div class="location"><div class="locationLeft"><a class="current">活期理财信息管理</a></div><a class="btn-add add addNew" href="../backadmin/fundAdd.jsp" style="margin-top:0px;">+&ensp;添加活期理财</a><div class="clear"></div></div>
