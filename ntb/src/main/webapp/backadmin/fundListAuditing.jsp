				...
				<div class="list-operate-hd">
					<table>
						<tr height="40px">
							...
							<td width="80%">
								{{if type=='netvalue'}}
									<span><a href="./fundListAuditingDetail.jsp?uuid={{:uuid}}">【{{:fundName}}】 ({{:scode}})</a></span>
								{{else}}
									<span><a href="./fundListAuditingDetail.jsp?uuid={{:uuid}}">【{{:fundName}}】 ({{:scode}})</a></span>
								{{/if}}
							</td>
							<td width="20%" class="text-center operate">
								{{if status=='checked'}}
									{{if type=='netvalue'}}
										<a href="./fundListAuditingDetail.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
									{{else}}
										<a href="./fundListAuditingDetail.jsp?uuid={{:uuid}}" class="color_gray">查看</a>
									{{/if}}
								...
								{{else status=='draft'}}
									...
									{{if type!='netvalue'}}
										<a href="./fundListAuditingMsg.jsp?uuid={{:uuid}}">修改</a>
									{{/if}}
...
<!-- 					</div> -->
        ...
        <script type="text/javascript" src="./js/fundListAuditing.js" ></script>
	</body>
</html>
