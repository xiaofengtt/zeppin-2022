...
<%--左侧栏目列表模板--%>
<script type="text/template" id="columnTpl">
    <div class="level_1">
        app首页
        <ul data-item="app">
            <li>新手专享</li>
    ...
    <div class="contain">
        ...
        <div class="contain-right">
            ...
            <div class="main-contain pt-13 pl-14 pr-16">
                ...
                <div class="right_box" data-name="app">
                    <div class="screening">
                        <nav>
                            <span>栏目：</span>
                            <span>App首页</span>
                        ...
                        <a href="./columnSelectProductList.jsp" id="add" class="add_account">发布到栏目</a>
                    ...
                    <table cellspacing="0" cellpadding="0" class="msg_table">
                        ...
                        <tbody id="queboxCnt">
                            <tr>
                                <td>1</td>
                                <td>【中国建设银行】利得盈第 45 期(ZH0102201706)</td>
                                <td class="color_red">5.00%</td>
                                <td>30天</td>
                                <td>未开始</td>
                                <td>
                                    <a href="javascript:void(0);" class="sorts" data-type="up" data-uuid="{{:uuid}}">上移</a>
                                    <a href="javascript:void(0);" class="sorts" data-type="down" data-uuid="{{:uuid}}">下移</a>
                                    <a href="javascript:void(0);" class="delete" data-uuid="{{:uuid}}">移出</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>

                    <div id="" data-name="app-page"></div>
                </div>
                ...
                <div class="right_box" data-name="banner">
                    <div class="screening">
                        <nav>
                            <span>栏目：</span>
                            <span>Banner</span>
                    ...
                    <div id="" data-name="banner-page"></div>
                </div>
...
<script src="./js/columnControl.js"></script>
