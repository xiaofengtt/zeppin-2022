...
function PDF_launch(ob, zzw, zzh, callback, titlestr) {
    ...
    var siteStr = "新疆国培";
    if (window.location.host.toLowerCase().indexOf("zeppin.cn") > -1) {
        siteStr = "";
    }
    if (titlestr) {
    ...
    PDF_c.innerHTML = '<div style="margin-top:2px;float:left; padding-left:8px;"><a href="http://www.zeppin.cn/" target="_blank" style="font-size:12px; color:#555;font-weight:bold;text-decoration:none;" id="hrefTitle">' + titlestr + '</a></div><div style="float:right; padding-right:8px;cursor:pointer; color:#666666;vertical-align:middle; margin-top:5px;" onclick="PDF_close();" ><table cellpadding="0" cellspacing="0"><tr><td style="font-size:16px;color:#ff5457"><b>×</b></td><td>关闭</td></tr></table></div>';
