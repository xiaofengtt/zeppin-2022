...
class ClassDetail extends Component {
    ...
    componentDidMount() {
        ...
        dispatch({ type: 'classDetail/getNewsDetail', payload: match.params }).then(()=>{
            const category = this.props.classDetail.newsDetail.category.indexOf(',')>-1?this.props.classDetail.newsDetail.category.substring(0,this.props.classDetail.newsDetail.category.indexOf(',')):this.props.classDetail.newsDetail.category
            dispatch({ type: 'classDetail/getNewsList',payload:{category:category,except:match.params.classId}}).then(()=>{
                Toast.hide();
