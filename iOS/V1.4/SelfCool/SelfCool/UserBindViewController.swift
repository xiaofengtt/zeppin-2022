...
class UserBindViewController: UIViewController , UITextFieldDelegate , HttpDataProtocol {
    ...
    override func viewDidAppear(animated: Bool) {
        MobClick.beginLogPageView("UserBind")
    }
    
    override func viewDidDisappear(animated: Bool) {
        MobClick.endLogPageView("UserBind")
    }
