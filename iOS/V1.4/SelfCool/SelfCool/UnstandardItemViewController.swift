...
class UnstandardItemViewController: UIViewController, UIScrollViewDelegate , UIAlertViewDelegate , HttpDataProtocol{
    ...
    override func viewDidAppear(animated: Bool) {
        MobClick.beginLogPageView("UnstandardItem")
    }
    
    override func viewDidDisappear(animated: Bool) {
        MobClick.endLogPageView("UnstandardItem")
    }
    ...
    func recieveDataResults(recieveType: String,dataDictionary: NSDictionary , inputParam : NSDictionary) {
        ...
        if recieveType == "unstandardMark"{
            if dataDictionary.objectForKey("Status") as! String == "success"{
                let data = dataDictionary.objectForKey("Records") as! NSDictionary
                let newProgress = data.objectForKey("progress") as! Double
                checkAchieve(selectSubject!.preparingProgress, newProgress: newProgress)
                selectSubject!.preparingProgress = newProgress
