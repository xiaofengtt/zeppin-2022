...
extension UnstandardItemViewController{
    ...
    func childAnalysisButton(sender : UIButton){
        ...
        let item = globalItemList[page].children![childPage-1]
        sender.hidden = true
        ...
        if item.answer.completeType == -1{
            ...
            let itemButton = itemListView!.viewWithTag(ItemViewTag.itemListButtonBase() + page + childPage * ItemViewTag.groupViewTagBase()) as! UIButton
