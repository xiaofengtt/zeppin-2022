...
class TeamDetailModel : NSObject{
    var uuid: String
    var category: String
    ...
    var arrayList: [Array<NSDictionary>]
    var isConcren: Bool
    var concren: String
