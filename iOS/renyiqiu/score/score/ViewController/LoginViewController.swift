...
class LoginViewController: UIViewController, UITextFieldDelegate {
    ...
    let submitUncheckedColor = UIColor.mainRed().withAlphaComponent(0.2)
    var kapCode: String = ""
    ...
    func createHead() {
        ...
        backIconView.image = UIImage(named: "login_close")
    ...
    func createBody() {
        ...
        privacyLabel.textColor = UIColor.mainRed()
        ...
        agreementLabel.textColor = UIColor.mainRed()
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        if(codePhoneInput.text! != "" && codeKapInput.text != "" && codeCodeInput.text != ""){
            submitButton.backgroundColor = UIColor.mainRed()
