    ...
    init(frame: CGRect, timeline: SportsTimelineModel, isFinal: Bool) {
        ...
        if(timeline.type == "subs"){
            if(timeline.side == "home"){
                ...
                subsOutIcon.image = UIImage(named: "phoenix_subs_out")
                ...
                subsInIcon.image = UIImage(named: "phoenix_subs_in")
            ...
            if(timeline.side == "home"){
                ...
                if(timeline.type == "goal"){
                    timelineIcon.image = UIImage(named: "phoenix_goal")
                }else if(timeline.type == "yellow card"){
                    timelineIcon.image = UIImage(named: "phoenix_yellowcard")
                }else if(timeline.type == "red card"){
                    timelineIcon.image = UIImage(named: "phoenix_redcard")
                }
