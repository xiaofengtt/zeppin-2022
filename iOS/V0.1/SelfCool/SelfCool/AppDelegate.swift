...
class AppDelegate: UIResponder, UIApplicationDelegate ,HttpDataProtocol {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "www.Zeppin.cn.SelfCool" in the application's documents Application Support directory.
        ...
        if recieveType == "userVerify"{
            if data.length == 0{
                ...
                if status == "success" {
                    ...
                    var userDictionary = dictionary.objectForKey("Records") as! NSDictionary
