...
extension UnstandardItemViewController{
    ...
    func analysisButton(sender : UIButton){
        ...
        var grayBounceView = childScrollView.viewWithTag(ItemViewTag.grayBounceViewTag())!
        sender.hidden = true
        analysisView.hidden = false
        grayBounceView.hidden = false
        ...
        if childScrollView.contentSize.height <= childScrollView.frame.height{
            childScrollView.contentSize.height = childScrollView.frame.height + 1
        }
