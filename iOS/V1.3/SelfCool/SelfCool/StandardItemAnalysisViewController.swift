        ...
        for index in 0 ..< globalItemList.count {
            ...
            if item.isGroup{
                ...
                for i in 0 ..< item.children!.count{
                    var childView = UIView(frame: CGRectMake(progressWidth * CGFloat(progressIndex), 0, progressWidth, progressHeight))
                    ...
                    if progressIndex != 0{
                        var breakView = UIView(frame: CGRectMake(progressWidth * CGFloat(progressIndex), 0, 1, progressHeight))
                ...
                if failItemList.count != 0{
                    var failItemModel : ItemModel = ItemModel()
