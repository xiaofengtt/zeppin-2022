...
extension WrongItemViewController{
    func childMultipleChoiceWrongItem(item: ItemModel , parent: UIScrollView){
        ...
        //提交按钮
        var submitButton = UIButton(frame: CGRectMake(0, parent.frame.height - submitButtonHeight, screenWidth, submitButtonHeight))
        ...
        submitButton.backgroundColor = UIColor.buttonGray()
