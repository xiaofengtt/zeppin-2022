...
class SportsStandingViewController: UIViewController, CategoryScrollViewDelegate, UITableViewDataSource, UITableViewDelegate {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
    ...
    override func viewDidLoad() {
        ...
        let categoryView = SportsCategoryScrollView(frame: CGRect(x: 5 * screenScale, y: headView.frame.height - 40 * screenScale, width: screenWidth - 10 * screenScale, height: 40 * screenScale), dataList: league, selected: "")
        ...
        typeButtonView.layer.cornerRadius = typeButtonView.frame.height/2
        let standingButton = UIButton(frame: CGRect(x: 0, y: 0, width: typeButtonView.frame.width/2, height: typeButtonView.frame.height))
        standingButton.layer.cornerRadius = typeButtonView.frame.height/2
        standingButton.layer.masksToBounds = true
        standingButton.tag = SportsNumberController.StandingNumbers.typeStandingButton
        ...
        scoredButton.layer.cornerRadius = typeButtonView.frame.height/2
        scoredButton.layer.masksToBounds = true
        scoredButton.tag = SportsNumberController.StandingNumbers.typeScoredButton
    ...
    @objc func changeType(_ sender : UIButton){
        let standingButton = typeView.viewWithTag(SportsNumberController.StandingNumbers.typeStandingButton) as! UIButton
        let scoredButton = typeView.viewWithTag(SportsNumberController.StandingNumbers.typeScoredButton) as! UIButton
        if(sender.tag == SportsNumberController.StandingNumbers.typeStandingButton){
            standingButton.isSelected = true
