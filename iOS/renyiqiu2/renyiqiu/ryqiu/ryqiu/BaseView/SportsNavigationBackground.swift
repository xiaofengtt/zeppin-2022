...
class SportsNavigationBackground: UIView {
    ...
    init(navigationController: UINavigationController) {
        ...
        titleLabel.frame = CGRect(x: 70 * screenScale, y: abs(navigationFrame.origin.y) - navigationFrame.height + 5 * screenScale, width: self.frame.width - 140 * screenScale, height: 30 * screenScale)
        ...
        backIconView.image = UIImage(named: "image_back")
