import UIKit
import WebKit
class ShoppingMarketViewController: UIViewController, WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler {
    var headView: ShoppingNavigationView!
    let mainView: WKWebView = WKWebView()
    let paramString = "?keys=红包&title=红包超市"
