...
class SportsMatchStatView: UIView {
    ...
    init(frame: CGRect, stat: NSDictionary) {
        ...
        homeProgress.backgroundColor = UIColor(red: 59/255, green: 104/255, blue: 243/255, alpha: 1)
        ...
        awayProgress.backgroundColor = UIColor(red: 195/255, green: 204/255, blue: 231/255, alpha: 1)
