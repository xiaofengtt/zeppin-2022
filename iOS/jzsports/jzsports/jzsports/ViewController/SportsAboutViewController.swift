...
class SportsAboutViewController: UIViewController {
    ...
    func createBody() {
        ...
        logoImageView.image = UIImage(named: "image_logo")
        ...
        let attributedString = NSMutableAttributedString(string: "    九州体育是一款专注服务于足球迷的体育赛事及新闻资讯类APP，提供世界上超过100多个国家地区的足球赛事即时数据、比赛直播、赛事数据等信息，力争为广大球迷用户提供最全、最新的足球数据和新闻资讯。")
    ...
    func createTable(){
        ...
        contactText.text = "service@jiuzhoutiyu.cn"
