import Foundation
class SportsUtils{
    static func examinePhone(phone: String) -> Bool{
    ...
    static func getStandingColor(category: String, place: Int) -> UIColor{
        ...
        let redColor = UIColor(red: 247/255, green: 49/255, blue: 82/255, alpha: 1)
        let yellowColor = UIColor(red: 255/255, green: 165/255, blue: 68/255, alpha: 1)
        let greenColor = UIColor(red: 59/255, green: 104/255, blue: 243/255, alpha: 1)
