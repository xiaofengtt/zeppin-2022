...
public class BankCardTextWatcher implements TextWatcher {
    ...
    private BankCardTextListener bankCardTextListener;
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (bankCardTextListener != null) {
            bankCardTextListener.afterTextChanged(s);
        }
    }

    public interface BankCardTextListener {
        public void afterTextChanged(Editable s);
    }

    public void setBankCardTextListener(BankCardTextListener bankCardTextListener) {
        this.bankCardTextListener = bankCardTextListener;
    }
}
