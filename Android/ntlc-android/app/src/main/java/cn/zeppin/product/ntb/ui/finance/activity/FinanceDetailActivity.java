...
import cn.zeppin.product.ntb.ui.finance.model.FinanceDetailModel;
import cn.zeppin.product.ntb.ui.finance.presenter.FinanceDetailPresenter;
 ...
 * 持仓详情
 */
public class FinanceDetailActivity extends BaseActivity<FinanceDetailPresenter, FinanceDetailModel> implements FinanceDetailContract.View, View.OnClickListener {
    ...
    private void initData() {
        ...
        if (NetWorkUtils.isNetConnected(this)) {
            mPresenter.getFinanceInfoPresenter(AppApplication.getInstance().getUuid(), finance_uuid);
        } else {
    ...
    @Override
    public void returnFinanceInfo(FinanceDetail data) {
        if (data != null) {
            this.data = data;
