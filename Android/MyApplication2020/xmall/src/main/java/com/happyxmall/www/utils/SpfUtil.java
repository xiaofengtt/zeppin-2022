...
public class SpfUtil {
    ...
    public static final String  KEY_GET_USER = "front_login_data";
    public static final String  KEY_GET_DATA = "front_data";
    public static final String  KEY_GET_DEVICE = "device_token";
    public static final String  KEY_GET_DEVICE_UNIQUE = "device_token_unique";
    public static final String  KEY_GET_IS_NOTICE_SHOW = "is_notice_show";
