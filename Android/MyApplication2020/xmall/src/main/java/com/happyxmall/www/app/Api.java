...
import com.happyxmall.www.utils.NetWorkUtils;
...
/*
   1. noCache 不使用缓存，全部走网络
     ...
     * @return
     */
    public static Observable<ResultData<String>> getTime() {
        return Api.getDefault().getTime().map(new Function<ResultData<String>, ResultData<String>>() {
            @Override
            public ResultData<String> apply(ResultData<String> resultData2) {
                return resultData2;
            }
        }).compose(RxSchedulers.<ResultData<String>>applySchedulers());
    }
}