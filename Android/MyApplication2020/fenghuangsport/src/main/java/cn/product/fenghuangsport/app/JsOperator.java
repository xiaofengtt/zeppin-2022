package cn.product.fenghuangsport.app;
...
import cn.product.fenghuangsport.bean.ApiConstants;
import cn.product.fenghuangsport.bean.FrontUser;
import cn.product.fenghuangsport.utils.ShareUtil;
import cn.product.fenghuangsport.utils.SpfUtil;
import cn.product.fenghuangsport.utils.ToastUtil;

import static cn.product.fenghuangsport.utils.ShareUtil.chinesizationByPlatform;
import static cn.product.fenghuangsport.utils.ToastUitl.showToastCenter;
...
//    }
    ...
    public void share(String param) {
        ...
        String coverUrl = params[2];
        String content = params[3];
        String shareUrl = ApiConstants.shareUrl+"?uuid="+uuid;
        System.out.println(uuid + "---"+title+"---"+coverUrl+"-----"+content);
        new ShareUtil((Activity) context).shareMenu(shareUrl,title,coverUrl, content, new UMShareListener() {
            @Override
            ...
            public void onCancel(SHARE_MEDIA share_media) {
                ToastUtil.showToastCenter("已取消分享");
            }
        });
    }
