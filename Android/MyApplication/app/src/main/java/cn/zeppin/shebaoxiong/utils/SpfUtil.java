package cn.zeppin.shebaoxiong.utils;
...
public class SpfUtil {
     ...
     */
    public static final String FILE_NAME = "shbx_data";
    public static final String  KEY_GET = "shbx_login";
    ...
    private static class SharedPreferencesCompat {
         ...
         * @throws Exception
         */
        public static void saveUser(Context context,String key,ShbxUser user) throws Exception {
         ...
         * @return
         */
        public static ShbxUser getUser(Context context,String key) {
            SharedPreferences sharedPreferences=context.getSharedPreferences(FILE_NAME,context.MODE_PRIVATE);
