...
public class CommonTools {
	...
	/**
	 * 判断密码 长度在6~18之间，只能包含字符、数字和下划线。
	 */
	public static boolean isPassword(String password) {
		Pattern pattern = Pattern.compile("^\\w{6,17}$");
	...
	// 关闭activity 返回resultCode
	public static void finishActivity(Activity from, int resultCode) {
		from.setResult(resultCode);
		from.finish();
		int enterAnim = R.anim.left_in;
		int exitAnim = R.anim.right_out;
		from.overridePendingTransition(enterAnim, exitAnim);
