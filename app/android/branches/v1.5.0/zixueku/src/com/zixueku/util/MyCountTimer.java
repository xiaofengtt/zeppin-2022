...
public class MyCountTimer extends CountDownTimer {
	public static final int TIME_COUNT = 31000;// 时间防止从119s开始显示（以倒计时120s为例子）
	...
	public void onFinish() {
		...
		btn.setText("发送验证码");
		btn.setBackgroundResource(R.drawable.btn_user_select);
		btn.setEnabled(true);
	}
	...
	public void onTick(long millisUntilFinished) {
		...
		btn.setBackgroundResource(R.drawable.btn_ca_background);
		btn.setText("重发验证码" + "(" + millisUntilFinished / 1000 + ")");
	}
}