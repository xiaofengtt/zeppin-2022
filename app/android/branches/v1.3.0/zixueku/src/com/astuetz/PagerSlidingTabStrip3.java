...
public class PagerSlidingTabStrip3 extends HorizontalScrollView implements IPagerSlidingTabStrip{
	...
	private int underlineColor = 0x1A000000; // 总下划线颜色
	...
	public PagerSlidingTabStrip3(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PagerSlidingTabStrip3(Context context, AttributeSet attrs, int defStyle) {
	...
	private void addIconTab(final int position, int resId) {
		...
		if (exercise != null && !item.isRight()) {
			...
			tab.setImageResource(R.color.green);
			tab.setTag(R.color.green);
		}
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
			...
			if (exercise.getItems().get(position).getModelType() == 4) {
				currentPosition = exercise.getItems().get(position).getChildren().get(AnalysisActivity.subViewPagers.get(position).getCurrentItem()).getIndex();
			} else {
