...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabTextColor = 0xFF666666; // 这个是标签卡上文字的颜色
	private int selectedTabTextColor = 0xeeeeeee;// 选中标签卡上文字的颜色
	...
	protected void onDraw(Canvas canvas) {
		...
		// 指示器为三角形
		/*
		 * Path path1 = new Path(); path1.moveTo(x - 9, height); path1.lineTo(x,
		 * height - indicatorHeight); path1.lineTo(x + 9, height);
