...
public class SuperAnalysisCombinationCardFragment extends LazyFragment implements OnTouchListener, OnDragListener {
	...
	public static SuperAnalysisCombinationCardFragment newInstance(Exercise exercise, int position, ViewPager viewPager,PagerSlidingTabStrip3 tab) {
		SuperAnalysisCombinationCardFragment f = new SuperAnalysisCombinationCardFragment(viewPager,tab);
		Bundle b = new Bundle();
	...
	public SuperAnalysisCombinationCardFragment(ViewPager parentViewPager,PagerSlidingTabStrip3 tab) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		pagerAdapter = new AnalysisCombinationPagerAdapter(getChildFragmentManager(), parentPosition, exercise.getItems().get(parentPosition).getChildren(),
