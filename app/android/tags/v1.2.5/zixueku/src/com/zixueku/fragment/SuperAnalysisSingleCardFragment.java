...
public class SuperAnalysisSingleCardFragment extends Fragment {
	...
	public SuperAnalysisSingleCardFragment(Exercise exercise, int position, ViewPager viewPager) {
	...
	public static SuperAnalysisSingleCardFragment newInstance(Exercise exercise, int position, ViewPager viewPager) {
		SuperAnalysisSingleCardFragment f = new SuperAnalysisSingleCardFragment(exercise, position, viewPager);
		// Bundle b = new Bundle();
