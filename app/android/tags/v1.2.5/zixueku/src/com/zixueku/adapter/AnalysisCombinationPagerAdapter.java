...
import com.zixueku.fragment.SuperAnalysisCombinationSingleCardFragment;
...
public class AnalysisCombinationPagerAdapter extends FragmentStatePagerAdapter {
	...
	public AnalysisCombinationPagerAdapter(FragmentManager fm, int parentPosition, List<Item> children, ViewPager parentViewPager, ViewPager subViewPager) {
		super(fm);
	...
	public Fragment getItem(int subPosition) {
		...
		// 单选题
		case 1:
			fragment = SuperAnalysisCombinationSingleCardFragment.newInstance(parentPosition, subPosition, parentViewPager);
			break;
		default:
