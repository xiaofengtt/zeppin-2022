...
//                    Logger.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        int padding = CommonTools.dip2px(context, 10);
        int topPadding = CommonTools.dip2px(context, 5);
        tv.setPadding(padding, topPadding, padding, topPadding);
        if (0 == itemHeight) {
            itemHeight = CommonTools.getViewMeasuredHeight(tv);
...
//            position = divided + offset + 1;
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            ...
            paint.setStrokeWidth(CommonTools.dip2px(context, 1f));
        }
