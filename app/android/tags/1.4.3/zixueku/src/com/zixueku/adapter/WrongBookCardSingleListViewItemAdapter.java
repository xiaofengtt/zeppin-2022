 ...
 */
public class WrongBookCardSingleListViewItemAdapter extends ArrayAdapter<Option> {
	...
	public WrongBookCardSingleListViewItemAdapter(Context context, Item item) {
