...
public class MainActivity extends AbstractAsyncActivity {
	...
	protected void setListener() {
		...
		/*
		 * actionBarAddCourse.setOnClickListener(new OnClickListener() {
		 * 
		 * @Override public void onClick(View v) { int categoryId = 50; //
		 * 下面是你的其他事务逻辑 Intent intent = new Intent(MainActivity.this,
		 * AddSujectActivity.class); intent.putExtra("categoryId", categoryId);
	...
	protected void processLogic() {
		...
		getDataFromServer(request, new ServerDataCallback<ActionResult<ArrayList<PrepareExam>>>() {
			@Override
			public void processData(ActionResult<ArrayList<PrepareExam>> paramObject, boolean paramBoolean) {
				...
				/*
				 * else { noFouceLayout.setVisibility(View.VISIBLE); int
				 * categoryId = 50; // 下面是你的其他事务逻辑 Intent intent = new
				 * Intent(MainActivity.this, AddSujectActivity.class);
		...
		prepareExamsList.setOnMenuItemClickListener(new OnMenuItemClickListener() {
			...
			public boolean onMenuItemClick(final int position, SwipeMenu menu, int index) {
				...
				case 0:
					...
					sendDataToServerNoProgressDialog(request, new ServerDataCallback<ActionResult<?>>() {
						@Override
