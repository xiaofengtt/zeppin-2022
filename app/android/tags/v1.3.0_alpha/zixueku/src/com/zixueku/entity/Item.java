...
public class Item implements Serializable, Cloneable {
	...
	public String toString() {
		return "Item [id=" + id + ", index=" + index + ", itemTypeId=" + itemTypeId + ", itemTypeName=" + itemTypeName + ", itemId=" + itemId + ", itemLevel="
				+ itemLevel + ", modelType=" + modelType + ", source=" + source + ", sourceTypeCN=" + sourceTypeCN + ", customerAnswer=" + customerAnswer
				+ ", analysis=" + analysis + ", isRight=" + isRight + ", data=" + data + ", children=" + children + ", testItemCorrectCount="
				+ testItemCorrectCount + ", testItemCount=" + testItemCount + ", testItemWrongCount=" + testItemWrongCount + ", isgroup=" + isgroup
				+ ", defaultScore=" + defaultScore + ", blankInx=" + blankInx + ", analysisIsRead=" + analysisIsRead + ", completeType=" + completeType + "]";
	}
