 ...
 */
public class SuperWrongBookCombinationCardFragment extends Fragment implements OnTouchListener, OnDragListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.wrongBook = ((App) (getActivity().getApplication())).getWrongBookInfo();
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		Spanned htmlSpan = Html.fromHtml(wrongBook.getWrongItemList().get(parentPosition).getData().getStem(), p, null);
