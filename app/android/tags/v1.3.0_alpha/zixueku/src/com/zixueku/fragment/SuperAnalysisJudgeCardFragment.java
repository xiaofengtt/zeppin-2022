 ...
 */
public class SuperAnalysisJudgeCardFragment extends Fragment {
	...
	public static SuperAnalysisJudgeCardFragment newInstance(int... position) {
		SuperAnalysisJudgeCardFragment f = new SuperAnalysisJudgeCardFragment();
		Bundle b = new Bundle();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listViewAdapter = new AnalysisCardJudgeItemAdapter(this.getActivity(), item);
