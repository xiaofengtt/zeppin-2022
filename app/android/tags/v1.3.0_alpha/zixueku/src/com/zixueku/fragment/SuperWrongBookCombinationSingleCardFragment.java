 ...
 * 
 */
public class SuperWrongBookCombinationSingleCardFragment extends Fragment implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * this.position = getArguments().getInt(ARG_POSITION); this.subPosition
		 * = getArguments().getInt(ARG_SUB_POSITION);
		 */
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if (item.isAnalysisIsRead()) {
			...
			listView.setOnItemClickListener(new WrongBookSingleItemListViewOnItemClickListener(context, wrongBookInfo, analysis, position, subPosition));
			analysis.setOnExpandStateChangeListener(new WrongBookAnalysisOnExpandStateChangeListener(context, listView, wrongBookInfo, position, subPosition));
		}
	...
	private void deleteItem() {
		BusinessCommonMethod.deleteCombinationItemFromWrongBook(context, wrongBookInfo, position, subPosition, viewPager, subViewPager, user);
	}
