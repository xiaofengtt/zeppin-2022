 ...
 */
public class SuperAnalysisChoiceCardFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//exercise = ((App) getActivity().getApplication()).getExercise();
		...
		if (item.getModelType() == 1) {
			listViewAdapter = new AnalysisCardSingleItemAdapter(this.getActivity(), item);
		} else {
			listViewAdapter = new AnalysisCardMultipleItemAdapter(this.getActivity(), item);
		}
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		content = (TextView) contactsLayout.findViewById(R.id.choice_content);
		...
		ImageGetter imageGetter2 = new HtmlRemoteImageGetter(analysis, this.getActivity(), null);
		Spanned htmlSpan2 = Html.fromHtml(item.getAnalysis(), imageGetter2, null);
