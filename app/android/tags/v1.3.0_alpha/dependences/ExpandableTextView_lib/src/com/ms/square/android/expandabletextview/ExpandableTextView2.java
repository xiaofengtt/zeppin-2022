...
public class ExpandableTextView2 extends LinearLayout implements View.OnClickListener {
	...
	public void onClick(View view) {
		...
		if (mCollapsed) {
			...
			this.outSideView.setBackgroundColor(Color.parseColor("#f7f7f7"));
		}
		...
		animation.setAnimationListener(new Animation.AnimationListener() {
			...
			public void onAnimationStart(Animation animation) {
				// notify the listener
				if (mListener != null) {
					mListener.onExpandStateStart(mTv, !mCollapsed);
				}
	...
	private void findViews() {
		...
		mTvTitle = (TextView) findViewById(R.id.analysis_title);
	}
	...
	public interface OnExpandStateChangeListener {
		...
		void onExpandStateStart(TextView textView, boolean isExpanded);
		/**
