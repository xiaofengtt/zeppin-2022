	...
	<div class="wrapper">
		...
		<div class="fliter">
			<form action="report_huizong.action" method="get">
				<fieldset>
					<div class="group">
						<span>省份： <select name="province" style="width:260px">
						...
						</span> <span>项目名称： <select name="project" style="width:260px">
					...
					<div class="section clearfix" style="border:0;padding:0;">
						<h2 class="clearfix"
							...
							<span class="fl">此问卷总体满意度： <s:property
									value="avgCountScore" />
							</span> <span><a href="report_huizongDoExcel.action">下载excel</a></span>
							<span><a href="report_huizongDoAllExcel.action?pid=<s:property value="#parameters.pid"/>">详细excel</a></span>
						</h2>
