...
//	
//	
	$.post("trainee_adminTraineeNumForSFLB.action",{subject:subjects,parent:parents}, function(r) {
...
function importTrainee() {	
	$("#layerDiv").css("display","block");
	$.post("trainee_importTraineeNumForSFLB.action",{subject:subjects,parent:parents}, function(r) {
		$("#layerDiv").css("display","none");
