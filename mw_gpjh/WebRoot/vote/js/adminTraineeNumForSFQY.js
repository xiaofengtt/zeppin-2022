...
//	
//	
	$.post("trainee_adminTraineeNumForSFQY.action",{subject:subjects,parent:parents}, function(r) {
...
function importTrainee() {	
	$("#layerDiv").css("display","block");
	$.post("trainee_importTraineeNumForSFQY",{subject:subjects,parent:parents}, function(r) {
		$("#layerDiv").css("display","none");
