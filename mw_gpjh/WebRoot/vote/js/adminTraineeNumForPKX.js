...
function initGrid() {	
	...
	$.post("trainee_adminTraineeNumForMWPKX.action",{subject:subjects,parent:parents}, function(r) {
...
function importTrainee() {	
	$("#layerDiv").css("display","block");
	$.post("trainee_importTraineeNumForPKX.action",{subject:subjects,parent:parents}, function(r) {
		$("#layerDiv").css("display","none");
