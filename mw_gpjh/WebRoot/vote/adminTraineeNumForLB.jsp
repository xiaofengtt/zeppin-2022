...
body{position: relative;}
	...
	<body onclick="closeSelect()">
		<div class="container">
			<h1>中西部项目学校类别维度人数统计 <span><a style="width: auto;" href="adminTraineeNumForSFLB.jsp" class="linka">示范性项目学校类别维度人数统计</a></span></h1>
			<form action="trainee_importTraineeNumForMWLB.action" method="post">
...
<!-- 					<div id="pager2"></div> -->
		...
		<script src="js/adminTraineeNumForLB.js" type="text/javascript"></script>
	</body>
</html>