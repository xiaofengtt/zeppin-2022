...
<script src="js/adminChildManager.js" type="text/javascript"></script>
			...
			$.get('project_getParents.action', function(r) {
				if (r != false) {
					...
					for (var i = 0; i < r.length; i++) {
						var ht = '<option value="'+r[i].id+'">' + r[i].name
								+ '</option>';
						opht += ht;
					}
	...
	<div class="container">
		<div class="content">
			...
			<div id="addDiv" style="display:none;">
				<div>
					<label>省份*:</label> <select id="addProvince" style="width:333px;"></select>
				</div>
				<div>
