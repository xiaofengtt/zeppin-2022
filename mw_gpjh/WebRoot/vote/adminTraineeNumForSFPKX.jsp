...
body{position: relative;}
	...
	<body onclick="closeSelect()">
		<div class="container">
			<h1>示范性项目特困地区/贫困县人数统计<span><a style="width: auto;" href="adminTraineeNumForPKX.jsp" class="linka">中西部项目特困地区/贫困县人数统计</a></span></h1>
			<form action="trainee_importTraineeNumForSFPKX.action" method="post">
			...
			<div class="content">
				<div class="list">
					<table>
						<tr class='tr1'><th>省份</th><th>总人数</th><th class='red'>集中连片特困地区县人数</th><th>占比</th><th class='red'>国家级贫困县人数</th><th>占比</th><th class='red'>特困地区/贫困县合计人数</th><th>占比</th></tr>
...
<!-- 					<div id="pager2"></div> -->
		...
		<script src="js/adminTraineeNumForSFPKX.js" type="text/javascript"></script>
	</body>
</html>