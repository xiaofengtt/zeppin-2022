...
<style type="text/css">
	...
	<body onclick="closeSelect()">
		<div class="container">
			<h1>示范性项目学校类别维度人数统计<span><a style="width: auto;" href="adminTraineeNumForLB.jsp" class="linka">中西部项目学校类别维度人数统计</a></span></h1>
			<form action="trainee_importTraineeNumForSFLB.action" method="post">
			...
			<div class="content">
				<div class="list">
					<table>
						<tr class='tr1'><th>省份</th><th>总人数</th><th class='red'>幼儿园人数</th><th>占比</th><th class='red'>小学人数</th><th>占比</th><th class='red'>初中人数</th><th>占比</th><th class='red'>高中人数</th><th>占比</th><th class='red'>完全高中人数</th><th>占比</th><th class='red'>九年一贯制学校人数</th><th>占比</th><th class='red'>十二年一贯制学校人数</th><th>占比</th><th class='red'>教学点人数</th><th>占比</th><th class='red'>其他人数</th><th>占比</th></tr>
...
<!-- 					<div id="pager2"></div> -->
		...
		<script src="js/adminTraineeNumForSFLB.js" type="text/javascript"></script>
	</body>
</html>