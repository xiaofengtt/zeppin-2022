...
body{position: relative;}
	...
	<body onclick="closeSelect()">
		<div class="container">
			<h1>示范性项目学校所在区域维度人数统计<span><a style="width: auto;" href="adminTraineeNumForQY.jsp" class="linka">中西部项目学校所在区域维度人数统计</a></span></h1>
			<form action="trainee_importTraineeNumForSFQY.action" method="post">
			...
			<div class="content">
				<div class="list">
					<table>
						<tr class='tr1'><th>省份</th><th>总人数</th><th class='red'>城市人数</th><th>占比</th><th class='red'>县城人数</th><th>占比</th><th class='red'>镇区（不含县城）人数</th><th>占比</th><th class='red'>乡人数</th><th>占比</th><th class='red'>村人数</th><th>占比</th><th class='red'>团场人数</th><th>占比</th></tr>
...
<!-- 					<div id="pager2"></div> -->
		...
		<script src="js/adminTraineeNumForSFQY.js" type="text/javascript"></script>
	</body>
</html>