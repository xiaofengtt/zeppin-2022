...
body{position: relative;}
	...
	<body onclick="closeSelect()">
		<div class="container">
			<h1>中西部项目特困地区/贫困县人数统计 <span><a style="width: auto;" href="adminTraineeNumForSFPKX.jsp" class="linka">示范性项目特困地区/贫困县人数统计</a></span></h1>
			<form action="trainee_importTraineeNumForPKX.action" method="post">
...
<!-- 					<div id="pager2"></div> -->
		...
		<script src="js/adminTraineeNumForPKX.js" type="text/javascript"></script>
	</body>
</html>