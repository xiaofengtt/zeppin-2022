...
body{position: relative;}
	...
	<body onclick="closeSelect()">
		<div class="container">
			<h1>中西部和幼师国培项目人数统计 <span><a style="width: auto;" href="adminTraineeNumForSF.jsp" class="linka">示范性项目人数统计</a></span></h1>
			<form action="trainee_adminTraineeNumForMW.action" method="post">
			...
			<div class="content">
				<div class="list">
					<table>
						<tr class="tr1"><th>省份</th><th>计划人数</th><th>参训人数</th><th>结业人数</th></tr>
