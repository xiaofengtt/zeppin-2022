...
body{position: relative;}
	...
	<body onclick="closeSelect()">
		<div class="container">
			<h1>中西部项目学校所在区域维度人数统计 <span><a style="width: auto;" href="adminTraineeNumForSFQY.jsp" class="linka">示范性项目学校所在区域维度人数统计</a></span></h1>
			<form action="trainee_importTraineeNumForMWQY.action" method="post">
...
<!-- 					<div id="pager2"></div> -->
		...
		<script src="js/adminTraineeNumForQY.js" type="text/javascript"></script>
	</body>
</html>