            ...
            <div class="tabQTypet" style="background: 0px; border: 0px; height: 40px;">
                <ul id="tQType">
					...
					<li><a href="javascript:createFreQ(&#39;question&#39;,5);" onmouseout="sb_setmenunav('divText', false,this)" onmouseover="sb_setmenunav('divText', true,this)"  style="text-decoration: none;
                        padding: 0;" class=""><span class="design-icon design-text"></span><span class="spanQTxt">填空题</span><span class="bordCss bordBottomCssN"></span></a></li>
					<li><a><input type='checkbox' id='techVote'/>排名</a></li>
...
document.cookie = name + "="+ escape (value) + ";expires=" + exp.toGMTString();
        ...
        //操作排名题
        var techVote= document.getElementById('techVote');
        
        techVote.onclick=function(){
        if(techVote.checked){
        // alert('cc');
         setCookie("isShowTech","true");
         }
         else
         {
            setCookie("isShowTech","false");
         }
