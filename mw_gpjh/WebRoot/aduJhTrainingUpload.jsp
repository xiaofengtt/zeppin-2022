...
<body>
	...
	<form action="trainee_trainJHUploadFile.action" method="post"
		...
		<table>
			...
			<tr>
				<td>学员EXCEL模板:</td>
				<td><input type="file" name="fileupload"  accept="application/msexcel" /></td>
				<td><a href="/mw_gpjh/中西部学员导入模板.xls" >模板下载</a></td>
			</tr>
			<tr>
				<td></td>
