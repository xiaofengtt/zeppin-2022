        ...
        function y(n, r, i, s, o, u) {
            ...
            var l = {
                ...
                beforeSend: function(e, n) {
                	...
                	$('#i1').html("上传速度:0KB/s");
                	$('#i2').html("上传进度:0MB/"+sizem.toFixed(2)+"MB");
                	$('#i3').html("剩余时间:00:00:00");
                    i.progressDiv.show();
                    i.cancel.hide();
                    i.done.hide();
                    if (r.showAbort) {
                ...
                uploadProgress: function(e, t, n, s) {
                	var tlc = (new Date()).getTime();
	                	...
	                	var sizem = s1/1024/1024;
	                	var fc = t/1024/1024; 
	                	$('#i2').html("上传进度:"+fc.toFixed(2)+"MB/"+sizem.toFixed(2)+"MB");
	                	var sc = t - sl;
	                	var vc = sc / (tlc - tl) * 1000;
	                	var vfc = vc / 1024;
	                	$('#i1').html("上传速度:" + vfc.toFixed(2) + "KB/s");
	                	var tc = (n - t)/ vc;
	                	$('#i3').html("剩余时间:"+toTime(tc.toFixed(0)));
                	}
                	sl = t;
                	tl = tlc;
                ...
                success: function(t, u, a) {
                	var sizem = s1/1024/1024;
                	$('#i1').html("上传速度:0KB/s");
                	$('#i2').html("上传进度:"+sizem.toFixed(2)+"MB/"+sizem.toFixed(2)+"MB");
                	$('#i3').html("剩余时间:00:00:00");
