...
public abstract class BaseDAO <T, PK extends Serializable> {
	 ...
	 * @return List<Entity>
	 */
	protected List<Entity> getBySQL(String sql, Class<?> resultClass) {
		// TODO Auto-generated method stub
	 ...
	 * @return List<Entity>
	 */
	protected List<Entity> getBySQL(String sql, Object[] objParas, Class<?> resultClass) {
		// TODO Auto-generated method stub
	...
	protected List<Object[]> getBySQL(String sql, final int offset, final int length) {
		// TODO Auto-generated method stub
		return this.getBySQL(sql, offset, length, (Object[]) null);
	}
	 ...
	 * @return List<Entity>
	 */
	protected List<Entity> getBySQL(String sql, final int offset, final int length, Class<?> resultClass) {
		// TODO Auto-generated method stub
		return this.getBySQL(sql, offset, length, null, resultClass);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected List<Entity> getBySQL(String sql, final int offset, final int length, Object[] objParas, Class<?> resultClass) {
		// TODO Auto-generated method stub
		Query query = getSession().createSQLQuery(sql);
		this.setParamValueTypes(query, objParas);
		if (offset >= 0 && length > 0){
