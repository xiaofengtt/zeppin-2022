...
//			总时长
			...
			for(var i=r.data.webVideoPoints.length-1;i>=0;i--){		
				...
				str+="<div class='swiper-slide'><a name='Show.html?id="+r.data.webVideoPoints[i].commodity+"&parentid="+id+"' onclick='aaa(this);' style='display:inline-block;width:100%;height:100%;'><img src='../"+r.data.webVideoPoints[i].showBannerURL+"'></a></div>";
