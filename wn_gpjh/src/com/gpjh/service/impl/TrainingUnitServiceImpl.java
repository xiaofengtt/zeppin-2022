...
public class TrainingUnitServiceImpl extends
		BaseServiceImpl<TrainingUnit, String> implements TrainingUnitService {
	...
	@Override
	public List<TrainingUnit> getListForPage(String hql, int pageId,
			int pageSize) {
		// TODO Auto-generated method stub
