			...
			<div class="ctt_bd">
				...
				<div class="section clearfix" style="border:0;padding:0;">
					<h2 style="color:#2084ca;margin-left:10px">
						...
						人次参与了此问卷;<a
							href="report_showAllAdvice.action?pid=<s:property value="#parameters.pid"/>&subject=<s:property value="#parameters.subject"/>&project=<s:property value="#parameters.project"/>&unit=<s:property value="#parameters.unit"/>">（查看所有意见）</a>
						<span>
					...
					<table class="table">
						...
						<tbody>
							...
							<s:iterator value="submits" id="submit">
								...
								<td><s:date name="#submit.creatTime"
								...
								<td><a
									href="report_detail.action?sub=<s:property value="id"/>&pid=<s:property value="#submit.paper.id"/>"
				...
				<div class="pagiation">
					...
					页 |<a
						href="report_summary.action?pid=<s:property value="#parameters.pid"/>&subject=<s:property value="#parameters.subject"/>&project=<s:property value="#parameters.project"/>&unit=<s:property value="#parameters.unit"/>&page=1"><首页</a>
					< <a
						href="report_summary.action?pid=<s:property value="#parameters.pid"/>&subject=<s:property value="#parameters.subject"/>&project=<s:property value="#parameters.project"/>&unit=<s:property value="#parameters.unit"/>&page=<s:property value="pageInfo.getPreviousPage()"/>">上一页</a>
					...
					<s:iterator value="pageInfo.pageList()" id="pa">
						...
						<s:else>
							<a
								href="report_summary.action?pid=<s:property value="#parameters.pid"/>&subject=<s:property value="#parameters.subject"/>&project=<s:property value="#parameters.project"/>&unit=<s:property value="#parameters.unit"/>&page=<s:property value="pa"/>"><s:property
									value="pa" /></a>
						</s:else>
					</s:iterator>

					<a
						href="report_summary.action?pid=<s:property value="#parameters.pid"/>&subject=<s:property value="#parameters.subject"/>&project=<s:property value="#parameters.project"/>&unit=<s:property value="#parameters.unit"/>&page=<s:property value="pageInfo.getNextPage()"/>">下一页</a>
					> <a
						href="report_summary.action?pid=<s:property value="#parameters.pid"/>&subject=<s:property value="#parameters.subject"/>&project=<s:property value="#parameters.project"/>&unit=<s:property value="#parameters.unit"/>&page=<s:property value="pageInfo.totalPage"/>">尾页</a>>|
				</div>
