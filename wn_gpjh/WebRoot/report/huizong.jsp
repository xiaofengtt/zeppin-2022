				...
				<div class="ctt_bd">
					...
					<div class="section clearfix" style="border:0;padding:0;">
						<h2 class="clearfix"
							...
							<span>
								<a
									href="report_huizongDoExcel.action?pid=<s:property value="paper.id" />">导出Excel</a>
							</span>
							<span>
								<a
									href="report_huizongDoAllExcel.action?pid=<s:property value="paper.id" />">详细导出Excel</a>
							</span>
						</h2>
