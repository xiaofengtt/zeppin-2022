...
function save_paper(c, T, F) {
    ...
    var f = "/wn_gpjh/paper_save.action?submitType=redesign&" + g + "&userguid=" + userGuid + "&validate_text=ys&t=" + (new Date()).valueOf() + "&sstate=" + encodeURIComponent(c);//接口
