...
public class PaperSectionEx {
	...
	private String name;
	private Short level;
	private List<PaperSectionEx> childSec = new LinkedList<PaperSectionEx>();
	...
	public List<PaperSectionEx> getChildSec() {
		return childSec;
	}

	public void setChildSec(List<PaperSectionEx> childSec) {
