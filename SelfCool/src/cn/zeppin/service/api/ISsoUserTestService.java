...
public interface ISsoUserTestService {
	 ...
	 * @return autoPaperMap
	 */
	public Map<String, Object> createAutoTest(Subject subject, SsoUser currentUser, List<Map<String, Object>> selectItems, String split ,String version);
	 ...
	 * @param ssoUserTest
	 * @param answers
	 * @return ssoUserTestItemList
	 */
	@SuppressWarnings("rawtypes")
	public List<SsoUserTestItem> saveSsoUserTest(SsoUserTest ssoUserTest,
			List<Map> answers);
