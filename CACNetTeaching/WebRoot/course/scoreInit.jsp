...
<script src="js/cScoreManage.js" type="text/javascript"></script>
<%String i = request.getParameter("id");%>
<div class="cca-main">
			  <div id="cbody" class="inn">
				
				 <div class="clearfix" style="padding:10px 0;">
				 	<a href="course_planManageInit.action" class="btn  btn-success" type="button"><i class="icon-arrow-left icon-white"></i>返回上层</a>
				 <div style="float:right;margin:0 5px;"><form class="form-horizontal"  action="course_scoreDownload.action?courseId=<%=i%>" method="post" style="display: inline"><button class="btn btn-primary" type="submit" ><i class="icon-download icon-white"></i>下载成绩表</button></form> <button id="submit" class="btn btn-primary" type="button" ><i class="icon-ok icon-white"></i>发布成绩</button><input type="hidden" id="isSubmit" value="<s:property value="coursedesign.scoreState"/>"/> </div>
				 </div>
