...
init.gridInit=function(){
	  ...
	  jQuery("#list").jqGrid({
		url:"admin_academyManage.action?opt=init",
	  	datatype: "json",
	  	altRows : 'true',
		height : "500",
		width:"800",
	    ...
	    viewrecords: true,
	    sortorder: "desc",
		editurl: "admin_academyManage.action?opt=add",
		keys:true,
		autowidth: true,
		caption: "部门（院系）表",
	     	colNames:['编号','院系部门名称','英文名称'],
	     	colModel:[
	  ...
	  {
		  //edit
		  url : "admin_academyManage.action?opt=edit", 
		  height:200,
		  width:400,
		  top:100,
		  left:500,
	  ...
	  },
	  {
		  ...
		  left:500,
		  reloadAfterSubmit:false,
		  url : "admin_academyManage.action?opt=del"
	  },
	  {
		  //search
