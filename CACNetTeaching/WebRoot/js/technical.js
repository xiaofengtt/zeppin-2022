...
init.gridInit=function(){
	  ...
	  jQuery("#list").jqGrid({
		url:"admin_technicalManage.action?opt=init",
	  	datatype: "json",
	  	altRows : 'true',
		height : "500",
		width:"800",
	    ...
	    viewrecords: true,
	    sortorder: "desc",
		editurl: "admin_technicalManage.action?opt=add",
		keys:true,
		autowidth: true,
		caption: "职称表",
	     	colNames:['编号','名称'],
	  ...
	  {
		  //edit
		  url : "admin_technicalManage.action?opt=edit", 
		  height:200,
		  top:100,
		  left:500,
	  ...
	  },
	  {
		  ...
		  left:500,
		  reloadAfterSubmit:false,
		  url : "admin_technicalManage.action?opt=del"
	  },
	  {
		  //search
