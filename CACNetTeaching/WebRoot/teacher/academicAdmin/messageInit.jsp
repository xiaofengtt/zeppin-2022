...
<script src="js/aMessageInit.js" type="text/javascript"></script>
    
	  <div class="cca-content">
		  <div class="cca-side">
			  <ul>
				  <li class=" chakanxiaoxi active"><a href="admin_messageInit.action">查看消息</a></li>
				   <li class=" fabuxiaoxi"><a href="admin_message.action">发布消息</a></li>
				  ...
				  <s:iterator value="lstSmm" id="sm">
					  ...
					  <div class="mod">
						  ...
						  <div class="bd">
							...
							<div class="info-date"><s:date name="#sm.message.sendTime" format="yyyy年MM月dd日 hh:mm:ss"/></div>
