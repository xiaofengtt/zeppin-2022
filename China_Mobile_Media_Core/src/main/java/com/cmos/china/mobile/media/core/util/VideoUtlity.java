...
public class VideoUtlity
{
    ...
    public static Boolean makeThumbnail(Resource resource, Double timeLength){
    	Integer imageCount = 10;
    	String outputPath = resource.getPath().substring(0,resource.getPath().lastIndexOf("/")+1) + "thumbnail.jpg";
    	Integer imageHeight = 255;
