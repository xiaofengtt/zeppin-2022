...
public class GestureSwitchButton extends CompoundButton {
    ...
    public GestureSwitchButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public GestureSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public GestureSwitchButton(Context context) {
        super(context);
        init(null);
    }
