...
import com.geng.library.base.BaseActivity;
...
import cn.zeppin.product.ntb.widget.DialogBinding;
import cn.zeppin.product.ntb.widget.DialogHelper;
 ...
 * 充值
 */
public class RechargeActivity2 extends BaseActivity<RechargePresenter, RechargeModel> implements RechargeContract.View, View.OnClickListener {
    @Bind(R.id.iv_back)
    ImageView ivBack;
...
//                double rechargePrice = buyPrice - accountBalance;
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_pay://支付
                ...
                if (price < 4) {
                    ...
                    //银行预留手机号
                    openSendsmsDialog("已发送至" + currentMyBank.getPhone() + "的手机");
                }
                break;
    ...
    private void openBankListDialog() {
        ...
        SelectBankAdapter mAdapter = new SelectBankAdapter(myBankList, currentMyBankUUid);
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                //记录当前选择的银行卡
                SpfUtil.putSerializable(RechargeActivity2.this, RECHARGE_BANK, currentMyBank);
                popDismiss(pop);
            }
        });
        ...
        pop.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                setBackgroundAlpha(RechargeActivity2.this, 1f);
            }
        });
    }
    ...
    private void getBindingCardPresenter(final String uuid) {
        mRxManager.add(Api.getTime().subscribe(new RxSubscriber<ResultData2<String>>(AppApplication.getAppContext(), false) {
            ...
            protected void _onNext(ResultData2<String> resultData2) {
                ...
                if (resultData2.success()) {
                    mRxManager.add(getBindingCardModel(uuid, ApiConstants.getToken(uuid, resultData2.getData())).subscribe(
                            new RxSubscriber<ResultData<MyBank>>(mContext, false) {
                                @Override
                                protected void _onNext(ResultData<MyBank> resultData) {
                                    if (resultData.success()) {
                                        returnMyBankList(resultData.getData());
                                    } else {
                                        showToastCenter(resultData.getMessage());
    ...
    private Observable<ResultData<MyBank>> getBindingCardModel(String uuid, String token) {
