...
//        Toast.makeText(this, "重写此方法显示自定义对话框", Toast.LENGTH_SHORT).show();
    ...
    private void customVersionDialogOne() {
        versionDialog = new BaseDialog(this, R.style.BaseDialog, R.layout.version_update_dialog);
        ...
        TextView tvDes= (TextView) versionDialog.findViewById(R.id.tv_des);
        tvTitle.setText(getVersionTitle());
        tvDes.setText(getVersionUpdateMsg());
    ...
    public void showLoadingDialog(int currentProgress) {
        if (!isCustomDownloading) {
            ...
            if (loadingDialog == null) {
                loadingView = LayoutInflater.from(this).inflate(R.layout.version_update_download, null);
